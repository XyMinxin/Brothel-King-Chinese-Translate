...
screen overlay(current_screen = None, kwargs=None, ttip=False):
    ...
    frame:
        ...
        button background None xalign 0.0 yalign 0.5 action NullAction():
            ...
            tooltip ("%s\n今天是%s, 第%i年的%i月%i日" % (moons[calendar.month].short_description, misc_name_dict[calendar.get_weekday()], calendar.year, calendar.month, calendar.day))
            ...
            hbox:
                ...
                text (" [calendar.day]日 (" + __(misc_name_dict[calendar.get_weekday()])[:3] + ")") size res_font(18) yalign 0.5
