...
screen button_overlay(girl, context="girls"):
    ...
    if context == "slavemarket":
        ...
        frame:
            ...
            if debug_mode:
                textbutton "图片" style "small_button" action (SetVariable("selected_girl", girl), Return("debug_pics")) text_size res_font(14) tooltip "Test girl pack with the game's picture generation." selected False
...
#            textbutton "Change program" text_size res_font(14) action Return(("change program", girl)) hovered tt.Action("Change " + girl.name + "'s current training program.")
            ...
            textbutton "离开农场" text_size res_font(14) action Return(("take out", girl)) hovered tt.Action("Send " + girl.name + " back to the brothel.")
