...
translate schinese strings:
    ...
    new "用魔法屏障保护你的女孩免受攻击。在女孩即将受到伤害时保护她。效果持续到阻挡一次攻击为止。"
    ...
    new "召唤一只不死鸟，它的鸣啼可以让人全身放松，轻松地摆出各种姿势。"
    ...
    new "外观并不代表一切，但是好皮囊总是更吃香一些。这种光环可以让你的女孩看起来更加美丽。"
    ...
    new "让你的赚钱机器开动起来。感谢万能的魔力。这种光环可以让女孩的身材看起来更加优美。"
    ...
    new "女孩的身上有一种神秘的气场，这让客人感到飘飘欲仙。这种光环可以激发女孩们的魅力。"
    ...
    new "不需要长年累月的积累，只需要用一些小魔法。这种光环能让你的女孩看起来更加优雅。"
    ...
    new "你的女孩们身上的神秘气场会让顾客们流连于此。这种气场会大幅提高女孩的魅力。"
    ...
    new "跪下，蛆虫们，违令者斩!这个光环能大幅提高女孩的服从性。"
    ...
    new "精密控制的魔力就像毛刷一样刺激着全身上下每一处部位。这个光环能大幅提高女孩的敏感度。"
    ...
    new "强大而又温柔的魔力顺着皮肤表面浸入身体。这种光环大大增强了女孩的体质。"
    ...
    new "一阵花香飘过，眼前仿佛出现万紫千红，女孩们的肉体和心灵都得到了治愈。"
    ...
    new "你就像是个只存在于传说中的混血精灵。你的精神力可以代替你的魅力进行检定。"
    ...
    new "这个技巧是从一个叫欧比旺的原力武士那里学来的。他用这招不知道免费吃了多少顿霸王餐。"
    ...
    new "在忧郁之月，人们感到沮丧和孤独。许多人在风月场所寻求慰藉。"
    ...
    new "腥红的月光会刺激人内心深处的暴力因子。每年的这个月犯罪率都会达到顶峰。"
    ...
    new "这是恋人们关系最为亲密的一个月，他们的爱情犹如盛开的花朵，灿烂而短暂。爱情不就是这样吗，昙花一现的怒放。"
    ...
    new "狩猎的季节开始了，一年一度的狩猎时刻。这个月对于长寿种来说尤其神圣。野兽的肉质在这个月达到最佳，矮人们喜欢把肉做成肉干配上自己酿的烈酒。"
    ...
    new "是时候收割庄稼、给奶牛挤奶，绵羊剃毛了....当然在情场上收割女性的芳心也是一种大丰收！你的工具是否足够强大？"
    ...
    new "银月的魔力正处于巅峰状态。经验丰富的法师会在这个月小心地施展他们的法术。有位巫师曾因在秘银之月释放‘阿瓦达索命’时魔力失控差点去世。"
    ...
    new "潮汐之力赋予月光神秘的波动。被月光照射到据说可以让身体放松，更加敏感。全身上下的每个毛孔都张开了..."
    ...
    new "这是一年中怪物和鬼魂最猖獗的时候，泽恩的女孩们会玩‘不给脱氧核糖就捣蛋’的游戏"
    ...
    new "失去了月光的夜晚，一切都显得更加可怕。灯火被暗影吞噬，据说只有举行名为性诞节的仪式后，月光才会恢复正常。"
