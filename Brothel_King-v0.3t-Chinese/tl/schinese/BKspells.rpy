# # TODO: Translation updated at 2024-04- 1:30
 ...
 translate schinese strings:
     ...
     new "用魔法屏障保护你的女孩免受外部攻击。在你的女孩即将受到伤害时抵御它。一直持续到阻挡下一次攻击为止。"


     # game/BKspells.rpy:21
     old "Pumping and Pimping."
     new "你四肢发达，力大无穷，头脑却不简单。"

     # game/BKspells.rpy:21
     old "It's like you can be everywhere at once."
     new "你可以随时出现在女孩身边保护她们。"
...
#     # game/BKspells.rpy:21
     ...
     new "青楼？这里更像是个军营，一群训练有素的士兵，准确的说是一群女兵。"
...
#     # game/BKspells.rpy:21
     ...
     new "外观并不代表一切，但是，嘿，它们很畅销。这种光环让你的女孩看起来更好。"



#     # game/BKspells.rpy:21
     old "AShake your money-maker. Now with magic. This aura enhances your girl's body."
     new "动摇你的赚钱机器。现在有了魔法。这种光环增强了你女孩的身体。"



#     # game/BKspells.rpy:21
     old "The air of mystery around your girls keep the patrons coming back for more. This aura boosts your girls' charm."
     new "女孩们周围的神秘气氛让顾客们流连忘返。这种光环增强了女孩的魅力。"



#     # game/BKspells.rpy:21
     old "It takes a real magician to make uncouth slaves look sophisticated. This aura makes your girls more refined."
     new "需要真正的魔术师才能让粗鲁的奴隶看起来很老练。这种气场让你的女孩更加精致。"
...
#     # game/BKspells.rpy:21
     ...
     new "只有真正的魔术师才能让粗野的奴隶看起来世故。这种气场让你的女孩更优雅。"
...
#     # game/BKspells.rpy:21
     ...
     new "现在，你知道有第五维度吗？还有第 6 个、第 7 个、第 13 个？"
...
#     # game/BKspells.rpy:21
     ...
     new "我的双脚有魔法。我的意思是，在两只脚上附魔一对风之翼。"
...
#     # game/BKspells.rpy:21
     ...
     new "这个招数是从一个叫索伦的珠宝商那里学来的。一个不错的家伙，只是对财宝有点着迷。催眠训练总会成功。"



#     # game/BKspells.rpy:21
     old "Learnt that trick from an old bum called Zobiwan. He was good at escorting druids, though."
     new "这个技巧是从一个叫佐比万的流浪之人那里学来的。他用这招不知道免费吃了多少顿霸王餐。"
...
#     # game/BKspells.rpy:98
     ...
     new "埃科埃洛斯新的一年刚刚开始！这是一年中最重要的节日。人们在市场上一掷千金来炫耀自己去年的好运气，并希望能一直保持下去。"
...
#     # game/BKspells.rpy:98
     ...
     new "枯萎之月没什么特别的，令人感到无聊。人们宁愿晚上加班，也不愿呆呆地盯着这暗淡的月亮。不如来把昆特牌？"
    


#     # game/BKspells.rpy:98
     old "Hunting season is at its peak. This month was especially holy to the elder races."
     new "狩猎季节来了，一年一度的狩猎时刻。这个月对于长寿种来说尤其神圣。野兽的肉质在这个月达到最佳，矮人们喜欢把肉做成肉干配上自己酿的烈酒。"
...
#     # game/BKspells.rpy:98
     ...
     new "银月的魔力正处于巅峰状态。经验丰富的法师会在这个月小心地施展他们的法术。有位巫师曾因在秘银之月释放‘阿瓦达啃大瓜’时魔力失控差点去世。"



#     # game/BKspells.rpy:98
     old "The water spirits grant the moon a surreal quality this month. It is said to make everyone loosen up a little."
     new "潮汐之力赋予月光神秘的波动。被月光照射到据说可以让身体放松，更加敏感。全身上下的每个毛孔仿佛都成为了..."
     ...
     new "为了纪念圣人净化百万恶魂而得名。这是一年中怪物和鬼魂最猖獗的时候，赞城的女孩们会玩‘不给脱氧核糖就捣蛋’的游戏"
     ...
     new "漆黑的月光下，一切都显得更加可怕。灯光再多也会被黑暗吞噬，夜晚只有在月底举行名为性诞节的仪式后才能恢复正常。"
# ###########################################################
