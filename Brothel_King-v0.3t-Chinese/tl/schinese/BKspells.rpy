...
translate schinese strings:
    ...
    # game/BKspells.rpy:21
     ...
     new "召唤一只神鸟，它的鸣啼可以让人全身放松，轻松地摆出各种姿势。"
...
#     # game/BKspells.rpy:98
     ...
     new "腥红的月光会刺激人内心深处的暴力因子。每年的这个月犯罪率都会达到顶峰。不过女冒险家也常因打斗而弄破衣服，。"

#     # game/BKspells.rpy:98
     old "A favorite month for lovers to elope together, their passion bright and short-lived as a spring flower."
     new "这是恋人们最喜欢的一个月，他们的激情如春天盛开的花朵，灿烂而短暂。爱情不就是这样吗，昙花一现的怒放。"
...
#     # game/BKspells.rpy:98
     ...
     new "枯萎之月没什么特别的，令人感到无聊。人们宁愿晚上加班，也不愿呆呆地盯着这暗淡的月亮。要不来把昆特牌？"
...
#     # game/BKspells.rpy:98
     ...
     new "为了纪念圣人净化百万恶魂而得名。这是一年中怪物和鬼魂最猖獗的时候，泽恩的女孩们会玩‘不给脱氧核糖就捣蛋’的游戏"
     ...
     new "在神秘的玄黑月光下，一切都显得更加可怕。灯火被暗影吞噬，只有在月底举行名为性诞节的仪式后，月亮才能恢复正常。"
# ###########################################################
