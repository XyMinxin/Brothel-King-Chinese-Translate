...
translate schinese strings:
    ...
    new "你已经激活了挑战。如果你想完成挑战，你就不能从后面的章节开始游戏。"
    ...
    new "'{i}这个钱包似乎很重。让我来替你拿吧...{/i}'\n\n{b}偷天换日{/b}\n所有的女孩都会扒窃. 拥有 {i}神偷{/i} 天赋的女孩永远不会失手。"
    ...
    new "在游戏开始时解锁瑞秋,拉米娅,古莉古拉,卡特琳, 双胞胎以及礼品店女孩。"
    ...
    new "明智地运用离岸金融、政治捐款和精心设计的巫术诅咒，这能减少你的税款。"
    ...
    new "从游戏一开始就获得一个生命扫描仪，允许你使用自动休息功能。"
    ...
    new "每个月月初你都会得到一个新的女孩，但奴隶市场将不再开放。如果你通关了本局游戏将获得100水晶。"
    ...
    new "农场训练变得更加有效率，但你将无法亲自训练你的女孩。如果你通关了本局游戏将获得200水晶。"
