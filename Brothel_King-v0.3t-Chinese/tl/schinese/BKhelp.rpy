...
# game/BKhelp.rpy:845
translate schinese help_MC_43e67d76:

    # sill "Please note that you can only use items that are intended {color=[c_main]}{b}for you{/b}{/color} and not {color=[c_pink]}{b}for your girls{/b}{/color}. Watch for the color in the item tab."
...
translate schinese help_brothel_intro_86408952:
    ...
    sill "还有一件事：如果你认识一些能人异士，你可以让她们协助你训练奴隶。他们会给青楼带来不小的助力。"
...
translate schinese help_shop_96c6c05e:
    ...
    sill happy "物品分为{color=[c_main]}主角物品{/color}、{color=[c_pink]}女孩物品{/color}和{color=[c_orange]}礼物{/color}这三类。查看道具详情时会标明类型。将鼠标悬停在每件道具上或点击它都可以了解更多信息。"

# game/BKhelp.rpy:1616
translate schinese help_shop_32c0b4e3:

    # sill "{b}{color=[c_main]}Personal items{/color}{/b} are intended for your use."
    sill "{b}{color=[c_main]}主角物品{/color}{/b}是供你使用的。"
...
translate schinese cheat_menu_daeba375:
...
# game/BKhelp.rpy:2653
translate schinese cheat_menu_f31de429:
