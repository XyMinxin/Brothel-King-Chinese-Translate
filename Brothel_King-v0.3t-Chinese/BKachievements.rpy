...
#                         Achievement("Bedded: The Adventurer", "You had sex with Scarlet.", pic="portrait.webp", pic_path="NPC/Jobgirl/", target="h jobgirl"), # Event not ready yet?
                        ...
                        Achievement("登峰造极", "有 %s 个女孩的全部技能超过 %s 。", pic="portrait.webp", pic_path="NPC/Sill/", target="ultimate", level_nb=5, requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 50, 2 : 100, 3 : 150, 4 : 200, 5 : 250}),
                        ...
                        Achievement("特质树：女仆", "在一名女孩上解锁女仆特质树上的所有特质分支。", pic="The Maid portrait.webp", pic_path="perks/", target="The Maid"),
                        Achievement("特质树：优伶", "在一名女孩上解锁优伶特质树上的所有特质分支。", pic="The Player portrait.webp", pic_path="perks/", target="The Player"),
                        Achievement("特质树：模特", "在一名女孩上解锁模特特质树上的所有特质分支。", pic="The Model portrait.webp", pic_path="perks/", target="The Model"),
                        Achievement("特质树：花魁", "在一名女孩上解锁花魁特质树上的所有特质分支。", pic="The Courtesan portrait.webp", pic_path="perks/", target="The Courtesan"),
                        Achievement("特质树：伴游", "在一名女孩上解锁伴游特质树上的所有特质分支。", pic="The Escort portrait.webp", pic_path="perks/", target="The Escort"),
                        Achievement("特质树：狐娘", "在一名女孩上解锁狐娘特质树上的所有特质分支。", pic="The Fox portrait.webp", pic_path="perks/", target="The Fox"),
                        Achievement("特质树：荡妇", "在一名女孩上解锁荡妇特质树上的所有特质分支。", pic="The Slut portrait.webp", pic_path="perks/", target="The Slut"),
                        Achievement("特质树：新娘", "在一名女孩上解锁新娘特质树上的所有特质分支。", pic="The Bride portrait.webp", pic_path="perks/", target="The Bride"),
