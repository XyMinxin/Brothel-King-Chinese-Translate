...
label init_items():
    python:
        ...
        all_items = [
                    ...
                    Item(name = '长枪', target = 'MC', type = IT_Weapon, pic = 'Lance.webp', rank = 2, rarity = 2, price = 2500, effects = (Effect('change', 'strength', 3), Effect('change', 'charisma', 1), ), description =  ""),
                    ...
                    Item(name = '礼剑', target = 'MC', type = IT_Weapon, pic = 'Rapier.webp', rank = 3, rarity = 3, price = 5000, effects = (Effect('change', 'strength', 4), Effect('change', 'charisma', 2), ), description =  ""),
                    ...
                    Item(name = '魔剑', target = 'MC', type = IT_Weapon, pic = 'Demon sword.webp', rank = 4, rarity = "S", price = 100000, effects = (Effect('change', 'strength', 8), Effect('change', 'charisma', 4), Effect('change', 'spirit', -2), ), description =  "剑刃随着被困在里面恶魔的黑暗怒火而跳动。据说他会吞噬每一个刀下亡魂。"),
                    ...
                    Item(name = '朽木法杖', target = 'MC', type = IT_Weapon, pic = 'Wooden staff.webp', rank = 1, rarity = 2, price = 500, effects = (Effect('change', 'spirit', 2), ), description =  ""),
                    Item(name = '地精法杖', target = 'MC', type = IT_Weapon, pic = 'Goblin staff.webp', rank = 2, rarity = 2, price = 1000, effects = (Effect('change', 'charisma', 1), Effect('change', 'spirit', 2), ), description =  ""),
                    Item(name = '黄铜法杖', target = 'MC', type = IT_Weapon, pic = 'Bronze staff.webp', rank = 2, rarity = 2, price = 2500, effects = (Effect('change', 'strength', 1), Effect('change', 'spirit', 3), ), description =  ""),
                    Item(name = '灵风法杖', target = 'MC', type = IT_Weapon, pic = 'Wind staff.webp', rank = 2, rarity = 3, price = 3500, effects = (Effect('change', 'strength', 1), Effect('change', 'charisma', 1), Effect('change', 'spirit', 3), ), description =  ""),
                    ...
                    Item(name = '幸运兔脚', target = 'girl', type = IT_Necklace, pic = 'Lucky charm.webp', rank = 1, rarity = 2, price = 1250, effects = (Effect('special', 'lucky', 1), ), description = "据说它能给主人带来好运。它的原主人兔子表示纯属造谣……"),
                    ...
                    Item(name = '魔兽核项链', target = 'girl', type = IT_Necklace, pic = 'Monster pearl necklace.webp', rank = 3, rarity = 5, price = 25000, effects = (Effect('boost', 'all sex skills gains', 0.1), ), description =  "它来自大海……"),
                    ...
                    Item(name = '魔法笔记本', target = 'MC', type = IT_Passive, pic = 'Magic notebook.webp', template = False, rank = 1, rarity = "S", price = 0, effects = (Effect('special', 'notebook', 1), ), description = "这个魔法笔记本将存储你知道的所有关于你的女孩的信息。它记录了你所有的想法。等等，别用它来做{i}那种事{/i}……太晚了吗。", hidden_effect = True),
                    ...
                    Item(name = '白色鲜花', target = 'girl', type = IT_Flower, pic = 'White flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'white', 1), ), description = "鲜花经常被用作表达爱意的礼物。", hidden_effect = True),
                    Item(name = '黄色鲜花', target = 'girl', type = IT_Flower, pic = 'Yellow flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'yellow', 1), ), description = "鲜花经常被用作表达爱意的礼物。", hidden_effect = True),
                    Item(name = '红色鲜花', target = 'girl', type = IT_Flower, pic = 'Red flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'red', 1), ), description = "鲜花经常被用作表达爱意的礼物。", hidden_effect = True),
                    Item(name = '绿色鲜花', target = 'girl', type = IT_Flower, pic = 'Green flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'green', 1), ), description = "鲜花经常被用作表达爱意的礼物。", hidden_effect = True),
                    Item(name = '蓝色鲜花', target = 'girl', type = IT_Flower, pic = 'Blue flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'blue', 1), ), description = "鲜花经常被用作表达爱意的礼物。", hidden_effect = True),
                    Item(name = '橙色鲜花', target = 'girl', type = IT_Flower, pic = 'Orange flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'orange', 1), ), description = "鲜花经常被用作表达爱意的礼物。", hidden_effect = True),
                    Item(name = '紫色鲜花', target = 'girl', type = IT_Flower, pic = 'Purple flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'purple', 1), ), description = "鲜花经常被用作表达爱意的礼物。", hidden_effect = True),
                    Item(name = '粉色鲜花', target = 'girl', type = IT_Flower, pic = 'Pink flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'pink', 1), ), description = "鲜花经常被用作表达爱意的礼物。", hidden_effect = True),
                    Item(name = '黑色鲜花', target = 'girl', type = IT_Flower, pic = 'Black flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'black', 1), ), description = "鲜花经常被用作表达爱意的礼物。", hidden_effect = True),
                    ]
        ...
        makibishi = Item(name = "撒菱", target = 'MC', type = IT_Misc, pic = 'bronze makibishi.webp', template = False, rank = 1, rarity = "S", price = 500, description = "在狩猎忍者的过程中自动抓住忍者。", hidden_effect = True)
...
label init_furniture():
    ...
    python:
        all_furniture = [
            ...
            Furniture('精美画作', type='Decoration', pic='Fantasy painting.webp', rank=2, chapter=3, cost=[('wood', 4), ('dye', 12), ('leather', 4), ], duration=3, effects=[Effect("allow", "craftsmen", 1, scope="brothel")], ),
            ...
            Furniture('大师画作', type='Decoration', pic='Erotic painting.webp', rank=3, chapter=5, cost=[('wood', 6), ('dye', 6), ('silk', 8), ('ore', 4), ], duration=6, effects=[Effect("allow", "patricians", 1, scope="brothel")], ),
            ...
            Furniture('小型吧台', type='Furnishing', pic='bar counter1.webp', rank=2, chapter=2, cost=[('wood', 4), ('leather', 4), ], duration=1, effects=[Effect("allow", "waitress preference", 1, scope="brothel")], ),
            Furniture('风雅吧台', type='Furnishing', pic='bar counter2.webp', rank=3, chapter=4, cost=[('wood', 4), ('dye', 4), ('leather', 4), ('marble', 4), ('ore', 2), ], duration=3, upgrade='小型吧台', effects=[Effect("allow", "waitress preference", 2, scope="brothel")], ),
            Furniture('清漆吧台', type='Furnishing', pic='bar counter3.webp', rank=4, chapter=6, cost=[('wood', 6), ('marble', 6), ('ore', 12), ], duration=5, upgrade='风雅吧台', effects=[Effect("allow", "waitress preference", 3, scope="brothel")], ),
            Furniture('漆雕吧台', type='Furnishing', pic='bar counter4.webp', rank=5, chapter=7, cost=[('marble', 5), ('ore', 10), ], duration=7, upgrade='清漆吧台', effects=[Effect("allow", "waitress preference", 5, scope="brothel")], ),
            ...
            Furniture('小型舞台', type='Furnishing', pic='stage1.webp', rank=2, chapter=2, cost=[('wood', 4), ('dye', 4), ], duration=1, effects=[Effect("allow", "dancer preference", 1, scope="brothel")], ),
            Furniture('业余舞台', type='Furnishing', pic='stage2.webp', rank=3, chapter=4, cost=[('leather', 12), ('marble', 4), ('ore', 2), ], duration=3, upgrade='小型舞台', effects=[Effect("allow", "dancer preference", 2, scope="brothel")], ),
            Furniture('剧院舞台', type='Furnishing', pic='stage3.webp', rank=4, chapter=6, cost=[('leather', 6), ('marble', 6), ('silk', 12), ], duration=5, upgrade='业余舞台', effects=[Effect("allow", "dancer preference", 3, scope="brothel")], ),
            Furniture('歌剧舞台', type='Furnishing', pic='stage4.webp', rank=5, chapter=7, cost=[('marble', 5), ('silk', 10), ], duration=7, upgrade='剧院舞台', effects=[Effect("allow", "dancer preference", 5, scope="brothel")], ),
            Furniture('小型席居', type='Furnishing', pic='tatami room1.webp', rank=2, chapter=2, cost=[('dye', 4), ('leather', 4), ], duration=1, effects=[Effect("allow", "geisha preference", 1, scope="brothel")], ),
            Furniture('花哨席居', type='Furnishing', pic='tatami room2.webp', rank=3, chapter=4, cost=[('dye', 12), ('silk', 6), ], duration=3, upgrade='小型席居', effects=[Effect("allow", "geisha preference", 2, scope="brothel")], ),
            Furniture('华美席居', type='Furnishing', pic='tatami room3.webp', rank=4, chapter=6, cost=[('dye', 6), ('silk', 12), ('ore', 6), ], duration=5, upgrade='花哨席居', effects=[Effect("allow", "geisha preference", 3, scope="brothel")], ),
            Furniture('雅致席居', type='Furnishing', pic='tatami room4.webp', rank=5, chapter=7, cost=[('silk', 10), ('ore', 5), ], duration=7, upgrade='华美席居', effects=[Effect("allow", "geisha preference", 5, scope="brothel")], ),
            Furniture('糖果自助机', type='Furnishing', pic='dispenser1.webp', rank=2, chapter=3, cost=[('wood', 6), ('dye', 4), ('leather', 6), ], duration=2, effects=[Effect("allow", "service preference", 1, scope="brothel")], ),
            Furniture('冰淇淋自助机', type='Furnishing', pic='dispenser2.webp', rank=3, chapter=5, cost=[('wood', 10), ('leather', 5), ('marble', 8), ('ore', 10), ], duration=4, upgrade='糖果自助机', effects=[Effect("allow", "service preference", 2, scope="brothel")], ),
            Furniture('棒棒糖自助机', type='Furnishing', pic='dispenser3.webp', rank=4, chapter=6, cost=[('leather', 6), ('marble', 8), ('ore', 12), ], duration=6, upgrade='冰淇淋自助机', effects=[Effect("allow", "service preference", 3, scope="brothel")], ),
            Furniture('魔法薄荷自助机', type='Furnishing', pic='dispenser4.webp', rank=5, chapter=7, cost=[('marble', 8), ('ore', 10), ], duration=8, upgrade='棒棒糖自助机', effects=[Effect("allow", "service preference", 5, scope="brothel")], ),
            Furniture('小型的情色收藏架', type='Furnishing', pic='shelves1.webp', rank=2, chapter=3, cost=[('wood', 6), ('dye', 6), ('leather', 4), ], duration=2, effects=[Effect("allow", "sex preference", 1, scope="brothel")], ),
            Furniture('新奇的情色收藏架', type='Furnishing', pic='shelves2.webp', rank=3, chapter=5, cost=[('wood', 5), ('leather', 10), ('marble', 10), ('ore', 8), ], duration=4, upgrade='小型的情色收藏架', effects=[Effect("allow", "sex preference", 2, scope="brothel")], ),
            Furniture('神秘的情色收藏架', type='Furnishing', pic='shelves3.webp', rank=4, chapter=6, cost=[('wood', 6), ('marble', 12), ('ore', 8), ], duration=6, upgrade='新奇的情色收藏架', effects=[Effect("allow", "sex preference", 3, scope="brothel")], ),
            Furniture('令人震撼的情色收藏架', type='Furnishing', pic='shelves4.webp', rank=5, chapter=7, cost=[('marble', 10), ('ore', 8), ], duration=8, upgrade='神秘的情色收藏架', effects=[Effect("allow", "sex preference", 5, scope="brothel")], ),
            Furniture('彩绘的维纳斯', type='Furnishing', pic='venus1.webp', rank=2, chapter=3, cost=[('dye', 16), ], duration=2, effects=[Effect("allow", "anal preference", 1, scope="brothel")], ),
            Furniture('大理石维纳斯', type='Furnishing', pic='venus2.webp', rank=3, chapter=5, cost=[('dye', 15), ('marble', 10), ('silk', 8), ], duration=4, upgrade='彩绘的维纳斯', effects=[Effect("allow", "anal preference", 2, scope="brothel")], ),
            Furniture('蒙面的维纳斯', type='Furnishing', pic='venus3.webp', rank=4, chapter=6, cost=[('dye', 6), ('marble', 8), ('silk', 12), ], duration=6, upgrade='大理石维纳斯', effects=[Effect("allow", "anal preference", 3, scope="brothel")], ),
            Furniture('发情的维纳斯', type='Furnishing', pic='venus4.webp', rank=5, chapter=7, cost=[('marble', 10), ('silk', 8), ], duration=8, upgrade='蒙面的维纳斯', effects=[Effect("allow", "anal preference", 5, scope="brothel")], ),
            Furniture('玩具木马', type='Furnishing', pic='woodhorse1.webp', rank=2, chapter=3, cost=[('wood', 6), ('dye', 2), ('leather', 8), ], duration=2, effects=[Effect("allow", "fetish preference", 1, scope="brothel")], ),
            Furniture('锯齿木马', type='Furnishing', pic='woodhorse2.webp', rank=3, chapter=5, cost=[('wood', 15), ('silk', 10), ('ore', 8), ], duration=4, upgrade='锯齿木马', effects=[Effect("allow", "fetish preference", 2, scope="brothel")], ),
            Furniture('古雅木马', type='Furnishing', pic='woodhorse3.webp', rank=4, chapter=6, cost=[('wood', 6), ('silk', 12), ('ore', 8), ], duration=6, upgrade='古雅木马', effects=[Effect("allow", "fetish preference", 3, scope="brothel")], ),
            Furniture('自动木马', type='Furnishing', pic='woodhorse4.webp', rank=5, chapter=7, cost=[('silk', 8), ('ore', 10), ], duration=8, upgrade='古雅木马', effects=[Effect("allow", "fetish preference", 5, scope="brothel")], ),
            Furniture('基础服装', type='Utility', pic='Basic outfit.webp', rank=0, chapter=0, cost=[], duration=0, effects=[Effect("special", "advertising power", 1, scope="brothel")], ),
            Furniture('牧工服装', type='Utility', pic='Shepherd outfit.webp', rank=2, chapter=2, cost=[('wood', 2), ('leather', 6), ], duration=0, upgrade='基础服装', effects=[Effect("special", "advertising power", 2, scope="brothel")], ),
            Furniture('祭司服装', type='Utility', pic='Priestess outfit.webp', rank=2, chapter=3, cost=[('dye', 8), ('leather', 12), ], duration=1, upgrade='牧工服装', effects=[Effect("special", "advertising power", 3, scope="brothel")], ),
            Furniture('轻薄服装', type='Utility', pic='Skimpy outfit.webp', rank=3, chapter=4, cost=[('dye', 8), ('leather', 4), ('silk', 4), ], duration=2, upgrade='祭司服装', effects=[Effect("special", "advertising power", 4, scope="brothel")], ),
            Furniture('性感服装', type='Utility', pic='Slutty outfit.webp', rank=3, chapter=5, cost=[('dye', 10), ('leather', 2), ('silk', 10), ('ore', 4), ], duration=2, upgrade='轻薄服装', effects=[Effect("special", "advertising power", 5, scope="brothel")], ),
            Furniture('和服服装', type='Utility', pic='Kimono outfit.webp', rank=4, chapter=6, cost=[('dye', 6), ('silk', 18), ], duration=3, upgrade='性感服装', effects=[Effect("special", "advertising power", 6, scope="brothel")], ),
            Furniture('偶像服装', type='Utility', pic='Idol outfit.webp', rank=5, chapter=7, cost=[('silk', 12), ('ore', 4), ], duration=3, upgrade='和服服装', effects=[Effect("special", "advertising power", 7, scope="brothel")], ),
            Furniture('基础门', type='Utility', pic='Basic door.webp', rank=0, chapter=0, cost=[], duration=0, effects=[Effect("boost", "security", 0, scope="brothel")], ),
            Furniture('围栏', type='Utility', pic='Fence.webp', rank=2, chapter=2, cost=[('wood', 4), ('leather', 4), ], duration=0, upgrade='基础门', effects=[Effect("boost", "security", 0.1, scope="brothel")], ),
            Furniture('小型陷阱', type='Utility', pic='Small traps.webp', rank=2, chapter=3, cost=[('leather', 20), ], duration=1, upgrade='围栏', effects=[Effect("boost", "security", 0.2, scope="brothel")], ),
            ...
            Furniture('魔法扫帚', type='Utility', pic='magic broom.webp', rank=3, chapter=5, cost=[('wood', 10), ('leather', 6), ('silk', 6), ], duration=2, upgrade='手推车', effects=[Effect("boost", "maintenance", 1, scope="brothel")], ),
            Furniture('蒸汽推车', type='Utility', pic='Steam cart.webp', rank=4, chapter=6, cost=[('leather', 6), ('marble', 6), ('silk', 6), ('ore', 6), ], duration=2, upgrade='手推车', effects=[Effect("boost", "maintenance", 1.5, scope="brothel")], ),
            Furniture('机械女仆', type='Utility', pic='Robot maid.webp', rank=5, chapter=7, cost=[('silk', 6), ('ore', 10), ], duration=3, upgrade='蒸汽推车', effects=[Effect("boost", "maintenance", 3, scope="brothel")], ),
            Furniture('木头雕像', type='Decoration', pic='Bronze statue.webp', rank=2, chapter=2, cost=[('wood', 4), ('dye', 4), ], duration=1, effects=[Effect("change", "brothel reputation", 6, scope="brothel")], ),
            Furniture('大理石雕像', type='Decoration', pic='Silver statue.webp', rank=3, chapter=4, cost=[('dye', 15), ('marble', 6), ], duration=2, upgrade='木头雕像', effects=[Effect("change", "brothel reputation", 12, scope="brothel")], ),
            Furniture('黄金雕像', type='Decoration', pic='Gold statue.webp', rank=4, chapter=6, cost=[('dye', 6), ('ore', 20), ], duration=3, upgrade='大理石雕像', effects=[Effect("change", "brothel reputation", 18, scope="brothel")], ),
            Furniture('铂金雕像', type='Decoration', pic='Platinum statue.webp', rank=5, chapter=7, cost=[('ore', 20), ('diamond', 1), ], duration=4, upgrade='黄金雕像', effects=[Effect("change", "brothel reputation", 24, scope="brothel")], ),
            Furniture('简易的保险箱', type='Utility', pic='safe1.webp', rank=2, chapter=2, cost=[('wood', 4), ('dye', 2), ('leather', 4), ], duration=3, effects=[Effect("special", "safe", 3000, scope="brothel")]),
            Furniture('带锁的保险箱', type='Utility', pic='safe2.webp', rank=3, chapter=4, cost=[('wood', 5), ('leather', 10), ('ore', 6), ], duration=5, upgrade='简易的保险箱', effects=[Effect("special", "safe", 6000, scope="brothel")]),
            Furniture('坚固的保险箱', type='Utility', pic='safe3.webp', rank=4, chapter=6, cost=[('wood', 6), ('marble', 8), ('ore', 12), ('diamond', 1), ], duration=7, upgrade='带锁的保险箱', effects=[Effect("special", "safe", 10000, scope="brothel")]),
            Furniture('牢不可破的保险箱', type='Utility', pic='safe4.webp', rank=5, chapter=7, cost=[('marble', 10), ('ore', 10), ('diamond', 2), ], duration=9, upgrade='坚固的保险箱', effects=[Effect("special", "safe", 20000, scope="brothel")]),
            ...
            Furniture('波斯窗', type='Windows', pic='oriental1.webp', rank=2, chapter=3, cost=[('wood', 6), ('dye', 6), ('leather', 6), ], duration=3, effects=[Effect("boost", "service preference increase", 0.25, scope="brothel")], ),
            ...
            Furniture('栅格窗', type='Windows', pic='barred1.webp', rank=2, chapter=3, cost=[('wood', 10), ('dye', 7), ('leather', 7), ], duration=4, effects=[Effect("boost", "fetish preference increase", 0.25, scope="brothel")], ),
            ...
            Furniture('彩色玻璃窗', type='Windows', pic='stainglass1.webp', rank=2, chapter=3, cost=[('wood', 10), ('dye', 8), ('leather', 8), ], duration=5, effects=[Effect("boost", "group preference increase", 0.25, scope="brothel")], ),
            Furniture('玻璃窗XL', type='Windows', pic='glass2.webp', rank=3, chapter=5, cost=[('wood', 5), ('dye', 10), ('marble', 6), ('silk', 6), ], duration=5, upgrade='玻璃窗', effects=[Effect("boost", "naked preference increase", 0.5, scope="brothel")], ),
            Furniture('波斯窗XL', type='Windows', pic='oriental2.webp', rank=3, chapter=5, cost=[('wood', 10), ('leather', 5), ('marble', 5), ('silk', 10), ], duration=5, upgrade='波斯窗', effects=[Effect("boost", "service preference increase", 0.5, scope="brothel")], ),
            ...
            Furniture('红色窗帘XL', type='Windows', pic='red curtains2.webp', rank=3, chapter=5, cost=[('dye', 10), ('silk', 18), ], duration=6, upgrade='红色窗帘', effects=[Effect("boost", "anal preference increase", 0.5, scope="brothel")], ),
            Furniture('栅格窗XL', type='Windows', pic='barred2.webp', rank=3, chapter=5, cost=[('wood', 10), ('leather', 5), ('marble', 10), ('ore', 10), ], duration=6, upgrade='栅格窗', effects=[Effect("boost", "fetish preference increase", 0.5, scope="brothel")], ),
            Furniture('双开玻璃窗XL', type='Windows', pic='double window2.webp', rank=3, chapter=5, cost=[('leather', 15), ('marble', 10), ('silk', 6), ('ore', 6), ], duration=7, upgrade='双开玻璃窗', effects=[Effect("boost", "bisexual preference increase", 0.5, scope="brothel")], ),
            Furniture('彩色玻璃窗XL', type='Windows', pic='stainglass2.webp', rank=3, chapter=5, cost=[('dye', 15), ('marble', 5), ('silk', 5), ('ore', 14), ], duration=7, upgrade='彩色玻璃窗', effects=[Effect("boost", "group preference increase", 0.5, scope="brothel")], ),
            Furniture('澡盆', type='Comfort', pic='Washtub.webp', rank=2, chapter=2, cost=[('wood', 4), ('dye', 4), ], duration=1, effects=[Effect("boost", "energy use", -0.1, scope="brothel")], ),
            Furniture('浴缸', type='Comfort', pic='Bathtub.webp', rank=3, chapter=4, cost=[('dye', 15), ('marble', 6), ], duration=3, upgrade='澡盆', effects=[Effect("boost", "energy use", -0.2, scope="brothel")], ),
            Furniture('贵族浴池', type='Comfort', pic='Royal bathtub.webp', rank=4, chapter=6, cost=[('dye', 8), ('marble', 15), ('silk', 15), ('diamond', 1), ], duration=5, upgrade='浴缸', effects=[Effect("boost", "energy use", -0.3, scope="brothel")], ),
            ...
            Furniture('简陋长椅', type='Comfort', pic='bench1.webp', rank=2, chapter=3, cost=[('wood', 25), ], duration=2, effects=[Effect("change", "job customer capacity", 1, scope="brothel")], ),
            Furniture('大型长椅', type='Comfort', pic='bench2.webp', rank=3, chapter=5, cost=[('wood', 10), ('leather', 6), ('marble', 15), ('ore', 10), ], duration=4, upgrade='简陋长椅', effects=[Effect("change", "job customer capacity", 2, scope="brothel")], ),
            Furniture('舒适沙发', type='Comfort', pic='sofa1.webp', rank=4, chapter=6, cost=[('leather', 10), ('silk', 20), ('diamond', 1), ], duration=6, upgrade='舒适长椅', effects=[Effect("change", "job customer capacity", 3, scope="brothel")], ),
            Furniture('贵族沙发', type='Comfort', pic='sofa2.webp', rank=5, chapter=7, cost=[('marble', 8), ('silk', 15), ('diamond', 2), ], duration=8, upgrade='舒适沙发', effects=[Effect("change", "job customer capacity", 4, scope="brothel")], ),
            Furniture('舒适的床', type='Comfort', pic='bed1.webp', rank=3, chapter=4, cost=[('wood', 12), ('leather', 10), ('silk', 6), ], duration=5, effects=[Effect("change", "whore customer capacity", 1, scope="brothel")], ),
            Furniture('天鹅绒', type='Comfort', pic='bed2.webp', rank=5, chapter=7, cost=[('marble', 10), ('silk', 20), ('diamond', 3), ], duration=10, upgrade='舒适的床', effects=[Effect("change", "whore customer capacity", 2, scope="brothel")], ),
            Furniture('简陋祭坛', type='Altars', pic='mana altar1.webp', rank=2, chapter=2, cost=[('wood', 2), ('dye', 2), ('leather', 4), ], duration=2, effects=[Effect("change", "mana", 1, scope="brothel")], ),
            Furniture('工作祭坛', type='Altars', pic='mana altar2.webp', rank=3, chapter=4, cost=[('leather', 15), ('marble', 3), ('silk', 2), ('ore', 1), ], duration=4, upgrade='简陋祭坛', effects=[Effect("change", "mana", 2, scope="brothel")], ),
            Furniture('权能祭坛', type='Altars', pic='mana altar3.webp', rank=4, chapter=6, cost=[('dye', 6), ('marble', 4), ('silk', 8), ('ore', 4), ('diamond', 1), ], duration=6, upgrade='工作祭坛', effects=[Effect("change", "mana", 3, scope="brothel")], ),
            Furniture('死亡祭坛', type='Altars', pic='mana altar4.webp', rank=5, chapter=7, cost=[('marble', 6), ('silk', 6), ('ore', 6), ('diamond', 2), ], duration=8, upgrade='权能祭坛', effects=[Effect("change", "mana", 4, scope="brothel")], ),
            ...
            Furniture('武器架XL', type='Utility', pic='weapon rack2.webp', rank=4, chapter=6, cost=[('wood', 6), ('marble', 10), ('ore', 12), ], duration=3, upgrade='武器架', effects=[Effect("change", "defense", 2, scope="brothel")], ),
            ...
            Furniture('昏暗的灯光', type='Comfort', pic='dim.webp', rank=3, chapter=4, cost=[('wood', 5), ('leather', 10), ('silk', 4), ('ore', 2), ], duration=3, effects=[Effect("boost", "customer events", 0.5, scope="brothel"), Effect("boost", "crazy", 1, scope="brothel")], can_deactivate=True),
            Furniture('明亮的灯光', type='Comfort', pic='bright.webp', rank=3, chapter=4, cost=[('wood', 10), ('leather', 5), ('silk', 2), ('ore', 4), ], duration=3, effects=[Effect("boost", "customer events", -1, scope="brothel"), Effect("boost", "crazy", -0.5, scope="brothel")], can_deactivate=True),
            Furniture('简易的书架', type='Comfort', pic='bookshelf1.webp', rank=2, chapter=2, cost=[('wood', 4), ('dye', 4), ('leather', 4), ], duration=3, effects=[Effect("set", "all skill max", 60, scope="brothel"), Effect("set", "all skill max", 60, scope="farm")], ),
            Furniture('精雕的书架', type='Comfort', pic='bookshelf2.webp', rank=3, chapter=4, cost=[('wood', 15), ('leather', 10), ('marble', 5), ('ore', 5), ], duration=6, upgrade='简易的书架', effects=[Effect("set", "all skill max", 115, scope="brothel"), Effect("set", "all skill max", 115, scope="farm")], ),
            Furniture('华丽的书架', type='Comfort', pic='bookshelf3.webp', rank=4, chapter=6, cost=[('wood', 6), ('marble', 15), ('silk', 5), ('ore', 5), ('diamond', 2), ], duration=9, upgrade='精雕的书架', effects=[Effect("set", "all skill max", 170, scope="brothel"), Effect("set", "all skill max", 170, scope="farm")], ),
            Furniture('奢华的书架', type='Comfort', pic='bookshelf4.webp', rank=5, chapter=7, cost=[('marble', 15), ('silk', 5), ('ore', 5), ('diamond', 4), ], duration=12, upgrade='华丽的书架', effects=[Effect("set", "all skill max", 225, scope="brothel"), Effect("set", "all skill max", 225, scope="farm")], ),
