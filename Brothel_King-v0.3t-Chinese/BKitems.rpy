...
label init_items():
    python:
        ...
        all_items = [
                    ...
                    Item(name = '橙郁鲜花', target = 'girl', type = IT_Flower, pic = 'Orange flower.webp', template = False, rank = 1, max_rank = 5, rarity = "F", price = 75, effects = (Effect('flower', 'orange', 1), ), description = "橙色鲜花接触皮肤会让皮肤变得十分敏感，你想涂在哪里？", hidden_effect = True),
