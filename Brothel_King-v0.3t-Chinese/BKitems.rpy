...
label init_furniture():
    ...
    python:
        all_furniture = [
            ...
            Furniture('舒适沙发', type='Comfort', pic='sofa1.webp', rank=4, chapter=6, cost=[('leather', 10), ('silk', 20), ('diamond', 1), ], duration=6, upgrade='大型长椅', effects=[Effect("change", "job customer capacity", 3, scope="brothel")], ),
