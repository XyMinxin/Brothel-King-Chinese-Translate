...
#        show screen dark_filter
            ...
            "Intervene and take [girl.name]'s side":
                ...
                if result >= 0:
                    ...
                    if punish_cust:
                        ...
                        $ attitude = girl.get_sex_attitude("fetish", fix)
    ...
    ### ONSEN ###
        ...
        $ pic = girl.get_pic("masseuse", "swim", "rest", and_tags=["rest"], naked_filter=True, soft=True)
        show screen show_img(pic)
        with fade
    ...
    if selected_act:
        ...
        $ girl.raise_preference(selected_act, bonus=intensity, context="misc")
    ...
    if changed_stats:
        ...
        python:
            for stat, value in changed_stats:
                ...
                if value > 5:
                    renpy.say("", __("[girl.name]'s [stat] skill has improved a lot."))
                elif value > 2:
                    renpy.say("", __("[girl.name]'s [stat] skill has improved."))
                elif value > 0:
                    renpy.say("", __("[girl.name]'s [stat] skill has improved a little."))
                elif value < -5:
                    renpy.say("", __("[girl.name]'s [stat] skill has decreased a lot."))
                elif value < -2:
                    renpy.say("", __("[girl.name]'s [stat] skill has decreased."))
                elif value < 0:
                    renpy.say("", __("[girl.name]'s [stat] skill has decreased a little."))
...
###
    ...
    elif punish_cust and fix in ["cowgirl", "femdom", "footjobs"]:
        $ pic = girl.get_fix_pic(selected_act, selected_fix, and_tags=and_tag, not_tags=["group", "bisexual", "cumshot"])
