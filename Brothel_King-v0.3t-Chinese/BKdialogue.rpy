...
#汉化标签，待润色#
    ...
    add_dialogue("slave thanks", ("generic"), ["谢谢。", "谢谢你，主人。", "谢谢你，[MC.name]。", "你真好。", "谢谢你，主人。我很感激。", "谢谢你，我很感激。"])
    ...
    add_dialogue("MC praise friend", ("generic"), "噢，谢谢你，主人！她会很高兴听到你这么说。 *微笑*", sound=s_laugh)
    ...
    add_dialogue("origin Westmarch", "generic", "我长大的西域公国是一个非常难以预测的地方。有一天，一座城市欣欣向荣，第二天，它就陷入无政府状态，掠夺者掠夺和掠夺城镇。我曾经认为危险是令人兴奋的，但我的[girl.story_guardian]一点也不喜欢它。")
    ...
    add_dialogue("slave reward sex accepted", "very lewd", "快来吧，主人。我幻想着这一刻自慰了好几回了....*脸红*", love=2, sound=s_ahaa, unlock="LM")
    add_dialogue("slave reward sex accepted", "lewd", "快来吧，主人。我已经饥渴难耐了....*微笑*。", love=1, sound=s_ahaa, unlock="LM")
    add_dialogue("slave reward sex accepted", "very modest", "噢，主人。我们就像恋人一样......噢......*脸红*", love=-1, sound=s_ahaa, unlock="LM")
    add_dialogue("slave reward sex accepted", "modest", "来吧，主人。请...温柔点...*微笑*", love=-0.5, sound=s_ahaa, unlock="LM")

    add_dialogue("slave reward sex resisted", "very dom", "什么？不！！！这算哪门子的奖励啊！！！", love=-2, sound=s_surprise, unlock="LM")
    add_dialogue("slave reward sex resisted", "dom", "这....这根本算不上是奖励....唉....", love=-1, sound=s_surprise, unlock="LM")
    add_dialogue("slave reward sex resisted", "very sub", "但、但是....我不想....你难道要....强迫我吗？", love=1, sound=s_surprise, unlock="LM")
    add_dialogue("slave reward sex resisted", "sub", "噢，我不想那样做！请你换个奖励吧！", love=0.5, sound=s_surprise, unlock="LM")

    # The love/fear penalty when refusing is handled within the 'resolve' method
    add_dialogue("slave reward sex refused", "dom", "什么？！？没门！！！离我远点！！！", sound=s_scream)
    add_dialogue("slave reward sex refused", "sub", "等等，不！！！我才不想和你...", sound=s_surprise)

    add_dialogue("slave reward praise", "very idealist", "谢谢你，主人。我会让你为我感到骄傲。", unlock="MI", love=1)
    add_dialogue("slave reward praise", "idealist", "谢谢你，主人。我很高兴您对我满意。", unlock="MI", love=0.5)
    add_dialogue("slave reward praise", "very materialist", "嗯...你不打算给我一些物质奖励吗？口头表扬太廉价了。", love=-1, unlock="MI")
    add_dialogue("slave reward praise", "materialist", "谢谢，我想...这是否意味着我会得到什么奖励？", love=-0.5, unlock="MI")

    add_dialogue("slave reward gold", "very idealist", "嗯...感觉就像你想贿赂我...但还是谢谢，我想。", love=-1, unlock="MI")
    add_dialogue("slave reward gold", "idealist", "好的，谢谢。", love=-0.5, unlock="MI")
    add_dialogue("slave reward gold", "very materialist", "天呐，好多金币！太好了....谢谢你，主人！", love=1, unlock="MI")
    add_dialogue("slave reward gold", "materialist", "谢谢你，主人。我一分钱也不会浪费的。", love=0.5, unlock="MI")

    add_dialogue("slave reward pet", "very dom", ["你想要给她一个拥抱，但她有些紧张，向后闪躲。", "g: 一个拥抱，你是认真的吗？拜托..."], multiple=True, love=-1, unlock="DS")
    add_dialogue("slave reward pet", "dom", ["你摸了摸她的头，而她只是被动地站在那里。随后她迅速离开。", "g: 谢谢....这就足够了。我还有事要忙，先走一步。"], multiple=True, love=-0.5, unlock="DS")
    add_dialogue("slave reward pet", "very sub", ["你把她的头枕在膝盖上，温柔地抚摸她的发丝。你可以听到她的呼噜声。", "g: 噢，主人....在你的怀抱里我感觉很安全...."], multiple=True, love=1, unlock="DS")
    add_dialogue("slave reward pet", "sub", ["你给了她一个拥抱，她双手环抱在背，依偎在你的肩膀上。", "g: 谢谢你，主人。我感觉好多了..."], multiple=True, love=0.5, unlock="DS")

    add_dialogue("slave reward day off", ("very dom", "very extravert"), "谢谢你主人！我总算有空可以做我想做的事了！", love=1, unlock="DS")
    add_dialogue("slave reward day off", ("dom", "extravert"), "真的吗？谢谢你，主人，这真是一​​个巨大的惊喜....", love=0.5, unlock="DS")
    add_dialogue("slave reward day off", ("very sub", "very introvert"), "呃，什么？但、但是....我应该去哪里？？？", love=-1, unlock="DS")
    add_dialogue("slave reward day off", ("sub", "introvert"), "呃？嗯....谢谢你，主人。我会努力享受它。", love=-0.5, unlock="DS")
    add_dialogue("slave reward day off KO", "generic", ["g: 但是主人，我今天本来就休息啊....", "mc: 啊，对。我记性不太好，哈哈。"], multiple=True)

    add_dialogue("slave punish scold deserved", "very idealist", ["她看起来被你的批评伤到了自尊。", "g: 我知道，我必须做到完美....对不起。"], multiple=True, fear=1, unlock="MI")
    add_dialogue("slave punish scold deserved", "idealist", ["她看起来很受伤。", "g: 很抱歉我没有让您满意。"], multiple=True, fear=0.5, unlock="MI")
    add_dialogue("slave punish scold deserved", "very materialist", ["她嗤之以鼻。", "g: 我就这样，对....随你怎么说。"], multiple=True, fear=-1, love=-0.5, unlock="MI")
    add_dialogue("slave punish scold deserved", "materialist", ["她看起来很生气。", "g: 哼...."], multiple=True, fear=-0.5, unlock="MI")

    add_dialogue("slave punish scold undeserved", "very idealist", ["她看起来被你的批评深深伤害了。", "g: 不是那样的...我尽力了！"], multiple=True, fear=1, love=-2, unlock="MI")
    ...
    add_dialogue("slave punish upkeep", ("materialist"), "无偿工作？噢，拜托！", fear=-0.5, unlock="MI")
    add_dialogue("slave punish upkeep KO", "generic", ["g: 但、但是....你已经克扣了我的薪水....", "mc: 哦，没错，嗯....我只是在测试你。"], multiple=True)

    add_dialogue("slave punish beat", "very dom", ["当你用力地打她时，她大喊大叫，你嘴上也没有停下侮辱她的话。", "g: 这就是你的全部本事了吗？啊啊！！！你这个混蛋....啊啊！"], multiple=True, fear=-1, sound=s_screams, unlock="DS")
    add_dialogue("slave punish beat", "dom", ["她咬紧牙关，等待惩罚结束。", "我才不在乎你对我做什么...啊啊！！！"], multiple=True, fear=-0.5, sound=s_screams, unlock="DS")
    add_dialogue("slave punish beat", "very sub", ["当你打她时，她泪流不止，直到她的屁股完全变肿发红。", "g: 哦....对不起，主人....*呜咽*"], multiple=True, fear=1, sound=s_screams, unlock="DS")
    add_dialogue("slave punish beat", "sub", ["当你让她尝尝你的惩罚时，每一次打击都伴随着她的哭泣和尖叫。", "g: 啊！啊啊哈！！！主人....求你了....啊啊！"], multiple=True, fear=0.5, sound=s_screams, unlock="DS")

    add_dialogue("slave punish farm", "very dom", "你不能这样对我！不！！！ *害怕*", fear=1, unlock="DS")
    add_dialogue("slave punish farm", "dom", "让我去农场？你在想什么？！？", fear=0.5, unlock="DS")
    add_dialogue("slave punish farm", "very sub", "*沉默*...", fear=-1, unlock="DS")
    add_dialogue("slave punish farm", "sub", "农场....真是个可怕的地方....", fear=-0.5, unlock="DS")

    add_dialogue("slave punish naked", "very lewd", "主人....你在做什么....*撕拉* 啊啊！", fear=-1, unlock="LM")
    add_dialogue("slave punish naked", "lewd", "不，主人....不是那样的..*撕拉*..*抽泣*", fear=-0.5, unlock="LM")
    add_dialogue("slave punish naked", "very modest", "呀！！！别碰我！！！不要！！！*撕拉*", fear=1, unlock="LM")
    add_dialogue("slave punish naked", "modest", "不！！！你以为你在做什么！！！*撕拉*", fear=0.5, unlock="LM")
    add_dialogue("slave punish naked KO", "generic", ["g: 呃？但是主人....我身上一块布料都没有了....", "mc: 呃....当然。我只是开个玩笑，国王的新装嘛，啊哈哈哈..."], multiple=True)
    ...
    add_dialogue("slave rape positive fixation", "generic", "啊，好羞耻啊....嗯....*脸红*", love=1, fear=-1, sound=s_aaah)
    add_dialogue("slave rape negative fixation", "generic", "不，不行！！！不不不！！！", love=-2, fear=3, sound=s_scream_loud)

    ### GIRL TAB DIALOGUE ###

    add_dialogue("rest", "generic", "那我就去休息了。{w=1.0}{nw}")
    add_dialogue("accept job", "generic", "我现在将作为{b}[girl.job_cn]{/b}服务客人。{w=1.0}{nw}")
    add_dialogue("work_whore", "generic", "我现在将一边作为{b}[girl.job_cn]{/b}服务客人，一边勾引客人上床。{w=1.0}{nw}")
    add_dialogue("exhausted", "generic", "对不起主人，我还是很累，需要多休息。休整完毕后，我才能继续作为{b}[girl.job_cn]{/b}服务客人。")

    add_dialogue("rank up", "generic", "谢谢你，主人。我现在是一名[newrank]阶的奴隶了！")

    add_dialogue("refuse whoring", "generic", "哼，没门！！！我可不是水性杨花的女人！")
    add_dialogue("refuse sex act", "generic", ["我不会那样做的！", "不行....不行！！！", "我....还没准备好。"])

    ### MARKET DIALOGUE ###

    add_dialogue("bought", "generic", "请对我好一点，主人。")
    add_dialogue("freed", "generic", "好吧，那就有缘再见了....")
    add_dialogue("freed", "masochist", "不！别抛弃我...我需要你，主人...")
    add_dialogue("sold", "generic", ["...", "那就再见了，那么....", "主人，我这就去收拾行李...."])
    add_dialogue("sold love", "generic", ["但、但是，主人！我...我爱你...*抽泣*", "不，主人！我想和你在一起... *抽泣*"], sound=s_surprise)

    ### POSTINGS DIALOGUE ###

    add_dialogue("leave for quest", "generic", "主人，我出发了。希望任务不要太难。")
    add_dialogue("leave for class", "generic", "主人，我走了。回头见。")

    ### NIGHT DIALOGUE ###

    # Note: "advertise" cannot use multiple lines
    add_dialogue("advertise", "generic", ["先生！要来试试我们的新套餐吗？ *咯咯*", "我好寂寞，先生....你能进来陪陪我吗？[emo_heart]", "我感觉好热....你好帅呀....[emo_heart]", "先生，喜欢里面这副景色吗？ *微笑*", "来吧，先生！好好奖励一下自己。[emo_heart]", "青楼规定客人不能与员工发生肢体接触，但我想这里很欢迎不守规矩的人....", "如果你想享用我性感的肉体，来饱餐一顿吧！[emo_heart] *眨眼*", "要加入我们刺激的派对吗，先生？ *微笑*", "你看过我的表演吗？虽然我的胸部没有那么大，但它的形状很好！", "来吧，甜心！我会给你一些特殊服务...[emo_heart]"])

    ### CITY EVENTS DIALOGUE ###

    add_dialogue("beach intro", "extravert", ["[girl.fullname]正在海滩上和一群人闲聊，其中一些人毫不掩饰地欣赏她健美的身材。"], sound=s_laugh)
    add_dialogue("beach intro", "introvert", ["在距离人群很远的地方，[girl.fullname]正看着波光粼粼的海面。"], sound=s_sigh)
    add_dialogue("beach meet MC", "modest", ["g: 哦，[MC.name]！我没注意到你在这...", "她本能地用毛巾遮住自己的身体，一副害羞的样子。", "mc: 算了吧，你的身体我早就看够了。", "g: ..."], multiple=True)
    add_dialogue("beach meet MC", "lewd", ["g: 您好，[MC.name]！你是来欣赏风景的吗？", "她毫不谦虚地炫耀自己的美貌，当她等待你的回应时，眼中闪烁着俏皮的光芒。", "mc: 是啊....确实很美....", "g: 哈哈，我就知道你喜欢。 *眨眼*"], multiple=True)
    add_dialogue("beach meet MC", "sub", ["g: 主、主人？对不起，我不是在偷懒....", "她在你面前畏畏缩缩，等待你的回应。", "mc: 别紧张，今天是你的假期。", "g: 咳咳，是的....谢谢。"], multiple=True)
    add_dialogue("beach meet MC", "dom", ["g: 什么？我就不能安安静静地享受假期吗？", "当你靠近她时，她摆出防御姿态。", "mc: 哇，注意你的语气，奴隶。我只是顺路过来。", "g: 哼。好吧，我想我可以在完美的早晨休息一下再和你谈谈......"], multiple=True)

    add_dialogue("beach oiling", "modest", ["哦...这很舒服，但是你能不能别把手放到那里...啊啊！"], sound=s_surprise)
    add_dialogue("beach oiling", "lewd", ["这太棒了，你能帮我抹抹别的地方吗....嗯，是的，就像这样，还有那里..."], sound=s_ahaa)

    add_dialogue("beach accept oiling", "modest", ["主人，你、你在做什么....那里不需要....呜呜...."])
    add_dialogue("beach accept oiling", "lewd", ["哦，你真顽皮....嗯...."])

    add_dialogue("beach refuse oiling", "dom", ["嘿！我确信那里不会被晒伤，非常感谢！请停手吧。"])
    add_dialogue("beach refuse oiling", "sub", ["不、不是这里，主人！我受够了....请停下来吧。"])

    add_dialogue("beach accept public sex", "modest", ["g: 哦，主人！大家正在看着我们，但是...我的身体感觉很热...请继续做下去吧...", "当你抓住她的臀部并向她靠近时，她喘息着。"], multiple=True)
    add_dialogue("beach accept public sex", "lewd", ["g: 我以为你没这个胆子呢！", "她用双手扒下了你的泳裤，掏出了你的鸡巴。"], multiple=True)

    add_dialogue("beach refuse public sex", "dom", ["大庭广众下做这种事？你疯了吗？！？"])
    add_dialogue("beach refuse public sex", "sub", ["请原谅我，但这是不可能的！对不起，对不起！"])

    add_dialogue("beach accept sex", "modest", ["哦，好的...."])
    add_dialogue("beach accept sex", "lewd", ["为什么不？我想这应该会很有趣..."])

    add_dialogue("beach refuse sex", "dom", ["真不敢相信！你太过分了！今天是我的假期，该死！"])
    add_dialogue("beach refuse sex", "sub", ["请主人原谅我，但这是不可能的！对不起，对不起！"])

    add_dialogue("beach whoring request", "materialist", ["无偿工作？在我的休息日？我的天呐！"])
    add_dialogue("beach whoring request", "idealist", ["你说好要让我好好休息的！你不能食言...."])

    add_dialogue("beach whoring accept", "lewd", ["好吧，反正我也没有其他事要做....不就是卖身么....我会做的。"])
    add_dialogue("beach whoring accept", "modest", ["噢，主人，既然是您的命令....我马上就去准备。"])

    add_dialogue("beach whoring refuse", "materialist", ["哼，我也不想啊！你需要付给我更多的薪水才能让我放弃假期......"])
    add_dialogue("beach whoring refuse", "idealist", ["不，这不是一个公平的交易。我需要休息。没得商量！"])

## v0.3 Dialogue addition


    add_dialogue("slave confused", "materialist", ["哎呀，刚刚发生了什么....我感觉好奇怪....至少我还完整。"])
    add_dialogue("slave confused", "idealist", ["什、发生什么事了？我突然感觉自己不像自己了"])
    add_dialogue("slave confused", "dom", ["嘿，什么....你在看什么？我脸上有东西吗？"])
    add_dialogue("slave confused", "sub", ["呃....我是不是睡着了？对不起...."])
...
## START PERVERT DIALOGUE 03.February.2022
    ...
    add_dialogue("slave positive reaction", ("pervert", "very extravert"), ["哇，我很感激。", "惊人的！", "甜的！谢谢你，主人。"])
    ...
    add_dialogue("slave send to master bedroom love +", ("pervert", "very lewd"), ["她对你的决定感到非常高兴。", "g: 哦，我会喜欢的！谢谢你，主人。我可以带我的玩具吗？"], multiple=True)
    ...
    add_dialogue("MC praise friend", ("pervert", "very lewd"), ("*咯咯*哦，谢谢你，主人。你不会相信我们在一起讨论什么样的变态话题。"), sound=s_laugh)
    ...
    add_dialogue("origin Karkyr", ("pervert", "very lewd"), ["g: 卡尔基的生活给我们带来了沉重的打击。我和我的[girl.story_guardian]都是局外人，从来没有教过如何使用魔法或保护自己免受魔法伤害。结果，我们无力抵抗那些试图入侵我们心灵的卡尔基公民。", "g: 我们经常遇到陌生人倾听我们的想法，或者在我们的脑海中植入变态的幻想。心灵强奸，就是这样....", "g: *叹气*你可能认为我疯了，不是吗？你无法想象我所经历的精神折磨......"], multiple=True)
    add_dialogue("origin Westmarch", ("pervert", "very lewd"), ["g: 西域公国是一个混乱的地方。你可以生活在肮脏或奢华中，但角色也可以很容易互换。", "g: 当我的[girl.story_guardian]继承了一个小头衔时，我们简直不敢相信自己的运气。从我们的 [girl.story_home] 搬到一座城堡，就像梦想成真一样。", "g: 那周晚些时候，我发现自己躲在地下室里，因为我们的城堡遭到掠夺并被烧毁。我的 [girl.story_guardian] 在被强奸时痛苦地尖叫。不久之后我发现自己来到了泽恩。"], multiple=True)
...
## START REBEL DIALOGUE 03.February.2022
    ...
    add_dialogue("free_give_gold +++", ("rebel", "schemer"), ("在我母亲的坟墓上，我保证今晚我不会把这些金币花在性奴隶和酒上。"), love=6, max_cap=75)
    ...
    add_dialogue("free_friend no_lie", ("rebel"), ["g: 操他妈的！那么您可以在金币滚滚而来的时候放松一下吗？", "mc: 还有更多的事情要做。女孩们可能会很多。需要花费很多时间来让他们保持一致。", "她点头同意。", "g: 我完全明白你的意思。有些人只能通过艰难的方式才能学到东西。", "mc: 那么，你也做了类似的事情吗？", "g: 我？不....我现在正处于两件事之间。"], multiple=True, love=3)
...
## START COLD DIALOGUE 03.February.2022
    ...
    add_dialogue("free_give_gold --", ("cold", "rebel", "stubborn", "princess"), ("我不需要你的金币。"), love=-2, max_cap=75)
    ...
    add_dialogue("slave lecture fascinated", ("cold", "very introvert"), ("明白了....谢谢你，主人。"), sound=s_aah)
...
## START MEEK DIALOGUE 03.February.2022
    ...
    add_dialogue("slave send to master bedroom love", ("generic", "very introvert", "very idealist", "very modest", "very sub"), ["她微笑着鞠躬。", "g: 谢谢，谢谢你，主人。"], multiple=True)
    ...
    add_dialogue("origin Karkyr", ("meek", "very introvert"), ["g: 卡尔基的一切都被魔法污染了。这听起来可能很有趣，但它很快就会过时。", "g: 想象一下：你正在和你的[girl.story_guardian]一起吃晚饭。你想问他们今天过得怎么样，但墙壁长了眼睛，桌布开始飞扬，餐具尖叫着侮辱你。每个糟糕透顶的日子。"], multiple=True)
    add_dialogue("origin Westmarch", ("meek", "very sub"), ("在西域公国，叛乱司空见惯，以至于我的[girl.story_guardian]每隔几周就会侍奉一位新主人。我想这就是为什么我讨厌冲突，即使是现在。"), multiple=True)
...
## START SWEET DIALOGUE 03.February.2022
    ...
    add_dialogue("slave reward gold", ("sweet", "very modest"), ("谢谢你，主人。我会好好利用这个。"), unlock="MI")
...
## START SUPERFICIAL DIALOGUE 03.February.2022
    ...
    add_dialogue("origin Westmarch", ("superficial", "very extravert", "very materialist", "very modest"), ["g: 我们在西域公国的生活很混乱。你永远不确定自己的存在。", "g: 战争还是和平。奢侈或无家可归。生活每天都会发生巨大的变化。我可以依靠我的[girl.story_guardian]，这是一件好事。"], multiple=True)
    ...
    add_dialogue("slave reward day off", ("superficial", "very extravert"), ("我现在完全值得一些自己的时间。谢谢你，主人！"), love=1, unlock="DS")
...
## START BIMBO DIALOGUE 03.February.2022
    ...
    add_dialogue("slave reward gold", ("very materialist"), ("哦，金子！太好了....谢谢你，主人！"), love=2, unlock="MI")
    ...
    add_dialogue("slave reward day off", ("bimbo" , "very sub", "very introvert"), ("呃？嗯....谢谢你，主人。我会努力享受它。"), love=-1, unlock="DS")
...
## START HELPER DIALOGUE 03.February.2022
    ...
    add_dialogue("slave thanks", ("helper"), ("谢谢。", "谢谢你，主人。", "谢谢你，[MC.name]主人。", "谢谢你，主人。", "谢谢你，主人。我很感激。", "谢谢你，我很感激。"))
    ...
    add_dialogue("MC praise friend", ("helper"), ("噢，谢谢你，主人！她会很高兴听到你这么说。 *微笑*"), sound=s_laugh)
    ...
    add_dialogue("slave chat origins 1", ("helper"), ("我很高兴你对我感兴趣，主人。我来自[girl.origin]。", "谢谢你，主人的提问。我出生在[girl.origin]。", "我很高兴你对我感兴趣，[MC.name]主人。我的家人来自[girl.origin]。"), unlock="EI")
...
## START REPRESSED DIALOGUE 03.February.2022
    ...
    add_dialogue("slave chat slave_life 1", ("repressed"), ["她笑了。", "g: 我喜欢当奴隶，主人。", "g: 我喜欢这样，当我没有自己决定事情的时候..", "g: 它帮助我控制危险的冲动。", "g: 这样我就有安全感了。谢谢你，主人。"], multiple=True, unlock="DS")
    ...
    add_dialogue("slave reward pet", ("repressed", "very sub"), ["你给了她一个拥抱，她靠在你的肩上，把头靠在你的肩上。", "g: 谢谢你，主人。感觉不错..."], multiple=True, love=1, unlock="DS")
    add_dialogue("slave reward day off", ("repressed","very extravert"), ("真的吗？谢谢你，主人，真是一​​个惊喜...."), love=1, unlock="DS")
...
## START PRUDE DIALOGUE 03.February.2022
    ...
    add_dialogue("free_girlfriend intro", ("prude"), ["g: 哦，很高兴见到你[MC.name]。我们可以一起度过一段时间吗？", "mc: 当然可以！想要玩个小游戏吗，[girl.name]？", "g: 呃，游戏？我发现大多数游戏都非常无聊。你有什么想法？", "mc: 这个在西域的贵族中非常流行。他们称之为{i}诚实和勇气{/i}。", "g: *喘息*这个名字确实反映了一些令人钦佩的品质。它是如何工作的？", "mc: 这是一款旨在向年轻贵族传授这些美德重要性的游戏。", "mc: 我们每个人轮流。你可以问我任何问题，我必须诚实回答，或者你可以向我提出任何挑战，考验我的勇气和决心。", "g: 多么迷人啊！很好....我问你一个问题！"], multiple=True)
    ...
    add_dialogue("accept farm", ("prude", "very modest"), ("我可以利用一些时间休息。远离这一切污秽....", "我当然不会错过我们的客户。", "哦，我会喜欢的。终于呼吸到新鲜空气了！", "谢谢你，主人。我期待着离开青楼一段时间。"))
...
## START PRINCESS DIALOGUE 03.February.2022
    ...
    add_dialogue("origin Westmarch", ("princess"), ["g: 我长大的西域公国是一个非常难以预测的地方。有一天，一座城市欣欣向荣，第二天，它就陷入无政府状态，掠夺者掠夺和掠夺城镇。我来自那里的一个古老家庭，他们在战争中失去了一切。", "g: 我和我的[girl.story_guardian]一起长大，他教会了我优良的血统和血管里流淌的高贵血统，以及我应该如何做相应的行为", "g: 我的[girl.story_guardian]曾经说过，像我这样为我们暂时陷入困境的家庭发芽的一朵玫瑰花，抵得上一百个农民或城市里的平民。这就是我从小到大所相信的。", "g: 最近，我听到一些让我烦恼的事情。一个女孩子骂我是个被宠坏的小妖精！", "g: 我不是风骚的！我绝对没有被宠坏。我不想被宠坏！主人，你觉得我被宠坏了吗？", "她看起来很悲伤。"], multiple=True)
...
## START PET DIALOGUE 03.February.2022
    ...
    add_dialogue("free_give_gold --", ("pet", "meek", "masochist"), ("我很困惑...你凭什么认为我想要你的金币？"), love=-2, max_cap=75)
...
## START CLASS PRESIDENT DIALOGUE 03.February.2022
    ...
    add_dialogue("rank up", ("generic"), ("谢谢你，主人。我现在是一名[newrank]奴隶。"))
...
## START LOYAL DIALOGUE 03.February.2022
    ...
    add_dialogue("slave thanks", ("loyal", "very sub"), ("谢谢。", "谢谢你，主人！你欣赏我的努力让我很高兴。", "谢谢你，[MC.name]主人。我只乐意尽我的职责。", "谢谢你，主人。", "谢谢你，主人。我很感激。", "谢谢您，我很高兴您发现我的工作符合 [brothel.name] 的标准。", "谢谢你，先生！我真的很感谢您给我这个机会！"))
    add_dialogue("slave effusive thanks", ("loyal", "very sub"), ("噢，谢谢你，主人！太感谢了！", "噢，我真是太感谢主人了！谢谢你！", "主人，我很高兴您为我提供了工作，并且似乎对我的贡献感到满意！"))
    ...
    add_dialogue("slave send to master bedroom love", ("loyal", "very idealist", "very sub"), ("谢谢你，主人！看来你对我最近在你青楼的工作很满意！ *微笑*"))
    ...
    add_dialogue("origin Karkyr", ("loyal", "very idealist"), ["g: 卡尔基是一个适合小女孩成长的有趣城市！一切都很神奇，天空充满了火花，发生了很多事情！", "g: 我曾经尝试偷偷溜出去观看法师施展法术，而我的[girl.story_guardian]常常责骂我。", "g: 我是一个多么不守规矩的孩子，直到有一天我吸取了教训。", "g: 涉及到一位大法师、我和一些普通的家养猫狗，有触手....*脸红*", "g: 这教会了我不要多管闲事！我答应过我会按照别人告诉我的去做....希望有一天生活会回报我。"], multiple=True)
    add_dialogue("origin Westmarch", ("loyal", "very sub"), ["g: 我在西域公国度过了一段美好的童年。当地的王子心胸宽广，心地善良。", "g: 他为穷人组织食物。他支持艺术、科学以及施法。", "g: 每年都会有一个盛大的节日，有音乐和舞蹈，直到太阳升起。", "g: 我的[girl.story_guardian]曾经说过：我们很幸运有这样的王子。", "g: 当然，这种情况并没有持续多久。与邻国公国之间长期存在不和。甚至没有人记得，这一切是从哪里开始的....", "g: 一天晚上，他们发动了一次突然袭击。大多数妇女都被强奸了。有些人被卖为奴隶。", "g: 我和我的[girl.story_guardian]侥幸逃脱。", "g: 我以前觉得成为奴隶并臣服于主人一定是一件很兴奋的事情。", "g: 我的[girl.story_guardian]有点不喜欢它并责备了我！", "g: 嗯，我现在在这里...."] , multiple=True)
    ...
    add_dialogue("origin the Arik mountains", ("loyal", "very idealist"), ["g: 我在阿里克山区长大。它们位于卡尔基和圣地之间。", "g: 我和我的[girl.story_guardian]一起长大的地方远离任何贸易路线，而且我们没有太多旅行者......", "g: 但是有一次，当我还小的时候，我看到一支军队行进到圣地作战。", "g: 他们在那里太小了....看起来像蚂蚁....但制服真的很鲜艳。", "g: 他们让我很好奇！我想象那些小士兵在军队中都有自己的目标，也有对指挥官的职责！", "g: 我还决定，等我长大了，我要去看看，那里的生活是什么样的....", "g: 我就在这里。"], multiple=True)
    ...
    add_dialogue("slave reward praise", ("loyal", "very idealist"), ("谢谢你，主人！我只是在做我的工作。", "我很高兴您对我的工作感到满意，主人！"), love=2, unlock="MI")
    ...
    add_dialogue("rank up", ("loyal", "very idealist"), ("谢谢你，主人。我现在是一名[newrank]奴隶。准备好把工作做得更好！"))
    ...
    add_dialogue("beach oiling", ("loyal", "very idealist"), ["g: 谢谢你，主人！那种感觉真好....", "g: 请把那些东西擦在我身上......"], multiple=True, sound=s_ahaa)
...
## START STUBBORN DIALOGUE 03.February.2022
    ...
    add_dialogue("slave toggle naked off", ("very modest"), ("谢谢你，主人。这太可耻了，我能感觉到每个人都在看着我....我不喜欢这样。", "很高兴衣服拿回来了..."), love=1)
    ...
    add_dialogue("slave chat brothel -2", ("stubborn"), ["她看起来很沮丧。", "g: 我不喜欢青楼。", "g: 我不喜欢接受命令。", "g: 我鄙视那些把辛苦赚来的金币花在妓女身上的男人。", "g: 你希望我回答什么？", "g: 我他妈的讨厌这里！这就是我喜欢你青楼的生活！"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel -1", ("stubborn"), ["她看上去又生气又心烦意乱。", "g: 这个地方太恶心了！我不赞成青楼和女人为了几金币出卖自己！", "g: 我怎么会到这里来？为什么我必须在这里？"], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat well_being -1", ("stubborn"), ("我不能说我在这里感觉很好。我不喜欢接受命令。我不喜欢把金币花在妓女身上的男人。"), unlock="MI")
    ...
    add_dialogue("origin Karkyr", ("stubborn", "very dom"), ["g: 卡尔基对于小孩子来说是一个很棒的成长之地。我和我的[girl.story_guardian]住在一起，她经常带我去看法师。当他们施展咒语并梦见遥远的地方时，我常常目瞪口呆。", "g: 如果我早知道它们不那么神奇就好了....哦，好吧，在这样的世界里，女孩需要为自己挺身而出！"], multiple=True)
    add_dialogue("origin Westmarch", ("stubborn", "very dom"), ["g: 西域公国很美丽，我的家也很珍贵。这是一个非常难以预测的地方，我们这些小人物往往会陷入城堡里王子们的一时兴起而互相发动战争的困境。", "g: 我的[girl.story_guardian]试图保护我，但生活很艰难。我知道我必须坚强并为自己挺身而出才能在这样的世界中生存。"], multiple=True)
