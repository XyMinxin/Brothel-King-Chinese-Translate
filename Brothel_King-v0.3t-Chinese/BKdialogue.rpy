...
init -1 python:
    ...
    add_dialogue("free_touch_breasts", ("generic"), "噢...你的手法很娴熟", love=2, max_cap=90)
...
#     add_dialogue("free_girl get_flowers", "generic", "This is very romantic... Was there something you wanted from me?") # Had to disable this for now
    ...
    add_dialogue("contract greeting", "cruise", ["嘿，你来了！欢迎上船。希望你能享受这次出海之旅。"])
    add_dialogue("contract intro", "cruise", ["客人们都快到了!来，我领你到你的房间去，也许你可以洗个澡，再喷点香水，记得换上我给你准备的服装。"])
...
## START HOLY DIALOGUE 03.February.2022
    ...
    add_dialogue("free_flirt_sex_experience reply_waiting failure", ("holy"), ("你知道，仅仅因为我是太阳神的追随者并不意味着我天真。虽然我很欣赏你的努力。", "真的吗？虽然是遵循亚里欧斯的教诲，但我实在无法相信你。毕竟我们是在赞。"), love=-1)
    ...
    add_dialogue("free_flirt_sex_experience reply_not_many failure", ("holy"), ("你知道，仅仅因为我是太阳神的追随者并不意味着我天真。虽然我很欣赏你的努力。", "真的吗？虽然是遵循亚里欧斯的教诲，但我实在无法相信你。毕竟我们是在赞。"))
...
## START LOYAL DIALOGUE 03.February.2022
    ...
    add_dialogue("free_friend no_lie", ("loyal"), ["g： 青楼？皮条客？！！我们都需要以某种方式谋生，但我认为你的方式很恶心！你让那些女孩出卖自己并虐待她们的身体......*悲伤*", "mc：这对你来说可能听起来很恶心，但我提供了一项重要的服务，让世界变得更安全、更美好。", "mc：这对女孩来说更安全，她们不需要在街上工作，而且可以免受触手怪物和疯狂乞丐的侵害。", "mc：妓女需要房子，国家需要青楼。", "mc：太阳神的牧师曾经试图取缔青楼，但这导致强奸和谋杀事件大幅增加。", "mc：我的青楼女孩为好斗的男人提供了一种积极的方式来释放他们被压抑的能量。可以说这是女孩子的义务。", "g：我从来没有这样想过。也许那些女孩确实对赞社区负有责任。", "g：不过，我还是感觉不太对劲....", "她看起来很深思熟虑，但似乎并不完全相信你的论点。"], multiple=True, love=-3)
...
## START STUBBORN DIALOGUE 03.February.2022
    ...
    add_dialogue("origin the border with the Holy Lands", ("stubborn", "very dom"), ["g：圣地是一个充满战争和苦难的地方，对于一个小女孩来说也是一个可怕的成长之地。 ", "g：以太阳神的名义发动战争的有权势的人不会想到这一点 - 但我们是生活在其中的真实人民，希望过上正常的生活。我在赞这里更安全，这说明了很多！", "g：尽管如此，那是我的家，我想念它！我和我的 [girl.story_guardian] 一起长大，他教会我要坚强，在这样的世界里为自己挺身而出。"], multiple=True)
