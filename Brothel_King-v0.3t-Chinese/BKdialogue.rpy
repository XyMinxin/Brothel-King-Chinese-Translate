...
init -1 python:
    ...
    add_dialogue("free_greetings_polite", ("superficial", "rebel", "sweet"), "天哪，我没想到会在这里遇到一位真正的绅士!*笑*我是 [girl.fullname]. 见到你很高兴.", love=2)
    add_dialogue("free_greetings_polite", ("cold", "masochist"), "...{w=1} 我是 [girl.fullname]. 我不需要帮助.")
    add_dialogue("free_greetings_polite", "generic", "呃?你不必这么正式... 我叫 [girl.fullname].", love=1)

    add_dialogue("free_greetings_casual", ("meek", "nerd", "cold"), "噢,嗨。我是 [girl.fullname]. 见到你很高兴.", love=2)
    add_dialogue("free_greetings_casual", ("superficial", "pervert"), ("g: 你在想什么，这样来找我?你就不能想出更有创意的点子吗?", "g: 我的名字是 [girl.fullname]. 现在, 给我滚开."), multiple=True)
    add_dialogue("free_greetings_casual", "generic", "你是直截了当的那种人，不是吗?嗨,我是 [girl.fullname].", love=1)

    add_dialogue("free_greetings_rude", ("lewd"), "啊哈, 一个知道自己想要什么的男人... *微笑* 我的名字是 [girl.fullname]. 见到你很高兴.", love=2)
    add_dialogue("free_greetings_rude", ("superficial", "cold"), "噢,嗨。我 [girl.fullname].", love=1)
    add_dialogue("free_greetings_rude", "generic", "你怎么敢! *怒吼*. 我的名字是 [girl.fullname], 我不喜欢你的举止!")

    add_dialogue("free_small_talk", ("pervert", "rebel"), "*哈欠* 别这样，这太无聊了.")
    ...
    add_dialogue("free_gossip", ("nerd", "sweet"), "你知道，我不太在乎流言蜚语.")
    add_dialogue("free_gossip", ("superficial", "rebel"), "你没听说吗?我有一些有趣的八卦要告诉你!", love=2, max_cap=25)
    ...
    add_dialogue("free_chat_life", ("generic"), "这是个很难回答的问题。我想我应该多考虑考虑...", love=1, max_cap=25)
    ...
    add_dialogue("free_chat_love", ("generic"), "每个人都需要找到自己的伴侣. 也许有一天我会的?", love=1, max_cap=25)

    add_dialogue("free_chat_origins", ("generic"), ("我来自于 [girl.origin].", "我出生在 [girl.origin].", "我的家庭来自 [girl.origin]."), love=1, max_cap=40) # Argument is girl.origin

    add_dialogue("free_chat_hobbies", ("generic"), ("我真的很喜欢 [hobby].", "我的爱好吗?我会说 [hobby].", "我喜欢 [hobby], 它照亮了我的一天."), love=1, max_cap=40) # Argument is hobby
    add_dialogue("free_chat_likes", ("generic"), ("我最喜欢的 [thing] 是 [best]."), love=1, max_cap=40) # Argument is 'thing', 'favourite'
    add_dialogue("free_chat_dislikes", ("generic"), ("我不喜欢的 [thing] 是 [worst]. Ew!", "我讨厌的 [thing] 是 [worst]."), love=1, max_cap=40) # Argument is 'thing', 'least favourite'

    add_dialogue("free_joke_harmless", ("very dom"), "... 你就只能做到这一点吗?", love=-1, max_cap=50)
    ...
    add_dialogue("free_joke_adult", ("very modest"), "我不喜欢它。你让我很不舒服.", love=-1, max_cap=50)
    add_dialogue("free_joke_adult", ("very lewd"), "哦，你真淘气... *咯咯笑*", love=3, max_cap=50)
    add_dialogue("free_joke_adult", ("generic"), "不错, 不错...", love=1, max_cap=50)

    add_dialogue("free_joke_dark", ("very extravert"), "哇, 真黑暗啊！我都看不见路了，开灯吧! *皱眉*", love=-1, max_cap=50)# 英语谐音梗，翻不明白
    ...
    add_dialogue("free_joke_mean", ("very idealist"), "卧槽... 闭嘴吧! *生气*", love=-1, max_cap=50)
    ...
    add_dialogue("free_touch_kiss", ("generic"), ["她给了你一个轻轻的吻.", "g: 好啦，好啦..."], multiple=True, love=2, max_cap=90)

    add_dialogue("free_touch_ass", ("rebel", "superficial"), "放手!你这个变态! *生气*", love=-1, max_cap=90)
    add_dialogue("free_touch_ass", ("nerd", "cold", "masochist"), "啊! 呣呣... *脸红*", love=3, max_cap=90)
    add_dialogue("free_touch_ass", ("generic"), "Hey! Control yourself... *咯咯笑*", love=2, max_cap=90)

    add_dialogue("free_touch_breasts", ("nerd", "cold"), "你在干什么?停下来.", love=-1, max_cap=90)
    add_dialogue("free_touch_breasts", ("rebel", "pervert", "superficial"), "呣呣... 感觉真好... *脸红*", love=3, max_cap=90)
    add_dialogue("free_touch_breasts", ("generic"), "噢...", love=2, max_cap=90)

    add_dialogue("free_touch_pussy", ("meek", "sweet"), "不!别碰我那里!", love=-1, max_cap=90)
    add_dialogue("free_touch_pussy", ("masochist", "pervert", "rebel"), "噢!! 呣... 噢...嗯, 继续... 这样... *脸红*", love=3, max_cap=90)
    add_dialogue("free_touch_pussy", ("generic"), "Aah!", love=2, max_cap=90)

    add_dialogue("free_play refuses", ("generic"), "没门!滚开!!!", love=-1)
    add_dialogue("free_play very reluctant", ("generic"), "我会做的，为了你……但我一点也不喜欢...", love=1, sound=s_sigh)
    add_dialogue("free_play reluctant", ("generic"), "噗... 好吧, 如果你 {i}真想{/i} 这么做的话...", love=2, sound=s_sigh)
    add_dialogue("free_play a little reluctant", ("generic"), "噗... 好吧, 如果这是你 {i}真的{/i} 想做的...", love=2, sound=s_sigh)
    add_dialogue("free_play indifferent", ("generic"), "嗯呣... 好吧...", love=3)
    add_dialogue("free_play a little interested", ("generic"), "嗯呣... 有何不可... 我很想要...", love=4, sound=s_mmh)
    add_dialogue("free_play interested", ("generic"), "嗯呣... 有何不可... 我很想要...", love=4, sound=s_mmh)
    add_dialogue("free_play very interested", ("generic"), "噢..., 啊... 我已经在想这件事了...", love=5, sound=s_mmh)
    add_dialogue("free_play fascinated", ("generic"), "噢..., 啊... 我已经在想这件事了...", love=5, sound=s_mmh)
    ...
    add_dialogue("free_flirt_beauty", ("rebel"), "哼, 你以为你无力的赞美会让你上我的床吗?", love=-1, max_cap=75)
    add_dialogue("free_flirt_beauty", ("superficial", "sweet"), "天啊，这话说得真好!", love=2, max_cap=75)
    add_dialogue("free_flirt_beauty", ("generic"), "哦，谢谢你.", love=1, max_cap=75)

    add_dialogue("free_flirt_body", ("masochist"), "...", love=-1, max_cap=75)
    add_dialogue("free_flirt_body", ("nerd", "sweet"), "闭嘴!谁想听那样下流的评论! *生气*", love=-1, max_cap=75)
    ...
    add_dialogue("free_flirt_mind", ("sweet", "nerd", "cold"), "终于有人在乎我的脑子了，而不仅仅是我的长相!", love=2, max_cap=75)
    add_dialogue("free_flirt_mind", ("generic"), "嘿，你今天真是个绅士啊...", love=1, max_cap=75)
    ...
    add_dialogue("free_flirt_spirit", ("sweet", "rebel"), "嘿，真贴心!我觉得我在你面前放松了警惕...", love=2, max_cap=75)
    add_dialogue("free_flirt_spirit", ("generic"), "好,谢谢!", love=1, max_cap=75)


    add_dialogue("free_flirt_sex_experience very experienced", "generic", ["她笑着说.", "g: 哦,天哪!要是你知道……我什么都干过，甚至更糟!"], multiple=True, love=3, sound=s_laugh)
    add_dialogue("free_flirt_sex_experience experienced", "generic", ["她伸出舌头.", "g: 那么，你知道，我是有经验的... *眨眼*"], multiple=True, love=2)
    add_dialogue("free_flirt_sex_experience average", "generic", ["她脸红.", "g: 这有点私人……当然，我这辈子都没有等你，你知道吗?"], multiple=True, love=1, sound=s_sigh)
    add_dialogue("free_flirt_sex_experience inexperienced", "generic", ["她脸红得通红.", "g: 嘿，不是那样的!我有过男朋友，但是你知道…没什么大不了的."], multiple=True, sound=s_surprise)
    add_dialogue("free_flirt_sex_experience very inexperienced", "generic", ["她给了你一个天真的眼神.", "g: 我不太明白你的意思?你不是说...", "她皱眉."], multiple=True, love=-1)

    add_dialogue("free_flirt_sex_experience virgin", "lewd", "但是我从来没有... 你知道，以前和一个男人{i}做过{/i} 。我很想知道那是什么感觉... *脸红*")
    add_dialogue("free_flirt_sex_experience virgin", "generic", "我不是荡妇，你知道的!我从来没有……我是说，我在等那个对的人.")
    ...
    add_dialogue("free_flirt_sex_experience reply_waiting failure", ("modest"), "你以为我会相信吗?你一定觉得我很笨...", love=-2)
    add_dialogue("free_flirt_sex_experience reply_waiting failure", ("generic"), "嘶, 我不相信你! *眨眼*")

    add_dialogue("free_flirt_sex_experience reply_not_many success", ("modest", "idealist"), "噢... 我想成为你唯一的女孩……但我会让你开心的!", love=2)
    add_dialogue("free_flirt_sex_experience reply_not_many success", ("modest", "materialist"), "噢. 我想这很正常，毕竟你是个男人...", love=2)
    add_dialogue("free_flirt_sex_experience reply_not_many success", ("lewd"), "好吧，至少你不是一无是处! *眨眼*", love=1)
    add_dialogue("free_flirt_sex_experience reply_not_many failure", ("modest"), "你以为我会相信吗?你一定觉得我很笨...", love=-1)
    add_dialogue("free_flirt_sex_experience reply_not_many failure", ("generic"), ("她伸出舌头.", "g: 就几个，嗯?也许有几十个? *眨眼*"), multiple=True)

    add_dialogue("free_flirt_sex_experience reply_been_around", ("very modest"), "好吧, 不。其实我不知道.", love=-1)
    ...
    add_dialogue("free_flirt_sex_experience reply_been_around", ("very lewd"), "啊，现在我们开始说话了!我希望你能给我表演一些新把戏...", love=2)

    add_dialogue("free_flirt_sex_experience reply_sex_god success", ("modest"), "噁, 你好恶心!", love=-1)
    add_dialogue("free_flirt_sex_experience reply_sex_god success", ("modest", "materialist"), "我希望你没有提到那件事。但男人是猪，所以我想这是意料之中的.")
    add_dialogue("free_flirt_sex_experience reply_sex_god success", ("lewd"), "Hey, watch out for diseases, you dog... *嘲笑*", love=2)
    ...
    add_dialogue("free_flirt_sex_experience reply_brothel_owner", ("very lewd"), "Well, you should always strive to be the best at your job, shouldn't you? *微笑*", love=3)
    ...
    add_dialogue("free_give_gold --", "generic", "Giving me money, are you? Do you think I'm a petty whore? *生气*", love=-1, max_cap=75)
    ...
    add_dialogue("free_friend lie", ("very extrovert"), ["g: Really? This is so awesome! It is a good job, isn't it?", "mc: Yeah, sure...", "g: Oh, maybe you'll need help someday... You could hire me! *眨眼*"], multiple=True, love=5)
...
#     add_dialogue("free_girl get_flowers", "generic", "This is very romantic... Was there something you wanted from me?") # Had to disable this for now
    add_dialogue("free_ask_out", "generic", ["mc: [girl.name], I like you. Let's be together.", "g: You want me... to be your girlfriend?", "mc: That's right.", "g: Why, finally you ask! Of course!", "She throws herself into your arms and gives you a long, deep kiss.", "g: I have to go for now... But I'll see you around soon, handsome! *眨眼*"], multiple=True)
    ...
    add_dialogue("free_girlfriend give_up", "generic", "Oh, really? I guess we don't know each other so well, after all... *皱眉*", love=-5)
    add_dialogue("free_girlfriend wrong", "generic", ["g: You're awful!!! It's not that at all!!! What a terrible boyfriend... *生气*", "mc: Ah, uh, sorry..."], multiple=True, love=-10)
    ...
    add_dialogue("contract failure", "cruise", ["Arr, ye good-for-nuthin' landlubber! If ye can't give good service to a couple sailors, ya got nuthin' to do on this ship! *生气*"])
    ...
    add_dialogue("contract partial", "ceremony", ["Child, I am not pleased. This should have gone better. *皱眉*"], sound=s_sigh)
    ...
    add_dialogue("contract partial", "festival", ["Ah, it's you... I've heard you didn't give satisfaction in all your tasks today. I hope you take it more seriously next time. *皱眉*"], sound=s_sigh)
    ...
    add_dialogue("contract buy offer refuse", "date", ["I see. My Master will be cross. I shall probably be whipped tonight for this. But it's all right. I desserve to be punished for my dismal failure. *脸红*"])
    add_dialogue("contract partial", "date", ["I was told your performance was less than satisfactory. Let me remind you that in this house, we expect only the best and most obedient slaves to work here. *皱眉*"], sound=s_sigh)
    ...
    add_dialogue("contract buy offer refuse", "meeting", ["This is... Disappointingly undiplomatic of you. *皱眉*\nNow, if you'll excuse me, I have to look for a suitable replacement."])
    ...
    add_dialogue("contract partial", "magic", ["That was, err... How should I say... Uninspireful. Surely you can do better than that. *皱眉*"], sound=s_sigh)
    ...
    add_dialogue("task failure", "onsen", ["Reluctantly, she joins the men, but withdraws into a corner when a few lechers try to cop a feel.", "g: No, that won't do *皱眉*! This is not a way to treat guests!"], multiple=True)
    ...
    add_dialogue("girl introduction", "extravert", ["啊，你好！我是[girl.name]。很高兴认识你。", "很高兴见到你。我是[girl.name]。"])
    add_dialogue("girl introduction", "introvert", ["...",  "我是……[girl.fullname]。"])

    add_dialogue("slave thanks", ("generic"), ["谢谢。", "谢谢主人。", "谢谢你，主人[MC.name]。", "谢谢主人。", "谢谢主人。我很感激。", "谢谢你，我很感激。"])
    ...
    add_dialogue("slave bullied", ("dom"), ["什么？？？决不..."])
    ...
    add_dialogue("slave negative fixation accept", "generic", ["但是老师，这太恶心了……", "我-我对此不太确定...", "C-我们不能做点别的吗？", "我不喜欢，但是……温柔一点，好吗？"])
    ...
    add_dialogue("slave toggle naked on", "modest", "是的主人。如果我必须...", mood=-1)
    add_dialogue("slave toggle naked off", "lewd", "嗯...当然...给我一两分钟...", mood=-1)
    add_dialogue("slave toggle naked off", "modest", "谢谢主人。这太可耻了，我能感觉到每个人都在看着我......*脸红*", mood=1)

    add_dialogue("slave toggle customer sex on", "dom", "该死的，我可以用我自己的判断。", mood=1)
    add_dialogue("slave toggle customer sex on", "sub", "哦，我以为你想要我……没关系。", mood=-1)
    add_dialogue("slave toggle customer sex off", "dom", "什么？难道我就不能自己决定任何事情吗？", mood=-1)
    add_dialogue("slave toggle customer sex off", "sub", "噢、当然了，主人。我做梦也不会...", mood=1)
    ...
    add_dialogue("slave chat brothel -1", ("lewd"), ["她看起来很生气。", "g：我不在乎这是妓院还是宫殿……但是这个地方就是垃圾场！"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel 0", ("lewd"), ["她沉默了一会儿。", "g：这不是我想象中的妓院，你知道……哪里来的奢华和魅力？但我挺过去了..."], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel 0.5", ("lewd"), ["她给你一个虚弱的微笑。", "g：虽然很难，但我想在这样的地方工作也很有趣。我学到了一些东西。"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel virgin", ("lewd"), ["She blushes bright red.", "g：这里太疯狂了，这让我很好奇...尽管我从来没有...嗯..."], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel 1", ("lewd"), ["She licks her lips.", "g：这里发生了很多事情，我永远不会感到无聊......而且我偶尔可以享受一次美好的性爱！ *脸红*"], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat brothel -1", ("modest"), ["她看起来很生气。", "g：这个地方是肮脏的妓院！我不是那种女孩...我在这里做什么...*抽泣*"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel 0", ("modest"), ["她低下头。", "g：我还是不敢相信我在这种地方工作……主人，我真的必须这么做吗？"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel 0.5", ("modest"), ["她耸耸肩。", "g：我最不想在妓院工作……但现在我还好。"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel virgin", ("modest"), ["她耸耸肩。", "g：听着，你知道我没有和其他女孩一样的经历，这并不是我梦想的生活。但我挺过去了。"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel 1", ("modest"), ["She blushes.", "g：我一直认为妓院是最糟糕的。但现在我在这里工作了，我想其实还不错。"], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat other_girls 0", ("extravert"), ["She frowns.", "g：有些女孩比其他女孩更好。但我确信有人在背后对我说坏话。"], multiple=True, unlock="EI")
    add_dialogue("slave chat other_girls 0.5", ("extravert"), ["She thinks for a moment.", "g：我有时间去见其他女孩并和她们聊天。我不能说我拥有令人惊叹的社交生活，但这只是一个开始。"], multiple=True, unlock="EI")
    ...
    add_dialogue("slave chat tastes likes", ("generic"), "我最喜欢的[thing]是[best]。我很喜欢！", unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("generic"), "One [thing] I really don't like is [worst]. Ew!", unlock="LM")

    # For presents
    add_dialogue("slave chat tastes loves +", ("generic"), "你知道什么会让我如此高兴吗？我喜欢[thing]...我希望我有一些。", unlock="LM")
    add_dialogue("slave chat tastes loves -", ("generic"), "我喜欢[thing]。他们很好。", unlock="LM")
    add_dialogue("slave chat tastes no loves", ("generic"), "礼物对我来说没有什么好处。这不关我的事。", unlock="LM")

    add_dialogue("slave chat tastes hates", ("generic"), "我真的很讨厌[thing]。请不要给我那样的东西。", unlock="LM")
    add_dialogue("slave chat tastes no hates", ("generic"), "我喜欢礼物，无论它是什么。", unlock="LM")

    add_dialogue("slave chat tastes positive act", ("modest"), "我注意到我对 [act_desc] 感兴趣...你认为这是错误的吗？", unlock="LM")
    ...
    add_dialogue("slave train resisted", ("dom"), ["大师请！别……别逼我这么做……", "不，等等……我不想！", "但、但是……我不喜欢这样！"])
    ...
    add_dialogue("slave lecture love", "extravert", "很高兴见到你，大师[MC.name]！我有很多问题...")
    ...
    add_dialogue("slave train a little reluctant", "modest", "我真的不想这样做……这是错误的……啊啊！", sound=s_surprise)
    ...
    add_dialogue("slave train fascinated", "lewd", "哦...我已经快射了...啊啊，[act_desc] 是最好的！", sound=s_orgasm_fast)
    ...
    add_dialogue("slave train naked failure", "generic", "S-停止...", sound=s_surprise)
    add_dialogue("slave train naked success", "lewd", "哦，老师，我想要更多……", sound=s_aaah)
    ...
    add_dialogue("slave train sex success", "lewd", "主人，我射了……啊啊啊！我喜欢被这样操！")
    add_dialogue("slave train sex success", "modest", "主人，我射了……啊啊啊！……当坏女孩真好……")

    add_dialogue("slave train anal failure", "lewd", "我……我不能这样做。不可能。")
    add_dialogue("slave train anal failure", "modest", "啊，好痛……*抽泣*")
    add_dialogue("slave train anal success", "lewd", "啊啊啊！！！我爱死了！啊哈！！！这是最好的...")
    ...
    add_dialogue("slave train bisexual success", "lewd", "请原谅我，主人，但我必须说……我喜欢阴户……", sound=s_mmh)
    ...
    add_dialogue("slave reward day off", ("dom", "extravert"), "真的吗？谢谢老师，真是一​​个惊喜……", love=0.5, unlock="DS")
    ...
    add_dialogue("accept job", "generic", "我现在将担任{b}[girl.job]{/b}，以满足客户的需求。{w=1.0}{nw}")
    add_dialogue("work_whore", "generic", "我现在将担任{b}[girl.job]{/b}和妓女，以满足客户的需求。{w=1.0}{nw}")
    add_dialogue("exhausted", "generic", "对不起主人，我还是很累，需要多休息。  康复后，我将回去担任 {b}[girl.job]{/b} 的工作。")

    add_dialogue("rank up", "generic", "谢谢大师。我现在是一名[newrank]奴隶。")
    ...
    add_dialogue("beach accept public sex", "modest", ["g：哦，主人！人们正在看着我们，但是...我的身体感觉很热...做你想做的...", "当你抓住她的臀部并将她靠近时，她喘息着。"], multiple=True)
...
## START PERVERT DIALOGUE 03.February.2022
    ...
    add_dialogue("free_greetings_rude", ("pervert", "very lewd", "masochist"), ("Ah, a man who knows what he wants... *微笑* My name is [girl.fullname]. 见到你很高兴."), love=4)

    add_dialogue("free_small_talk", ("pervert", "rebel", "stubborn", "bimbo"), ("*哈欠* Come on, this is boring."), max_cap=25)
    add_dialogue("free_gossip", ("pervert", "superficial", "bimbo", "princess"), ("我会给你所有有趣的细节......"), love=2, max_cap=25)
    add_dialogue("free_chat_life", ("pervert", "yandere", "creep"), ["g：我所知道的是，我的生活、我的宇宙、我的一切都可以在赞这里找到。","mc：哦？","g：*咯咯*别装模作样，你知道我在说什么！"], multiple=True, max_cap=25)
    add_dialogue("free_chat_love", ("pervert", "sweet", "princess", "pet"), ("I'm waiting for my knight in shining armor, of course... *咯咯笑*"), love=2, max_cap=25)
    add_dialogue("free_chat_origins", ("pervert", "very lewd", "bimbo"), ("我在[girl.origin]的一家妓院旁边长大。", "我在[girl.origin]长大。那里太无聊了！", "呃，[girl.origin]。赞好多了！"), love=1, max_cap=40)
    add_dialogue("free_chat_hobbies", ("pervert", "rebel", "easy"), ("我{i}热爱{/i}[hobby]。", "大多数爱好都很无聊，但[hobby]还可以。", "最近我看到了一类性奴隶[hobby]的裸体。它让我湿透了。赞不奇怪吗？"), max_cap=40)
    add_dialogue("free_chat_likes", ("pervert", "bimbo", "easy", "tsundere"), ("我{i}最喜欢{/i}[best]。这是最好的。吸它，任何其他[thing]！ *傻笑*", "我很确定每个人都同意最好的[thing]就是[best]。"), love=2, max_cap=40)
    add_dialogue("free_chat_dislikes", ("pervert", "creep"), ("让我超级沮丧的一件事是[worst]。哎呀！", "我唯一比禁欲更讨厌的是[thing][worst]。"), love=1, max_cap=40)
    ...
    add_dialogue("free_touch_pussy", ("pervert", "very lewd", "bimbo"), ["g：*呻吟* 嗯，是的，就在那里！", "她用双臂搂住你，磨蹭你的腿。", "g：*低语* {i}把几根手指伸进去，[MC.name]...感觉一下我有多湿吗？{/i}"], multiple=True, love=5, max_cap=90)
    ...
    add_dialogue("free_flirt_sex_experience virgin", ("pervert", "very lewd"), ("But I've never... {i}done it{/i} with a man before, you know. I'm curious to know how it feels... *脸红*"), love=1)
    ...
    add_dialogue("free_flirt_sex_experience reply_not_many success", ("pervert", "very lewd"), ("Well, at least you're not entirely useless then! *眨眼*"), love=-1)
    ...
    add_dialogue("free_flirt_sex_experience reply_brothel_owner", ("pervert", "very lewd"), ("Well, you should always strive to be the best at your job, shouldn't you? *微笑*"), love=1)
    ...
    add_dialogue("free_flirt_sex_act fascinated", ("pervert", "yandere", "creep", "superficial", "bimbo"), ["g：*脸红*我不敢相信我们正在谈论这个......", "她将一只手滑进大腿之间，然后将几根手指滑了进去。", "g：*呻吟*","然后她举起手放在你面前，手上沾满了汁液。", "g：我的意思是，看看这个狗屎...你让我他妈的欲火中烧，[MC.name]！"], multiple=True, love=3)
    ...
    add_dialogue("free_offer_job half_lie", ("pervert", "very lewd"), ["她看起来很生气。", "g：你本来可以早点告诉我的。我对赞的性交易绝对没有问题。", "mc：嗯，有些女孩没有你那么开放……", "g：噗……你的时间都浪费在那些女孩身上了。", "她停顿了一下，咬住嘴唇。", "g：所以如果我在那里工作，我一天会上几次床，对吧？"], multiple=True, love=2)
    add_dialogue("free_offer_job lie", ("pervert", "very lewd"), ["她看起来很生气。", "g：你本来可以早点告诉我的。我对赞的性交易绝对没有问题。", "mc：嗯，有些女孩没有你那么开放……", "g：噗……你的时间都浪费在那些女孩身上了。", "她停顿了一下，咬住嘴唇。", "g：所以如果我在那里工作，我一天会上几次床，对吧？"], multiple=True)
    ...
    add_dialogue("free_offer_job failure no_lie", ("pervert", "very lewd"), ["g：哇哦...我不签合同！", "g：我可能渴望鸡巴，但这并不会让我成为性奴隶！", "g：你有严重的问题……我要走了！","她气冲冲地走了……"], multiple=True, love=-15)
    ...
    add_dialogue("free_ask_out", ("pervert"), ["mc：[girl.name]，我在想……我们应该成为情侣。", "g: You want me... to be your girlfriend?", "mc：是的，我愿意。", "g：嗯...哦，为什么不呢！我期待着与你更加亲密。 *眨眼*", "她紧紧地拥抱你，然后把手放在你的胯部。", "g：我迫不及待地想进一步了解你...我很快就会见到你！ *眨眼*"], multiple=True)
    ...
    add_dialogue("free_girlfriend wrong", ("pervert"), ("不！那是完全错误的！破坏心情的方式。 *疯狂的*"), love=-10)
    add_dialogue("free_girlfriend success", ("pervert"), ["她脱下衣服，双手捧住胸部，轻轻抚摸乳头。", "g：*呻吟*你不认为我们应该更多地探索彼此的身体吗？", "g：*咯咯*随意触摸任何你喜欢的地方......", "你的手指慢慢地沿着她的身体从上到下抚摸。当你接近她的阴部时，她会打断你。","g：哦，我差点忘了！我还有一个惊喜要给你！", "她翻遍了地板上的衣服，拿出了一个带遥控器的小型子弹振动器。", "她把振动器放在她的阴户上，然后把遥控器递给你。", "g：从现在开始，我会确保每次我们见面时它都在那里。", "g：所以，如果您有心情，请打开它告诉我！ *眨眼*"], multiple=True)
    add_dialogue("free_girlfriend success naked", ("pervert"), ["她脱下衣服，双手捧住胸部，轻轻抚摸乳头。", "g：*呻吟*衣服真是太痛苦了！我们应该拥抱自己的本性并始终赤身裸体！", "g：*咯咯*随意触摸任何你喜欢的地方......", "你的手指慢慢地沿着她的身体从上到下抚摸。当你接近她的阴部时，她会打断你。","g：哦，我差点忘了！我还有一个惊喜要给你！", "她翻遍了地板上的衣服，拿出了一个带遥控器的小型子弹振动器。", "她把振动器放在她的阴户上，然后把遥控器递给你。", "g：从现在开始，我会确保每次我们见面时它都在那里。", "g：所以，如果您有心情，请打开它告诉我！ *眨眼*"], multiple=True)

    add_dialogue("free_job_request", ("pervert"), ["g: This is a disaster! The Jolly Paladins are leaving!", "mc: The... The what??", "g: The Jolly Paladins! Don't you know them? They're a wizzball team famous all over Xeros!", "mc: And...", "g: And? And I was their support girl!!! I used to date the team captain, and his second, and... They lavished me with gifts and attention...", "mc: Well, uh... What?", "g: Sorry, honey, don't take it personally, you're great, but a girl's gotta have her fun... A wizzball team is 23 players!!! Where am I gonna find another batch of rich, horny men???", "mc: Mmmh..."], multiple=True)

    add_dialogue("accept farm", ("pervert", "very lewd"), ["g：呃...我必须这样做吗？赞这里有很多我可以训练的动物！","她盯着你看了一会儿，希望你能重新考虑。", "g：好的主人，我这就去……啊，我真的会想念这个地方的。帮我保暖我的床，好吗？ *眨眼*"], multiple=True)
    ...
    add_dialogue("girl introduction", ("pervert", "very lewd"), ["g：很高兴认识你，我是[girl.fullname]。", "g：*低语* {i}我把振动器放在了我的阴部。我希望你帮我拿着这个遥控器。今晚我们一起玩吧，好吗？{/i}"], multiple=True)
    ...
    add_dialogue("slave positive fixation accept", ("pervert", "very lewd"), ["哦，那真是太他妈的热了！", "他妈的，是的，这让我兴奋......", "啊……这感觉真他妈的好！", "*呻吟*我喜欢你这样对待我。"])
    ...
    add_dialogue("MC break promise", ("pervert", "very extravert"), ("不、不，等等……我还以为您会是一位善良又慈爱的Master呢……"), love=-5, fear=1)
    ...
    add_dialogue("slave leave master bedroom fear +", ("generic", "very introvert", "very idealist", "very materialist", "very modest", "very sub"), ["She looks worried.", "g：是的，是的，主人。我、我让你失望了吗？"], multiple=True)
    add_dialogue("slave leave master bedroom fear", ("pervert", "very lewd"), ["她耸耸肩。","g：我想是在寻找新鲜的肉来耕种吧？好吧...当你再次渴望我的阴户时请告诉我。 *眨眼*"], multiple=True)
    ...
    add_dialogue("slave chat brothel 0", ("pervert", "very lewd"), ["她耸耸肩。","g：我一直想在妓院工作，但说实话，这比我预想的要多得多……"], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat brothel 2", ("pervert", "very lewd"), ["g：啊，看看这个……", "她把两根手指伸进她的阴户。当她把它们拿出来时，一长串猫汁在它们后面拱起。","g：看那个！我每次醒着的时候都感觉超级他妈的饥渴……多亏了你的指导，我也不用花太多时间就能达到高潮！"], multiple=True, unlock="LM")
    ...
    add_dialogue("MC demean rival", ("pervert", "rebel", "stubborn", "yandere", "creep"), ("是的，操她。我希望她的阴户能掉下来。"), sound=s_evil_laugh)
    ...
    add_dialogue("slave chat well_being attacked", ("pervert", "rebel", "stubborn", "yandere", "creep", "stubborn"), ("呃...你觉得我在一个月内被攻击和强奸[nb_times]后感觉如何？！完蛋了。请大师做点什么吧。"))
    ...
    add_dialogue("slave chat well_being MC apology", ("pervert", "helper", "sweet", "nerd", "holy", "prude", "loyal", "repressed", "class president"), ("我指望你，大师[MC.name]。"))
    ...
    add_dialogue("slave chat feelings very disobedient", ("pervert", "very extravert"), ("对我来说，你就像赞州的其他人一样，真的。"), unlock="DS")
    ...
    add_dialogue("slave chat tastes likes", ("pervert", "very extravert"), ("我{i}最喜欢{/i}[best]。这是最好的。吸它，任何其他[thing]！ *傻笑*", "我很确定每个人都同意最好的[thing]就是[best]。"), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("pervert", "very extravert"), ("让我超级沮丧的一件事是[worst]。哎呀！", "我唯一比禁欲更讨厌的是[thing][worst]。"), unlock="LM")
    add_dialogue("slave chat tastes loves +", ("pervert", "very lewd"), ("我{i}喜欢{/i}[thing]。 *咯咯*看看我的手臂，光是谈论它就让我起鸡皮疙瘩。", "我已经有一段时间没有被赋予[thing]了。我真的很想念他们。", "这听起来可能很奇怪，但[thing]让我很湿。"), unlock="LM")
    add_dialogue("slave chat tastes loves -", ("generic", "very extravert", "very introvert", "very idealist", "very materialist", "very modest", "very dom"), ("小时候我经常收集[thing]。现在看来已经是很久以前的事了。", "我对大多数礼物都不感兴趣。不过，我确实喜欢[thing]。"), unlock="LM")
    add_dialogue("slave chat tastes no loves", ("pervert", "rebel", "stubborn", "bimbo", "schemer", "tsundere"), ("别费心给我送什么礼物了。我不喜欢那些浪漫的举动。"), unlock="LM")
    add_dialogue("slave chat tastes hates", ("pervert", "very extravert"), ("如果你给我买过[thing]，我会把它直接扔进垃圾桶，让你知道。"), unlock="LM")
    ...
    add_dialogue("slave chat origins 1", ("pervert", "very lewd", "bimbo"), ("我在[girl.origin]的一家妓院旁边长大。", "我在[girl.origin]长大。那里太无聊了！", "呃，[girl.origin]。赞好多了！"), unlock="EI")
    ...
    add_dialogue("origin Zan", ("pervert", "very lewd"), ["g：我对赞的每一个角落都了如指掌。我最喜欢的地方是海滩附近。那里有一个僻静的地方，情侣们会偷偷去那里。当我还是个孩子的时候，我经常躲在岩石后面，看着他们干活。", "g：有一次我很惊讶地看到我的 [girl.story_guardian] 在那里取悦了五名水手。当然，我仍然留下来观看……"], multiple=True)
    add_dialogue("origin the border with the Holy Lands", ("generic", "very extravert", "very idealist", "very materialist", "very lewd", "very dom"), ["g：在圣地，人类居住区永远不会长久存在。成群结队的怪物总是潜伏在荒野中，准备夺回他们的土地。", "g：我的 [girl.story_guardian] 教会我一次只过一天。现在我来到了赞，这是我一生中第一次开始梦想我的未来。"], multiple=True)
    add_dialogue("origin the Blood Islands", ("generic", "very extravert", "very idealist", "very materialist", "very lewd", "very dom"), ["g：回到家后，我发现很难相信我的 [girl.story_guardian] 关于 Zan 的荒诞故事。这一切听起来好得令人难以置信。", "g：即使是现在，每当顾客对我有一点尊严时，我有时还是要掐自己一下。与血色群岛相比，赞确实是奴隶的天堂。"], multiple=True)
    ...
    add_dialogue("origin Westmarch", ("pervert", "very lewd"), ["g：威斯特玛公国是一个混乱的地方。你可以生活在肮脏或奢华中，但角色也可以很容易互换。", "g：当我的[girl.story_guardian]继承了一个小头衔时，我们简直不敢相信自己的运气。从我们的 [girl.story_home] 搬到一座城堡，就像梦想成真一样。", "g：那周晚些时候，我发现自己躲在地下室里，因为我们的城堡遭到掠夺并被烧毁。我的 [girl.story_guardian] 在被强奸时痛苦地尖叫。不久之后我发现自己来到了赞。"], multiple=True)
    ...
    add_dialogue("origin Borgo, the port city", ("pervert", "very extravert", "very idealist", "very materialist", "very lewd", "very dom"), ["g：我的[girl.story_guardian]会在博尔戈的港口工作，装卸船只。大部分工作都是不记名的，当然也有大量的走私活动。", "g：奴隶贸易尤其突出。尽管博尔戈与赞竞争，大多数奴隶仍然首先经过博尔戈。", "g：Zan 已经获得了好处，而 Borgo 至今仍因缺乏监管而遭受损失。"], multiple=True)
    add_dialogue("origin the Goliath desolations", ("pervert", "very lewd", "very introvert", "cold", "nerd", "masochist",  "repressed", "schemer"), ["g：在歌利亚的荒凉之地，拼命谋生是很困难的。即使是小孩子，我们也必须每天努力工作才能生存。找到时间放松下来玩耍并不容易。", "g：在某个时候，我的 [girl.story_guardian] 坐下来跟我谈话，教我如何玩自己的阴部。这让我可以从日常的挣扎中分散注意力。"], multiple=True)
    ...
    add_dialogue("slave train resisted", ("pervert", "very lewd"), ("但是……我想我还没有准备好，主人。", "拜托，主人……你能先跟我讲一下吗？我认为我还没有准备好将其付诸实践。", "我一点也不喜欢这样。这让我真的很不舒服。", "为什么你想要{i}那个{/i}？老师，我们就不能做点别的吗？"))
    ...
    add_dialogue("slave train naked failure", ("pervert", "very lewd"), ("C-我可以做点别的事吗？我、我应该为你张开我的阴部吗？不，等等……嗯……也许我应该弯下腰，把一根手指放在我的屁眼里？ *傻笑*"), sound=s_surprise)
    ...
    add_dialogue("slave train bisexual failure", ("pervert", "very lewd"), ("我就是不明白！我想要的只是一根真正的有血有肉的鸡巴进入我的阴户……让她在这里有什么意义？"))
    add_dialogue("slave train bisexual success", ("pervert", "bimbo", "creep", "yandere"), ("*咯咯*你想知道我的秘密吗，主人？不要告诉她，但是... *低声* {i}我只是假装我正在取悦我自己的阴户{/i}。"), sound=s_mmh)
    add_dialogue("slave train group failure", ("generic", "very introvert", "very idealist", "very materialist", "very lewd", "very sub"), ("是、所以……我应该先关注谁？ M-大师？"))
    ...
    add_dialogue("slave punish naked", ("pervert", "very lewd"), ["g：*咯咯*哦不……那太可耻了！", "她想都没想就脱掉衣服，开始在妓院里跑来跑去。", "g：大家好，看着我！我现在正在受到惩罚！"], multiple=True, fear=-1, unlock="LM")
    ...
    add_dialogue("accept job", ("pervert", "very extravert"), ("当然，我不介意成为一名{b}[girl.job]{/b}。实际上，它有点适合我。{w=1.0}{nw}"))
    add_dialogue("work_whore", ("pervert", "very lewd"), ("所以我正式是一名{b}[girl.job]{/b}，但归根结底我是一名妓女。 *咯咯笑*是的，听起来不错。 {w=1.0}{nw}"))
    add_dialogue("exhausted", ("pervert", "very lewd"), ("主人...我的阴部完全酸痛...别问...我需要更多时间休息，我会以{b}[girl.job]{/b}的身份重新开始工作我一康复。"))
    ...
    add_dialogue("bought", ("pervert", "very extravert"), ("是、所以……我首先应该关注什么？ M大师？"))
    add_dialogue("freed", ("pervert", "very lewd"), ("哇...我会想念这个地方的。"))
    add_dialogue("sold", ("pervert", "very lewd"), ("*叹气*我希望我至少会去另一家妓院……再见，主人[MC.name]。"))
...
## START REBEL DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_likes", ("rebel"), ("[thing][best]是不会出错的。","你让我陷入了困境……我会说[best]是一个相当愚蠢的[thing]。"), love=2, max_cap=40)
    add_dialogue("free_chat_dislikes", ("rebel", "pervert"), ("呃，为什么要讲这个？你让我很沮丧。 [thing][worst]很糟糕。", "他妈的[worst]是一件狗屎[thing]。"), max_cap=40)
    ...
    add_dialogue("free_flirt_sex_act very interested", ("rebel"), ["She bites her lip.", "g：那太他妈的热了……继续说，我正在挖掘它。"], multiple=True, love=3)
    ...
    add_dialogue("free_offer_job lie", ("rebel"), ["她看起来很生气。", "g：你说的和我想的一样吗？我应该把你打晕，[MC.name]。", "mc：考虑到你的情况，我认为你没有太多选择。", "她握紧拳头，摆出战斗的姿势。", "g：你真的想这么做吗，[MC.name]？来找我吧，混蛋！", "主持人：[girl.name]，听我说。在这里考虑一下你的选择......我正在努力帮助你。"], multiple=True, love=-5)
    ...
    add_dialogue("free_offer_job failure lie", ("rebel"), ["她开始攻击你，左右扔钩子。你勉强躲开了她的攻击。", "g：拿着这个，你这个混蛋！", "g：你他妈的怎么敢！我要把你那家妓院烧毁！", "mc：简单！简单的！", "你击退了她，让自己脱离了困境，给了她一些时间来思考问题。"], multiple=True, love=-15)
    ...
    add_dialogue("free_girlfriend intro", ("rebel"), ["[girl.name] 脸上挂着顽皮的微笑。", "g：[MC.name]...你对我很好。我打赌你一定很渴，不是吗？", "mc：你什么意思？", "g：是时候我们采取更进一步的行动了。跟我来。我会为你脱光。", "MC：哦，很高兴！带路。", "g: But first, I wanna ask you a question."], multiple=True)
    ...
    add_dialogue("slave chat tastes likes", ("rebel"), ("[thing][best]是不会出错的。","你让我陷入了困境……我会说[best]是一个相当愚蠢的[thing]。"), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("rebel", "pervert"), ("呃，为什么要讲这个？你让我很沮丧。 [thing][worst]很糟糕。", "他妈的[worst]是一件狗屎[thing]。"), unlock="LM")
...
## START COLD DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_dislikes", ("cold", "rebel", "superficial", "bimbo", "prude", "schemer", "stubborn", "repressed"), ("你知道，[worst]是一件可怕的[thing]。"), max_cap=40)
    ...
    add_dialogue("free_offer_job half_lie", ("cold"), ["g：他妈的什么？！妓院老板和[MC.playerclass]之间有很大的区别！", "MC：哦，对不起……有吗？", "mc：到目前为止，我作为[MC.playerclass]的技能似乎与日常操作密切相关......", "g：那么一般女孩每天能赚多少钱？"], multiple=True, love=1)
    add_dialogue("free_offer_job lie", ("cold"), ["g：我猜你在隐瞒什么……", "g：在妓院工作听起来还不错……", "mc：我相信你会喜欢的。你会有自己的房间和一切！", "mc：你可以免费使用所有设施，甚至可以对我的私人奴隶西尔发号施令。", "g：听起来不错……", "她茫然地望着远方，陷入了沉思。"], multiple=True)
    ...
    add_dialogue("free_friend half_lie", ("cold"), ["g：好的。说实话，我真的不在乎。", "mc: And what is it you do?", "g：不多，如果我能帮忙的话……"], multiple=True, love=2)
    ...
    add_dialogue("free_girlfriend wrong", ("cold"), ("错误的！你对我一无所知，是吗？"), love=-10)
    ...
    add_dialogue("slave chat tastes dislikes", ("cold", "rebel", "superficial", "bimbo", "prude", "schemer", "stubborn", "repressed"), ("你知道，[worst]是一件可怕的[thing]。"), unlock="LM")
    add_dialogue("slave chat tastes loves +", ("cold", "very introvert"), ("你可以随时叫醒我[thing]。"), unlock="LM")
    add_dialogue("slave chat tastes loves -", ("cold", "very introvert"), ("[thing]有什么意义？我不明白。"), unlock="LM")
    add_dialogue("slave chat tastes no loves", ("cold", "very dom"), ("把礼物留给自己吧。"), unlock="LM")
    add_dialogue("slave chat tastes hates", ("cold", "very dom"), ("永远不要递给我[thing]。我会毁掉它。"), unlock="LM")
    ...
    add_dialogue("origin the Goliath desolations", ("cold"), ("歌利亚荒原真是他妈的荒凉！你对这样的名字有什么期望？我应该知道，因为我和我的[girl.story_guardian]一起在那里度过了毫无意义的人生最初几年。很高兴来到赞，那里确实发生了一些事情......"))
    ...
    add_dialogue("slave magic libido success", ("cold", "very introvert"), ("啊！ D、别碰我..."), sound=s_mmh)
    ...
    add_dialogue("accept job", ("cold", "very introvert"), ("成为一名{b}[girl.job]{/b}？听起来很容易。","当然，我会成为你的{b}[girl.job]{/b}。","好的，{b}[girl.job]{/b} 是的。"))
    add_dialogue("work_whore", ("cold", "very introvert"), ("我可以将{b}[girl.job]{/b}和嫖娼结合起来，没问题。","当然可以。 {b}[girl.job]{/b} 和嫖娼。","我是个放荡的{b}[girl.job]{/b}。确认的。"))
    add_dialogue("exhausted", ("cold", "very introvert"), ("不是现在，主人。我累极了。当我准备好后，我会以{b}[girl.job]{/b}的身份回来。"))
    ...
    add_dialogue("advertise", ("cold", "very introvert"), ("访问[brothel.name]。这是一家妓院。你知道会发生什么。", "生活让你沮丧吗？参观妓院。", "参观[brothel.name]，为什么不呢？", "阅读标志。", "访问[brothel.name]。或者不这样做。我不在乎。"))
    ...
    add_dialogue("beach accept public sex", ("cold", "very introvert"), ["她为你张开她的阴户。", "g：来吧……已经放进去了！"], multiple=True)
...
## START NERD DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_likes", ("nerd", "class president"), ("我喜欢更多地了解[thing]。特别是[best]。", "我对每一种[thing]都很着迷，但我发现[best]特别有趣。"), love=1, max_cap=40)
    add_dialogue("free_chat_dislikes", ("nerd", "class president", "repressed"), ("我对[thing]了解得越多，我就越意识到[worst]是多么可怕。", "每当提到[worst]我就会生气。任何其他[thing]都将是首选。"), love=2, max_cap=40)
    ...
    add_dialogue("free_flirt_sex_experience very experienced", ("nerd"), ["她咯咯地笑着，伸出舌头。", "g：*咯咯*我可以写一本关于我所做的所有事情的书。如果我这样做的话，它可能会成为赞的畅销书。"], multiple=True, love=3)
    add_dialogue("free_flirt_sex_experience experienced", ("nerd"), ["她笑着对你眨眼。", "g：哦，我还不够。我喜欢阅读它，我喜欢思考它，我喜欢这样做。"], multiple=True, love=2)
    add_dialogue("free_flirt_sex_experience average", ("nerd"), ["She blushes.", "g：嗯，我喜欢更多地了解这类事情……多年来我有一些不同的合作伙伴可以一起学习。"], multiple=True, love=1)
    ...
    add_dialogue("free_offer_job half_lie", ("nerd"), ["g：我还是第一次听说。你为什么不告诉我？", "mc：我并不是有意隐瞒你。我确实是一个[MC.playerclass]。妓院只是我的副业。", "g：嗯……嗯，这是一个危险信号。你应该让我知道的。"], multiple=True, love=-2)
    add_dialogue("free_offer_job lie", ("nerd"), ["g：我还是第一次听说。你为什么不告诉我？", "mc：我并不是有意隐瞒你。我实际上是一个[MC.playerclass]。妓院只是我的副业。", "g：嗯，他妈的怎么了。你不应该对我撒谎。真乱来。"], multiple=True, love=-4)
    ...
    add_dialogue("free_friend no_lie", ("nerd"), ["g：哎呀...这不完全是一份理想的工作，不是吗？", "mc：*笑*你会感到惊讶的。有些人绝对会认为这是一份梦想的工作。", "g：那些人都是妄想症。妓院可能听起来很有趣，但你我都知道它们吸引的是最糟糕的人。", "mc：哦，我知道如何让他们保持一致。这对我的女儿们和我的顾客来说都是如此。那么你梦想的工作是什么？", "g：嗯...我猜你已经找到我了。我真的没有一个..."], multiple=True, love=-6)
    add_dialogue("free_friend half_lie", ("nerd"), ["g：嗯……我相信你在转行时会有很多选择。 [MC.playerclass] 的技能可以在各个方面发挥作用。", "mc：是的，这就是我所希望的。你呢？", "g：啊……我还没有真正找到我的才能的好用处。小时候我一直想成为一名图书管理员。但在赞呆了一段时间后，我不再那么确定了......"], multiple=True, love=2)
    ...
    add_dialogue("free_ask_out", ("nerd"), ["mc：[girl.name]，我很想成为你的王子，让你在我身边。", "g: You want me... to be your girlfriend?", "mc：没有什么能让我更快乐。", "g：哦，[MC.name]！我感觉自己好像在做梦。这真的发生了吗？我的意思是……是的！我的回答是，当然可以！", "She throws herself into your arms and gives you a long, deep kiss.", "g：我现在得走了……不过很快就会见到你的，英俊的王子！ *眨眼*"], multiple=True)
    ...
    add_dialogue("refuse farm", ("generic"), ["No! Not the farm! I know what goes on there... I refuse!", "I don't wanna go to the farm! Please, Master, no!", "No! Not the farm! Please...", "I cannot go, Master... I cannot... Please spare me..."])
    add_dialogue("gizel take girl to farm", ("nerd"), ("完美的！血岛种马迫切需要奴隶的阴户。"))
    ...
    add_dialogue("slave chat tastes likes", ("nerd", "class president"), ("我喜欢更多地了解[thing]。特别是[best]。", "我对每一种[thing]都很着迷，但我发现[best]特别有趣。"), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("nerd", "class president", "repressed"), ("我对[thing]了解得越多，我就越意识到[worst]是多么可怕。", "每当提到[worst]我就会生气。任何其他[thing]都将是首选。"), unlock="LM")
    ...
    add_dialogue("slave lecture love", ("nerd", "very extravert"), ("很高兴见到你，大师[MC.name]！我有很多问题..."))
...
## START MASOCHIST DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_likes", ("masochist", "meek"), ("你为什么会对我最喜欢的[thing]感兴趣？我感觉自己就像显微镜下的虫子。嗯...[best]，我猜？", "[thing][best]还可以。我们可以谈谈别的事情吗？"), max_cap=40)
    add_dialogue("free_chat_dislikes", ("masochist", "loyal", "helper"), ("我是那些讨厌[thing][worst]的女孩之一。", "不要因此而恨我，但我认为[worst]是一件可怕的[thing]。"), love=2, max_cap=40)
    ...
    add_dialogue("free_flirt_sex_experience reply_sex_god success", ("masochist"), ["She licks her lips.", "g：噢，是吗？现在我越来越好奇了..."], multiple=True, love=4)
    ...
    add_dialogue("free_offer_job failure lie", ("masochist"), ["她看起来很失望。", "g：哦……只是临时合同？唔...", "g：我需要一些时间考虑一下这个问题。你并没有让这听起来像我希望的那样有辱人格。", "她走开，看上去若有所思。"], multiple=True, love=-15)
    add_dialogue("free_offer_job failure no_lie", ("masochist"), ["她看起来很失望。", "g：哦……只是临时合同？唔...", "g：我需要一些时间考虑一下这个问题。你并没有让这听起来像我希望的那样有辱人格。", "她走开，看上去若有所思。"], multiple=True, love=-15)

    add_dialogue("free_friend no_lie", ("masochist"), ["g：真的吗？我很好奇...你有命令过你的奴隶舔你的脚吗？", "mc：呃……不，我不记得了。所以你会怎么做？", "g：噢...不多..."], multiple=True, love=0)
    add_dialogue("free_friend half_lie", ("masochist"), ["g： 很公平。你和赞恩的其他一千个[MC.playerclass]。 *笑*", "mc：是的，我注意到这里的竞争很激烈。那你有工作吗？", "g： 不，现在不是……"], multiple=True, love=2)
    ...
    add_dialogue("slave chat tastes likes", ("masochist", "meek"), ("你为什么会对我最喜欢的[thing]感兴趣？我感觉自己就像显微镜下的虫子。嗯...[best]，我猜？", "[thing][best]还可以。我们可以谈谈别的事情吗？"), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("masochist", "loyal", "helper"), ("我是那些讨厌[thing][worst]的女孩之一。", "不要因此而恨我，但我认为[worst]是一件可怕的[thing]。"), unlock="LM")
...
## START MEEK DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_likes", ("meek", "loyal", "helper", "masochist", "prude"), "嗯……[best]相当不错。这也是我母亲最喜欢的[thing]。但我更愿意讨论另一个话题。", max_cap=40)
    add_dialogue("free_chat_dislikes", ("meek", "very sub"), "[thing][worst]让我感到毛骨悚然！我还是不明白为什么...", love=2, max_cap=40)
    ...
    add_dialogue("free_offer_job half_lie", ("meek", "superficial", "very sub"), ["She starts to cry.", "g：我不敢相信你...你在说什么！我感到很困惑...", "g: It sounds scary! I don't want to... Oh, what am I going to do..."], multiple=True)
    add_dialogue("free_offer_job lie", ("meek", "superficial", "very sub"), ["She starts to cry.", "g：我不敢相信你...你在说什么！我感到很困惑...", "g: It sounds scary! I don't want to... Oh, what am I going to do...", "g：如果我为你工作，你会照顾我吗？"], multiple=True, love=1)
    add_dialogue("free_offer_job success", ("meek", "very modest", "very sub"), ["g：这太糟糕了……但我看不出有任何其他方法可以摆脱这种情况……", "g：如果你是我的Master，你会好好照顾我的，不是吗？"], multiple=True)
    add_dialogue("free_offer_job thinking", ("meek", "very modest", "very sub"), ["g：这太糟糕了……但我看不出有任何其他方法可以摆脱这种情况……", "g：如果你是我的Master，你会好好照顾我的，不是吗？", "She bursts into tears.", "g：不、不……我做不到！我不能！！"], multiple=True)
    add_dialogue("free_offer_job failure lie", ("meek", "very modest", "very sub"), ["g：这太糟糕了……但我看不出有任何其他方法可以摆脱这种情况……", "g：如果你是我的Master，你会好好照顾我的，不是吗？", "She bursts into tears.", "g：不、不……我做不到！我不能！请别打扰我！"], multiple=True, love=-15)
    add_dialogue("free_offer_job failure no_lie", ("meek", "very modest", "very sub"), ["g：这太糟糕了……但我看不出有任何其他方法可以摆脱这种情况……", "g：如果你是我的Master，你会好好照顾我的，不是吗？", "She bursts into tears.", "g：不、不……我做不到！我不能！请别打扰我！"], multiple=True, love=-15)
    ...
    add_dialogue("free_ask_out", ("meek"), ["mc: [girl.name], I like you. Let's be together.", "当她投入你的怀抱并给你一个漫长而深沉的吻时，她流下了喜悦的泪水。", "g：我、我太高兴了！我们在约会！！"], multiple=True)
    ...
    add_dialogue("free_girlfriend success", ("meek"), ["她一件一件地脱掉衣服。", "当她脱下内裤时，空气中悬挂着一串浓浓的阴液。", "g：看到了吗？！每当我和你说话的时候都是这样！", "她张开她的阴唇，露出她闪闪发光的湿润阴户。果汁继续滴到地板上。", "当她把它放在你面前时，你会感觉到血液涌入你的阴茎。", "g：啊看！ ……越来越难了！", "你们花了一点时间彼此更加熟悉。"], multiple=True)
    add_dialogue("free_girlfriend success naked", ("meek"), ["她一件一件地脱掉衣服。", "当她脱下内裤时，空气中悬挂着一串浓浓的阴液。", "g：看到了吗？！每当我和你说话的时候都是这样！", "她张开她的阴唇，露出她闪闪发光的湿润阴户。果汁继续滴到地板上。", "当她把它放在你面前时，你会感觉到血液涌入你的阴茎。", "g：啊看！ ……越来越难了！", "你们花了一点时间彼此更加熟悉。"], multiple=True)

    add_dialogue("free_job_request", ("meek", "very sub"), ["g: Oh, [MC.name], this is so awful... *sob*", "mc: Baby what's going on?", "g: The guard... They evicted us from the house... And mother... She's sick... My brothers told me they couldn't have another mouth to feed...", "g：我现在孤身一人了。我怎样才能赚到足够的钱来维持生活？肯定会饿死，不然就会被恶棍抓住，奸杀我！", "She bursts into tears.", "mc: [girl.name] calm down, we'll find a solution..."], multiple=True)
    ...
    add_dialogue("refuse farm", ("meek", "very sub"), ["*呜咽*请大师怜悯……", "*呜咽*但-但是主人...农场肯定会让我崩溃...我求求你，请放过我...", "*抽泣*不——不是农场，主人……拜托，除了那个以外什么都可以！"])
    add_dialogue("gizel take girl to farm", ("meek", "holy", "prude", "easy"), ("呃……这个看起来很弱啊。我会开始准备复活咒语，以防万一。"))

    add_dialogue("girl introduction", ("meek", "very sub"), ["你-明白了！ [girl.fullname]，很高兴认识你。", "我-我明白...[girl.fullname]。我会照我说的去做。", "是-是的，听你的命令。我的名字是大师 [MC.name] 的 [girl.fullname]。"])
    ...
    add_dialogue("slave positive reaction", ("meek", "very modest", "very sub"), ("*脸红* M、主人……你太善良了……", "谢谢，老师。", "*脸红*我不值得这样的善意，主人。"))
    ...
    add_dialogue("slave strongly refuse", ("meek", "very modest", "very sub"), ("*抽泣*不、不……请怜悯，主人……", "*呜咽*啊啊！！ M大师...", "*抽泣* N-不是这样的..."), sound=s_screams)
    ...
    add_dialogue("slave train beg", ("meek", "very modest", "very sub"), ("*呜咽*不、不，不是这样……请怜悯，主人……", "*呜咽*啊啊！！主人……请不要……", "*呜咽* N-不是那个，请大师..."))
    ...
    add_dialogue("slave beg give up", ("meek", "very sub", "very idealist"), ("*呜呜*主人……你太善良了……", "谢谢，老师。", "我、我不值得如此仁慈，主人。"), love=1, fear=-2, sound=s_surprise)
    ...
    add_dialogue("slave send to master bedroom love", ("generic", "very introvert", "very idealist", "very modest", "very sub"), ["她微笑着鞠躬。", "g：谢谢，谢谢老师。"], multiple=True)
    ...
    add_dialogue("slave chat tastes likes", ("meek", "loyal", "helper", "masochist", "prude"), "嗯……[best]相当不错。这也是我母亲最喜欢的[thing]。但我更愿意讨论另一个话题。", unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("meek", "very sub"), "[thing][worst]让我感到毛骨悚然！我还是不明白为什么...", unlock="LM")
    add_dialogue("slave chat tastes loves +", ("generic", "very modest", "very sub"), ("啊……我一直很喜欢【东西】，就像我妈妈一样。这么说是不是很奇怪？"), unlock="LM")
    add_dialogue("slave chat tastes loves -", ("meek", "very sub"), ("我想我喜欢[thing]，但我还没有完全探索所有选项。"), unlock="LM")
    ...
    add_dialogue("origin Zan", ("meek", "very introvert"), ["g：在像赞这样的大城市，找到并珍惜那些可以让自己与世隔绝的地方很重要。", "g：每当我的[girl.story_guardian]喝醉时，我总是躲在港口的一座桥下。"], multiple=True)
    ...
    add_dialogue("origin the Goliath desolations", ("meek", "very modest", "very sub"), ["g：你很快就会学会如何应对在歌利亚荒凉中所面临的困难。我们每天都必须为取暖和食物而奋斗。", "g：这与赞这里的生活完全不同。即使是穷人也能享受这样的奢侈！我希望我的 [girl.story_guardian] 能在这里看到它。"], multiple=True)
    ...
    add_dialogue("slave train accepted", ("meek", "very sub"), ["如您所愿，主人。", "大师你说什么都行。", "好的，主人...", "遵命，主人。"])
    ...
    add_dialogue("slave lecture love", ("very sub", "masochist", "meek", "helper", "pet", "loyal"), ("我很高兴有你作为我的老师，大师[MC.name]。"))
    ...
    add_dialogue("slave train obedience", ("meek", "very sub", "very extravert"), ["[girl.name]一边工作一边安静地给自己唱歌。" ,"g：*唱* {i}嗡嗡嗡……扫帚发出清脆的声音……如果我们保持妓院清洁，没有人会刻薄……{/i}"], multiple=True)
    ...
    add_dialogue("slave train interested", ("meek", "very modest", "very sub"), ("*脸红* 嗯...大师[MC.name]..."), sound=s_mmh)
    ...
    add_dialogue("accept job", ("meek", "very sub", "very materialist"), ("当然。我将成为一名{b}[girl.job]{/b}。{w=1.0}{nw}"))
    add_dialogue("work_whore", ("meek", "very sub", "very materialist"), ("当然，我不介意。除了成为一名{b}[girl.job]{/b}之外，我还将为客户提供服务。{w=1.0}{nw}"))
    add_dialogue("exhausted", ("meek", "very sub", "very materialist"), ("*叹气*我大便了...我会尽快恢复成为一名{b}[girl.job]{/b}。"))
    ...
    add_dialogue("advertise", ("meek", "very introvert"), ["请、请来我们的妓院参观……","E-享受[brothel.name]的服务...", "今晚来找我吧..."])
...
## START SWEET DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_hobbies", ("sweet", "helper", "loyal"), ("嗯……我喜欢童话故事，总有一个美好的结局。 【爱好】也挺好玩的。", "大多数时候我很忙很忙......但我尝试为[hobby]腾出一些时间。", "当我[hobby]的时候，时间过得真快。"), max_cap=40)
    add_dialogue("free_chat_likes", ("very extravert", "helper", "creep"), ("啊，我最喜欢的[thing]？我最喜欢]。", "最喜欢的[thing]？这是一次千钧一发的机会，但我不得不说[best]就是最好的。 *微笑*"), love=1, max_cap=40)
    add_dialogue("free_chat_dislikes", ("sweet", "helper"), ("我不喜欢[thing][worst]。我很好奇人们在其中看到了什么。我肯定错过了什么！", "我不喜欢[worst]这样的[thing]。对我来说似乎很平淡。也许我有什么问题？ *傻笑*"), love=2, max_cap=40)
    ...
    add_dialogue("free_touch_pussy", ("sweet", "loyal", "superficial"), ("*脸红*什-什么？！突然间这是怎么回事？", "*脸红* D-别碰我那么多，我有点紧张！", "*脸红*什么……？！你-你让我很惊讶...", "Aah!", "*脸红*哎呀！"), love=2, max_cap=90)
    ...
    add_dialogue("free_offer_job no_lie", ("sweet"), ["g：等等……你不会是认真的吧？！", "g：*哭*哦，这太可怕了...为你工作我能得到什么？", "mc: Well, I would protect you, give you lodging and regular pay...", "g：我该怎么办……"], multiple=True, love=2)
    add_dialogue("free_offer_job half_lie", ("sweet"), ["g：你什么？我不敢相信我竟然信任你！ *哭泣*", "g: Oh, this is so terrible... My last hope, gone... What would I even get from working for you?", "mc: Well, I would protect you, give you lodging and regular pay...", "g: What should I do... Are you serious?"], multiple=True, love=-2)
    ...
    add_dialogue("free_friend no_lie", ("sweet"), ["g：噢，那破坏了气氛。你就不能找到更好的事情做吗？", "mc：我为自己的工作感到自豪。我知道这听起来可能很肮脏，但我想你会感到惊讶……妓院为这个世界贡献了很多积极性和爱。", "g：也许我判断得太快了。我现在并没有做出太多贡献......*悲伤*"], multiple=True)
    ...
    add_dialogue("free_ask_out", ("sweet"), ["mc：[girl.name]，我喜欢你。你能做我女朋友吗？", "g：你真的想让我...做你的女朋友吗？", "mc：是的，我愿意。", "g：哦，这让我很高兴！当然！", "She throws herself into your arms and gives you a long, deep kiss.", "g：我现在得走了……不过我们很快就会再见面的，亲爱的！ *眨眼*"], multiple=True)
    ...
    add_dialogue("free_job_request", ("very idealist"), ["g: Oh, [MC.name]. You wouldn't happen to know of a quick and efficient way to make money, would you?", "mc: Well, I just might... What's going on?", "g：是学校。我必须以某种方式支付学费才能继续在那里学习，但现在我所有的积蓄都花光了。", "g: If I don't find a way to make money quickly, I will drop out and lose my chance to get an education...", "She looks worried.", "mc: There might be a way... Flexible hours, and all. You probably won't like it, though.", "g: Come on, I'd do anything to keep studying. This is very important to me."], multiple=True)
    ...
    add_dialogue("slave chat other_girls 0", ("very extravert"), ["She frowns.", "g：有些女孩比其他女孩更好。但我确信有人在背后对我说坏话。"], multiple=True, unlock="EI")
    add_dialogue("slave chat other_girls 0.5", ("very extravert"), ["She thinks for a moment.", "g：我有时间去见其他女孩并和她们聊天。我不能说我拥有令人惊叹的社交生活，但这只是一个开始。"], multiple=True, unlock="EI")
    ...
    add_dialogue("slave chat tastes likes", ("very extravert", "helper", "creep"), ("啊，我最喜欢的[thing]？我最喜欢]。", "最喜欢的[thing]？这是一次千钧一发的机会，但我不得不说[best]就是最好的。 *微笑*"), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("sweet", "helper"), ("我不喜欢[thing][worst]。我很好奇人们在其中看到了什么。我肯定错过了什么！", "我不喜欢[worst]这样的[thing]。对我来说似乎很平淡。也许我有什么问题？ *傻笑*"), unlock="LM")
...
## START SUPERFICIAL DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_origins", ("superficial", "rebel", "bimbo" ), ("我来自[girl.origin]。那里实在是太无聊了。", "我来自[girl.origin]。我决定尽快搬到赞。", "我很高兴我们能够从 [girl.origin] 搬到 Zan。 [girl.origin] 简直就是一个屎坑。"), love=2, max_cap=40)
    ...
    add_dialogue("free_friend no_lie", ("superficial", "very extravert"), ["g：哦？我完全在挖掘这一点。听起来你知道如何参加派对！", "mc: And what is it you do?", "g：……介意我们彻底换个话题吗？"], multiple=True, love=6)
    add_dialogue("free_friend half_lie", ("superficial", "very extravert"), ["g：哦，那很酷或者怎么样。", "mc: And what is it you do?", "g：我？没关系，我们可以换个话题吗？"], multiple=True, love=-2)
    add_dialogue("free_friend lie", ("superficial", "very extravert"), ["g：哦，那很酷或者怎么样。", "mc: And what is it you do?", "g：我？没关系，我们可以换个话题吗？"], multiple=True, love=-2)

    add_dialogue("free_love_interest", ("superficial"), ["主持人：嗨[girl.name]。这是美好的一天，不是吗？", "g：嗯，我想...嘿，听着。我们完全应该找到一项可以一起做的新{i}活动{/i}。", "g：我知道你很喜欢我。我已经完全忘记了这一切友谊之类的事情。我已经准备好接受更多了。", "g：是时候认真起来或者离开了，你知道我的意思吗[MC.name]？", "g：给我一些花，单膝下跪，做任何你必须做的事……我们应该完全{i}在一起{/i}。是的？", "mc：嗯……我会考虑一下。"], multiple=True)
    add_dialogue("free_girl get_flowers", ("superficial"), ("天啊，这真是太浪漫了……你有什么话要对我说吗？"))
    add_dialogue("free_ask_out", ("superficial"), ["mc: [girl.name], I like you. Let's be together.", "g：天啊，是啊！  我很高兴您提出这个问题。我简直{i}渴望{/i}你约我出去。", "g：我得去告诉我所有的朋友，就像现在一样。所以也许下次我们可以，比如……没关系！再见！"], multiple=True)
    ...
    add_dialogue("slave toggle naked on", ("superficial", "very extravert"), ("*咯咯*请大饱眼福吧，大师。"))
    add_dialogue("slave toggle naked off", ("superficial", "very materialist"), ("当然可以，主人。只要你看...凭借{i}我{/i}精美的衣柜，我仍然会引人注目。 *眨眼*"))
    add_dialogue("slave train beg", ("superficial", "very extravert"), ["她把手放在臀部并向你挑战。", "g：呃，你这个变态……这是错误的……我不会那样做。"], multiple=True)
    ...
    add_dialogue("slave chat brothel virgin", ("superficial", "very extravert"), ["她看起来很困惑。", "g：太奇怪了，对吧？我没想到我最终会进妓院。"], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat well_being attacked", ("superficial", "very materialist"), ("我知道我是不可抗拒的，但一个月内被攻击[nb_times]可不是闹着玩的。请大师做点什么吧！"))
    ...
    add_dialogue("slave chat tastes hates", ("superficial", "very extravert"), ("嗯，如果你喜欢[thing]，我真的不想被看到和你在一起，所以......", "我朋友现在就面临这样的情况。她喜欢[thing]，而我就像……嗯……不怎么样？！友谊结束了。", "实际上，我{i}真的{/i}不喜欢[thing]。"), unlock="LM")
    ...
    add_dialogue("slave chat origins 1", ("superficial", "rebel", "bimbo" ), ("我来自[girl.origin]。那里实在是太无聊了。", "我来自[girl.origin]。我决定尽快搬到赞。", "我很高兴我们能够从 [girl.origin] 搬到 Zan。 [girl.origin] 简直就是一个屎坑。"), unlock="EI")
    ...
    add_dialogue("origin the Blood Islands", ("superficial", "very extravert", "very materialist"), ("回到血群岛时我一直生活在恐惧之中。吸引过多的注意力可能会导致快速死亡。在赞这里，我终于可以做我自己了。"))
    ...
    add_dialogue("origin the Goliath desolations", ("superficial", "generic", "very idealist", "very materialist"), ["g：我不想谈论我在荒凉中度过的时光。这是一个没有生命和希望的地方。", "g：歌利亚的荒凉永远停留在过去，而在赞这里，我们可以展望未来。我认为人们没有意识到这是多么值得珍惜的特别事情。"], multiple=True)
    ...
    add_dialogue("slave train accepted", ("superficial", "very extravert"), ("噢，主人。我们{i}完全{/i}意见一致。","老师，让我们一起创造一些回忆吧。","我很愿意，主人。"))
    ...
    add_dialogue("slave train fascinated", ("superficial", "very extravert"), ("*呻吟*天哪，呀啊啊！我非常喜欢[act_desc]！你是最棒的，大师[MC.name]。"), sound=s_orgasm_fast)
    ...
    add_dialogue("slave rape negative fixation", ("superficial", "very extravert"), ("啊啊，好痛啊……你最惨了，主人。"), love=-2, fear=3, sound=s_scream_loud)

    add_dialogue("rest", ("superficial", "very extravert", "very introvert"), ("终于有时间了！ {w=1.0}{nw}"))
    add_dialogue("accept job", ("superficial", "very materialist"), ("您见过这么漂亮的{b}[girl.job]{/b}吗？ {w=1.0}{nw}"))
    add_dialogue("work_whore", ("superficial", "very extravert"), ("*咯咯笑*我会成为最放荡的{b}[girl.job]{/b}{i}有史以来{/i}。 {w=1.0}{nw}"))
    add_dialogue("exhausted", ("superficial", "generic", "very materialist"), ("我现在已经精疲力尽了...我会尽快以{b}[girl.job]{/b}的身份回来。"))
    ...
    add_dialogue("advertise", ("superficial", "very extravert"), ["来[brothel.name]找我吧！我们会一起享受{i}很多乐趣{/i}！", "哦，先生...就像...我知道欺骗你的妻子可能是错误的，但这正是它变得{i}如此{/i}有趣的原因，明白我的意思吗？","{i}字面上{/i}迫不及待地想在[brothel.name]招待您！","我们的妓院里有很多荡妇，太疯狂了！", "让我们一起创造一些回忆吧，先生。", "呀呀！我非常喜欢[brothel.name]！您绝对应该来拜访我们。"])

    add_dialogue("beach intro", ("superficial", "very extravert"), ["[girl.fullname] 正在玩沙滩排球。她的技术还有很多不足之处，但她利用她在[brothel.name]学到的技能设法弥补了这一点。", "在比赛的关键时刻，她狡猾地向对手展示自己的阴部，分散了对手的注意力。"], multiple=True, sound=s_laugh)
    ...
    add_dialogue("beach whoring request", ("superficial", "generic", "very materialist"), ["老师，今天不是应该休息吗？"], multiple=True)
    add_dialogue("beach whoring accept", ("superficial", "very extravert", "very lewd"), ["我想我现在有点兴奋……我还不如得到报酬。 *咯咯笑*我就是个荡妇！"], multiple=True)
    add_dialogue("beach whoring refuse", ("superficial", "generic", "very dom"), ["没办法，大师。你就不能给我一天，让我不用听从命令吗？"], multiple=True)
...
## START BIMBO DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_likes", ("bimbo", "pervert", "superficial", "princess"), ("我在[best]俱乐部里。真正的[thing]王。 *笑*"), love=2, max_cap=40)
    add_dialogue("free_chat_dislikes", ("bimbo", "superficial", "princess", "cold"), ("我不喜欢[worst]。那是小孩子的[thing]。"), max_cap=40)
    ...
    add_dialogue("free_play indifferent", ("bimbo", "superficial", "schemer"), ("*微笑*当然，算我一个。我会扮演老师，给你上一堂你不会忘记的课。"), love=3)
    ...
    add_dialogue("free_offer_job no_lie", ("bimbo"), ["g：啊，非常感谢您的邀请！我一直在为此钓鱼。我很高兴你终于明白了。 *眨眼*", "g：你知道，Denars 和 dicks 是我最喜欢的两个东西。", "g：嗯...我很好奇是否可以从您的竞争对手那里撬取一些竞争性报价，但是..."], multiple=True, love=3)
    ...
    add_dialogue("free_offer_job failure lie", ("bimbo"), ["g：你希望我说什么？", "g：与一条刚刚透露自己喜欢隐藏秘密的蛇签订合同……这可不是什么明智之举，不是吗？", "g：在我开始发脾气之前，我们就在这里结束这次讨论吧。"], multiple=True, love=-15)
    add_dialogue("free_offer_job failure no_lie", ("bimbo"), ["g：我不相信将工作与娱乐结合起来是一个好主意。毕竟你会成为我的主人……", "g：如果我们没有恋爱关系，我会立刻签下这份合同。", "g：咱们聊点别的吧，我没心情考虑。"], multiple=True, love=-15)
    ...
    add_dialogue("free_job_request", ("bimbo"), ["g：哦，[MC.name]！我需要一些建议...", "mc：发生什么事了？听起来很严重。", "g：所以我在旁边勾引了一些人……我的意思是，我确信你经常在自己身上胡闹，是吗？", "MC：呃……不能说我是无辜的……继续吗？", "g：我惹错了人……是个跟踪狂，对我着迷了……然后那个怪物突然拿着刀出现在我家！", "她看起来心烦意乱。", "g：我猜他不知何故发现了我们的事。他问了我各种各样关于你和我的问题......", "g：最终我设法说服他不要做任何鲁莽的事情，但是……", "g：我、我在自己家里不再感到安全了。如果他回来怎么办？如果他一直跟踪我怎么办？ *哭*", "She looks at you with tearful eyes.", "g：我要搬家……我需要保镖……这家伙真是个神经病！ *哭泣*", "mc：嗯……嗯，也许有一个办法……我的守卫会很容易制服这样的家伙。", "g：啊？"], multiple=True)
    add_dialogue("gizel take girl to farm", ("bimbo"), ("哈哈！是时候给你这个奴隶荡妇一些理智了。"))
    add_dialogue("slave positive fixation accept", ("generic"), ["哦，我喜欢这个...", "是的，给我吧...", "这太热了...", "哦，这让我兴奋......", "哦是的！我们开工吧。"])
    add_dialogue("slave naked request permanent", ("very lewd"), ("我明白了...好吧，为什么不呢？光着身子的感觉真好，反正赞的天气太热了，不适合穿衣服……"), love=2, fear=-2, sound=s_sigh)
    add_dialogue("MC demean rival", ("generic"), ("哦，我会告诉她的！她会生气的！ *笑*"), sound=s_evil_laugh)
    add_dialogue("slave chat tastes likes", ("bimbo", "pervert", "superficial", "princess"), ("我在[best]俱乐部里。真正的[thing]王。 *笑*"), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("bimbo", "superficial", "princess", "cold"), ("我不喜欢[worst]。那是小孩子的[thing]。"), unlock="LM")
    ...
    add_dialogue("slave train fascinated", ("very lewd"), ("哦...我已经快射了...啊啊，[act_desc] 是最好的！"), sound=s_orgasm_fast)

    add_dialogue("slave train naked success", ("very lewd"), ("哦，老师，我想要更多……"), sound=s_aah)
    add_dialogue("slave train service failure", ("very lewd"), ("她感到沮丧和羞愧，开始哭泣。"))
    add_dialogue("slave train sex success", ("very lewd"), ("主人，我射了……啊啊啊！我喜欢被这样操！"))
    ...
    add_dialogue("slave train bisexual success", ("very lewd"), ("请原谅我，主人，但我必须说……我喜欢阴户……"), sound=s_mmh)
...
## START HELPER DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_hobbies", ("helper"), ("我的空闲时间？虽然我喜欢出去，但我并不总是有那么多时间专注于我真正喜欢的事情。不过，我还是会说[hobby]。", "如果有空闲时间，我喜欢【爱好】，那就最好了！", "我喜欢和朋友一起出去玩、聊天。我们通常只是做他们喜欢的事情，但一旦它成为[hobby]，我真的很喜欢！"), max_cap=40)
    add_dialogue("free_chat_likes", ("helper", "sweet", "pet"), ("哈哈，我喜欢告诉我的朋友，我最喜欢的[thing]是[best]。", "哦……你真的想知道吗？我认为[best]就是最好的[thing]。", "在这个女孩看来，【最好】就是最好的【事情】。"), max_cap=40)
    add_dialogue("free_chat_dislikes", ("helper", "pet", "sweet"), ("我曾经和一些朋友谈到过这个问题，我真正不喜欢的一件事是[worst]。呃！", "哦...好问题...我讨厌的一件事是[worst]。", "虽然我喜欢陪伴我的朋友，但有一次他们中的一个人说他们喜欢[worst]。我没有告诉她，但我只是不明白这一点......", "我真的不喜欢[worst]。我认为这是最糟糕的[thing]。不过，如果我的朋友喜欢它，我会尽量不去评判，因为我更看重与她的友谊。"), love=2, max_cap=40)
    ...
    add_dialogue("free_joke_mean", ("helper", "pet", "holy"), ("由阿里奥斯！这实在是太卑鄙了，但却很有趣！", "我简直不敢相信你刚才说的话，[MC.name]！", "我还没有遇到过有胆量开这样的玩笑的人。", "很刻薄，但很有趣！", "哈哈……你真是个混蛋！像我这样的女孩该拿你做什么？ *脸红*"), love=3, max_cap=50)
    ...
    add_dialogue("free_touch_pussy", ("helper", "pet"), ("哇，你真的是在追求自己想要的东西！", "天哪，阿里奥斯！那种感觉很好...", "哦哦...*脸红*", "啊啊啊……", "我是你的，[MC.name]。", "哎呀，我的两腿之间有一只男人的手！我们怎么这么快就陷入了这种境地？ *微笑*"), love=4, max_cap=90)
    ...
    add_dialogue("free_flirt_sex_experience experienced", ("helper"), ["She sticks her tongue out.", "g：我确实有社交生活，而且不仅仅限于你认识的女朋友……*眨眼*"], multiple=True, love=2)
    add_dialogue("free_flirt_sex_experience average", ("helper"), ["She blushes.", "g：天啊，你真是个开门见山的人……", "g：当然，我也有过一些情人。", "g：你难道希望我一生都在等待[MC.name]先生出现的那一天吗？ *咯咯笑*"], multiple=True, love=1)
    add_dialogue("free_flirt_sex_experience inexperienced", ("helper"), ["She blushes bright red.", "g： 根本不是那样的！我有过几个情人，但都不是很认真的。"], multiple=True)
    add_dialogue("free_flirt_sex_experience very inexperienced", ("helper"), ["她看起来有些惊讶，甚至震惊。", "g：我不是那种女孩……我不会和很多男人鬼混。", "She frowns."], multiple=True, love=-1)
    ...
    add_dialogue("free_flirt_sex_experience reply_not_many success", ("helper"), ["She frowns.", "g：就几个吧？你看起来睡过很多女孩。", "g：当我的朋友警告我关于你的事情时，也许我应该注意。"], multiple=True)
    add_dialogue("free_flirt_sex_experience reply_not_many failure", ("helper"), ["She frowns.", "g：就几个吧？我看得出来，你睡过很多女孩，却对我不诚实。", "g：当我的朋友警告我有关你的事情时，我应该注意的。"], multiple=True, love=-1)
    ...
    add_dialogue("free_flirt_sex_act very reluctant", ("helper"), ["She gives you a disgusted look.", "g：这些问题是怎么回事？我不是那种女孩。我更喜欢我们的聊天内容是天气和八卦。"], multiple=True)
    add_dialogue("free_flirt_sex_act reluctant", ("helper"), ["She frowns.", "g：我{i}很{/i}熟悉这一点，尽管我希望我不是……我们可以谈谈别的事情吗……？甚至生命、宇宙、一切……", "g：……虽然我对此了解不多。"], multiple=True)
    add_dialogue("free_flirt_sex_act a little reluctant", ("helper"), ["She frowns.", "g：我真的不是特别喜欢这个。我想我可以被说服去尝试，但可能不会……"], multiple=True)
    add_dialogue("free_flirt_sex_act indifferent", ("helper", "sweet", "loyal"), ["She thinks for a moment.", "g：那还不错……我不介意……"], multiple=True, love=1)
    add_dialogue("free_flirt_sex_act interested", ("helper"), ["She blushes.", "g：嗯……天啊，最好不要谈论这个，你会让我想做的……", "谈论奇怪的动物和天气更安全。"], multiple=True, love=2)
    add_dialogue("free_flirt_sex_act a little interested", ("helper", "sweet"), ["She blushes.", "g：嗯……哦天哪，最好不要谈论这个，你会让我性欲旺盛的……"], multiple=True, love=2)
    add_dialogue("free_flirt_sex_act very interested", ("helper", "sweet", "pet"), ["She licks her lips.", "g：我喜欢它...这是我在床上最喜欢的东西之一。"], multiple=True, love=3)
    add_dialogue("free_flirt_sex_act fascinated", ("helper", "sweet", "pet"), ["She licks her lips.", "g：别让我开始，我喜欢它......这是世界上我最喜欢的东西之一。", "g： 真是太棒了！"], multiple=True, love=3)
    ...
    add_dialogue("free_offer_job no_lie", ("helper"), ["她给你一种害羞、崇拜的表情。", "g：我很高兴你告诉我有关你工作的真相。这给了我时间去思考...",  "g：我想和你在一起，即使这意味着成为你的奴隶。事实上，我很想成为那样的人。 *脸红*", "g：你认为我可以在你的妓院工作吗？", "g：周围还有很多其他女孩，不是吗？", "g：我喜欢有很多女朋友在身边聊天！"], multiple=True, love=1)
    add_dialogue("free_offer_job half_lie", ("helper"), ["g: You never told me!", "mc: Well, I thought it was unimportant at the time...", "g：所以我的朋友警告我关于你的事是对的？你是妓院老板。", "g：但我不介意。你看，就在前几天，当我的朋友警告我不要再花这么多时间和你在一起时，我告诉她......", "g：那如果他是呢？这是世界上最古老的职业，许多人在赞这里从事这种职业！", "g：[MC.name]对我很好。也许我会去妓院帮助他，而不是总是帮助你解决问题！"], multiple=True, love=1)
    add_dialogue("free_offer_job lie", ("helper"), ["g: You never told me!", "mc: Well, I thought it was unimportant at the time...", "g：所以我的朋友警告我关于你的事是对的？你是妓院老板！", "g：但是……我不介意。你看，就在前几天，当我的朋友警告我不要再花这么多时间和你在一起时，我告诉她......", "g：那如果他是呢？这是世界上最古老的职业，许多人在赞这里从事这种职业！",  "g：[MC.name]对我很好。也许我会去帮助他去妓院，而不是帮助你解决所有的问题！"], multiple=True, love=1)
    add_dialogue("free_offer_job success", ("helper"), ["g：好吧，我别无选择……", "g：我想永远靠近你。我会尽一切努力留在你身边。", "g：我会成为你的奴隶和妓女，并帮助你打理你的妓院。我是你的。请带我看看我的新家，主人[MC.name]。"], multiple=True)
    add_dialogue("free_offer_job thinking", ("helper"), ["g: Thank you for your offer... But...", "g：我很受诱惑……尽管我爱你，想永远靠近你，但成为奴隶和妓女是一件大事。我需要想一想。", "She leaves, looking thoughtful."], multiple=True)
    add_dialogue("free_offer_job failure lie", ("helper"), ["g：让 Shalia 让你见鬼去吧，我就是这么想的！你觉得我是个什么样的女孩子啊！", "g：你骗了我，现在你还想让我去你那愚蠢的妓院工作！我还不如死了，你这个撒谎的混蛋！", "g: Fuck off!", "She leaves, looking really mad.", "mc: That went well. Maybe later, when she's cooled off?"], multiple=True, love=-15)
    add_dialogue("free_offer_job failure no_lie", ("helper"), ["g：让 Shalia 让你见鬼去吧，我就是这么想的！你觉得我是个什么样的女孩子啊！", "g：你认为因为我愿意在你的生意上做饭或做衣服，我会成为一个漂亮的小妓女吗？", "g: Fuck off!", "She leaves, looking really mad.", "mc: That went well. Maybe later, when she's cooled off?"], multiple=True, love=-15)
    ...
    add_dialogue("free_friend half_lie", ("helper"), ["g：哦，我明白了。 [MC.playerclass] 听起来非常适合您！", "g：我和一位好朋友聊天。她说不要相信那个人，[MC.name]。他看起来像个妓院老板！", "g：我说，不可能！不是[MC.name]。他太善良了！我们只是好朋友。", "g：有时我们只是闲聊，有时讨论一些深奥的事情，比如生命、宇宙和一切，尽管[MC.name]比我更理解。", "g：有时他会给我钱，还开玩笑说我身材火辣。", "g：这都是朋友做的事。", "g：下次见到我的朋友时，我会告诉她你是[MC.playerclass]。那她就会相信我了！"], multiple=True)
    add_dialogue("free_friend lie", ("helper"), ["g：A...[lie]？我应该相信你吗？", "g：你让我对你很好奇。我可以告诉你的一件事是你没有[lie]。", "g：我和一位好朋友聊天。她说不要相信那个人，[MC.name]。他看起来像个妓院老板！", "g：我说，不可能！不是[MC.name]。他太好了，但我真的应该相信你是一个[lie]吗？ *皱眉*", "mc: Haha, sure... And you, what is it you do?", "g: Oh, you know, this and that..."], multiple=True, love=-3)

    add_dialogue("free_love_interest", ("helper"), ["mc: Hi, [girl.name]. Is something wrong?", "g：呃，我？不……几天前，在一个美丽的[season]日，我刚刚和我最好的朋友之一聊天……", "g：一位非常和蔼可亲的年轻人来找她，还给她带来了一朵可爱的花。", "g：我当然为她感到非常高兴……", "g：但内心深处让我想知道，这种事会发生在我身上吗？我想可能不会。我什至还哭了一点。", "g：但后来她说，也许那个你一直在谈论的男人[MC.name]会给你带来一个！", "g：我想，Arios，也许这可能会发生！我觉得我们已经变得如此亲密，我发现与你交谈如此轻松。", "g：当然不是为了给你带来任何压力！"], multiple=True)
    add_dialogue("free_girl get_flowers", ("helper"), ["g：你真是太好了……但是有理由吗？！", "我很好奇你想要什么？"], multiple=True)
    add_dialogue("free_ask_out", ("helper"), ["mc：[girl.name]，我喜欢你。但也许我们可以更接近……你知道，把这提升到一个新的水平吗？", "g: You want me... to be your girlfriend?", "mc: That's right.", "g：怎么，你终于问了！当然！我迫不及待地想把这件事告诉我所有的朋友！", "She throws herself into your arms and gives you a long, deep kiss.", "g：我会尽一切努力留在你身边并完全属于你。"], multiple=True)

    add_dialogue("free_girlfriend intro", ("helper"), ["g：哦，[MC.name]！来这里吧，亲爱的...", "mc: Hi, love. How are you today?", "g：我很好，亲爱的...你应该跟我一起去，我要给你看一些我想你已经想要了很长时间的东西...", "mc: Why, sure...", "g：但首先，为了知道你真的关心我，而不是装模作样，我想问你一个问题。"], multiple=True)
    ...
    add_dialogue("free_girlfriend success", ("helper"), ["Dropping her clothes to the ground, she looks deep into your eyes.", "g：既然你已经向我展示了你的关注和照顾我的能力……现在是你应该拥有我的时候了。", "g: Do you like what you see?", "你可以感觉到你的鸡巴每一秒都变得更硬。她似乎注意到了这一点，并对你微笑。", "g：也许我可以帮你……*脸红并微笑*"], multiple=True)
    add_dialogue("free_girlfriend success naked", ("helper"), ["当她脱下衣服时，你喘息着。", "g: Don't you think being comfortable with one's body is a wonderful feeling?", "g: I always feel very comfortable when I'm naked around the house... I wish I could be naked all the time!", "g: But I'm not going around the town naked, of course... *sigh* I'm not crazy.", "g: Still, I'm happy I could show you my true self... You look happy too! *咯咯笑*", "g：也许我可以帮助你解决下面的问题... *眨眼*"], multiple=True)

    add_dialogue("free_job_request", ("helper"), ["g: Are you... Are you seeing other girls?", "mc: Uh?", "g: Tell me the truth... Oh, I know... I've seen you with them... It feels like my heart will burst!", "g：我以为我能接受，但我就是不能！", "mc: I'm sorry... I... I will explain...", "g：没关系。我知道你是谁。你不必爱我，但我爱你。我想永远靠近你。", "g: I'll do anything to stay by your side. I'll become your slave, even, if you want me to.", "g: Will... Will you have me? I beg you, please take me... I'm yours!", "mc: Well... I'll... Let me think..."], multiple=True)
    ...
    add_dialogue("slave chat tastes likes", ("helper", "sweet", "pet"), ("我们有时会和其他女孩谈论这个。我最喜欢的[thing]是[best]。", "我真的很高兴你想了解你的女奴，主人！简单来说，我认为【最好】就是最好的【事情】。", "在这个女孩看来，【最好】就是最好的【事情】。谢谢您向我询问，主人。 *微笑*"), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("helper", "pet", "sweet"), ("我曾经和其他女孩讨论过这个问题，我真正不喜欢的一件事是[worst]。呃！", "我很高兴你对你的奴隶感兴趣，主人。我讨厌的一件事是[worst]。", "我有时会和其他女孩谈论这个问题。有一次他们中的一个人说他们喜欢[worst]。我没有告诉她，但我只是不明白这一点......", "我真的不喜欢[worst]。我认为这是最糟糕的[thing]。不过，如果其中一位顾客喜欢它，我会像一个好女孩那样尽量保留自己的意见。"), unlock="LM")
    add_dialogue("slave chat origins 1", ("helper"), ("我很高兴你对我感兴趣，主人。我来自[girl.origin]。", "谢谢大师的提问。我出生在[girl.origin]。", "我很高兴你对我感兴趣，大师[MC.name]。我的家人来自[girl.origin]。"), unlock="EI")
...
## START HOLY DIALOGUE 03.February.2022
    ...
    add_dialogue("free_greetings_casual", ("holy"), ("你好，我是[girl.fullname]。愿阿里奥斯的光芒照耀着你。 *微笑*"), love=2)
    add_dialogue("free_greetings_rude", ("holy"), ("[girl.fullname]。要知道，阿里奥的教义并不认可你的举止！"))

    add_dialogue("free_small_talk", ("holy"), ("这一切在亚里欧斯眼里都是毫无意义的。", "别浪费我宝贵的时间。", "请直接进入您的询问点。", "为什么这会引起我或阿里奥斯教会的关注？"), max_cap=25)
    add_dialogue("free_gossip", ("holy"), ("有时人们会把最疯狂的故事带到阿里奥斯教堂。像这个。", "你是否也想知道阿里奥斯对某些事件有何感想？", "请听我说完。这个谣言实在是太吸引人了！"), love=2, max_cap=25)
    add_dialogue("free_chat_life", ("holy"), ("我很高兴你问了。我觉得阿里奥斯对我们所有人都有一个计划。", "加入我们的 Arios 教堂，我们将回答您所有的问题。 *微笑*。", "哦，终于等到你问我这些问题了！ *微笑*"), love=2, max_cap=25)
    add_dialogue("free_chat_love", ("holy"), ("这一切在亚里欧斯眼里都是毫无意义的。", "别浪费我宝贵的时间。", "我没有时间做这个。显然阿里奥斯是我的爱人。", "为什么这会引起我或阿里奥斯教会的关注？"), max_cap=25)
    add_dialogue("free_chat_origins", ("holy"), ("哦，我出生在[girl.origin]。但我们都来自阿里奥斯。我有告诉过你世界的起源吗？这一切都始于阿里奥第一次......", "阿里奥.我是他创造的，就像你一样。按照他的设计，我是在[girl.origin]中被创造出来的。请让我告诉你更多关于亚里欧斯和这个世界的诞生的事情。"), love=3, max_cap=40, sound=s_laugh)
    add_dialogue("free_chat_hobbies", ("holy"), ("可以说我喜欢[hobby]。但这已经是过去式了。现在阿里奥斯教堂需要我的时间。", "我曾经花时间[hobby]。但如您所知，阿里奥斯对我们所有人都施加了严格的规则。"), max_cap=40)
    add_dialogue("free_chat_likes", ("holy", "loyal", "repressed", "cold"), ("我认为[best]是一件好事。但谈论个人需求是浪费时间。"), max_cap=40)
    add_dialogue("free_chat_dislikes", ("holy", "prude"), ("你能想象人们喜欢[worst]吗？他们赞同这个[thing]，是在取笑阿里奥！哦，很抱歉就这样爆发了。 *眨眼*", "任何认为[worst]是最好的[thing]的人都有一个严重的问题。阿里奥一定会惩罚他们的。 *微笑*谢谢你让我发泄一些蒸汽。我需要那个。"), love=1, max_cap=40)
    ...
    add_dialogue("free_joke_adult", ("holy"), ("幸运的是，阿里奥斯听不到所说的一切。但是我可以。请继续。 *眨眼*", "那个很好。现在该我了！", "哈哈，这让我想起我们教会的一个案例。有点悲伤，但仍然很有趣。"), love=1, max_cap=50, sound=s_laugh)
    add_dialogue("free_joke_dark", ("holy"), ("以阿里奥斯的名字来说，这真是太棒了！请再多一点！", "请不要告诉任何人，但比莎莉亚的教义更黑暗的笑话只是我的专长。 *眨眼*", "哈哈哈，太黑了，能把亚里欧斯教堂的光都熄灭了。多一个！"), love=3, max_cap=50, sound=s_laugh)
    add_dialogue("free_joke_mean", ("holy", "repressed"), ("幸运的是，阿里奥斯听不到所说的一切。但是我可以。请继续。 *眨眼*", "那个很好。现在该我了！", "哈哈，好痛啊最好准备好接受一些回报。 *眨眼*"), love=1, max_cap=50, sound=s_laugh)
    ...
    add_dialogue("free_touch_ass", ("holy"), ("以阿里奥斯之名！是的！", "*低语*如果你再用点力气，我就会爬到你的脚边。 *脸红*我真的这么说了吗？", "哦，这正是阿里奥的教导中所缺少的！ *眨眼*"), love=3, max_cap=90, sound=s_aah)
    add_dialogue("free_touch_breasts", ("holy"), ("以阿里奥斯之名！是的！", "*低语*用力掐他们，我将永远属于你。 *脸红*我真的这么说了吗？", "哦，这可以为阿里奥斯的教义增添新的篇章！ *眨眼*"), love=2, max_cap=90, sound=s_aah)
    add_dialogue("free_touch_pussy", ("holy", "stubborn", "prude", "repressed", "cold"), ("立即移开你的手。", "你要我叫警卫吗？", "停下来。严重地。停下来吧。"), love=1, max_cap=90)

    add_dialogue("free_play refuses", ("holy"), ("你这个异教徒！是什么让你认为我会和你这么做！", "这是不可原谅的。我信了你！", "放开你的手，混蛋！ *smack*让这成为你的一个教训！"), love=-1, sound=s_punch)
    ...
    add_dialogue("free_play indifferent", ("holy"), ("理论上阿里奥斯禁止这样做。但我没有看到他阻止我们。", "嗯...为什么不呢？让我们算一下吧。", "这或许没有得到亚里欧斯的认可……不过如果是你的话，我也没关系。"), love=3)
    add_dialogue("free_play a little interested", ("holy"), ("理论上阿里奥斯禁止这样做。但我很好奇。所以... *眨眼*", "我可能有兴趣。 *眨眼*所以让我们算数吧。", "你怎么知道我只是想知道那会是什么样的感觉？你受到阿里奥斯的祝福吗？"), love=4)
    add_dialogue("free_play interested", ("holy"), ("我一直想知道那些莎莉亚信徒在谈论什么。我想我快要追上了……*眨眼*", "以阿里奥斯的名义，我对此有很多疑问。请做一个好老师。  *眨眼*", "你怎么知道我需要什么以及何时需要？你受到阿里奥斯的祝福吗？ *眨眼*"), love=4)
    add_dialogue("free_play very interested", ("holy"), ("那些莎莉亚母狗说话总是一副行动最多的样子。我想我快要追上了……*眨眼*", "以阿里奥斯的名义，教我一切知识……哦，光是这个想法就让我湿透了。", "您确切地知道我需要什么、何时需要以及在哪里需要。就这样，此时此地。"), love=5, sound=s_mmh)
    add_dialogue("free_play fascinated", ("holy"), ("那些莎莉亚母狗说话总是一副行动最多的样子。如果他们知道我们要做什么就好了……*aaaah*", "以阿里奥斯的名义，如果我们现在就在他的神庙里就好了……哦，光是这个想法就让我如此湿润。", "您确切地知道我需要什么、何时需要以及在哪里需要。就这样，此时此地。希望阿里奥斯能够关注！"), love=5, sound=s_mmh)
    add_dialogue("MC take virginity", ("holy"), ("我们今天所做的，是在亚里欧斯守护下的神圣誓言。我很高兴第一次和你在一起。"), love=5)
    add_dialogue("free_play interested after", ("holy"), ("阿里奥可能不会同意。但是我愿意。 *吻*", "蛮好玩的。我们什么时候再做一次？", "在阿里奥斯的光芒下，我喜欢它。"))
    add_dialogue("free_play not interested after", ("holy"), ("对不起，但我必须回去履行我的职责。愿阿里奥斯保护你。", "嗯，这确实是一种新的体验。但我明白为什么阿里奥斯不赞成它。"))
    ...
    add_dialogue("free_flirt_sex_experience average", ("holy"), ("有一些。虽然还在合理范围之内！", "我的意思是，这是自然的，不是吗？所以，是的，有一些……但只有阿里奥斯留在了我身边。"), love=1)
    ...
    add_dialogue("free_flirt_sex_experience reply_waiting failure", ("holy"), ("你知道，仅仅因为我是阿里奥斯的追随者并不意味着我天真。虽然我很欣赏你的努力。", "真的吗？虽然是遵循亚里欧斯的教诲，但我实在无法相信你。毕竟我们是在赞。"), love=-1)
    ...
    add_dialogue("free_flirt_sex_experience reply_not_many failure", ("holy"), ("你知道，仅仅因为我是阿里奥斯的追随者并不意味着我天真。虽然我很欣赏你的努力。", "真的吗？虽然是遵循亚里欧斯的教诲，但我实在无法相信你。毕竟我们是在赞。"))
    ...
    add_dialogue("free_flirt_sex_experience reply_sex_god success", ("holy"), ("我不敢相信你为此感到自豪！这完全违背了阿里奥斯的教诲！", "我不知道，在你宣布之后我也不想知道！"))
    add_dialogue("free_flirt_sex_experience reply_sex_god failure", ("holy"), ("你是谁，你需要在这件事上撒谎吗？您让我恶心！", "你真可怜……我以为我认识你……"), love=-1)
    add_dialogue("free_flirt_sex_experience reply_brothel_owner", ("holy"), ("我明白了……至少你在这座城市里传播了一些欢乐。虽然不知道Arios对此有何感想……", "嗯，这是一份工作，赞需要它。至少当我们到达时你会知道该怎么走......*脸红*"), love=1)

    add_dialogue("free_flirt_sex_act refuses", ("holy"), ("阿里奥！是什么让你觉得我想和你谈谈这个？", "以阿里奥斯的名义，为什么？这根本不关你的事！", "换个话题，就现在！"))
    ...
    add_dialogue("free_flirt_sex_act a little interested", ("holy"), ("理论上阿里奥斯禁止这样做。但我对这个话题很好奇。所以... *眨眼*", "我可能对这个话题感兴趣。 *眨眼*所以让我们让谈话变得有意义。", "你怎么知道我只是想知道那是怎么回事？你受到阿里奥斯的祝福吗？"), love=2)
    add_dialogue("free_flirt_sex_act interested", ("holy"), ("我一直想知道那些莎莉亚信徒在谈论什么。我想我快要追上了……*眨眼*", "以阿里奥斯的名义，我对此有很多疑问。请做一个好老师。  *眨眼*", "你怎么知道我现在在想什么？你受到阿里奥斯的祝福吗？ *眨眼*"), love=2)
    add_dialogue("free_flirt_sex_act very interested", ("holy"), ("那些莎莉亚母狗说话总是一副行动最多的样子。终于我有一个可以公开交谈的人了……*眨眼*", "以阿里奥斯的名义，让我找出所有需要知道的事情！", "你清楚地知道我想讨论什么以及何时讨论。就这样，此时此地。"), love=3)
    add_dialogue("free_flirt_sex_act fascinated", ("holy"), ("那些莎莉亚母狗说话总是一副行动最多的样子。如果他们知道我要告诉你什么就好了……*aaaah*", "以阿里奥斯的名义，如果他知道我要告诉你的事情就好了……哦，光是这个想法就让我湿透了。", "你清楚地知道我想讨论什么以及何时讨论。就这样，此时此地。我希望阿里奥斯能够倾听！"), love=3)

    add_dialogue("free_give_gold +++", ("holy", "prude"), ("太感谢了。你是阿里奥斯亲自送来的祝福！", "哦，我非常需要这个！愿阿里奥斯祝福你！"), love=6, max_cap=75)
    add_dialogue("free_give_gold ++", ("holy"), ("非常感谢。阿里奥今天肯定在照顾我。 *眨眼*", "这是对真神之道的慷慨贡献。阿里奥祝福你。"), love=4, max_cap=75)
    add_dialogue("free_give_gold +", ("holy"), ("谢谢。那是没有必要的...但是谢谢你。", "今天阿里奥斯的祝福与你同在。"), love=2, max_cap=75)
    ...
    add_dialogue("free_offer_job no_lie", ("holy"), ["[girl.name] 看着你，眼中充满了深深的悲伤。", "g：我爱你，但是……我刚刚逃离了我神的假庙里的狂欢。妓院工作真的是我的宿命吗？", "g：我知道，传播爱是阿里奥的教诲。但我不再知道我应该相信什么。什么是真实的。", "g: Do you... think I could do it?"], multiple=True, love=-1)
    add_dialogue("free_offer_job half_lie", ("holy"), ["[girl.name] 眼中充满震惊地看着你。", "g：我以为我爱你，但你和那些假神父一样坏！你还瞒着我什么？", "你及时后退，躲开了她的一巴掌，等了一会儿，她的能量再次离开了她。", "mc：亲爱的，事情没有你想象的那么糟糕。我爱你，这将是我们永远在一起的机会。", "g：我刚刚逃离了我神的假庙里的狂欢。现在你来了。妓院工作真的是我的宿命吗？", "g：我知道，传播爱是阿里奥的教诲。但我不再知道我应该相信什么。什么是真实的。", "g: Do you... think I could do it?"], multiple=True, love=-3)
    add_dialogue("free_offer_job lie", ("holy"), ["[girl.name] 眼中充满震惊地看着你。", "g：我以为我爱你，但你和那些假神父一样坏！你还撒过什么谎？", "你及时后退，躲开了她的一巴掌，等了一会儿，她的能量再次离开了她。", "mc：亲爱的，我们第一次见面时我只是不想吓跑你。我爱你，这将是我们永远在一起的机会。", "g：我刚刚逃离了我神的假庙里的狂欢。现在你来了。妓院工作真的是我的宿命吗？", "g：我知道，传播爱是阿里奥的教诲。但我不再知道我应该相信什么。什么是真实的。", "g: Do you... think I could do it?"], multiple=True, love=-4)
    add_dialogue("free_offer_job success", ("holy"), ["深吸了几次气，又缓缓呼出，她终于给出了答案。", "g：也许……也许这一切都是Arios设计的一部分。我的意思是，不然我们为什么要在这场危机之前相遇呢？", "g：所以是的，我会成为你的奴隶。而你将成为我的主人。我确信，阿里奥斯会希望这样。"], multiple=True)
    add_dialogue("free_offer_job thinking", ("holy"), ["g: Thank you for your offer... But...", "g：我现在还不能接受。我将寻求 Arios 的进一步指导，以扫清我前进的道路。", "她离开时，一边向阿里奥斯低声祈祷，一边走开。"], multiple=True)
    add_dialogue("free_offer_job failure lie", ("holy"), ["g：你最坏了，先是骗我，现在又这样？！", "g：我是阿里奥斯的一名自豪的助手。我不是妓女，更不是你的奴隶！", "g：我确信您也参与了仪式！别管我了，你这个异教徒！", "She leaves, looking really mad.", "mc：是的，进展顺利。也许稍后，等她冷静下来？"], multiple=True, love=-15)
    add_dialogue("free_offer_job failure no_lie", ("holy"), ["g：你是最糟糕的！", "g：我是阿里奥斯的一名自豪的助手。我不是妓女，更不是你的奴隶！", "g：我确信您也参与了仪式！别管我了，你这个异教徒！", "She leaves, looking really mad.", "mc：是的，进展顺利。也许稍后，等她冷静下来？"], multiple=True, love=-15)

    add_dialogue("free_friend no_lie", ("holy"), ["g：是这样吗？阿里奥不太喜欢这个行业，但我猜你有助于传播快乐。以你自己的方式...", "mc：这当然是一种表达方式。你是做什么的？", "g：我是阿里奥斯教会一个分支的侍僧。不过最近感觉有些奇怪。但我们现在不谈这个......"], multiple=True, love=1)
    add_dialogue("free_friend half_lie", ("holy"), ["g：哦，我明白了。这些天周围有很多冒险者。愿阿里奥斯的祝福与你同在。", "mc：谢谢。你是做什么的？", "g：我是阿里奥斯教会一个分支的侍僧。不过最近感觉有些奇怪。但我们现在不谈这个......"], multiple=True, love=1)
    add_dialogue("free_friend lie", ("holy"), ["g：奇怪……你没有表现出我所期望的[lie]的氛围。", "mc: Haha, sure... And you, what is it you do?", "g：我是阿里奥斯教会一个分支的侍僧。不过最近感觉有些奇怪。但我们现在不谈这个......"], multiple=True)

    add_dialogue("free_love_interest", ("holy"), ["mc：嗨，[girl.name]。你现在不应该去参加仪式吗？", "g：仪式？哦不……我完全陷入了沉思，完全忘记了时间。", "mc：是什么让你忘记了仪式？阿里奥教堂不是你的生活吗？", "g：你知道，有那对情侣手牵着手......", "g：你知道吗，在阿里奥斯教堂里，鲜花是永恒爱情的象征？如果你给我一些，阿里奥斯一定会同意的……*脸红*", "g：在阿里奥的光辉下，我必须走了。现在。仪式。是的。忘记它吧，好吗？再见！", "[girl.name]说着，脸色变得猩红，看也不看你一眼就跑开了。", "mc：等等[girl.name]！教堂在另一个方向！ ... 花，嗯？很高兴知道。"], multiple=True)
    add_dialogue("free_girl get_flowers", ("holy"), ("在亚里欧斯的光芒下，它们很美丽。这意味着什么？"))
    add_dialogue("free_ask_out", ("holy"), ["mc：[girl.name]，我喜欢你。你觉得阿里奥会同意我们在一起吗？", "g：你前几天听说过？哦不，我该怎么办？", "mc：嗯，你可以接受这些花。至少如果你也喜欢我的话。", "g：当然啦。我只是……这对我来说太新鲜了。我绝不会想到...现在怎么办？", "mc：现在你拿着花，用双臂搂住我的脖子，闭上眼睛。", "[girl.name] 的困惑表情很快变成了明亮的红晕，因为她意识到即将发生什么。尽管如此，她还是照你说的做了，并让你靠过来轻轻地吻她。", "在这个吻中徘徊了一段时间后，她把嘴唇从你身上移开。", "g：那是……特别的。对不起，但我得尽快走了。还有另一个仪式，他们明确要求我出席。某个特别的事件，但具体内容我不知道……啊，但愿这一刻能够永远持续下去！阿里奥斯，我太高兴了！"], multiple=True)

    add_dialogue("free_girlfriend intro", ("holy"), ["g：你好[MC.name]，今天是美好的一天，不是吗？", "MC：确实是这样。尤其是当我可以和你一起度过的时候。", "g：哦，你真可爱。你的话比阿里奥的教导更能照亮我的心情！尤其是最近……等等，不在这儿，跟我来吧！", "mc: Why, sure...", "她紧紧握住你的手，把你拉进狭窄的小巷。", "g：现在应该没人能听到我们的声音了。为了确保确实是您本人，请回答一个问题。"], multiple=True)
    ...
    add_dialogue("free_job_request", ("holy"), ["当 [girl.name] 靠近时，您注意到她穿着与平常不同的侍僧长袍。这些似乎是用更优质的材料制成的，装饰凸显了她的女性曲线。", "但只有当她投入你的怀抱，你能感觉到她半透明的布料下柔软的身体时，你才会想起她的“特殊”仪式。", "g： *抽泣* 哦，[MC.name]，我太蠢了... *抽泣*", "mc：[girl.name]，发生什么事了？阿里奥教堂发生了什么事情吗？", "你想知道她是否可以哭得更厉害。答案是“是的！”。经过长时间的拥抱和多次哭泣后，她再次开始说话。", "g：我的教堂……祭司长……阿里奥斯！我正在为一个伪装的莎莉亚邪教工作！这段时间！ *哭泣*", "现在让你无语了。但回想起来，可能有一些迹象。最好什么也不说，只是暂时听着。", "g：他们狂欢了！我所有的朋友，我的姐妹们……我必须逃跑……", "g：我现在孤身一人了。我的一生都是建立在为阿里奥斯服务的基础上的......而现在，连主教堂都不会接纳我了。*抽泣*", "She bursts into tears.", "g：[MC.name]，我能做什么？我应该去哪儿？我什么都没有剩下...*抽泣*", "mc：[girl.name]冷静点，我们一起想办法……", "你当然可以想出解决办法。但你首先得想出好词好句让她融入你的妓院。她肯定会是一个很好的补充。"], multiple=True)
    ...
    add_dialogue("slave chat tastes dislikes", ("holy", "prude"), ("你能想象人们喜欢[worst]吗？他们赞同这个[thing]，是在取笑阿里奥！哦，很抱歉就这样爆发了。 *眨眼*", "任何认为[worst]是最好的[thing]的人都有一个严重的问题。阿里奥一定会惩罚他们的。 *微笑*谢谢你让我发泄一些蒸汽。我需要那个。"), unlock="LM")
    add_dialogue("slave chat origins 1", ("holy"), ("哦，我出生在[girl.origin]。但我们都来自阿里奥斯。我有告诉过你世界的起源吗？这一切都始于阿里奥第一次......", "阿里奥.我是他创造的，就像你一样。按照他的设计，我是在[girl.origin]中被创造出来的。请让我告诉你更多关于亚里欧斯和这个世界的诞生的事情。"), unlock="EI")
...
## START CREEP DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_hobbies", ("creep", "yandere"), ("*低语*表现得正常，[girl.name]。他喜欢这样。 *咳咳*我喜欢[hobby]。", "让我们看看...我喜欢玩刀。我喜欢[hobby]。我喜欢跟踪你。嗯，还有什么？", "我就知道你会这么问。我知道我应该回答是[hobby]。我知道关于你的一切。", "我大部分时间都在写关于一个非常英俊的 [MC.playerclass] 的色情故事。除此之外，我还喜欢【爱好】。"), love=2, max_cap=40)
    add_dialogue("free_chat_likes", ("creep"), ("*低语*别吓跑他，[girl.name]。 *咳咳*你不同意[best]是一件美妙的[thing]吗？", "我知道你喜欢[best]。这是一件很棒的事情，不是吗？", "我非常喜欢和你说话。我可以和你谈论任何事情。即使是像[thing][best]这样的小事。"), love=2, max_cap=40)
    add_dialogue("free_chat_dislikes", ("creep"), ("嗯...我讨厌排队等候。我讨厌乞丐。我讨厌[thing][worst]。我讨厌看到你和其他女孩说话。","我无法忍受你必须生活在一个存在[thing][worst]的世界里。我会尽一切努力从你的生活中消除[worst]。"), love=1, max_cap=40)
    ...
    add_dialogue("free_touch_pussy", ("creep", "masochist", "yandere"), ("呵呵。隔着衣服触碰就够了，还是……？", "呃。呵呵。呵呵呵呵呵呵！", "如果你想让我做某事，就说吧。你的愿望就是我的命令。", "啊……我浑身湿透了，无法思考了。", "啊啊啊……我已经等不及让你火辣的、抽动的鸡巴一遍又一遍地操我湿漉漉的阴户了！", "啊[MC.name]！你在公共场合触摸我就像梦想成真。", "继续...我只需要几秒钟就可以到达..."), love=3, max_cap=90)
    ...
    add_dialogue("free_offer_job no_lie", ("creep", "yandere"), ["mc：是的，你可以和我一起住在妓院。", "她转身背对着你，开始自言自语。", "g：我和[MC.name]住在同一屋檐下……呵呵呵呵。想想我们将会享受到的所有乐趣。", "g：但是等等……其他人呢？那些荡妇。我们不能让他们破坏我们的乐趣！", "g：啊，我有一个主意了……呃呃呃……我要开始制定消灭他们的计划了。是的，这样就可以了..."], multiple=True, love=2)
    add_dialogue("free_offer_job half_lie", ("creep", "yandere"), ["mc：是的，你可以和我一起住在妓院。", "g：没有必要再对我保守秘密了，[MC.name]。我知道所有的东西。我一直在看着你。","她转身背对着你，开始自言自语。", "g：我和[MC.name]住在同一屋檐下……呵呵呵呵。想想我们将会享受到的所有乐趣。", "g：但是等等……其他人呢？那些荡妇。我们不能让他们破坏我们的乐趣！", "g：啊，我有一个主意了……呃呃呃……我要开始制定消灭他们的计划了。是的，这样就可以了..."], multiple=True, love=2)
    add_dialogue("free_offer_job lie", ("creep", "yandere"), ["mc：是的，你可以和我一起住在妓院。", "g：没有必要再对我保守秘密了，[MC.name]。我知道所有的东西。我一直在看着你。","她转身背对着你，开始自言自语。", "g：我和[MC.name]住在同一屋檐下……呵呵呵呵。想想我们将会享受到的所有乐趣。", "g：但是等等……其他人呢？那些荡妇。我们不能让他们破坏我们的乐趣！", "g：啊，我有一个主意了……呃呃呃……我要开始制定消灭他们的计划了。是的，这样就可以了..."], multiple=True)
    ...
    add_dialogue("free_ask_out", ("creep", "yandere"), ["mc：[girl.name]，你的热情是不可抗拒的。让我们永远在一起吧。", "g：诶嘿嘿！掐我。扇我！我一定是在做梦！", "你打了[girl.name]一巴掌。","g：诶嘿嘿！我简直不敢相信。是的！当然！", "She throws herself into your arms and gives you a long, deep kiss.", "g：我非常非常非常爱你。", "g：永远不要离开我...我非常爱你，我可以杀了你。也许我会杀了我们两个，这样这一刻就可以持续永恒。"], multiple=True)
    ...
    add_dialogue("free_girlfriend success", ("creep", "yandere"), ["当她把衣服扔到地上时，各种刀具从她的口袋里掉到地板上。", "g：我的身体就是你的身体，所以我会好好照顾它。", "g：我的阴户太湿了，我无法再思考了。拜托……我希望你用我的身体来满足你的每一个愿望。"], multiple=True)
    add_dialogue("free_girlfriend success naked", ("creep", "yandere"), ["当她把衣服扔到地上时，各种刀具从她的口袋里掉到地板上。", "g：我的身体就是你的身体，所以我会好好照顾它。", "g：我的阴户太湿了，我无法再思考了。拜托……我希望你用我的身体来满足你的每一个愿望。", "g：一旦我成为你的妻子，我发誓我再也不会穿衣服了。容易接近。"], multiple=True)

    add_dialogue("free_job_request", ("creep"), ["g：哦，[MC.name]！我-我犯了一个可怕的错误...*抽泣*", "mc：发生什么事了？告诉我，[女孩的名字]。", "g：我父亲...他告诉我我们要搬家...*抽泣*然后我...", "g：*抽泣*我只是无法忍受离开你的想法...*抽泣*", "g：所以我抓起我的刀，然后...*抽泣*然后...", "She bursts into tears.", "mc：[girl.name]...你做了什么？", "g：我不能再回家了...*抽泣*我不能...我不能...", "mc：现在冷静点，[girl.name]。我们将为您找到一个新家。"], multiple=True)
    add_dialogue("gizel take girl to farm", ("creep"), ("*叹气*我已经知道这将是少数。你肯定知道如何挑选它们......"))
    add_dialogue("slave hit", ("creep", "very dom"), ["哎哟!好痛..."])
    add_dialogue("slave chat tastes likes", ("creep"), ("*低语*别吓跑他，[girl.name]。 *咳咳*你不同意[best]是一件美妙的[thing]吗？", "我知道你喜欢[best]。这是一件很棒的事情，不是吗？", "我非常喜欢和你说话。我可以和你谈论任何事情。即使是像[thing][best]这样的小事。"), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("creep"), ("嗯...我讨厌排队等候。我讨厌乞丐。我讨厌[thing][worst]。我讨厌看到你和其他女孩说话。","我无法忍受你必须生活在一个存在[thing][worst]的世界里。我会尽一切努力从你的生活中消除[worst]。"), unlock="LM")
...
## START REPRESSED DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_likes", ("repressed", "sweet", "helper", "loyal"), ("每个人都有自己最喜欢的[thing]。对我来说，它必须是[best]。"), max_cap=40)
    add_dialogue("free_chat_dislikes", ("repressed", "stubborn", "princess"), ("当我想到[thing]时，[worst]是最后想到的。总的！", "我知道有些人喜欢[worst]。与此相比，我更喜欢任何其他[thing]。"), love=1, max_cap=40)
    ...
    add_dialogue("free_play not interested after", ("repressed"), ("我很羞愧……这是错误的！让我们永远不再谈论它。"))
    ...
    add_dialogue("free_flirt_sex_act fascinated", ("repressed", "nerd"), ["当她靠近你时，她的脸颊变得鲜红。", "g：*低语* {i}你能……保守秘密吗？{/i}", "mc: Uh... Sure!", "g：*低语* {i}我呃...我确实想了很多...{/i}"], multiple=True, love=3)
    ...
    add_dialogue("free_offer_job lie", ("repressed"), ["g：你……什么？一个小人物？我的男朋友是皮条客？！", "她看起来非常愤怒。", "g：我……简直不敢相信！你这是什么蛇啊！！", "g：我们一起做的所有事情……一直以来，你都在经营一家妓院？！", "她开始无法控制地哭泣。你试图安慰她，但她却伤心不已。", "g：*抽泣*我...我不敢相信*抽泣*我什至*抽泣*考虑到它...", "g：*呜咽*我怎么了？ *抽泣*我真的*抽泣*这么低落吗？"], multiple=True, love=-4)
    add_dialogue("free_offer_job success", ("repressed"), ["泪水不断地从她的脸上滚落。痛苦的哭声使她无法与你说话。", "g： *呜咽* 哇啊啊！！ *哭泣*", "mc：来吧，[girl.name]。你知道我会好好照顾你的。我保证！", "她继续无法控制地大哭。", "mc：只要在虚线上签下合同，你很快就会重新站起来。", "g：*呜咽*哇啊！ *呜咽*哇啊啊啊啊！！ *哭泣*", "mc：那里，那里……就在这里签名吧……", "你握住她的手，轻轻地引导她在奴隶合同上签名。"], multiple=True)
    ...
    add_dialogue("free_job_request", ("repressed"), ["g：哦，[MC.name]，可怕的消息...... *抽泣*", "mc：哦不……怎么了，[girl.name]？", "g：我们的房子...它被烧毁了...而父亲...他在试图扑灭火焰时倒下了...而母亲...她失踪了！", "g：我现在孤身一人了。没有床可以睡，没有家可以回……", "g：我不能生活在阴沟里！我该怎么办？！", "She bursts into tears.", "mc：可怜的[girl.name]...别担心，我们会想办法的..."], multiple=True)
    ...
    add_dialogue("slave chat slave_life -2", ("repressed"), ["当她看着你时，脸上满是泪水。", "g：*呜咽*", "mc：来吧，[girl.name]。事情不可能那么糟糕！", "g：*抽泣*是的，它可以而且确实如此。", "像我这样的女孩——妓院的奴隶？！这一切就像一场非常可怕的噩梦......", "g：但我好像没有醒来……"], multiple=True, unlock="DS")
    ...
    add_dialogue("slave chat slave_life 0.5", ("repressed"), ["她鞠躬。", "g：作为您的奴隶，生活并不坏，主人。", "g：还有更糟糕的事情可能发生在我身上。", "我只是希望它不是在妓院里。我的 [girl.story_guardian] 总是警告我那些......"], multiple=True, unlock="DS")
    ...
    add_dialogue("slave chat brothel 0", ("repressed", "very modest"), ["她沉默了一会儿。", "g：这个地方并不像我想象的妓院那么糟糕。我的 [girl.story_guardian] 总是警告我关于欲望之屋以及堕落女性会发生什么......", "g：但是当我了解了她们之后，我发现无论是女孩还是顾客都是普通人。", "g：生活还要继续，我会挺过去的……"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel 0.5", ("repressed"), ["她的唇边带着淡淡的微笑。", "g：这根本不像我想象中的妓院。", "g：生活很艰难，但我……*吞咽*……发现了……关于我自己的新事物。", "g：我在妓院工作，感觉……就像工作一样……还不错。"], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat tastes likes", ("repressed", "sweet", "helper", "loyal"), ("每个人都有自己最喜欢的[thing]。对我来说，它必须是[best]。"), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("repressed", "stubborn", "princess"), ("当我想到[thing]时，[worst]是最后想到的。总的！", "我知道有些人喜欢[worst]。与此相比，我更喜欢任何其他[thing]。"), unlock="LM")
    ...
    add_dialogue("slave magic sensitivity success", ("generic"), ("嗯……我是取悦诸神的容器……"), sound=s_mmh)
    add_dialogue("slave magic failure", ("repressed", "very dom"), ("什...你到底在做什么？嘿，你在对我尝试一些肮脏的魔法！哎呀！离开！！！"), sound=s_scream, unlock="DS")
    ...
    add_dialogue("slave reward day off", ("repressed","very extravert"), ("真的吗？谢谢老师，真是一​​个惊喜……"), love=1, unlock="DS")
    add_dialogue("slave reward day off KO", ("generic"), ["g：但是主人，今天已经是我休息的日子了……", "MC：啊，对了。我已经忘记了。"], multiple=True)
...
## START SCHEMER DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_likes", ("schemer", "rebel"), ("除了[best]之外，我才不在乎任何[thing]。", "所有其他[thing]都应该跪下并崇拜[best]。"), love=2, max_cap=40)
    add_dialogue("free_chat_dislikes", ("schemer"), ("如果没有[worst]作为[thing]，世界将会变得更加美好。", "我已经制定了一个计划来消除世界上的[worst]。", "如果我有办法的话，[worst]将不再是[thing]。我将确保它成为过去时代的珍品，只能在博物馆中找到。"), max_cap=40)
    ...
    add_dialogue("free_flirt_sex_experience reply_waiting failure", ("schemer"), ("来吧...我们在他妈的赞，已知世界的性之都。你为什么要对这样的事情撒谎？"), love=1)

    add_dialogue("free_flirt_sex_experience reply_not_many success", ("schemer"), ("哦？这让我想知道为什么。我以为你比这更有趣。"), love=4)
    add_dialogue("free_flirt_sex_experience reply_not_many failure", ("schemer"), ("我猜你至少有几十个。赞的女孩子就是这么简单。"), love=1)
    ...
    add_dialogue("free_flirt_sex_act interested", ("schemer"), ["She blushes.", "g：你为什么想知道？你是那些试图引诱我的特工之一吗？我不会被转身。", "尽管她试图隐瞒，但你怀疑她对这个话题感兴趣。"], multiple=True, love=2)
    add_dialogue("free_flirt_sex_act a little interested", ("schemer"), ["She blushes.", "g：谁想知道？难道是光明会想引诱我落入陷阱？你永远抓不到我。", "尽管她试图隐瞒，但你怀疑她对这个话题感兴趣。"], multiple=True, love=2)
    ...
    add_dialogue("free_offer_job lie", ("schemer"), ["她突然大笑起来。","g：我只是跟你开玩笑，我已经这么想了。", "g：我的意思是，来吧……一个[girl.MC_lied]？真的吗？", "mc：呵呵，看来你已经看透我了……", "g：所以你认为我可以在妓院工作，是吗？"], multiple=True, love=-5)
    ...
    add_dialogue("free_offer_job failure lie", ("schemer"), ["g：谢谢你的邀请，但这不适合我。", "g：你太不靠谱了。我不会和你做生意。", "g：不知道你还向我隐瞒了什么。", "她离开并开始与一家竞争对手妓院的老板聊天。", "mc：哦，好吧，她接受这个世界充满了说谎的渣男只是时间问题。"], multiple=True, love=-15)
    ...
    add_dialogue("free_ask_out", ("schemer"), ["mc：[girl.name]，你愿意做我的女朋友吗？", "她咧嘴一笑，搓着手。", "g：我很乐意，[MC.name]。这让我很高兴！", "她拍拍你的头，亲吻你的嘴唇。然后她开始在你耳边低语。", "g：{i}齐心协力，我们势不可挡。赞所有的人都会跪在我们面前。{/i}"], multiple=True)
    ...
    add_dialogue("free_girlfriend wrong", ("schemer"), ("他妈的不！这是错误的！"), love=-10)
    ...
    add_dialogue("slave chat tastes likes", ("schemer", "rebel"), ("除了[best]之外，我才不在乎任何[thing]。", "所有其他[thing]都应该跪下并崇拜[best]。"), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("schemer"), ("如果没有[worst]作为[thing]，世界将会变得更加美好。", "我已经制定了一个计划来消除世界上的[worst]。", "如果我有办法的话，[worst]将不再是[thing]。我将确保它成为过去时代的珍品，只能在博物馆中找到。"), unlock="LM")
...
## START PRUDE DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_life", ("prude", "holy"), ("一个有趣的问题！愿阿里奥斯引导我们找到我们如此迫切寻求的答案。"), love=1, max_cap=25)
    ...
    add_dialogue("free_chat_likes", ("prude", "repressed", "holy", "loyal", "pet"), "我最喜欢的[thing]？我承认我确实时不时地享受[best]。", max_cap=40)
    add_dialogue("free_chat_dislikes", ("prude", "holy", "very modest"), ("嗯……我很抱歉，但是……我不能说我曾经认真考虑过这件事。我想[worst]并不是我最喜欢的[thing]。", "我的朋友们在谈论[thing]时变得非常兴奋。他们说[worst]是Arios的祝福，但我完全不同意！"), max_cap=40)
    ...
    add_dialogue("free_play fascinated", ("prude", "very modest"), ("*脸红*我羞于承认这一点，但我无法抗拒诱惑。", "我知道这是错误的，但你就是无法抗拒。"), love=5)
    ...
    add_dialogue("free_offer_job no_lie", ("prude", "very modest"), ["她看起来很震惊。","g：这、这太荒谬了！你把我当成什么浪荡子了！","mc：妓院有很多就业机会。我们有警卫、女佣、厨房工作人员，应有尽有。", "g：对——对，当然！我很抱歉仓促下结论。"], multiple=True)
    add_dialogue("free_offer_job half_lie", ("prude", "very modest"), ["她看上去既震惊又震惊。","g：呃！我要生病了！", "g：所以、所以你一直向我隐瞒你这种放荡的生活方式……而现在你却希望我简单地接受这一点并开始为了金钱而自我贬低？", "g：这、这太荒谬了！你把我当成什么浪荡子了？！","mc：妓院有很多就业机会。我们有警卫、女佣、厨房工作人员，应有尽有。", "g：哦，对……我想是这样……很抱歉仓促下结论。"], multiple=True)
    add_dialogue("free_offer_job lie", ("prude", "very modest"), ["她看上去既震惊又震惊。","g：呃！我要生病了！", "g：所以、所以你一直向我隐瞒你这种放荡的生活方式……而现在你却希望我简单地接受这一点并开始为了金钱而自我贬低？", "g：这、这太荒谬了！你把我当成什么浪荡子了？！","mc：妓院有很多就业机会。我们有警卫、女佣、厨房工作人员，应有尽有。", "g：哦，对……我想是这样……很抱歉仓促下结论。"], multiple=True)
    ...
    add_dialogue("free_offer_job thinking", ("prude", "very modest"), ["g：这只是一种形式，对吧？", "[girl.name] 仔细考虑你的提议，看上去很沉思。", "g：我需要更多时间来考虑这个问题。", "g：我实在无法想象自己在妓院工作。一定还有别的办法。"], multiple=True)
    ...
    add_dialogue("free_friend half_lie", ("prude", "very modest"), ["g：谢天谢地，你终于找到了一份受人尊敬的职业的工作。", "g：你看上去是一个正派、有能力的人。我确信无论您致力于哪个职业，您都会取得成功。", "mc：谢谢你的客气话。那你是做什么的？", "g：哦，不多……但我很乐意贡献自己的时间来帮助那些被引入歧途的人。", "g：我相信你会同意，现在赞恩存在着令人担忧的不道德和无法无天的现象。", "MC：哦，有吗？我没注意到。"], multiple=True, love=3)
    add_dialogue("free_friend lie", ("prude", "very modest"), ["g：谢天谢地，你终于找到了一份受人尊敬的职业的工作。", "mc：谢谢你的客气话。那你是做什么的？", "g：哦，不多……但我很乐意贡献自己的时间来帮助那些被引入歧途的人。", "g：我相信你会同意，现在赞恩存在着令人担忧的不道德和无法无天的现象。", "MC：哦，有吗？我没注意到。"], multiple=True, love=-2)
    ...
    add_dialogue("accept farm", ("prude", "very modest"), ("我可以利用一些时间休息。远离这一切污秽……", "我当然不会错过我们的客户。", "哦，我会喜欢的。终于呼吸到新鲜空气了！", "谢谢大师。我期待着离开妓院一段时间。"))
    ...
    add_dialogue("slave effusive thanks", ("prude", "very modest"), ("我的天啊！言语无法形容这让我多么高兴。", "阿里奥斯值得称赞！我不值得这样的善意。", "祝福你！我爱你无以言表！", "哦，哇！我对此非常感激！", "祝福你！我真的很感激！"))
    ...
    add_dialogue("slave negative fixation accept", ("prude", "very modest"), ("*喘气*这是错误的！", "呃！这绝对是令人反感的！", "*抽泣*我不敢相信你让我这么做。", "呃！！我想我要生病了！"))
    ...
    add_dialogue("MC fair promise", ("prude", "very modest"), ["她看上去很不自在。", "g：哦不……这、这是妓院，不是吗？", "MC：确实是这样。欢迎来到[brothel.name]。", "当你分享一些[brothel.name]的历史时，她的脸色变得苍白。"], multiple=True, fear=-1)
    ...
    add_dialogue("MC harsh promise", ("prude", "very modest"), ["她看起来非常害怕。", "当她盘起双腿蹲下时，她的眼里涌出泪水。看来这个女孩已经生自己的气了。", "主持人：*叹气*把自己清理干净，你这个肮脏的荡妇。"], multiple=True, love=-4, fear=3)
    ...
    add_dialogue("slave fear intro", ("prude", "very modest"), ["她看上去很害怕，双手抱住头。", "g：阿里奥斯是世界之光。凡跟从他的人，就不在黑暗里行走。让我们抛弃黑暗的行为，穿上光明的军装。阿门。", "她似乎处于某种惊慌的恍惚状态，背诵着宗教经文。她没有能力回答你的问题。"], multiple=True)
    ...
    add_dialogue("slave train beg", ("prude", "very modest"), ["[girl.name]挺直背部并表明立场。", "g：你、你怎么敢提出这么卑鄙的事！这当然不是我应该参与的事情。", "g：你没看出这是错误的吗？"], multiple=True)
    ...
    add_dialogue("slave send to master bedroom fear +", ("prude", "very modest"), ["[girl.name]看起来非常震惊。她低声念叨着简短的祈祷。", "g：（阿里奥斯，请保护我的灵魂免受黑暗的腐蚀。愿你的敌人连同他们的家园和壁炉一起燃烧。）"], multiple=True)
    ...
    add_dialogue("slave chat slave_life -2", ("prude", "very modest"), ["她看起来很生气。","g：我要求你立即解除我这份敲诈勒索的合同！我不属于这里。"], multiple=True, unlock="DS")
    ...
    add_dialogue("slave chat well_being -3", ("prude", "very modest"), ("别迟钝了！我祈祷阿里奥斯能够迅速将我从这里所遭受的恐惧中释放出来。"), multiple=True, unlock="MI")
    add_dialogue("slave chat well_being -2", ("prude", "very modest"), ["g：一点也不！！我日日夜夜都感到恶心。", "g：我担心我永远无法从脑海中抹去我在这里看到的恐怖。"], unlock="MI")
    add_dialogue("slave chat well_being -1", ("prude", "very modest"), ("别迟钝了！我祈祷阿里奥斯能够迅速将我从这里所遭受的恐惧中释放出来。"), multiple=True, unlock="MI")
    add_dialogue("slave chat well_being 0", ("prude", "very modest"), ("住在妓院怎么能安心呢？我不明白这怎么可能。"), unlock="MI")
    ...
    add_dialogue("slave chat well_being attacked", ("prude", "very modest"), ["g：我已经受够了这些渣男想要攻击我了。", "g：看在阿里奥斯的份上，请给我一把好武器，这样我就可以结束他们的痛苦。"], multiple=True)
    ...
    add_dialogue("slave chat tastes likes", ("prude", "repressed", "holy", "loyal", "pet"), "我最喜欢的[thing]？我承认我确实时不时地享受[best]。", unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("prude", "holy", "very modest"), ("嗯……我很抱歉，但是……我不能说我曾经认真考虑过这件事。我想[worst]并不是我最喜欢的[thing]。", "我的朋友们在谈论[thing]时变得非常兴奋。他们说[worst]是Arios的祝福，但我完全不同意！"), unlock="LM")
    add_dialogue("slave chat tastes loves +", ("prude", "very modest"), ("还有什么比与亲人分享[thing]更有益健康的事情吗？"), unlock="LM")
    add_dialogue("slave chat tastes loves -", ("prude", "very modest", "very materialist"), ("你喜欢[thing]吗？它总是让我振作起来。"), unlock="LM")
    add_dialogue("slave chat tastes no loves", ("prude", "very modest"), ("我不喜欢人们沉迷于物质。重要的是你内心的想法。"), unlock="LM")
    add_dialogue("slave chat tastes hates", ("prude", "very modest", "very materialist"), ("我不知道那是什么，但我无法忍受[thing]。"), unlock="LM")
    add_dialogue("slave chat tastes no hates", ("prude", "very modest"), ("当人们无法欣赏一份真心的礼物时，你不讨厌吗？"), unlock="LM")
    add_dialogue("slave chat tastes positive act", ("prude", "very modest"), ("我注意到我对 [act_desc] 感兴趣...你认为这是错误的吗？"), unlock="LM")
    ...
    add_dialogue("slave train accepted", ("prude", "very modest"), ("我不同意这种做法，但我会遵守规定。", "我不敢相信你让我这么做。", "哦不...这是非常错误的，但我会按照你的要求去做。", "这绝对是可悲的，但我会忍受它。"))
    ...
    add_dialogue("slave train a little reluctant", ("prude", "very modest"), ("我真的不想这样做……这是错误的……啊啊！"), sound=s_surprise)
    ...
    add_dialogue("slave train service success", ("prude", "very modest"), ("老师，你太脏了。我马上用我的嘴把你清理干净。"))
    ...
    add_dialogue("slave magic anal success", ("prude", "very modest"), ("最脏的洞...阿里奥斯不介意..."), sound=s_ahaa)
    ...
    add_dialogue("slave punish scold undeserved", ("prude", "very modest"), ["她非常挑衅。", "g：这显然是错误的！你的判断是基于谎言，我不接受！"], multiple=True, love=-1, fear=-1, unlock="MI")
    ...
    add_dialogue("accept job", ("prude", "very modest", "very materialist"), ("我明白了，[MC.name]。我会以{b}[girl.job]{/b}的身份帮助妓院。{w=1.0}{nw}"))
    add_dialogue("work_whore", ("prude", "very modest"), ["g：哦[MC.name]，多么不正当的要求啊！很好，我会这么做的。{w=1.5}{nw}", "g：我会一边做{b}[girl.job]{/b}一边通奸。{w=1.5}{nw}"], multiple=True)
    add_dialogue("exhausted", ("prude", "very modest", "very materialist"), ("对不起，[MC.name]。我绝对被击败了。我会尽快恢复作为{b}[girl.job]{/b}的职责。"))
    ...
    add_dialogue("freed", ("prude", "very modest"), ("这是为了最好的。我一直很难接受住在妓院的生活。告别！"))
    add_dialogue("sold", ("prude", "very modest"), ["g：这是最好的。我一直很难接受住在妓院的生活。", "g：我希望我的下一个工作地点有一个更高尚的目标。告别！"], multiple=True)
    add_dialogue("sold love", ("prude", "very modest"), ["g：*嗅一嗅*我真的会想念你，主人……但也许这是最好的。", "g：我一直很难接受住在妓院的生活。", "g：我希望我的下一个工作地点有一个更高尚的目标。你将永远在我心中占有特殊的位置！"], multiple=True, sound=s_surprise)
    ...
    add_dialogue("advertise", ("prude", "repressed", "holy"), ("请记住，通奸是一种罪过！欲了解更多信息，请访问 [brothel.name]！", "警告你的丈夫注意[brothel.name]，这是一座邪恶的不道德寺庙！", "快来亲自看看，[brothel.name] 是赞猖獗的性轻浮的完美例子。", "赞的家庭主妇们，警告你们的丈夫注意那个名为[brothel.name]的罪恶宫殿！"))
...
## START PRINCESS DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_likes", ("princess"), ("我对很多事情感到高兴。例如，我最喜欢的[thing]是[best]。", "当你爱上我并开始给我买我喜欢的东西时，你应该知道我最喜欢的[thing]是[best]。", "我现在不需要你提供任何东西，但如果时机成熟，你最好记住我最喜欢的[thing]是[best]。"), love=2, max_cap=40)
    add_dialogue("free_chat_dislikes", ("princess"), ("这个世界上有很多无意义的事情。例如，我最不喜欢的[thing]是[worst]。", "好问题。我一直以为【最差】是平民的【事】，缺乏文雅和品位！", "在我看来，[worst]是一件愚蠢的[thing]。如今，在较好的豪宅中很少见到这种情况。", "任何对什么是优雅有所了解的人都认为[worst]是一种粗俗[thing]。"), max_cap=40)
    ...
    add_dialogue("free_flirt_mind", ("princess"), ("你想侮辱我吗？女人光鲜亮丽是不合适的！", "你还叫我聪明啊！下一步是什么？告诉我我应该穿裤子去工作谋生！？", "看在阿里奥斯的份上，我不聪明！那不优雅。这对于一个女孩来说是不可取的。"), love=-1, max_cap=75)
    ...
    add_dialogue("free_flirt_sex_experience average", ("princess"), ["She blushes.", "g：这有点个人化……但是如果我们不尝试一下，我怎么知道我的仰慕者能在卧室里满足我呢？"], multiple=True, love=1)
    add_dialogue("free_flirt_sex_experience inexperienced", ("princess"), ["She blushes bright red.", "g：我也接到过绅士的来电，我也尝试过，但是像个普通的妓女一样到处乱睡可不是什么淑女风范。"], multiple=True)
    add_dialogue("free_flirt_sex_experience very inexperienced", ("princess"), ["She gives you an innocent look.", "g：不要向女士问这个问题……", "She frowns."], multiple=True, love=-1)
    ...
    add_dialogue("free_flirt_sex_act indifferent", ("princess"), ["She thinks for a moment.", "g：哦，好吧...这是人们在卧室里做的事情之一，我想...我不介意你有时这样做。"], multiple=True, love=1)
    ...
    add_dialogue("free_offer_job no_lie", ("princess"), ["She looks at you with newfound resolve.", "g：我？妓女？难道就没有别的办法了吗...", "g：我并不反对性本身，但我反对真正的女士必须工作的想法。你确定你不只是想支持我这样可爱的女孩吗？", "g：另外，一个像我一样成长和血统的女孩成为奴隶的想法简直是荒谬的。", "mc：恐怕你已经欠了很多债了，[girl.fullname]。签署临时奴隶合同会让你摆脱困境。"], multiple=True, love=3)
    add_dialogue("free_offer_job half_lie", ("princess"), ["g: You never told me!", "mc: Well, I thought it was unimportant at the time...", "g：我并不反对性，但我反对女性必须工作的想法。你确定你不只是想支持我这样可爱的女孩吗？", "g：另外，一个与我有血统和成长经历的女孩成为奴隶的想法真是荒谬。", "mc：你已经欠了很多债，[girl.fullname]。签署临时奴隶合同会让你摆脱困境。"], multiple=True, love=3)
    add_dialogue("free_offer_job lie", ("princess"), ["g：噢，所以你骗了我！我以为你从事的是令人印象深刻且浪漫的职业，但事实证明你是虚假且自负的！", "g：这不是我梦想的那样……我，一个妓女？", "mc: Well, some girls prefer the term 'escort'...", "g：护送？困扰我的不是性别，而是你真的希望像我这样长大的优雅女士像平民一样工作吗？"], multiple=True, love=-1)
    ...
    add_dialogue("free_offer_job failure lie", ("princess"), ["g：去你的吧，我就是这么想的！以阿里奥斯的名义，你以为我是谁！", "g：你对我撒了谎，现在你却想让我像一个普通的妓女一样在你那可怕的妓院里工作！我一生中没有一天工作过。那是不会发生的！", "g：滚出我的视线！", "She leaves, looking really mad.", "mc: That went well. Maybe later, when she's cooled off?"], multiple=True, love=-15)
    add_dialogue("free_offer_job failure no_lie", ("princess"), ["g：去你的吧，我就是这么想的！你以为我是亚里欧斯的谁啊！", "g：你认为我会因为对你的工作感兴趣而像一个普通的妓女一样工作吗？", "g：滚出我的视线！", "She leaves, looking really mad.", "mc: That went well. Maybe later, when she's cooled off?"], multiple=True, love=-15)
    ...
    add_dialogue("free_love_interest", ("princess"), ["mc: Hi, [girl.name]. Is something wrong?", "g：呃，我？不……我只是在想。当我还是个小女孩的时候，我喜欢读浪漫的老式书籍。", "g：在那些书中，主人公总是给他们的爱人带来一朵美丽的花，以表达他对她的奉献。", "g：真是侠义又浪漫啊！", "g：既然我们已经如此亲密，如果您是一位英勇的绅士并给我带来一个，我将非常感激。"], multiple=True)
    add_dialogue("free_girl get_flowers", ("princess"), ("哦，一朵美丽的花送给你的女士。这真是太浪漫了……你有什么想要从我这里得到的吗？"))
    add_dialogue("free_ask_out", ("princess"), ["mc: [girl.name], I like you. Let's be together.", "g：你想让我……成为你的情人吗？", "mc: That's right.", "g: Why, finally you ask! Of course!", "她向你伸出手，期待你亲吻它。", "g：既然你对我忠诚了，你就可以满足我的愿望，给我买礼物……", "g：……也许我会给你一些好东西作为回报。 *眨眼*"], multiple=True)

    add_dialogue("free_girlfriend intro", ("princess"), ["g：哦，[MC.name]！过来吧，我的骑士……", "mc: Hi, love. How are you today?", "g：我很好，亲爱的...跟我来，我想给你看一些东西...", "mc: Why, sure...", "g：但首先，我要问你一个问题。"], multiple=True)
    ...
    add_dialogue("free_girlfriend wrong", ("princess"), ["g：你太糟糕了！！！根本不是那么回事！！！你配不上我这样的少女……*疯狂*", "mc: Ah, uh, sorry..."], multiple=True, love=-10)
    add_dialogue("free_girlfriend success", ("princess"), ["Dropping her clothes to the ground, she looks deep into your eyes.", "g：你觉得我丰满的优美身材怎么样？", "You can feel your dick become harder by the second. She seems to notice it, and smiles back at you.", "g: Hmmm..."], multiple=True)
    add_dialogue("free_girlfriend success naked", ("princess"), ["You gasp as she drops her clothes, cupping her boobs in her hands and lightly caressing her nipples.", "g：我一直以为像我这样高贵的身体，赤身裸体才是最优雅的", "g: I always feel very comfortable when I'm naked around the house... I wish I could be naked all the time!", "g：但不幸的是，出于道德和习俗的考虑，我当然不会光着身子在城里走来走去……*叹气*我没有疯。", "g: Still, I'm happy I could show you my true self... You look happy too! *咯咯笑*"], multiple=True)

    add_dialogue("free_job_request", ("princess"), ["g：哦，[MC.name]！为什么每个人都试图让我的生活变得如此糟糕！", "mc: Come on, honey, that's not true... What's going on?", "g：是我叔叔！他的遗产……自从他去世后……我只用了一些开支，几个手提包，六件衣服，神奇的内衣……", "g：但是那个愚蠢的店员说钱没了！全没了！现在我借了一些小钱的贪婪的高利贷者想要回来。 *哭*", "She looks at you with tearful eyes.", "g: I am so deeply in debt! What am I gonna do... *sob*", "mc: Mmmh... Well, there's one way maybe... Slaves cannot own debt, you know?", "g：呃？你有什么建议？！"], multiple=True)
    ...
    add_dialogue("slave chat brothel -1", ("princess","very modest"), ["她看起来很生气。", "g：这个地方是肮脏的妓院！我不是那种女孩...我在这里做什么...*抽泣*"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel 0", ("princess","very modest"), ["她低下头。", "g：我还是不敢相信我在这种地方工作……主人，我真的必须这么做吗？"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel 0.5", ("princess","very modest"), ["她耸耸肩。", "g：我最不想在妓院工作……但现在我还好。"], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat brothel 1", ("princess","very modest"), ["She blushes.", "g：我一直认为妓院是最糟糕的。但现在我在这里工作了，我想其实还不错。"], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat tastes likes", ("princess"), ("我对很多事情感到高兴。例如，我最喜欢的[thing]是[best]。", "当你爱上我并开始给我买我喜欢的东西时，你应该知道我最喜欢的[thing]是[best]。", "我现在不需要你提供任何东西，但如果时机成熟，你最好记住我最喜欢的[thing]是[best]。"), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("princess"), ("这个世界上有很多无意义的事情。例如，我最不喜欢的[thing]是[worst]。", "好问题。我一直以为【最差】是平民的【事】，缺乏文雅和品位！", "在我看来，[worst]是一件愚蠢的[thing]。如今，在较好的豪宅中很少见到这种情况。", "任何对什么是优雅有所了解的人都认为[worst]是一种粗俗[thing]。"), unlock="LM")
    ...
    add_dialogue("origin the Blood Islands", ("princess"), ["g：血腥群岛是一个严酷的地方。我非常习惯奴隶制并看到奴隶以最残酷的方式受到惩罚。", "g 我和我的[girl.story_guardian]一起长大，她总是提醒我，尽管我们很穷，但我们与那里的贵族统治家族之一有联系，必须表现得相应。", "g：我的[girl.story_guardian]曾经说过，像你这样美丽的血玫瑰，胜过一百个农民或一万个奴隶。", "g：当我搬到赞恩时，我总是试图记住我的高贵血统，以及我的[girl.story_guardian]所说的话。", "g：最近，我听到一些让我烦恼的事情。一个女孩子骂我是个被宠坏的小妖精！", "g：我不是风骚的！我绝对没有被宠坏。我不想被宠坏！主人，你觉得我被宠坏了吗？", "她看起来很悲伤。"] , multiple=True)
    add_dialogue("origin Karkyr", ("princess"), ["卡基尔是一座美丽而迷人的城市，由大法师议会统治。我和我的[girl.story_guardian]一起长大，他告诉我，我来自一个非常古老而高贵的血统，即使我们不像我最近去世的赞恩叔叔那样富有。", "g：我的[girl.story_guardian]告诉我，一朵像我这样的神奇玫瑰，比一百个农民或城市里的平民还要值钱。", "g：最近，我听到一些让我烦恼的事情。一个女孩子骂我是个被宠坏的小妖精！", "g：我不是风骚的！我绝对没有被宠坏。我不想被宠坏！主人，你觉得我被宠坏了吗？", "她看起来很悲伤。"], multiple=True)
    ...
    add_dialogue("slave train resisted", ("very dom"), ["大师请！别……别逼我这么做……", "不，等等……我不想！", "但、但是……我不喜欢这样！"])
    ...
    add_dialogue("slave train sex success", ("very modest"), ("主人，我射了……啊啊啊！做个坏女孩真好……"))
...
## START EASY DIALOGUE 03.February.2022
    ...
    add_dialogue("slave chat brothel -1", ("very lewd"), ["她看起来很生气。", "g：我不在乎这是妓院还是宫殿……但是这个地方就是垃圾场！"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel 0", ("very lewd"), ["她沉默了一会儿。", "g：这不是我想象中的妓院，你知道……哪里来的奢华和魅力？但我挺过去了..."], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel 0.5", ("very lewd"), ["她给你一个虚弱的微笑。", "g：虽然很难，但我想在这样的地方工作也很有趣。我学到了一些东西。"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel virgin", ("very lewd"), ["She blushes bright red.", "g：这里太疯狂了，这让我很好奇...尽管我从来没有...嗯..."], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel 1", ("very lewd"), ["She licks her lips.", "g：这里发生了很多事情，我永远不会感到无聊......而且我偶尔可以享受一次美好的性爱！ *脸红*"], multiple=True, unlock="LM")
...
## START PET DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_likes", ("pet", "helper", "loyal"), "嗯，我最近做了一个梦，世界上唯一的[thing]是[best]。你喜欢[best]吗？", max_cap=40)
    add_dialogue("free_chat_dislikes", ("pet", "helper", "masochist"), ("嗯，我不喜欢的一件事是[worst]。但——但也许我只是需要热身一下。你觉得【最差】怎么样？", "嗯……说到【事情】，你觉得【最糟糕】的是什么？", "[MC.name]，你对作为[thing]的[worst]有何看法？"), love=1, max_cap=40)
    ...
    add_dialogue("free_flirt_sex_experience experienced", ("pet"), ["She sticks her tongue out.", "g：嗯，我接受过一些广泛的培训……每个女人都应该学习如何取悦男人。 *眨眼*"], multiple=True, love=2)
    ...
    add_dialogue("free_flirt_sex_act refuses", ("pet", "helper"), ["She gives you an innocent look.", "g：你-你能解释一下吗？我不明白你在问什么..."], multiple=True, sound=s_surprise)
    ...
    add_dialogue("free_flirt_sex_act indifferent", ("pet", "helper"), ["She thinks for a moment.", "g：只要能让你开心的事，我就喜欢！"], multiple=True, love=1)
    ...
    add_dialogue("free_love_interest", ("pet"), ["mc：嗨，[girl.name]。一切都好吗？", "g：[MC.name]！我真的很想念你...", "g：我们应该出去玩。有什么我可以为您做的吗？", "g：我可以给你喝一杯......或者我可以给你按摩......任何你喜欢的！", "g：每当你离开的时候我真的很想念你...但幸好现在你又来了，我的生活就像春天来了一样！", "主持人：嘘，[girl.name]。你有点太强势了。从现在起你为什么不让我来领导呢？"], multiple=True)
    add_dialogue("free_girl get_flowers", ("pet"), ("你是最棒的，[MC.name]！我爱他们！"))
    add_dialogue("free_ask_out", ("pet"), ["mc：[girl.name]，你对我很重要。我想你成为我生活的一部分。", "g: You want me... to be your girlfriend?", "mc: That's right.", "g：我非常爱你！", "She throws herself into your arms and gives you a long, deep kiss.", "g：我得走了。我需要与大家分享这个好消息！"], multiple=True)
    ...
    add_dialogue("free_girlfriend success", ("pet"), ["她笑了，开始脱衣服。", "g：你觉得你的奖品怎么样？", "她用手指抚摸着自己的身体，然后四肢着地，在你面前爬来爬去。", "g：那你觉得怎么样？老师，我是个好女孩吗？ *傻笑*"], multiple=True, sound=s_dress)
    ...
    add_dialogue("slave chat tastes likes", ("pet", "helper", "loyal"), "嗯，我最近做了一个梦，世界上唯一的[thing]是[best]。你喜欢[best]吗？", unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("pet", "helper", "masochist"), ("嗯，我不喜欢的一件事是[worst]。但——但也许我只是需要热身一下。你觉得【最差】怎么样？", "嗯……说到【事情】，你觉得【最糟糕】的是什么？", "[MC.name]，你对作为[thing]的[worst]有何看法？"), unlock="LM")
...
## START CLASS PRESIDENT DIALOGUE 03.February.2022
    ...
    add_dialogue("free_greetings_casual", ("class president"), ("你好，[MC.name] 先生。我是[girl.fullname]。您介意参加一项关于 昙山 生活质量的调查吗？ *微笑*", "哦，终于是一个不粗鲁的人了；我没想到赞里还有你这种人。哦，可是我的礼貌呢！我是[girl.fullname]。很高兴见到你。 *微笑*", "你还算顺利。 [girl.fullname]，随时为您服务。"), love=3)
    ...
    add_dialogue("free_chat_likes", ("class president", "nerd"), ("口味无法解释，但我最喜欢的[thing]是[best]。", "我最近读了一篇关于[thing]理论的研究，证实[best]就是最好的[thing]。"), max_cap=40)
    add_dialogue("free_chat_dislikes", ("class president", "nerd"), ("我不太能解释为什么，但我厌恶[thing][worst]。", "我最近听了一场关于[thing]理论的讲座，该理论推测[worst]是一种劣等[thing]。"), love=2, max_cap=40)
    ...
    add_dialogue("free_ask_out", ("class president"), ["mc: [girl.name], I like you. Let's be together.", "g：你想让我...成为你的搭档吗？", "mc: That's right.", "g： 哎呀，我会很高兴的！是的！", "She throws herself into your arms and gives you a long, deep kiss.", "g：我现在得走了……但很快就会见到你，[MC.name]！ *眨眼*"], multiple=True)
    ...
    add_dialogue("free_girlfriend success", ("class president"), ["一旦你们两个找到一个僻静的地方，[girl.name]就开始脱衣服。她一边这样做，一边整齐地叠好衣服。", "g：*叹气*从你脸上好色的表情来看，你在想不正当的想法。正确的？", "MC：在这种情况下。这是很自然的。只要看看你，你就很美！", "g：*脸红*谢谢……现在，如果您能好心的话，请脱掉衣服。", "你连忙答应。她好奇地看着你半充血的鸡巴。", "g：我发现它还没有完全直立。那么，我们是不是应该从研究女性解剖学开始呢？", "她在桌子上站起来，将她的阴户摊开在你面前。", "g：如你所见，这里是大阴唇和小阴唇，这里是阴蒂……啊！我看到男性对象已经准备好接受检查了……", "她停下手头的事情，急切地开始检查你勃起的阴茎。", "g：抱歉，几个月来我一直在彻底研究我自己的阴户。这个器官更有趣。", "g：啊，有一条系带连接着龟头，很有趣！让我们看看它对刺激有何反应，好吗？", "你花了一点时间和[girl.name]一起学习。"], multiple=True)
    add_dialogue("free_girlfriend success naked", ("class president"), ["一旦你们两个找到一个僻静的地方，[girl.name]就开始脱衣服。她一边这样做，一边整齐地叠好衣服。", "g：*叹气*从你脸上好色的表情来看，你在想不正当的想法。正确的？", "MC：在这种情况下。这是很自然的。只要看看你，你就很美！", "g：*脸红*谢谢……现在，如果您能好心的话，请脱掉衣服。", "你连忙答应。她好奇地看着你半饱的鸡巴。", "g：我发现它还没有完全直立。那么，我们是不是应该从研究女性解剖学开始呢？", "她在桌子上站起来，将她的阴户摊开在你面前。", "g：如你所见，这里是大阴唇和小阴唇，这里是阴蒂……啊！我看到男性对象已经准备好接受检查了……", "她停下手头的事情，急切地开始检查你勃起的阴茎。", "g：对不起，我一生都在彻底研究我自己的阴部。你的器官更有趣。", "g：我和我的母亲在家里总是赤身裸体，但我的父亲通常穿着衣服，所以我对男性解剖学的大部分了解纯粹是理论性的。", "g：啊，有一条系带连接着龟头，很有趣！让我们看看它对刺激有何反应，好吗？", "你花了一点时间和[girl.name]一起学习。"], multiple=True)

    add_dialogue("free_job_request", ("class president"), ["g：噢，[MC.name]，可怕的消息……*抽泣*", "mc：[girl.name]，发生什么事了？", "g：这是我的学校……警卫突击搜查了这个地方，发现我们的炼金术课程是赞的大部分非法毒品交易的罪魁祸首。", "g：现在他们已经关闭了{i}整个{/i}学校，包括所有其他课程。这太糟糕了！", "g：我和那些炼金术课程没有任何关系，但我的学术生涯却受到玷污和诽谤。这不公平！！", "She bursts into tears.", "g：哦，我该怎么办！ *呜咽*没有其他学校会录取我！我得找份工作了...", "mc: [girl.name] calm down, we'll find a solution..."], multiple=True)
    ...
    add_dialogue("slave chat tastes likes", ("class president", "nerd"), ("口味无法解释，但我最喜欢的[thing]是[best]。", "我最近读了一篇关于[thing]理论的研究，证实[best]就是最好的[thing]。"), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("class president", "nerd"), ("我不太能解释为什么，但我厌恶[thing][worst]。", "我最近听了一场关于[thing]理论的讲座，该理论推测[worst]是一种劣等[thing]。"), unlock="LM")
...
## START LOYAL DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_origins", ("loyal", "generic", "very idealist"), ("我来自[girl.origin]。", "我来自[girl.origin]。试图在赞取得成功。", "我来自[girl.origin]...而我现在就在这里。"), love=1, max_cap=40)
    ...
    add_dialogue("free_chat_likes", ("loyal", "helper", "holy", "very idealist"), ("我最喜欢的[thing]是[best]。", "让我想想...我可能没有充分考虑我真正喜欢什么，但是，既然你问了，我想我最喜欢的[thing]是[best]。", "我最喜欢的东西？我倾向于把自己放在最后，但如果你真的想知道，我应该告诉你。我最喜欢的[thing]是[best]。"), max_cap=40)
    add_dialogue("free_chat_dislikes", ("loyal", "helper", "meek", "very idealist"), ("是的，有些事情我不喜欢。例如，我真的不喜欢的一件[thing]是[worst]！", "感谢您的询问，[MC.name]！很多人对我喜欢和不喜欢的东西不感兴趣。但你做了！我最不喜欢的[thing]可能是[worst]。"), love=3, max_cap=40)
    ...
    add_dialogue("free_touch_pussy", ("loyal", "sweet", "pet"), ("哦...你已经走得很远了，但我不介意！ *脸红*", "触摸我的阴部！我开始有心情了……", "我的小猫，随时为您服务。 *咯咯笑*", "触摸我，[MC.name]，我已经开始准备好了！"), love=2, max_cap=90)
    ...
    add_dialogue("free_flirt_spirit", ("loyal", "very idealist"), ("哦谢谢！世界可能会让你沮丧，但我觉得女孩需要保持精神振奋！", "谢谢你！很高兴你注意到了！我正在努力让自己打起精神。我觉得这是我欠自己的。", "赞的街道可能是一个艰难的地方。我觉得保持精神振奋是我的责任！"), love=2, max_cap=75)
    ...
    add_dialogue("free_flirt_sex_experience inexperienced", ("loyal"), ["She blushes bright red.", "g：我试过了...我有过几个男朋友，但都没有达到我所希望的...", "g：……你看，当我找到合适的男人时，我的责任就是对他负责，同时也是床上完美的女人……", "g：……但到目前为止我还没有找到他！"], multiple=True)
    ...
    add_dialogue("free_flirt_sex_experience reply_brothel_owner", ("loyal"), ("当然，你是妓院老板。别让我想起你有多恶心……*闷闷不乐*"), love=-1)
    ...
    add_dialogue("free_flirt_sex_act fascinated", ("loyal", "generic"), ("你把我弄湿了！我的阴户告诉我是的..."), love=3)
    ...
    add_dialogue("free_offer_job no_lie", ("loyal"), ["She looks at you with newfound resolve.", "g：我？妓女？我觉得生活交给我的任何责任我都应该尽力而为，但我没想到会用我的身体为无数的男人服务......", "g：但我很高兴你告诉了我有关你工作的真相。这给了我时间去思考。", "g：如果这就是我一生的命运，那么我就应该拥抱它并尽力而为……", "g：你认为我能做到吗...？"], multiple=True, love=3)
    add_dialogue("free_offer_job half_lie", ("loyal"), ["g: You never told me!", "mc: Well, I thought it was unimportant at the time...", "g：那里的女孩们……她们的职责就是和任何付钱的人做爱，对吗？"], multiple=True, love=1)
    add_dialogue("free_offer_job lie", ("loyal"), ["g: Oh, so you lied...", "g：这不是我梦想的那样……我，一个妓女？", "mc: Well, some girls prefer the term 'escort'...", "g：护送？嗯，它确实有一种更令人愉快的感觉。那些陪护女孩的职责就是和任何付钱的人做爱，对吗？"], multiple=True, love=1)
    ...
    add_dialogue("free_offer_job thinking", ("loyal", "generic"), ["g: Thank you for your offer... But...", "g：我还没准备好接受这一点。一定还有其他工作……还有一些我没有考虑过的选择……", "She leaves, looking thoughtful."], multiple=True)
    add_dialogue("free_offer_job failure lie", ("loyal"), ["g：操你妈的，我就是这么想的！你以为我是什么鬼啊！", "g：你骗了我，现在又要我在你恶心的妓院里工作！那不会发生！", "g：我可能有很强的责任感，像你这样的人渣会想方设法利用，但我确实有一些自尊心。滚蛋！", "She leaves, looking really mad.", "mc: That went well. Maybe later, when she's cooled off?"], multiple=True, love=-15)
    add_dialogue("free_offer_job failure no_lie", ("loyal"), ["g：操你妈的，我就是这么想的！你以为我是什么鬼啊！", "g：你认为因为我有强烈的责任感，我就会成为一个漂亮的小妓女，愿意把自己的身体卖给谁出钱吗？", "g: Fuck off!", "She leaves, looking really mad.", "mc: That went well. Maybe later, when she's cooled off?"], multiple=True, love=-15)

    add_dialogue("free_friend no_lie", ("loyal"), ["g： 妓院？皮条客？！！我们都需要以某种方式谋生，但我认为你的方式很恶心！你让那些女孩出卖自己并虐待她们的身体......*悲伤*", "mc：这对你来说可能听起来很恶心，但我提供了一项重要的服务，让世界变得更安全、更美好。", "mc：这对女孩来说更安全，她们不需要在街上工作，而且可以免受触手怪物和疯狂乞丐的侵害。", "mc：妓女需要房子，国家需要妓院。", "mc：阿里奥斯的牧师曾经试图取缔妓院，但这导致强奸和谋杀事件大幅增加。", "mc：我的妓院女孩为好斗的男人提供了一种积极的方式来释放他们被压抑的能量。可以说这是女孩子的义务。", "g：我从来没有这样想过。也许那些女孩确实对赞社区负有责任。", "g：不过，我还是感觉不太对劲……", "她看起来很深思熟虑，但似乎并不完全相信你的论点。"], multiple=True, love=-3)
    ...
    add_dialogue("free_friend lie", ("loyal"), ["g：一个……[lie]？而我其实就是乔装打扮的黑姬公主本人！", "我很难相信你是一个[lie]。你看起来只是另一个充满希望的[MC.playerclass]，试图在赞取得成功。", "mc：那你是做什么的？", "g：我的职责！ ...", "g：……如果我真的有一份就好了……因为我有点没有工作……*她看起来很不好意思*"], multiple=True, love=-1)

    add_dialogue("free_love_interest", ("loyal"), ["mc: Hi, [girl.name]. Is something wrong?", "g：呃，我？不……不，我只是想我们已经变得非常亲密了。你对我来说意义重大，我希望你也是如此。", "g：我只是看着情侣们在这个轻松愉快的[season]日子里手牵着手......", "g：啊啊，我现在感觉自己就像一个迷失和孤独的女孩......", "g：你知道吗...男孩给女孩送花是为了告诉她们喜欢她们。这是一个很好的举动，可以表明你对我的忠诚......", "mc: Is that so?"], multiple=True)
    add_dialogue("free_girl get_flowers", ("loyal"), ("花朵！真是一个令人愉快的惊喜！但为什么？"))
    add_dialogue("free_ask_out", ("loyal"), ("是的，当然，亲爱的……我的职责就是你！ *吻*"))

    add_dialogue("free_girlfriend intro", ("loyal"), ["g：哦，[MC.name]！来这里吧，亲爱的...", "mc: Hi, love. How are you today?", "g：我很好，亲爱的...跟我来，我想你应该得到一点东西...", "mc: Why, sure...", "g：但是，为了测试你的忠诚度，我会问你一个问题。"], multiple=True)
    ...
    add_dialogue("free_girlfriend wrong", ("loyal"), ["g：你太可怕了！！！你完全忘记了！！！你真是个可怕的男朋友……*生气*", "mc: Ah, uh, sorry..."], multiple=True, love=-10)
    add_dialogue("free_girlfriend success", ("loyal"), ["Dropping her clothes to the ground, she looks deep into your eyes.", "g：亲爱的，你喜欢你所看到的吗？", "你可以感觉到你的鸡巴变得越来越硬。她似乎注意到了这一点，并对你微笑。", "g：我是不是对你做了那种事……我想，女孩子的身体就是为了让男孩子变硬吧！"], multiple=True)
    add_dialogue("free_girlfriend success naked", ("loyal"), ["当她脱下衣服时，你喘息着。", "g: Don't you think being comfortable with one's body is a wonderful feeling?", "g：我认为我们对自己的身体有责任，尽可能让它们自由……我希望我能一直赤身裸体！", "g: But I'm not going around the town naked, of course... *sigh* I'm not crazy.", "g：不过，我还是很高兴能向你展示真实的自己……看你裤子上的那个凸起，看来我的身体也尽到了它的职责了！ *傻笑*"], multiple=True)

    add_dialogue("free_job_request", ("loyal"), ["g: Oh, [MC.name], this is so awful... *sob*", "MC：宝贝，发生什么事了？", "g：我希望能在Zan开始新的生活", "看守们……他们把我从我住的地方赶了出来……我没有可以一起住的朋友……", "g：我现在孤身一人了。我是一个好工人，无论做什么工作都尽职尽责，但没有人愿意给我证明自己的机会！", "g：请帮忙，[MC.name]！你是唯一一个对我好的人！", "She bursts into tears.", "mc：[girl.name]，冷静点，我们会找到解决办法的……"], multiple=True)
    ...
    add_dialogue("slave apology", ("loyal", "very idealist"), ("对不起，老师，让您失望了……", "对不起，我下次会努力的……", "对不起，主人。不会再有这样的事了……以后我要做一个好女孩……", "我不是故意的……对不起。这样的事不会再发生了。"))
    add_dialogue("slave hit", ("loyal", "very idealist", "generic"), ("哎哟!真的很痛啊！", "呜呜呜……痛痛！！！"))
    add_dialogue("slave positive fixation accept", ("loyal", "very idealist"), ("哦，老师，这是我最喜欢的...", "是的，这太好了...很高兴为您服务！", "哦主人，我作为你的性奴隶的责任从未感觉如此美好！", "哦，这感觉真好……我的职责从来没有这么好过！ ", "*舔她的嘴唇*我很高兴这样做！{/i}"))
    ...
    add_dialogue("slave send to master bedroom love +", ("loyal", "very idealist", "very sub"), ["你可以看到她听到你的话高兴得几乎发出咕噜声。", "g：哦，主人，我很高兴……你似乎对我最近在妓院的工作很满意！ *脸红*"], multiple=True)
    add_dialogue("slave send to master bedroom love", ("loyal", "very idealist", "very sub"), ("谢谢主人！看来你对我最近在你妓院的工作很满意！ *微笑*"))
    ...
    add_dialogue("slave chat brothel 0", ("loyal", "very idealist"), ["她沉默了一会儿。", "g：这不是我想象中的妓院……不过没关系。", "g：为所有这些客户提供服务已经成为一种日常工作......", "g：不过我还过得去……我已经习惯了。"], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat brothel virgin", ("loyal", "very idealist"), ["She blushes bright red.", "g：这里发生的一切都很疯狂，这让我很好奇......有一天我很想自己尝试更多......嗯......"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel 1", ("loyal", "very idealist"), ["g： 太忙了！我不知道是谁说的...", "g：……女人的工作永远做不完……",  "g：……但他们显然是对的。总会有新顾客需要阴部或其他东西！"], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat other_girls -2", ("loyal", "very idealist"), ["g：其他女孩看起来都是经验丰富的妓女，但以阿里奥斯的名义，像我这样的女孩在这里做什么！", "g：我觉得我不适合这个行业！"], multiple=True, unlock="EI")
    ...
    add_dialogue("slave chat other_girls 0", ("loyal", "very idealist"), ["She frowns.", "g：我不知道。我将尽我所能地完成这项新工作……就像我应该做的那样……", "g：……但他们似乎花在闲聊上的时间和工作的时间一样多。", "g：……我有这种感觉，有人在背后议论我。 *伤心*"], multiple=True, unlock="EI")
    add_dialogue("slave chat other_girls 0.5", ("loyal", "very idealist"), ["She thinks for a moment.", "g：他们中的很多人都非常好。无论如何，我有时间与之交谈的人。", "g：有一点支持网络感觉很好，即使我仍然觉得我和他们中的很多人没有那么多共同点。"], multiple=True, unlock="EI")
    ...
    add_dialogue("slave chat tastes likes", ("loyal", "helper", "holy", "very idealist"), ("我最喜欢的[thing]是[best]。", "让我想想...我可能没有充分考虑我真正喜欢什么，但是，既然你问了，我想我最喜欢的[thing]是[best]。", "我最喜欢的东西？我倾向于把自己放在最后，但如果你真的想知道，我应该告诉你。我最喜欢的[thing]是[best]。"), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("loyal", "helper", "meek", "very idealist"), ("是的，有些事情我不喜欢。例如，我真的不喜欢的一件[thing]是[worst]！", "感谢您的询问，[MC.name]！很多人对我喜欢和不喜欢的东西不感兴趣。但你做了！我最不喜欢的[thing]可能是[worst]。"), unlock="LM")
    add_dialogue("slave chat tastes loves +", ("loyal", "very idealist"), ["g：我不太在意礼物。", "g：先生，请不要特意去拿东西……", "g：……但我想我不会介意，如果我有一些[thing]……"] , multiple=True, unlock="LM")
    add_dialogue("slave chat tastes loves -", ("loyal", "very idealist"), ("不需要给我任何东西，先生。虽然我想我不会介意[thing]。他们很好。"), unlock="LM")
    add_dialogue("slave chat tastes no loves", ("loyal", "very idealist"), ("呵呵，我真的不需要什么，先生！我想我是一个容易被取悦的女孩..."), unlock="LM")
    add_dialogue("slave chat tastes hates", ("loyal", "very idealist"), ["g：嗯，无论如何你也买不到我的感情。", "g：但是如果你确实给我买了一些东西，请不要做[thing]。", "g：我没有看到上诉..."], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat tastes negative act", ("loyal", "very idealist"), ("我知道我现在在妓院工作，我的身体被用来以各种方式获得快乐，但我根本不明白 [act_desc] 的吸引力......", "光是想到 [act_desc] 就感觉很可怕。我什至不知道为什么。", "我正在尽最大努力让 [act_desc] 变得专业，但不知怎的，它只是让我感到毛骨悚然！"), unlock="LM")
    add_dialogue("slave chat tastes no negative act", ("loyal", "very idealist"), ("我的工作就是满足性幻想。我对他们中的任何一个都很好！ *她看起来很自豪*"), unlock="LM")

    add_dialogue("slave chat origins 1", ("loyal", "very idealist"), ("我来自[girl.origin]。", "我来自[girl.origin]。试图在赞取得成功。", "我来自[girl.origin]...而我现在就在这里。"), unlock="EI")
    ...
    add_dialogue("origin Zan", ("loyal", "very idealist"), ["g：我来自赞恩，现在我仍然在这里，只是年纪大了一点，希望能更聪明一点。我和我的[girl.story_guardian]一起长大。", "g：这不是一个糟糕的城市，尽管我在这里的生活并不轻松。", "g：我越来越喜欢它，并努力忠于自己……"], multiple=True)
    add_dialogue("origin the border with the Holy Lands", ("loyal", "very idealist"), ["g：圣地是一片有着深绿色森林、雪白山顶和一望无际的荒野的地方。它们是各种怪物、半怪物和亚人的家园。", "g：我和我的[girl.story_guardian]一起在那里长大。那里很美丽……如果那些怪物没有那么努力地想要杀死我们的话，那可能会是一个非常令人兴奋的地方……", "g：……并不是说来到那里的阿里奥斯和其他人的圣堂武士总是好得多！", "g：尽管如此，那是我的家，无论我走到哪里，我心里都有一片圣地！", "g：Zan比较平和，有很多机会，但有时我还是觉得自己像个童年的流放者。"], multiple=True)
    ...
    add_dialogue("slave train accepted", ("generic", "loyal", "very idealist"), ("是的主人。", "如您所愿，主人。", "你的愿望就是我的命令，主人。", "哦，主人[MC.name]...*脸红*", "当然，主人。", "我很乐意效劳，主人。", "是啊是啊，大师[MC.name]！"))
    ...
    add_dialogue("slave lecture love", ("loyal", "very idealist"), ("噢，主人，我们今天要聊什么呢？ *脸红*", "这可能听起来很奇怪，大师[MC.name]。但我喜欢听你谈论几乎任何事情！", "有这样一位学识渊博的大师真是太好了！", "哦哦，今天你想教训我什么淘气的事？ *咯咯笑*"))
    ...
    add_dialogue("slave lecture a little interested", ("loyal", "very idealist"), ("这是一个有趣的话题，大师[MC.name]。我想知道，您是否有任何关于如何做得更好的建议？", "我明白我的身体是用来享乐的。请给我解释一下，如何充分利用它？", "我想像我这样的性工作者是在用我们的身体工作。如果您能帮助我更好地使用 [act_desc]，那就太好了。"), sound=s_surprise)
    ...
    add_dialogue("slave train fascinated", ("loyal", "very idealist"), ("哦... [act_desc] 是我的最爱。让我们继续！", "先生，湿透了！ *兴奋的*", "光是提到这件事就让我双腿之间湿润了，先生！", "我的阴户已经准备好工作了，先生！光是提到就让我湿透了！"), sound=s_orgasm_fast)
    add_dialogue("slave train naked failure", ("loyal", "very idealist"), ("不、不、不……对不起，主人。我就是做不到！", "不！这让我太不舒服了。"), sound=s_surprise)
    add_dialogue("slave train naked success", ("loyal", "very idealist"), ("老师，我很高兴我的身体让您满意！"), sound=s_aah)
    ...
    add_dialogue("slave train sex success", ("loyal", "very idealist"), ("噢...aaahh...我感觉到高潮即将到来...AAAAAH！", "噢，天哪，阿里奥斯！这真是恰到好处！"))
    ...
    add_dialogue("slave train fetish failure", ("loyal", "very idealist"), ("你在干什么！由阿里奥斯！不！！！"))
    ...
    add_dialogue("slave punish naked", ("loyal", "very lewd"), ["g：但是请大师...每个人都会看到我...*抽泣*", "mc：这就是重点。"], multiple=True, unlock="LM")
    ...
    add_dialogue("accept job", ("loyal", "very idealist"), ("如您所愿，我现在将担任{b}[girl.job]{/b}，并尽全力满足客户的需求。{w=1.0}{nw}"))
    add_dialogue("work_whore", ("loyal", "very idealist"), ("我现在将担任{b}[girl.job]{/b}和妓女，以满足客户的需求。{w=1.0}{nw}"))
    add_dialogue("exhausted", ("loyal", "very idealist"), ("对不起老师，我还是很累。我需要多休息。", "康复后，我将回去担任 {b}[girl.job]{/b} 的工作。我需要保持良好的状态才能正确地完成这件事。"))
    add_dialogue("rank up", ("loyal", "very idealist"), ("谢谢大师。我现在是一名[newrank]奴隶。准备好把工作做得更好！"))
    ...
    add_dialogue("sold love", ("loyal", "very idealist"), ["g：请不要出卖我，主人！ *哭泣*。我不是你最忠实的仆人吗？", "g：我已经尽力在这家妓院工作中取得成功，因为我爱你...... *哭泣*"], multiple=True, sound=s_surprise)
    ...
    add_dialogue("beach accept public sex", ("loyal", "very idealist"), ["g：Master，你想当着这么多人的面这么做吗？！", "mc：没错，女孩。我会傻傻地操你，他们会看着的。这对妓院来说是很好的宣传。", "g：很公平，先生...我想我是作为[brothel.name]的雇员来到这里...即使今天是我的休息日...", "g：先生，让我们给他们表演一场让我们的机构感到自豪的表演吧！"], multiple=True)
...
## START YANDERE DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_likes", ("yandere", "schemer"), ("听着，[best]是一件很棒的[thing]。这没有争议。", "我讨厌有人不喜欢[best]作为[thing]。我的意思是……什么？这是最好的[thing]！这是事实！", "每当有人没有给予[thing][best]应有的尊重时，我就会非常生气。"), love=3, max_cap=40)
    add_dialogue("free_chat_dislikes", ("yandere"), ("嗯...我想是[thing][worst]？说实话，我真的不在乎。","在我看来，[thing][worst]并不是那么特别。但谁关心这些东西……我们能谈谈别的吗？"), max_cap=40)
    ...
    add_dialogue("slave chat tastes likes", ("yandere", "schemer"), ("听着，[best]是一件很棒的[thing]。这没有争议。", "我讨厌有人不喜欢[best]作为[thing]。我的意思是……什么？这是最好的[thing]！这是事实！", "每当有人没有给予[thing][best]应有的尊重时，我就会非常生气。"), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("yandere"), ("嗯...我想是[thing][worst]？说实话，我真的不在乎。","在我看来，[thing][worst]并不是那么特别。但谁关心这些东西……我们能谈谈别的吗？"), unlock="LM")
...
## START STUBBORN DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_likes", ("stubborn"), ("我是一个与自己的情感相协调的女人，我就是爱[best]！", "我知道我喜欢什么并且我最喜欢[best]！", "我通常对我喜欢的事情充满热情。例如，我最喜欢的[thing]是[best]。我就喜欢！"), love=1, max_cap=40)
    add_dialogue("free_chat_dislikes", ("stubborn"), ("我为自己非常了解自己而感到自豪。这也意味着我知道自己不喜欢什么。例如，我最不喜欢的[thing]是[worst]。布莱...", "呃……我真的很讨厌[worst]。", "有些东西我真的不喜欢，比如【最差】。", "我无意评判，但我很难理解那些喜欢[worst]的人。", "我不想评判，但我怎么能不评判那些最喜欢的[thing]却是[worst]人呢？我只是觉得我们没有任何共同点！"), max_cap=40)
    ...
    add_dialogue("free_flirt_sex_act very reluctant", ("stubborn", "prude", "rebel"), ["She frowns.", "g：你真的很以性为中心。给我一朵花并不意味着你可以问任何私人问题。我决定什么时候你可以问这样的问题。"], multiple=True)
    add_dialogue("free_flirt_sex_act reluctant", ("stubborn", "repressed"), ["She gives you a disgusted look.", "g：我不是那种女孩，先生。我们来讨论别的事情吧。"], multiple=True)
    add_dialogue("free_flirt_sex_act a little reluctant", ("stubborn", "repressed", "rebel"), ["She frowns.", "g：不是我的事。我是否以某种方式让你觉得可以直接问这样的问题......？"], multiple=True)
    add_dialogue("free_flirt_sex_act indifferent", ("stubborn", "rebel"), ["She thinks for a moment.", "g：没关系……我没有什么反对的。"], multiple=True, love=1)
    add_dialogue("free_flirt_sex_act interested", ("stubborn", "loyal"), ["She thinks for a moment.", "g：没关系...如果我喜欢这个家伙，我不介意这样做。"], multiple=True, love=2)
    ...
    add_dialogue("free_flirt_sex_act fascinated", ("stubborn"), ["She licks her lips.", "g：天哪，我喜欢它……你现在让我感觉双腿之间湿润了！ *脸红*我希望你能解决这个问题。 *眨眼*"], multiple=True, love=3)
    ...
    add_dialogue("free_offer_job half_lie", ("stubborn"), ["g：你个渣男。你从来没有告诉过我。我更喜欢诚实！", "mc: Well, I thought it was unimportant at the time...", "g：那里的女孩...她们...只是和付钱的人睡觉，对吗？"], multiple=True, love=-1)
    add_dialogue("free_offer_job lie", ("stubborn"), ["g: Oh, so you lied...", "g：我已经准备好为这段关系付出这么多了……这就是你眼中的我吗，一个妓女？", "mc: Well, some girls prefer the term 'escort'...", "g：护送？哦，拜托，别废话了。当我看到黑桃时，我称它为黑桃；当我看到妓女时，我称她为妓女。但我从没想过我最终会成为其中之一！我的 [girl.story_guardian] 会怎么想？", "g：所以你毕竟不是[girl.MC_lied]。这是一个地狱般的选择：妓院还是监狱......"], multiple=True, love=-5)
    add_dialogue("free_offer_job success", ("stubborn"), ["g：好的，我会做的。但请注意，像我这样脾气的女孩对被命令的反应不太好......", "g：不过，我想他们只是男人。", "g：我什么时候开始？"], multiple=True)
    add_dialogue("free_offer_job thinking", ("stubborn"), ["g：那肯定能让我摆脱麻烦……但是……", "g：当我说我宁愿在妓院工作时，我实际上并不是这个意思。一定还有其他选择...", "她离开了，看上去既愤怒又绝望。"], multiple=True)
    add_dialogue("free_offer_job failure lie", ("stubborn"), ["g：去你妈的，你这个爱操纵别人的混蛋。那就是我所想的！你以为我是个什么样的廉价荡妇啊！？", "g：你先骗我，然后又想让我去你那破烂的妓院干活！是什么让你的自以为是的头脑里产生了如此愚蠢的想法！", "g：滚出我的视线，[MC.name]，否则我会踢你的屁股！", "她离开了，看起来真的很生气。", "mc: That went well. Maybe later, when she's cooled off?"], multiple=True, love=-15)
    add_dialogue("free_offer_job failure no_lie", ("stubborn"), ["g：操你妈的，混蛋，我就是这么想的！你以为我是谁啊！", "g：你认为，因为我曾经说过，我宁愿在妓院工作，也不愿向那个出身名门的贱人低头，我就会成为一个听话的小妓女，乐意张开双腿，听从你的指挥？", "g: Fuck off!", "She leaves, looking really mad.", "mc: That went well. Maybe later, when she's cooled off?"], multiple=True, love=-15)

    add_dialogue("free_friend no_lie", ("stubborn"), ["g：妓院老板？这太恶心了……我不喜欢从事肉体贸易的人。我对你印象很好。也许我错了？ ……我已经习惯了自己是对的。", "mc: And what is it you do?", "g: ..."], multiple=True, love=-2)
    add_dialogue("free_friend half_lie", ("stubborn"), ["g：冒险家，太酷了！我是一个很脚踏实地的女孩，但我不介意一点兴奋。 *眨眼*", "mc: And what is it you do?", "g: Me? Oh, ahem..."], multiple=True, love=1)
    add_dialogue("free_friend lie", ("stubborn"), ["g：A...[lie]？那太令人兴奋了！我只是一个普通的脚踏实地的女孩，尽我最大的努力在Zan取得成功。我从没想过我会遇到[lie]。哇！", "mc: Haha, sure... And you, what is it you do?", "g: Oh, you know, this and that..."], multiple=True, love=3)

    add_dialogue("free_love_interest", ("stubborn"), ["mc: Hi, [girl.name]. Is something wrong?", "g：你知道吗...男孩给女孩送花是为了告诉她们喜欢她们。这是昙县的习俗。", "g：我一直在想……是时候让我们的关系更上一层楼了。如果你能给我带来一朵花，我将非常感激，[MC.name]。", "g：我通常不是一个愚蠢浪漫的女孩，但这是一个传统，我真的很喜欢！", "mc: Is that so?"], multiple=True)
    add_dialogue("free_girl get_flowers", ("stubborn"), ("哦，一朵花。正如我所要求的！现在，约我出去吧，[MC.name]！ *微笑*"))
    add_dialogue("free_ask_out", ("stubborn"), ["mc：我喜欢你，[girl.name]。我们在一起吧。", "g：你终于要我做你女朋友了吗？", "mc: That's right.", "g： 是的，当然！", "She throws herself into your arms and gives you a long, deep kiss.", "g：我认真对待人际关系！我希望你也这样做..."], multiple=True)

    add_dialogue("free_girlfriend intro", ("stubborn"), ["g：哦，[MC.name]！来这里吧，亲爱的...", "mc: Hi, love. How are you today?", "g：我很好，亲爱的...跟我来，我想向你展示...我的全部。 *微笑*", "mc: Why, sure...", "g：但首先，要知道你不仅仅是想利用像我这样天真的、有原则的女孩，我要问你一个问题。"], multiple=True)
    ...
    add_dialogue("free_girlfriend success", ("stubborn"), ["Dropping her clothes to the ground, she looks deep into your eyes.", "g：所以，这是我的身体。你喜欢你看到的吗？", "You can feel your dick become harder by the second. She seems to notice it, and smiles back at you.", "g：看来你那里有点问题…… "], multiple=True)
    add_dialogue("free_girlfriend success naked", ("stubborn"), ["当她脱下衣服时，你喘息着。", "g：当我完全赤身裸体时，我总是感觉最舒服。", "g：我更喜欢直接做我想做的事，无论是说出我的意思还是做我自己。我希望我能一直赤身裸体！", "g：但是我当然不会光着身子在城里走来走去！", "g: Still, I'm happy I could show you my true self... You look happy too! *咯咯笑*"], multiple=True)

    add_dialogue("free_job_request", ("stubborn"), ["g：我必须和你谈谈，[MC.name]。早些时候我遇到了一些麻烦，当时我被错误地指控偷了这个出身高贵的母狗的……呃……女士的钱包。","g：这一切都是误会……","g：守卫抓住了真正的小偷，但我可能已经把那头高贵的母牛称为一些最好不说的事情，现在她要求道歉，否则他们会因为诽谤而把我关进监狱！","g：我永远不会道歉。不是我的错！","g：我不喜欢道歉，即使我做错了事......", "g：这次我没有做错什么！","g：我宁愿砍掉我的手臂，也不愿让那头蠢牛看到我卑躬屈膝的满足！ *冒烟*", "g：天啊……我宁愿在阿里奥该死的妓院里工作！"], multiple=True)

    add_dialogue("accept farm", ("stubborn", "very dom"), ("哦，农场？我明白了...您想培训我，让我的工作做得更好。我会为你做这件事。", "……如果必须的话，我会去。", "I understand, Master."))
    add_dialogue("accept farm fear", ("stubborn", "very dom"), ["当吉泽尔向她走来时，她因恐惧和愤怒而浑身颤抖，她退缩了，但她不敢反抗。", "她看上去像是在忍气吞声，但却低着头，不敢违抗你的命令。"])
    add_dialogue("refuse farm", ("stubborn", "very dom"), ("No! Not the farm! I know what goes on there... I refuse!", "我不想去农场！我也许愿意当妓女，但我有我的极限！", "不！不是农场！我不同意...", "我不能走，主人……我知道那里发生了什么……我不能……而且你不能逼迫我！ *尖叫声*"))
    ...
    add_dialogue("slave positive reaction", ("stubborn", "very dom"), ("哇！你真是太好了！", " 老师，我很高兴您认可我的努力。", "噢，主人……这真是出乎意料。", "谢谢你，主人。这是一个很好的惊喜！"))
    ...
    add_dialogue("MC fair promise", ("stubborn", "very dom"), ("感谢你们承诺的公平待遇，但是什么是公平呢？你自由了。我是一个奴隶。你拥有一家妓院。而我是个妓女。"), fear=-1)
    ...
    add_dialogue("slave toggle naked on", ("very modest"), ("是的主人。如果我必须...", "我会让赞所有的人看到我的身体。"), love=-1)
    ...
    add_dialogue("slave chat brothel -2", ("stubborn"), ["她看起来很沮丧。", "g：我不喜欢妓院。", "g：我不喜欢接受命令。", "g：我鄙视那些把辛苦赚来的第纳尔花在妓女身上的男人。", "g：你希望我回答什么？", "g：我他妈的讨厌这里！这就是我喜欢你妓院的生活！"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel -1", ("stubborn"), ["她看上去又生气又心烦意乱。", "g：这个地方太恶心了！我不赞成妓院和女人为了几第纳尔出卖自己！", "g：我怎么会到这里来？为什么我必须在这里？"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel 0", ("stubborn"), ["她沉默了一会儿。", "g：这不是我想象中的妓院，但说实话我并没有抱太大的期望……", "g：我已经学会了接受这里的现实，但我不是那种喜欢嫖娼的女人。这是错误的。"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel 0.5", ("stubborn", "repressed", "very dom"), ["她给你一个虚弱的微笑。", "g：这很难，也不适合我，但我并不特别讨厌你们的机构。就妓院而言，我想情况可能会更糟。"], multiple=True, unlock="LM")
    add_dialogue("slave chat brothel virgin", ("stubborn"), ["She blushes bright red.", "g：这里太疯狂了……到处都是性爱！", "g：我一直以为我会把我的童贞给合适的男人，他会听我的并且尊重我的真实身份......", "g：但是这里的女孩总是和任何人做这种事！我不得不承认，这让我有点好奇……"], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat other_girls 0", ("stubborn", "very dom"), ["She frowns.", "g：有些还不错。其他人可能会抱怨我的对抗态度或同样荒谬的事情......", "g：……但我会把它们放在原来的位置！"], multiple=True, unlock="EI")
    ...
    add_dialogue("slave chat other_girls 1", ("stubborn", "very dom"), ["She thinks for a moment.", "g：我有时间去见其他女孩并和她们聊天。我已经告诉他们我对赞和这个地方以及作为一个妓女的看法。", "g：他们似乎对我的观点很满意。我觉得他们其实还好。"], multiple=True, unlock="EI")
    ...
    add_dialogue("slave chat well_being sick", ("stubborn", "very dom"), ("过去一个月我生病了 [nb_times] 次。那是非常不愉快的。这肮脏的妓院让我感到恶心！"))
    ...
    add_dialogue("slave chat feelings love 2", ("stubborn"), ["我爱你，主人。我想一直靠近你。", "我知道我对自己关心的事情可能非常固执，我决心帮助您使这家酒店成为赞州最好的酒店！"], multiple=True, unlock="DS")
    ...
    add_dialogue("slave chat tastes dislikes", ("stubborn"), ("虽然我是奴隶，但我很了解自己。这也意味着我知道自己不喜欢什么。其中一件事情就是[worst]。", "有些东西我真的不喜欢，比如【最差】。", "我无意评判，但我很难理解那些喜欢[worst]的人。"), unlock="LM")
    add_dialogue("slave chat tastes loves +", ("stubborn"), ("你还记得我说过，我很了解自己喜欢什么和不喜欢什么吗？你知道什么会让我如此高兴吗？是【东西】！"), unlock="LM")
    add_dialogue("slave chat tastes loves -", ("stubborn"), ("我怀疑你是否很关心对我来说重要的事情，但我喜欢[thing]。"), unlock="LM")
    add_dialogue("slave chat tastes no loves", ("stubborn"), ("不，我真的不需要任何东西......我是一个非常脚踏实地的女孩。"), unlock="LM")
    add_dialogue("slave chat tastes hates", ("stubborn"), ("我是一个很了解她的情绪和厌恶的人。我真正不喜欢的是[thing]。"), unlock="LM")
    ...
    add_dialogue("slave chat tastes negative act", ("stubborn"), ["g：我知道我现在在妓院工作，但我根本不明白[act_desc]的吸引力......", "g： 感觉非常糟糕且错误！我不想做出评判，但为什么会有女孩这么做呢？！"], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat origins 3", ("generic"), ("我记得我和我的[girl.story_guardian]住的[girl.story_home]..."), unlock="EI")
    add_dialogue("origin Zan", ("stubborn", "very dom", "rebel"), ("我很喜欢这个地方，尽管它道德败坏……我的[girl.story_guardian]教会我要坚强和独立，才能在赞的街道上生存。我学会了在这里取得成功的技巧，最重要的是，我学会了为自己挺身而出。"))
    add_dialogue("origin the border with the Holy Lands", ("stubborn", "very dom"), ["g：圣地是一个充满战争和苦难的地方，对于一个小女孩来说也是一个可怕的成长之地。 ", "g：以阿里奥斯的名义发动战争的有权势的人不会想到这一点 - 但我们是生活在其中的真实人民，希望过上正常的生活。我在赞这里更安全，这说明了很多！", "g：尽管如此，那是我的家，我想念它！我和我的 [girl.story_guardian] 一起长大，他教会我要坚强，在这样的世界里为自己挺身而出。"], multiple=True)
    ...
    add_dialogue("origin the desert of Hokoma", ("stubborn", "very dom", "rebel"), ["g：沙漠人更喜欢独来独往。我们有我们自己的方式。我的[girl.story_guardian]知道很多秘密，并把其中一些传给了我。", "g：也许是因为我是在赞这样的地方长大的，所以我不喜欢那些自以为是的贵族和他们虚伪的等级制度。", "g：我想念沙漠。没有一个地方像家一样，不是吗？"], multiple=True)
    add_dialogue("origin Borgo, the port city", ("stubborn", "very dom"), ["g：博尔戈比赞活泼得多，这说明了很多问题。这个地方有傲慢的贵族和不成文的社会规则，对我来说从来没有感觉到真实。", "g：我受到我的[girl.story_guardian]的照顾。我长大了，变得坚强、独立。我学会了为自己挺身而出。"], multiple=True)
    ...
    add_dialogue("origin the Arik mountains", ("stubborn", "very dom"), ["g：我是山里的姑娘。阿里克山脉高于这片大陆上的一切，而我们登山者则与其他人不同。这是一种艰苦的生活，但比在赞的腐败之中要简单。", "g：我的[girl.story_guardian]教会我如何像山一样坚强和独立。"], multiple=True)
    ...
    add_dialogue("slave lecture neutral", ("stubborn", "very dom"), ("又来给我讲一堂课吗？是的，我知道这是妓院。性是我们所有人的食物……我应该更加开放……yada yada yada。"))
    ...
    add_dialogue("slave lecture very reluctant", ("stubborn"), ("啊，不是这个！ [act_desc] 是糟糕且错误的。我不是那种女孩！"))
    ...
    add_dialogue("slave lecture indifferent", ("stubborn", "very dom"), ("嗯……这只是妓院里发生的事情之一。这只是许多其他行为中的一种性行为......"))
    ...
    add_dialogue("slave train sex success", ("stubborn", "very dom"), ("哦...感觉就像魔法在我的血管里流淌。啊啊啊……我射了！！！"))
    ...
    add_dialogue("slave train fetish success", ("stubborn", "very dom"), ("请大师带上吧！ [girl.fullname] 是你的了！ *眨眼*"))
    ...
    add_dialogue("slave train group failure", ("stubborn", "very dom"), ("我勒个去？！决不！！ ……一次一个，不是他妈的赞的全部！"))
    ...
    add_dialogue("accept job", ("stubborn", "very dom"), ("我现在将担任{b}[girl.job]{/b}，以满足客户的需求。{w=1.0}{nw}"))
    add_dialogue("work_whore", ("stubborn", "very dom"), ("我现在将担任一名{b}[girl.job]{/b}，并卖掉自己半天的时间，以满足客户的需求。{w=1.0}{nw}"))
    add_dialogue("exhausted", ("stubborn", "very dom"), ("没办法……我还是很累，需要多休息。  我会以{b}[girl.job]{/b}的身份回去工作，但之前必须先躺下。"))
    ...
    add_dialogue("sold love", ("stubborn"), ["但、但是，为什么？！我...我爱你...*抽泣*", "我可能很难相处，但我相信你和你的妓院！ *哭泣*"], multiple=True, sound=s_surprise)
