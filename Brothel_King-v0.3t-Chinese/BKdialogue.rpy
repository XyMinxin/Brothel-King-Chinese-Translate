...
init -1 python:
    ...
    add_dialogue("free_flirt_sex_experience reply_sex_god success", ("lewd"), "嘿，小心疾病，你这只狗... *嘲笑*", love=2)
    add_dialogue("free_flirt_sex_experience reply_sex_god success", ("pervert"), "有趣…我真的可以利用你的才能...", love=3)
    ...
    add_dialogue("free_flirt_sex_experience reply_brothel_owner", ("modest", "materialist"), "别在我脸上做文章!我男朋友是个皮条客已经够糟糕的了，我不需要提醒.", love=-1)
    add_dialogue("free_flirt_sex_experience reply_brothel_owner", ("lewd"), "好吧，我相信你会积累足够的经验来更好地满足我...", love=2)
    ...
    add_dialogue("free_flirt_sex_act very reluctant", "generic", ["她厌恶地看了你一眼.", "g: 这方面我知道的不多。我们讨论点别的吧."], multiple=True, love=-1)
    ...
    add_dialogue("free_flirt_sex_act a little interested", "generic", ["她脸红.", "g: Hmmm... 别谈这个，你会让我欲火焚身的..."], multiple=True, love=2)
    add_dialogue("free_flirt_sex_act interested", "generic", ["她脸红.", "g: Hmmm... 别谈这个，你会让我欲火焚身的..."], multiple=True, love=2)
    add_dialogue("free_flirt_sex_act very interested", "generic", ["她舔了舔嘴唇.", "g: 别让我开口，我喜欢……这是我最喜欢的事情之一."], multiple=True, love=3, sound=s_mmh)
    add_dialogue("free_flirt_sex_act fascinated", "generic", ["她舔了舔嘴唇.", "g: 别让我开口，我喜欢……这是我最喜欢的事情之一."], multiple=True, love=3, sound=s_mmh)

    add_dialogue("free_give_gold +++", "generic", "哦，这太多了!我从心底感谢你……我真的很需要钱...", love=5, max_cap=75)
    add_dialogue("free_give_gold ++", "generic", "这么多，非常感谢!", love=3, max_cap=75)
    add_dialogue("free_give_gold +", "generic", "谢谢你，这是一个很好的表示.", love=2, max_cap=75)
    add_dialogue("free_give_gold -", "generic", "你为什么要给我这个?你希望得到回报吗?")
    add_dialogue("free_give_gold --", "generic", "给我钱，是吗?你觉得我是个卑鄙的婊子吗? *生气*", love=-1, max_cap=75)

    add_dialogue("free_offer_job no_lie", ("meek", "superficial", "very sub"), ["她开始哭泣.", "g: 听起来很可怕!我不想……哦，我该怎么办呢...", "g: 如……如果我去了，你会好好照顾我吗?"], multiple=True, love=-5)
    add_dialogue("free_offer_job no_lie", ("rebel", "very dom"), ["她怒视了你一眼.", "g: 我吗?一个妓女吗?你他妈的疯了吗?!", "mc: 考虑到你的选择，你真的有选择吗?", "g: 什么……这太糟糕了。至少能帮我摆脱麻烦吧?"], multiple=True, love=-2)
    add_dialogue("free_offer_job no_lie", ("generic"), ["她用新发现的决心看着你.", "g: 我吗?一个妓女吗?没有别的办法了吗...", "g: 我很高兴你告诉了我你工作的真相。这给了我思考的时间.", "g: 你……我想我能做到?"], multiple=True, love=1)
    add_dialogue("free_offer_job no_lie", ("masochist", "pervert", "very lewd"), ["她好奇地看了你一眼.", "g: 你一定认为我是个下流的婊子，是吗?", "mc: 哎呀...", "g: 我不是说你错了...Mmmh...", "她咬着嘴唇.", "g: 如果我在那里工作，我就会整天被陌生人操，对吧?"], multiple=True, love=3)

    add_dialogue("free_offer_job half_lie", ("masochist", "pervert"), ["g: 管他呢!你之前可以提到的...", "mc: 对不起...", "g: 这比我想象的有趣多了…你为什么瞒着我!!我很生气...", "g: 所以如果我在那里工作，我就可以整天和陌生人随便做爱，对吗? Hmm..."], multiple=True)
    add_dialogue("free_offer_job half_lie", ("generic"), ["g: 你从没告诉过我!", "mc: Well, 我当时认为这并不重要...", "g: 那里的女孩们……他们……为了钱做爱，对吗?"], multiple=True, love=-2)

    add_dialogue("free_offer_job lie", ("idealist"), ["g: 你说什么?", "g: 你他妈的骗子!!! 我怎么能相信你!!! *哭喊*", "g: 哦，这太可怕了……我最后的希望破灭了……我为你工作能得到什么?", "mc: 好吧, 我会保护你，给你住宿和固定工资...", "g: 我该怎么办?你是认真的吗?"], multiple=True, love=-5)
    add_dialogue("free_offer_job lie", ("very materialist"), ["g: 啊哈，所以你一直在撒谎，是吗?这很聪明.", "g: 我想知道人们会怎么想...", "g: 为你工作是个好主意吗?"], multiple=True, love=3)
    add_dialogue("free_offer_job lie", ("generic"), ["g: Oh, 所以你撒谎了...", "g: 我做梦都没想到会是这样... 我，一个妓女?", "mc: Well, 有些女孩更喜欢 '陪护'这个词...", "g: 护送吗?我想这名字听起来更好听.", "g: 所以你不是 [girl.MC_lied], 毕竟。但这仍然是一个很好的情况，对吧?我的意思是..."], multiple=True)

    add_dialogue("free_offer_job success", ("idealist"), ["g: 好吧，我会照你说的做。反正我也没办法了...", "g: 我是你的了。带我走."], multiple=True)
    add_dialogue("free_offer_job success", ("materialist"), "好吧。这是一个公平的提议。我买了。!")

    add_dialogue("free_offer_job thinking", ("generic"), ["g: 谢谢你方的报价……但...", "g: 我还没准备好接受。肯定还有其他选择...", "她离开了，看上去若有所思."], multiple=True)

    add_dialogue("free_offer_job failure lie", ("generic"), ["g: 去你妈的，我就是这么想的!你以为我是谁啊!", "g: 你骗了我，现在你想让我在你的破公司工作!这是不可能的!", "g: 滚蛋!", "她离开了，看起来很生气.", "mc: 进展顺利。等她冷静下来再说吧?"], multiple=True, love=-15)
    add_dialogue("free_offer_job failure no_lie", ("generic"), ["g: 去你妈的，我就是这么想的!你以为我是谁啊!", "g: 你以为我不介意你的工作我就会成为一个漂亮的小妓女吗?", "g: 滚蛋!", "她离开了，看起来很生气.", "mc: 进展顺利。等她冷静下来再说吧?"], multiple=True, love=-15)

    add_dialogue("free_friend no_lie", ("modest"), ["g: 这个…这是一种可怕的生活方式!这是答错了!", "mc: 嗯，它能支付账单…你是做什么的?", "g: 呃, 我..."], multiple=True, love=-5)
    add_dialogue("free_friend no_lie", ("very lewd"), ["g: Ooh, 太神奇了! !你一定要让我哪天去看看，我太好奇了!我可以去吗?", "mc: Well, 当然... 你呢，你是做什么的?", "g: Oh, 我吗?最近时间不多了，没做什么..."], multiple=True, love=5)
    add_dialogue("free_friend no_lie", ("generic"), ["g: 是这样吗?呃，我想那是一份很好的工作...", "mc: 你是做什么的?", "g: ..."], multiple=True)

    add_dialogue("free_friend half_lie", ("very idealist", "rebel"), ["g: 一个 [MC.playerclass]? Oh, 这太棒了!你应该教我一些把戏!", "mc: Well, 当然... 你呢，你是做什么的?", "她的情绪有点低落.", "g: Well, 就像你一样…我在找工作..."], multiple=True, love=2)
    add_dialogue("free_friend half_lie", ("generic"), ["g: 哦，我明白了。现在到处都是冒险家.", "mc: 你是做什么的?", "g: 我吗?哦,嗯哼..."], multiple=True)

    add_dialogue("free_friend lie", ("very introvert"), ["她冷冷地看着你.", "g: 是这样吗?奇怪。我从来没听说过你。你说的是实话吗?", "mc: 嗯,嗯…哦，看看时间，哈哈!我真的得走了."], multiple=True, love=-5)
    add_dialogue("free_friend lie", ("very extrovert"), ["g: 真的吗?这太棒了!这是一份好工作，不是吗?", "mc: 是的, 当然...", "g: 哦，也许有一天你会需要帮助……你可以雇佣我! *眨眼*"], multiple=True, love=5)
    add_dialogue("free_friend lie", ("generic"), ["g: 一个... [lie]? 我明白了.", "mc: 哈哈, 当然... 你呢，你是做什么的?", "g: 哦，你知道的，这个那个..."], multiple=True)

    add_dialogue("free_love_interest", "generic", ["mc: Hi, [girl.name]. 出什么事了吗?", "g: Uh, 我? 不... 我只是看着情侣们在这个美好的 [season] 亲吻、牵手...", "g: Uh, 我? 吧... 我只是看着情侣们在这个美好的 [season] 亲吻、牵手...", "g: Ah, 我现在感到孤独...", "g: 你知道吗?男孩给女孩送花，告诉她们他们喜欢她们。这是一个很好的表示...", "mc: 这样的吗?"], multiple=True, fear=-5)
...
#     add_dialogue("free_girl get_flowers", "generic", "This is very romantic... Was there something you wanted from me?") # Had to disable this for now
    add_dialogue("free_ask_out", "generic", ["mc: [girl.name], 我喜欢你。让我们在一起.", "g: 你想让我…做你的女朋友?", "mc: 没错.", "g: 为什么不, 你终于说出口了! 我答应你!", "她扑进你的怀抱，给你一个又长又深的吻.", "g: 我现在得走了……但我们很快就会再见的，帅哥! *眨眼*"], multiple=True)

    add_dialogue("free_girlfriend intro", "generic", ["g: Oh, [MC.name]! 过来，亲爱的...", "mc: 嗨,我的最爱。你今天过的好吗?", "g: 我很好，亲爱的……跟我来，我想给你看点东西...", "mc: 什么, 好的...", "g: 但首先，我想问你一个问题."], multiple=True, fear=-5)
    add_dialogue("free_girlfriend right", "generic", "你当然是对的!跟我来.")
    add_dialogue("free_girlfriend give_up", "generic", "哦,真的吗?我想我们还是不太了解对方... *皱眉*", love=-5)
    add_dialogue("free_girlfriend wrong", "generic", ["g: 你真会瞎编!根本不是这样的!!多糟糕的男朋友... *生气*", "mc: 呃, 呃, 对不起..."], multiple=True, love=-10)
    add_dialogue("free_girlfriend success", "generic", ["她把衣服扔在地上，凝视着你的眼睛.", "g: 你喜欢你所看到的吗?", "你可以感觉到你的鸡巴在第二秒变得更硬。她似乎注意到了，并对你报以微笑.", "g: Hmmm..."], multiple=True, sound=s_dress)
    add_dialogue("free_girlfriend success naked", "generic", ["当她脱下衣服，双手捧起胸部，轻轻地抚摸着她的乳头时，你倒吸了一口气.", "g: 你不觉得对自己的身体感到舒适是一种美妙的感觉吗?", "g: 当我在家里裸体的时候，我总是觉得很舒服。我希望我能一直裸体!", "g: 但我当然不会光着身子在镇上转悠... *叹气* 我可没疯.", "g: 不过，我很高兴能向你展示真实的自己……你看起来也很开心! *咯咯笑*"], multiple=True, sound=s_sigh)

    add_dialogue("free_job_request", "very sub", ["g: Oh, [MC.name], 这太可怕了... *抽泣*", "mc: 宝贝，发生了什么事?", "g: 守卫...他们把我们从房子里赶了出来...还有母亲...她生病了...我哥哥们告诉我他们没有多余的食物可以养活我们...", "g: 现在我一个人了。我肯定会饿死，或者被恶棍抓走并被强奸和杀害!", "她突然哭了起来.", "mc: [girl.name] 冷静下来，我们会找到解决办法的..."], multiple=True, fear=-5)
    add_dialogue("free_job_request", "very idealist", ["g: Oh, [MC.name]. 你知道有什么快速有效的赚钱方法吗?", "mc: 嗯，我可能知道... 发生了什么事?", "g: 是因为学校。我必须想办法支付学费才能继续学习，但我所有的积蓄都用完了.", "g: 如果我找不到一个快速赚钱的方法，我就会辍学，失去接受教育的机会...", "她看起来很担心.", "mc: 可能有个办法... 工作时间灵活。不过你可能不会喜欢.", "g: 拜托了，为了能继续学习我愿意做任何事。这对我来说非常重要."], multiple=True, fear=-5)
    add_dialogue("free_job_request", "pervert", ["g: 这真是个灾难！欢乐骑士团要离开了!", "mc: 什么...什么??", "g: 欢乐骑士团！你不知道他们吗？他们是威兹博尔球界的一支著名球队!", "mc: 后来呢...", "g: 后来? 我是他们的支持女孩!!我曾经和队长约会过，还有他的副手，还有…他们给我大量的礼物和关心...", "mc: 嗯,嗯…什么?", "g: 抱歉，亲爱的，别往心里去，你很棒，但女孩子总要找点乐子... A 威兹博尔 队有23名队员!!! 我到哪里去找另一批又有钱又好色的男人???", "mc: Mmmh..."], multiple=True, fear=-5)
    add_dialogue("free_job_request", "very dom", ["g: [MC.name]... 帮帮我, 求你了! *恐慌*", "mc: 寻求帮助?这听起来不像你...", "g: 我…几周前我遇到过这个人…他想强奸我。几天后我就要受审了。他们会……他们会奴役我的!", "在泽安这里, 如果你没有钱来偿还你的罪行，法官可以把你变成奴隶...", "g: 我用最后一点钱付了保释金。他们会认定我有罪，那人的兄弟会奴役我!他们会在我的余生里强奸和折磨我!", "g: 数万第纳尔……没有出路……要是我能逃过这场审判就好了...", "mc: Mmmh... 你知道奴隶是不能受审的吗?只有自由的男人和女人?", "g: 但我不是奴隶……你的意思是什么?"], multiple=True, fear=-5)
    add_dialogue("free_job_request", "very materialist", ["g: Oh, [MC.name]! 为什么每个人都想让我的生活如此糟糕!", "mc: 拜托，亲爱的，那不是真的…发生了什么事?", "g: 是我爸爸!他的遗产……自从他去世后……我只用它买了几件东西，几个手袋，六件裙子，神奇的内衣...", "g: 但是那个愚蠢的职员说钱不见了!都不见了!现在贪婪的高利贷者想要回我借的零用钱... *哭泣*", "她泪眼婆娑地看着你.", "g: 我负债累累!我该怎么办... *啜泣*", "mc: Mmmh... 好吧，也许有一种方法…你知道，奴隶不能负债?", "g: 唔?"], multiple=True, fear=-5)
    add_dialogue("free_job_request", "very introvert", ["g: 嗨, [MC.name].", "mc: Hi, [girl.name].", "g: 我可以为你工作吗?", "mc: 呃?", "g: 我说，我可以为你工作吗？我需要钱。反正这工作能有多难呢?", "mc: 嗯……这真是个意外的请求……让我想想."], multiple=True, fear=-5)
    add_dialogue("free_job_request", "masochist", ["g: ...", "mc: 怎么了, [girl.name]?", "g: 我不值得.", "mc: 啊???", "g: 我是个没用的废物。我想让你虐待我。我想被像厕所一样利用。我想要...", "mc: 哇，我们确实有一些古怪的时刻，但是……这真前卫.", "g: 请帮助我，让我跪下，虐待我，我想成为一个奴隶...", "mc: 你现在知道了，对吧..."], multiple=True, fear=-5)
    add_dialogue("free_job_request", "very extravert", ["g: 你...你在看其他女孩吗?", "mc: 嗯?", "g: 告诉我真相...哦，我知道了...我看到你和她们在一起...我的心感觉要碎了!", "mc: 对不起...我...我会解释的...", "g: 没关系。你不必爱我，但我爱你。我想永远在你身边.", "g: 我愿意做任何事来留在你身边。如果你愿意，我甚至可以成为你的奴隶.", "g: 你会...你要我吗？我求你了，请接受我...我是你的!", "mc: 嗯...我...让我想想..."], multiple=True, fear=-5)
    ...
    add_dialogue("accept farm", "generic", ["我明白了...我一定是以某种方式让你不高兴了...", "哦，农场...如果必须的话，主人...", "如果你这么说，主人.", "那么我就去吧...", "我明白, 主人."])
    add_dialogue("accept farm", ("masochist", "pervert", "libido"), ["农场...我听说吉泽尔在那里做了很多肮脏的事情... *脸红*", "那是不是意味着...我会被像动物一样锁起来? *脸红*", "我知道我不应该，但是...不知怎么的，我感到有些兴奋..."])
    add_dialogue("accept farm fear", "generic", ["吓得发抖，她在吉泽尔向她走来时退缩了，但她不敢抵抗.", "她用眼神恳求不要让她去，但她不敢违抗你的命令.", "她太害怕了，不敢违抗你的命令."])
    add_dialogue("refuse farm", "generic", ["不！不要去农场！我知道那里会发生什么...我拒绝!", "我不想去农场！求你了，主人，不要!", "不！不要去农场！求你了...", "我不能去，主人...我不能...请饶了我..."])
    add_dialogue("refuse farm", "dom", ["农场？不！！！你不能强迫我去!", "我不会去农场的，这是最后的决定！不!!!", "啊，不要，不是农场吧，你在开玩笑吗?!?"])
    add_dialogue("refuse farm", "sub", ["哦，主人，请别把我留给那个疯狂的女精灵...", "不，我不想去农场...那是个可怕的地方...", "哦，主人，我做了什么让你不高兴的事吗?"])
    add_dialogue("gizel take girl to farm", "generic", "哈！过来，你这愚蠢的奴隶婊子，在我让你尝尝我的鞭子之前.")

    ### CONTRACT DIALOGUE ###

    add_dialogue("contract greeting", "cruise", ["嘿，我的伙伴！欢迎上船."])
    add_dialogue("contract intro", "cruise", ["客人们都快到了!来，我领你到你的住处去."])
    add_dialogue("contract success", "cruise", ["亲爱的，你做得很好，听到了吗?肯定会有战利品等着你的."], sound=s_surprise)
    add_dialogue("contract success special", "cruise", ["亲爱的，你做得很好，听到了吗?肯定会有战利品等着你的。老板们对你印象深刻."], sound=s_surprise)
    add_dialogue("contract buy offer", "cruise", ["喂,头儿。我的老板说他们喜欢上了你的小宠物[girl.name]。他们已经准备好给你一箱金子来抓她了。你觉得怎么样?"])
    add_dialogue("contract buy offer accept", "cruise", ["干得好！你得让那些老水手们满意。这是你的赏金，你这个海盗!"])
    add_dialogue("contract buy offer refuse", "cruise", ["哼，你这疯狂的狗！老板们，他们不会对此感到高兴的。但这是你自己的选择，你的决定."])
    add_dialogue("contract partial", "cruise", ["哼，那是什么？下次你得拿出你的真本事来，姐妹。这可不够我们付你的价格. *恼怒*"], sound=s_sigh)
    add_dialogue("contract partial special", "cruise", ["哼，那是什么？好吧，至少你还能完成老板的特殊要求..."], sound=s_sigh)
    add_dialogue("contract failure", "cruise", ["哼，你这没用的旱鸭子！如果你连几个水手都服务不好，那你在这艘船上就没什么用了! *生气*"])
    add_dialogue("contract failure special", "cruise", ["哼，你这没用的旱鸭子！你或许能迎合他们的口味，但如果你不能让一个诚实的水手满足，那又有什么用呢!"])

    add_dialogue("contract greeting", "party", ["嘿，姑娘，怎么了？你会喜欢这个派对的，它超级疯狂的!"])
    add_dialogue("contract intro", "party", ["别那么紧张，放松点。客人们期待的是一个真正的派对女孩，所以别让他们失望!"])
    add_dialogue("contract success", "party", ["哦，你的表演太卖力了！我真的很佩服你，希望将来我也能这么棒!"])
    add_dialogue("contract success special", "party", ["哦，你表现得太棒了！我真的很佩服你，希望有一天我也能做到那样！我从主持人那里听到的关于你的都是好评..."], sound=s_surprise)
    add_dialogue("contract buy offer", "party", ["瞧，[MC.name]先生. 我的主人有个大胆的提议。他想要[girl.fullname]。作为他的私人性宠物加入他的家族，给你 [gold_offer] 听起来怎么样?"], sound=s_surprise)
    add_dialogue("contract buy offer accept", "party", ["哦，太棒了！我的主人是个有权势的人。你接受他的慷慨是明智之举."])
    add_dialogue("contract buy offer refuse", "party", ["哦，太令人失望了。尽管如此，还是有很多性奴隶…我相信血祖一周内就会忘记她。我会让他..."])
    add_dialogue("contract partial", "party", ["嗯，这没什么好印象。你应该更努力训练，亲爱的。这不是你的能力范围. *恼怒*"], sound=s_sigh)
    add_dialogue("contract partial special", "party", ["嗯，这没什么好印象。至少，你可以满足主人的特殊要求..."], sound=s_sigh)
    add_dialogue("contract failure", "party", ["那到底是什么东西! 真无能... 你给我们性奴带来了坏名声!!! *愤怒*"])
    add_dialogue("contract failure special", "party", ["哼，真是无能……仅仅因为你们满足了他们珍贵的“要求”，并不意味着你可以表现得像个他妈的小混蛋!"])

    add_dialogue("contract greeting", "ceremony", ["你好，我的孩子。我很高兴欢迎你走上正确的道路."])
    add_dialogue("contract intro", "ceremony", ["现在，让我们继续我们的职责吧，孩子。我们的会众在等待."])
    add_dialogue("contract success", "ceremony", ["恭喜你，我的孩子。你给人留下了极为虔诚的印象。你真的受到了祝福."], sound=s_surprise)
    add_dialogue("contract success special", "ceremony", ["恭喜你，我的孩子。你给人留下了极为虔诚的印象。我听到修道院院长在称赞你."], sound=s_surprise)
    add_dialogue("contract buy offer", "ceremony", ["啊, [MC.name]主人. 我带来了修道院院长的一个提议。她想欢迎 [girl.name] 加入我们的教团。她认为她的特别“技能”在她的小教堂里会创造奇迹……我是说，在她的礼拜堂里。当然，你会得到补偿的."])
    add_dialogue("contract buy offer accept", "ceremony", ["谢谢，这非常令人满意。修道院院长也会很高兴，当然还有我们的神."])
    add_dialogue("contract buy offer refuse", "ceremony", ["啊，看来你并不信奉我们的信仰。小心假神和世俗之事的诱惑。想想你不朽的灵魂吧..."])
    add_dialogue("contract partial", "ceremony", ["孩子，我不满意。这本应该做得更好. *皱眉*"], sound=s_sigh)
    add_dialogue("contract partial special", "ceremony", ["孩子，我不满意。这本应该做得更好.*叹气*\n至少你满足了我们的特别请求，所以还算不错..."], sound=s_sigh)
    add_dialogue("contract failure", "ceremony", ["以一切神圣的名义，那算什么东西？！教堂要求的是听话且勤奋的奴隶，而不是什么街头流浪汉! *愤怒*"])
    add_dialogue("contract failure special", "ceremony", ["以一切神圣的名义，那是什么鬼东西？！？仅仅因为我们满足了我们的要求，并不意味着你可以停止努力!"])

    add_dialogue("contract greeting", "festival", ["欢迎，欢迎！我们这里有什么……一个新面孔，不是吗?"])
    add_dialogue("contract intro", "festival", ["令人愉快！来，让我们一起享受这个可爱的传统节日，与我们尊贵的客人一起."])
    add_dialogue("contract success", "festival", ["过来, [girl.name], 过来！你今天做得非常棒。我真的很自豪."], sound=s_surprise)
    ...
    add_dialogue("contract buy offer", "festival", ["啊, [MC.name]. 你这边的漂亮 [girl.name] 既可爱又有才华。事实上，一个有钱的西方地主问你是否考虑把她卖给他."])
    add_dialogue("contract buy offer accept", "festival", ["完美。那她将会加入他的后宫。有人说他拥有的女人和牛一样多，但我确信 [girl.name] 无论如何都会留下深刻的印象。我会安排资金转给你。..."])
    add_dialogue("contract buy offer refuse", "festival", ["哦不……我就知道，他本应该出更多的。真是太遗憾了，不过也许下次吧."])
    add_dialogue("contract partial", "festival", ["啊，是你……我听说你今天的所有任务都没有让人满意。我希望你下次能更认真对待. *皱眉*"], sound=s_sigh)
    add_dialogue("contract partial special", "festival", ["啊，是你……我听说你今天的所有任务都未能让人满意。不过，至少你还是完成了我们的特别请求."], sound=s_sigh)
    add_dialogue("contract failure", "festival", ["不，不，不！这样不行，完全不可以。你是被雇来做事的，但你完全让我们失望了！我不该信任这个 [MC.name]... *恼怒*"])
    add_dialogue("contract failure special", "festival", ["不，不，不！这样不行，完全不可以。你可能满足了我们的要求，但你却没有用心去做."])

    add_dialogue("contract greeting", "date", ["啊，新来的女孩。欢迎。注意你的举止."])
    add_dialogue("contract intro", "date", ["好了，介绍够多了。跟我来。不要离开指定区域。否则你会后悔的."])
    add_dialogue("contract success", "date", ["非常满意。你按照吩咐做了一切。我的主人对此很满意."], sound=s_surprise)
    add_dialogue("contract success special", "date", ["非常令人满意。你按照吩咐做了一切。事实上，你还吸引了 [con.organizer].的注意。这是一种罕见的荣誉。."], sound=s_surprise)
    add_dialogue("contract buy offer", "date", ["先生, [con.organizer] 对您的奴隶, [girl.name]. 印象非常深刻。事实上，他希望她能成为他的妻子之一。他已经准备好向您购买她的自由了。."])
    add_dialogue("contract buy offer accept", "date", ["很好。我会立即安排婚礼的准备工作。婚礼将在地下室举行。抱歉，不邀请第三方..."])
    add_dialogue("contract buy offer refuse", "date", ["我明白了。我的主人会生气的。我今晚可能会因此挨鞭子。不过没关系。我应该为我的失败而受到惩罚. *脸红*"])
    add_dialogue("contract partial", "date", ["我被告知你的表现不太令人满意。让我提醒你，在这座房子里，我们只期望最优秀、最顺从的奴隶在这里工作. *皱眉*"], sound=s_sigh)
    add_dialogue("contract partial special", "date", ["我被告知你的表现不太令人满意。算你走运，至少你还满足了我主人的特别请求."], sound=s_sigh)
    add_dialogue("contract failure", "date", ["现在就离开。永远不要再在这里露面."])
    add_dialogue("contract failure special", "date", ["哼，真是个没用的废物。如果你不符合我主人的品味，我早就把你扔出去了."])

    add_dialogue("contract greeting", "meeting", ["啊，你终于来了。保持安静，照吩咐行事."])
    add_dialogue("contract intro", "meeting", ["除非有人跟你说话，否则不要开口。回答要简短且切题。明白吗？我们很快就会需要你的“才能”。现在，跟我来."])
    add_dialogue("contract success", "meeting", ["[girl.fullname]! 稍息。你以最高的荣誉完成了这里的职责。骄傲地走吧."], sound=s_surprise)
    add_dialogue("contract success special", "meeting", ["[girl.fullname]! 稍息。你以最高的荣誉完成了这里的职责，上级非常希望保留你的服务."], sound=s_surprise)
    add_dialogue("contract buy offer", "meeting", ["[MC.name]先生，阁下. [con.organizer] 希望征用你的奴隶, Miss [girl.lastname], 小姐，执行……军事任务。她将成为第一营的首席“慰问官”。当然，你会得到公平的补偿."])
    add_dialogue("contract buy offer accept", "meeting", ["谢谢你，好市民。我们会立即将 [girl.lastname] 小姐转移到她的单位。这是我们欠你的钱."])
    add_dialogue("contract buy offer refuse", "meeting", ["这……你这样做未免太不懂得变通了. *皱眉*\n现在，如果你不介意的话，我得去找一个合适的替代者了."])
    add_dialogue("contract partial", "meeting", ["士兵，我是说，奴隶，我已经了解了你最近的活动。看来你在上次任务中表现不佳。以后不要这么粗心大意."], sound=s_sigh)
    add_dialogue("contract partial special", "meeting", ["士兵，我是说，奴隶，我已经了解了你最近的活动。看来你在上次任务中表现不佳。不过，你通过完成我们的特别请求稍微弥补了一点."], sound=s_sigh)
    add_dialogue("contract failure", "meeting", ["[girl.fullname]! 那完全是场糟糕透顶的表演！下次你再搞砸得这么严重，我会把你的脑袋拧下来然后 *不可理喻*!!!"])
    add_dialogue("contract failure special", "meeting", ["[girl.fullname]! 那完全是场糟糕透顶的表演！我们之所以还留着你，只是因为你符合我们的要求，但别再想来露脸了."])

    add_dialogue("contract greeting", "magic", ["欢迎你，可爱的孩子，来到一个奇妙而神秘的夜晚!!!"])
    add_dialogue("contract intro", "magic", ["真了不起! 跟我来，别踩到迷路的传送门。我们就这样失去了很多奴隶."])
    add_dialogue("contract success", "magic", ["太棒了！你作为一个非魔法使用者，竟然懂得这么多令人印象深刻的招数！请有空教教我..."], sound=s_surprise)
    add_dialogue("contract success special", "magic", ["真是了不起！作为一个非魔法使用者，你竟然懂得这么多令人印象深刻的招数! [con.organizer] 对你非常满意."], sound=s_surprise)
    add_dialogue("contract buy offer", "magic", ["啊，我亲爱的朋友伙计！你的这位不可思议的奴隶, [girl.name], 她在床上看起来像是魔法一般！有一位巫师想留下她来进行他的实验。他有的是钱。你怎么看?"])
    add_dialogue("contract buy offer accept", "magic", ["太棒了！那个老家伙会欣喜若狂的。他一直念叨着他那些重要的实验，我想是和触手有关的……给你，拿着你的奥波尔币."])
    add_dialogue("contract buy offer refuse", "magic", ["什么？这太离谱了……算了，那个老家伙可能早就把这忘得一干二净了."])
    add_dialogue("contract partial", "magic", ["那个，呃……我该怎么说呢……没有激励作用。你肯定能做得更好吧. *皱眉*"], sound=s_sigh)
    add_dialogue("contract partial special", "magic", ["那个，呃……我该怎么说呢……没有激励作用。不过好在至少你成功完成了我们的特别请求."], sound=s_sigh)
    ...
    add_dialogue("contract greeting", "orgy", ["哇哦, 这只漂亮的小鸟是谁?来吧，别害羞."])
    add_dialogue("contract intro", "orgy", ["嗯，我也很高兴见到你 但你穿得实在是{i}太多了{/i} 来吧，我们会让你更舒服一些."])
    add_dialogue("contract success", "orgy", ["噢... 啊啊啊... 我的意思是... 啊啊啊啊... 光是看着你我就... 呣呣呣, 噢... 操我! 用力操我!!!"], sound=s_orgasm)
    add_dialogue("contract success special", "orgy", ["噢, 我的小鸟，多么精彩的表演啊……派对上的男人还在手淫想着你。我也是... *呻吟*"], sound=s_moans)
    add_dialogue("contract buy offer", "orgy", ["Ah, [MC.name], 你介意把手指放在这里吗? 噢，啊啊，就是那个地方……继续弄我……他说, 如果卖个好价钱，你愿意放弃 [girl.name]吗? 一位不愿透露姓名的绅士想把她买进他的地牢... Mmmh..."])
    add_dialogue("contract buy offer accept", "orgy", ["噢, 我的天, 啊! 啊!!! 啊啊啊啊啊啊啊!!! *喘息* *喘息*\n对不起... 我有点太爽了..."])
    add_dialogue("contract buy offer refuse", "orgy", ["噢 不... 不要! 不... 不要啊啊啊啊啊啊!!!!! *喘息* *喘息*\n我是因为失望... 我才变成这样的... 我是个变态的婊子..."])
    add_dialogue("contract partial", "orgy", ["Fufufufu, 小鸟，你还有很多要学的……我可以教你，但你得报答我。我知道怎么做... *得意的笑*"], sound=s_sigh)
    add_dialogue("contract partial special", "orgy", ["Fufufufu, 小鸟，你还有很多要学的……但他们很高兴你至少满足了他们的特殊要求."], sound=s_sigh)
    add_dialogue("contract failure", "orgy", ["那是什么鬼东西!我不得不亲自给所有男人打飞机就因为你不能好好工作!滚出我的视线... *厌恶*"])
    add_dialogue("contract failure special", "orgy", ["那是什么鬼东西!你满足了我们的特殊要求不代表你就能像个唱诗班女孩一样!"])
    ...
    add_dialogue("task description", "clean", "[girl.fullname] 被送到 [con.venue]帮助清理团队, 客人离开后，确保一切保持一尘不染.")
    add_dialogue("task success", "clean", ["这项任务对她来说很容易，因为她已经习惯了在妓院看到更糟糕的事情. 她把这个地方保持得一尘不染.", "g: 太好了，你是个很棒的管家!"], multiple=True)
    add_dialogue("task failure", "clean", ["[girl.name] 努力跟上客人变得吵闹和醉酒. 最终，人们开始抱怨[con.venue]里的污垢.", "g: 那是什么?到处都是污渍!动起来, [girl.name]!"], multiple=True)

    add_dialogue("task description", "serve guests", "[girl.fullname] 被派去[con.venue]为顾客服务. 她必须确保他们有他们需要的一切.")
    add_dialogue("task success", "serve guests", ["[girl.name] 习惯了顺从地为顾客服务，她在完成任务时既有效又谨慎.", "g: 很好!你帮了很大的忙."], multiple=True)
    add_dialogue("task failure", "serve guests", ["[girl.name] 不太乐意为顾客服务，应付他们贪婪的手。最后，她把一杯红酒洒在了一位客人的衬衫上.", "g: 你!你是故意的!!! *生气*"], multiple=True)

    add_dialogue("task description", "serve drinks", "[girl.fullname] 的任务是为客人提供饮料.")
    add_dialogue("task success", "serve drinks", ["[girl.name] 与顾客聊天，迅速了解他们的口味，建议他们点什么饮料。他们心存感激.", "g: 你做得很好。保持下去!"], multiple=True, sound=s_potion)
    add_dialogue("task failure", "serve drinks", ["[girl.name] 不太乐意为顾客服务，应付他们贪婪的双手。最后，她把一杯红酒洒在了一位客人的衬衫上.", "g: 你!你是故意的!!! *生气*"], multiple=True)

    add_dialogue("task description", "feed guests", "[girl.fullname] 的任务是为客人提供食物.")
    add_dialogue("task success", "feed guests", ["[girl.name] 勤奋地穿梭于厨房和客人的餐桌之间，端着盛满食物的大托盘，让每个人都高兴.", "g: 好姑娘..."], multiple=True)
    add_dialogue("task failure", "feed guests", ["[girl.name] 费力地把大托盘从厨房端到餐桌上。在饥肠辘辘的客人和好色的酒鬼的骚扰下，她最终把所有的食物都洒在了地上，筋疲力尽.", "g: 不! !真是一场灾难..."], multiple=True, sound=s_crash)

    add_dialogue("task description", "onsen", "[girl.fullname] 被送到澡堂，陪伴年长的客人.")
    add_dialogue("task success", "onsen", ["她和男人们混在一起，只穿着一件浴袍，让它滑了一点下来，让每个人都很高兴.", "g: 干得好，亲爱的，他们看着你都流口水了..."], multiple=True)
    add_dialogue("task failure", "onsen", ["她不情愿地加入了男人们的行列，但当几个好色者试图摸她时，她退到了一个角落里.", "g: 不，那不行 *皱眉*! 这不是对待客人的方式!"], multiple=True)

    add_dialogue("task description", "swimming pool", "穿着性感泳装的, [girl.fullname] 被派去参加一个大型游泳池派对的客人.")
    add_dialogue("task success", "swimming pool", ["[girl.name] 当她和一群试图在她的泳衣下摸一摸的英俊男人玩耍时，她又笑又叫.", "g: 很好，很好，让他们保持沉默和饥渴..."], multiple=True)
    add_dialogue("task failure", "swimming pool", ["[girl.name] 加入客人们的行列，但很快就发现她不会让他们碰她，他们就失去了兴趣.", "g: 不，不，你这个没用的奴隶!我们付钱给你是为了什么!"], multiple=True)
    ...
    add_dialogue("slave chat brothel 1", ("modest"), ["她脸红.", "g：我一直认为妓院是最糟糕的。但现在我在这里工作了，我想其实还不错。"], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat tastes dislikes", ("generic"), "我最不喜欢的[thing]是[worst]. 呸!", unlock="LM")
...
## START PERVERT DIALOGUE 03.February.2022
    ...
    add_dialogue("free_offer_job half_lie", ("pervert", "very lewd"), ["她看起来很生气。", "g：你本来可以早点告诉我的。我对赞的性交易绝对没有意见。", "mc：嗯，有些女孩没有你那么开放……", "g：噗……你的时间都浪费在那些女孩身上了。", "她停顿了一下，咬住嘴唇。", "g：所以如果我在那里工作，我一天会上几次床，对吧？"], multiple=True, love=2)
    ...
    add_dialogue("exhausted", ("pervert", "very lewd"), ("主人...我的小穴完全酸痛...别问...我需要更多时间休息，我会以{b}[girl.job]{/b}的身份重新开始工作我一康复。"))
...
## START REBEL DIALOGUE 03.February.2022
    ...
    add_dialogue("free_job_request", ("rebel", "very dom"), ["g: [MC.name]... 帮帮我, 求你了! *恐慌*", "mc: 寻求帮助？那听起来不像是你...", "g: 我…几周前我遇到过这个人…他想强奸我。几天后我就要受审了。他们会……他们会奴役我的!", "在赞，如果你没有钱来支付你的罪行，法官可以判你为奴隶...", "g: 我用我最后的一点钱支付了保释金……他们会判我有罪，然后那个人的兄弟会把我变成奴隶！他们会在我有生之年一直强奸和折磨我!", "g: 数以千计的迪纳……已经没有办法了……如果我能设法逃脱这场审判就好了...", "mc: Mmmh... 你知道奴隶是不能被审判的吗？只有自由人才可以?", "g: 但我不是一个奴隶……你在暗示什么?"], multiple=True)
...
## START SUPERFICIAL DIALOGUE 03.February.2022
    ...
    add_dialogue("advertise", ("superficial", "very extravert"), ["来[brothel.name]找我吧！我们会一起享受{i}很多乐趣{/i}！", "哦，先生...就像...我知道欺骗你的妻子可能是答错了，但这正是它变得{i}如此{/i}有趣的原因，明白我的意思吗？","{i}字面上{/i}迫不及待地想在[brothel.name]招待您！","我们的妓院里有很多荡妇，太疯狂了！", "让我们一起创造一些回忆吧，先生。", "呀呀！我非常喜欢[brothel.name]！您绝对应该来拜访我们。"])
...
## START HELPER DIALOGUE 03.February.2022
    ...
    add_dialogue("free_offer_job half_lie", ("helper"), ["g: 你从没告诉过我!", "mc: 我当时认为这并不重要...", "g：所以我的朋友警告我关于你的事是对的？你是妓院老板。", "g：但我不介意。你看，就在前几天，当我的朋友警告我不要再花这么多时间和你在一起时，我告诉她......", "g：那如果他是呢？这是世界上最古老的职业，许多人在赞这里从事这种职业！", "g：[MC.name]对我很好。也许我会去妓院帮助他，而不是总是帮助你解决问题！"], multiple=True, love=1)
    add_dialogue("free_offer_job lie", ("helper"), ["g: 你从没告诉过我!", "mc: 我当时认为这并不重要...", "g：所以我的朋友警告我关于你的事是对的？你是妓院老板！", "g：但是……我不介意。你看，就在前几天，当我的朋友警告我不要再花这么多时间和你在一起时，我告诉她......", "g：那如果他是呢？这是世界上最古老的职业，许多人在赞这里从事这种职业！",  "g：[MC.name]对我很好。也许我会去帮助他去妓院，而不是帮助你解决所有的问题！"], multiple=True, love=1)
    ...
    add_dialogue("free_offer_job failure lie", ("helper"), ["g：让 Shalia 让你见鬼去吧，我就是这么想的！你觉得我是个什么样的女孩子啊！", "g：你骗了我，现在你还想让我去你那愚蠢的妓院工作！我还不如死了，你这个撒谎的混蛋！", "g: 滚蛋!", "她离开了，看起来很生气.", "mc: 进展顺利。等她冷静下来再说吧?"], multiple=True, love=-15)
    ...
    add_dialogue("free_friend lie", ("helper"), ["g：A...[lie]？我应该相信你吗？", "g：你让我对你很好奇。我可以告诉你的一件事是你没有[lie]。", "g：我和一位好朋友聊天。她说不要相信那个人，[MC.name]。他看起来像个妓院老板！", "g：我说，不可能！不是[MC.name]。他太好了，但我真的应该相信你是一个[lie]吗？ *皱眉*", "mc: 哈哈,肯定…你呢，你是做什么的?", "g: 哦，你知道的，这个那个..."], multiple=True, love=-3)
...
## START HOLY DIALOGUE 03.February.2022
    ...
    add_dialogue("free_play interested", ("holy"), ("我一直想知道那些莎莉亚信徒在谈论什么。我想我快要追上了……*眨眼*", "以阿里奥斯的名义，我对此有很多疑问。请做一个好主人。  *眨眼*", "你怎么知道我需要什么以及何时需要？你受到阿里奥斯的祝福吗？ *眨眼*"), love=4)
    ...
    add_dialogue("free_flirt_sex_act interested", ("holy"), ("我一直想知道那些莎莉亚信徒在谈论什么。我想我快要追上了……*眨眼*", "以阿里奥斯的名义，我对此有很多疑问。请做一个好主人。  *眨眼*", "你怎么知道我现在在想什么？你受到阿里奥斯的祝福吗？ *眨眼*"), love=2)
    ...
    add_dialogue("free_offer_job thinking", ("holy"), ["g: 谢谢你的邀请……但是...", "g：我现在还不能接受。我将寻求 Arios 的进一步指导，以扫清我前进的道路。", "她离开时，一边向阿里奥斯低声祈祷，一边走开。"], multiple=True)
    add_dialogue("free_offer_job failure lie", ("holy"), ["g：你最坏了，先是骗我，现在又这样？！", "g：我是阿里奥斯的一名自豪的助手。我不是妓女，更不是你的奴隶！", "g：我确信您也参与了仪式！别管我了，你这个异教徒！", "她离开了，看起来很生气.", "mc：是的，进展顺利。也许稍后，等她冷静下来？"], multiple=True, love=-15)
    add_dialogue("free_offer_job failure no_lie", ("holy"), ["g：你是最糟糕的！", "g：我是阿里奥斯的一名自豪的助手。我不是妓女，更不是你的奴隶！", "g：我确信您也参与了仪式！别管我了，你这个异教徒！", "她离开了，看起来很生气.", "mc：是的，进展顺利。也许稍后，等她冷静下来？"], multiple=True, love=-15)
    ...
    add_dialogue("free_friend lie", ("holy"), ["g：奇怪……你没有表现出我所期望的[lie]的氛围。", "mc: 哈哈,肯定…你呢，你是做什么的?", "g：我是阿里奥斯教会一个分支的侍僧。不过最近感觉有些奇怪。但我们现在不谈这个......"], multiple=True)
    ...
    add_dialogue("free_job_request", ("holy"), ["当 [girl.name] 靠近时，您注意到她穿着与平常不同的侍僧长袍。这些似乎是用更优质的材料制成的，装饰凸显了她的女性曲线。", "但只有当她投入你的怀抱，你能感觉到她半透明的布料下柔软的身体时，你才会想起她的“特殊”仪式。", "g： *抽泣* 哦，[MC.name]，我太蠢了... *抽泣*", "mc：[girl.name]，发生什么事了？阿里奥教堂发生了什么事情吗？", "你想知道她是否可以哭得更厉害。答案是“是的！”。经过长时间的拥抱和多次哭泣后，她再次开始说话。", "g：我的教堂……祭司长……阿里奥斯！我正在为一个伪装的莎莉亚邪教工作！这段时间！ *哭泣*", "现在让你无语了。但回想起来，可能有一些迹象。最好什么也不说，只是暂时听着。", "g：他们狂欢了！我所有的朋友，我的姐妹们……我必须逃跑……", "g：我现在孤身一人了。我的一生都是建立在为阿里奥斯服务的基础上的......而现在，连主教堂都不会接纳我了。*抽泣*", "她突然哭了起来.", "g：[MC.name]，我能做什么？我应该去哪儿？我什么都没有剩下...*抽泣*", "mc：[girl.name]冷静点，我们一起想办法……", "你当然可以想出解决办法。但你首先得想出好词好句让她融入你的妓院。她肯定会是一个很好的补充。"], multiple=True)
...
## START PRUDE DIALOGUE 03.February.2022
    ...
    add_dialogue("accept farm", ("prude", "very modest"), ("我可以利用一些时间休息。远离这一切污秽……", "我当然不会错过我们的客户。", "哦，我会喜欢的。终于呼吸到新鲜空气了！", "谢谢主人。我期待着离开妓院一段时间。"))
...
## START PRINCESS DIALOGUE 03.February.2022
    ...
    add_dialogue("free_offer_job no_lie", ("princess"), ["她用新发现的决心看着你.", "g：我？妓女？难道就没有别的办法了吗...", "g：我并不反对性本身，但我反对真正的女士必须工作的想法。你确定你不只是想支持我这样可爱的女孩吗？", "g：另外，一个像我一样成长和血统的女孩成为奴隶的想法简直是荒谬的。", "mc：恐怕你已经欠了很多债了，[girl.fullname]。签署临时奴隶合同会让你摆脱困境。"], multiple=True, love=3)
    add_dialogue("free_offer_job half_lie", ("princess"), ["g: 你从没告诉过我!", "mc: 我当时认为这并不重要...", "g：我并不反对性，但我反对女性必须工作的想法。你确定你不只是想支持我这样可爱的女孩吗？", "g：另外，一个与我有血统和成长经历的女孩成为奴隶的想法真是荒谬。", "mc：你已经欠了很多债，[girl.fullname]。签署临时奴隶合同会让你摆脱困境。"], multiple=True, love=3)
    ...
    add_dialogue("free_offer_job failure lie", ("princess"), ["g：去你的吧，我就是这么想的！以阿里奥斯的名义，你以为我是谁！", "g：你对我撒了谎，现在你却想让我像一个普通的妓女一样在你那可怕的妓院里工作！我一生中没有一天工作过。那是不会发生的！", "g：滚出我的视线！", "她离开了，看起来很生气.", "mc: 进展顺利。等她冷静下来再说吧?"], multiple=True, love=-15)
    ...
    add_dialogue("slave chat brothel 1", ("princess","very modest"), ["她脸红.", "g：我一直认为妓院是最糟糕的。但现在我在这里工作了，我想其实还不错。"], multiple=True, unlock="LM")
...
## START CLASS PRESIDENT DIALOGUE 03.February.2022
    ...
    add_dialogue("free_job_request", ("class president"), ["g：噢，[MC.name]，可怕的消息……*抽泣*", "mc：[girl.name]，发生什么事了？", "g：这是我的学校……警卫突击搜查了这个地方，发现我们的炼金术课程是赞的大部分非法毒品交易的罪魁祸首。", "g：现在他们已经关闭了{i}整个{/i}学校，包括所有其他课程。这太糟糕了！", "g：我和那些炼金术课程没有任何关系，但我的学术生涯却受到玷污和诽谤。这不公平！！", "她突然哭了起来.", "g：哦，我该怎么办！ *呜咽*没有其他学校会录取我！我得找份工作了...", "mc: [girl.name] 冷静点，我们会找到解决办法的..."], multiple=True)
...
## START LOYAL DIALOGUE 03.February.2022
    ...
    add_dialogue("free_offer_job failure lie", ("loyal"), ["g：操你妈的，我就是这么想的！你以为我是什么鬼啊！", "g：你骗了我，现在又要我在你恶心的妓院里工作！那不会发生！", "g：我可能有很强的责任感，像你这样的人渣会想方设法利用，但我确实有一些自尊心。滚蛋！", "她离开了，看起来很生气.", "mc: 进展顺利。等她冷静下来再说吧?"], multiple=True, love=-15)
    ...
    add_dialogue("exhausted", ("loyal", "very idealist"), ("对不起主人，我还是很累。我需要多休息。", "康复后，我将回去担任 {b}[girl.job]{/b} 的工作。我需要保持良好的状态才能正确地完成这件事。"))
...
## START STUBBORN DIALOGUE 03.February.2022
    ...
    add_dialogue("free_offer_job lie", ("stubborn"), ["g: Oh, so you lied...", "g：我已经准备好为这段关系付出这么多了……这就是你眼中的我吗，一个妓女？", "mc: 有些女孩更喜欢“陪护”这个词...", "g：护送？哦，拜托，别废话了。当我看到黑桃时，我称它为黑桃；当我看到妓女时，我称她为妓女。但我从没想过我最终会成为其中之一！我的 [girl.story_guardian] 会怎么想？", "g：所以你毕竟不是[girl.MC_lied]。这是一个地狱般的选择：妓院还是监狱......"], multiple=True, love=-5)
    ...
    add_dialogue("free_offer_job failure lie", ("stubborn"), ["g：去你妈的，你这个爱操纵别人的混蛋。那就是我所想的！你以为我是个什么样的廉价荡妇啊！？", "g：你先骗我，然后又想让我去你那破烂的妓院干活！是什么让你的自以为是的头脑里产生了如此愚蠢的想法！", "g：滚出我的视线，[MC.name]，否则我会踢你的屁股！", "她离开了，看起来真的很生气。", "mc: 进展顺利。等她冷静下来再说吧?"], multiple=True, love=-15)
    add_dialogue("free_offer_job failure no_lie", ("stubborn"), ["g：操你妈的，混蛋，我就是这么想的！你以为我是谁啊！", "g：你认为，因为我曾经说过，我宁愿在妓院工作，也不愿向那个出身名门的贱人低头，我就会成为一个听话的小妓女，乐意张开双腿，听从你的指挥？", "g: 滚蛋!", "她离开了，看起来很生气.", "mc: 进展顺利。等她冷静下来再说吧?"], multiple=True, love=-15)

    add_dialogue("free_friend no_lie", ("stubborn"), ["g：妓院老板？这太恶心了……我不喜欢从事肉体贸易的人。我对你印象很好。也许我错了？ ……我已经习惯了自己是对的。", "mc: 你是做什么的?", "g: ..."], multiple=True, love=-2)
    ...
    add_dialogue("slave chat brothel 0", ("stubborn"), ["她沉默了一会儿。", "g：这不是我想象中的妓院，但说实话我并没有抱太大的期望……", "g：我已经学会了接受这里的现实，但我不是那种喜欢嫖娼的女人。这是答错了。"], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat other_girls 1", ("stubborn", "very dom"), ["她想了一会儿.", "g：我有时间去见其他女孩并和她们聊天。我已经告诉他们我对赞和这个地方以及作为一个妓女的看法。", "g：他们似乎对我的观点很满意。我觉得他们其实还好。"], multiple=True, unlock="EI")
    ...
    add_dialogue("slave lecture neutral", ("stubborn", "very dom"), ("又来给我讲一堂课吗？是的，我知道这是妓院。性是我们所有人的食物……我应该更加开放……废话连篇中.....。"))
