...
#     add_dialogue("free_girl get_flowers", "generic", "This is very romantic... Was there something you wanted from me?") # Had to disable this for now
    ...
    add_dialogue("task success", "clean", ["这项任务对她来说很容易，因为她已经习惯了在青楼看到更糟糕的事情. 她把这个地方保持得一尘不染.", "g: 太好了，你是个很棒的管家!"], multiple=True)
...
## START PERVERT DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_origins", ("pervert", "very lewd", "bimbo"), ("我在[girl.origin]的一家青楼旁边长大。", "我在[girl.origin]长大。那里太无聊了！", "呃，[girl.origin]。赞好多了！"), love=1, max_cap=40)
    ...
    add_dialogue("slave chat origins 1", ("pervert", "very lewd", "bimbo"), ("我在[girl.origin]的一家青楼旁边长大。", "我在[girl.origin]长大。那里太无聊了！", "呃，[girl.origin]。赞好多了！"), unlock="EI")
...
## START HELPER DIALOGUE 03.February.2022
    ...
    add_dialogue("free_offer_job half_lie", ("helper"), ["g: 你从没告诉过我!", "mc: 我当时认为这并不重要...", "g：所以我的朋友警告我关于你的事是对的？你是青楼老板。", "g：但我不介意。你看，就在前几天，当我的朋友警告我不要再花这么多时间和你在一起时，我告诉她......", "g：那如果他是呢？这是世界上最古老的职业，许多人在赞这里从事这种职业！", "g：[MC.name]对我很好。也许我会去青楼帮助他，而不是总是帮助你解决问题！"], multiple=True, love=1)
    add_dialogue("free_offer_job lie", ("helper"), ["g: 你从没告诉过我!", "mc: 我当时认为这并不重要...", "g：所以我的朋友警告我关于你的事是对的？你是青楼老板！", "g：但是……我不介意。你看，就在前几天，当我的朋友警告我不要再花这么多时间和你在一起时，我告诉她......", "g：那如果他是呢？这是世界上最古老的职业，许多人在赞这里从事这种职业！",  "g：[MC.name]对我很好。也许我会去帮助他去青楼，而不是帮助你解决所有的问题！"], multiple=True, love=1)
...
## START PRUDE DIALOGUE 03.February.2022
    ...
    add_dialogue("accept job", ("prude", "very modest", "very materialist"), ("我明白了，[MC.name]。我会以{b}[girl.job]{/b}的身份帮助青楼。{w=1.0}{nw}"))
...
## START PRINCESS DIALOGUE 03.February.2022
    ...
    add_dialogue("free_offer_job failure lie", ("princess"), ["g：去你的吧，我就是这么想的！以阿里奥斯的名义，你以为我是谁！", "g：你对我撒了谎，现在你却想让我像一个普通的妓女一样在你那可怕的青楼里工作！我一生中没有一天工作过。那是不会发生的！", "g：滚出我的视线！", "她离开了，看起来很生气.", "mc: 进展顺利。等她冷静下来再说吧?"], multiple=True, love=-15)
...
## START LOYAL DIALOGUE 03.February.2022
    ...
    add_dialogue("free_friend no_lie", ("loyal"), ["g： 青楼？皮条客？！！我们都需要以某种方式谋生，但我认为你的方式很恶心！你让那些女孩出卖自己并虐待她们的身体......*悲伤*", "mc：这对你来说可能听起来很恶心，但我提供了一项重要的服务，让世界变得更安全、更美好。", "mc：这对女孩来说更安全，她们不需要在街上工作，而且可以免受触手怪物和疯狂乞丐的侵害。", "mc：妓女需要房子，国家需要青楼。", "mc：阿里奥斯的牧师曾经试图取缔青楼，但这导致强奸和谋杀事件大幅增加。", "mc：我的青楼女孩为好斗的男人提供了一种积极的方式来释放他们被压抑的能量。可以说这是女孩子的义务。", "g：我从来没有这样想过。也许那些女孩确实对赞社区负有责任。", "g：不过，我还是感觉不太对劲……", "她看起来很深思熟虑，但似乎并不完全相信你的论点。"], multiple=True, love=-3)
