...
label init_perks():
    python:
        ...
        perk_description = {
                             "女仆训练" : "'{i}我来为您做性欲处理了，主人{/i}'",
                             "忠心耿耿" : "女仆必须对主人忠心耿耿.你的身体，你的灵魂，你的一切都是主人的",
                             "不辞辛劳" : "'{i}只要你全身心的投入，就不会感觉疲惫.{/i}'",
                             "再接再厉" : "'{i}非常抱歉，让我再为您服务一次.{/i}'",
                             "劫后余生" : "她从地狱中归来, 为了满足主人她愿意奉献自己的一切.",
                             "力臻完美" : "'{i}在主人射精之前可不允许自己先高潮哦.{/i}'",

                             "兔装女郎" : "'{i}谁能喂可怜的小兔子一根大胡萝卜?{/i}'",
                             "派对之星" : "'{i}别急着走嘛，派对才刚刚开始...后面还有更刺激的{/i}'",
                             ...
                             "纯洁新娘" : "只要处女膜还在，我就还是纯洁之身，没错！",
                             "助人为乐" : "'{i}有困难就来找我吧，我们可是好姐妹，除非你想和我争主人的肉棒.{/i}'",
                             "同甘共苦" : "'{i}今日你我义结金兰，苟富贵，勿相忘.{/i}'",
                             "以身作则" : "来，跟我这一起做，把手放到这里，嗯~没错.",
        ...
        perk_dict = {
                     ...
                     "Survivor" : Perk(name="劫后余生", type="level", perk_level=2, archetype="The Maid", effects=[Effect("boost", "fear", 0.5), Effect("resist", "hurt", 3, dice=True)], pic = "maid2_2.webp"),
                     ...
                     "Party Girl" : Perk(name="派对之星", type="level", perk_level=1, archetype="The Player", effects=[Effect("change", "job customer capacity", 2), Effect("boost", "customer penalties", -0.5)], pic = "player1_1.webp"),
                     ...
                     "Exhibitionist" : Perk(name="万众瞩目", type="level", perk_level=2, archetype="The Player", effects=[Effect("boost", "naked bonus", 0.15)], pic = "player2_2.webp"),
                     "Star Power" : Perk(name="天王巨星", type="level", perk_level=3, archetype="The Player", effects=[Effect("increase satisfaction", "all jobs", 1), Effect("increase satisfaction", "all sex acts", 1)], pic = "player3.webp"),
...
#                     "Rules of Attraction" : Perk(name="Rules of Attraction", type="level", perk_level=1, archetype="The Model", effects=[Effect("special", "BBCR bonus", 1, chance=0.25)], pic = "model1_1.webp"), # Shelving stat bonuses for now
                     "Rules of Attraction" : Perk(name="大众情人", type="level", perk_level=1, archetype="The Model", effects=[Effect("change", "customers", 3, dice=True, scope="brothel")], pic = "model1_1.webp"),
                     ...
                     "Life of Luxury" : Perk(name="珠光宝气", type="level", perk_level=2, archetype="The Model", effects=[Effect("special", "luxury"), Effect("change", "mood", 0.5, scales_with="equipped")], pic = "model2_2.webp"),
                     "Beauty Queen" : Perk(name="选美冠军", type="level", perk_level=3, archetype="The Model", effects=[Effect("change", "all main skills", 15), Effect("boost", "job customer budget", 1.0)], pic = "model3.webp"),
                     ...
                     "Warm welcome" : Perk(name="热情似火", type="level", perk_level=1, archetype="The Courtesan", effects=[Effect("change", "first customer satisfaction", 1), Effect("boost", "half-shift resting bonus", 0.5)], pic = "courtesan1_1.webp"),
                     ...
                     "Five Stars" : Perk(name="五星品质", type="level", perk_level=2, archetype="The Courtesan", effects=[Effect("change", "total tip", 25, scales_with="customer satisfaction")], pic = "courtesan2_1.webp"),
                     "Heavenly Pleasures" : Perk(name="飘飘欲仙", type="level", perk_level=2, archetype="The Courtesan", effects=[Effect("boost", "perfect result tip", 0.1), Effect("boost", "perfect result xp", 0.1), Effect("boost", "perfect result jp", 0.1)], pic = "courtesan2_2.webp"),
                     "Royal Treatment" : Perk(name="皇家体验", type="level", perk_level=3, archetype="The Courtesan", effects=[Effect("boost", "first customer tip", 1.5), Effect("boost", "first customer rep", 2.5), Effect("boost", "whore customer budget", 1.0)], pic = "courtesan3.webp"),

                     "Available" : Perk(name="见钱眼开", type="level", perk_level=0, archetype="The Escort", effects=[Effect("change", "constitution", 5), Effect("increase satisfaction", "group", 1)], pic = "escort0.webp"),
#                     "Extras" : Perk(name="Extras", type="level", perk_level=1, archetype="The Escort", effects=[Effect("special", "LOCS bonus", 1, chance=0.25)], pic = "escort1_1.webp"), # Shelving stat bonuses for now
                     "Convincing" : Perk(name="巧舌如簧", type="level", perk_level=1, archetype="The Escort", effects=[Effect("special", "temptress", 0.66)], pic = "slut2_2.webp"),
                     ...
                     "Business and Pleasure" : Perk(name="乐在其中", type="level", perk_level=3, archetype="The Escort", effects=[Effect("boost", "total tip", 0.01, scales_with="job cust nb"), Effect("boost", "total tip", 0.03, scales_with="whore cust nb"), Effect("change", "mood", 0.25, scales_with="cust nb")], pic = "escort3.webp"),
                     ...
                     "Something New" : Perk(name="触类旁通", type="level", perk_level=1, archetype="The Fox", effects=[Effect("boost", "xp gains", 1.0, chance=0.1), Effect("boost", "all jp gains", 1.0, chance=0.1)], pic = "fox1_1.webp"),
                     "Lost and Found" : Perk(name="拾金有昧", type="level", perk_level=1, archetype="The Fox", effects=[Effect("special", "random item", 1, chance=0.025)], pic = "fox1_2.webp", base_description = "'I'm sure he won't miss it.'"),
                     ...
                     "Tempting Fate" : Perk(name="幸运女神", type="level", perk_level=2, archetype="The Fox", effects=[Effect("special", "effect chance", 1)], pic = "fox2_2.webp"),
                     "Stars Are Aligned" : Perk(name="招财进宝", type="level", perk_level=3, archetype="The Fox", effects=[Effect("boost", "income", 1, chance=0.02, scope="brothel")], pic = "fox3.webp"),

                     "Teaser" : Perk(name="搔首弄姿", type="level", perk_level=0, archetype="The Slut", effects=[Effect("change", "libido", 5), Effect("gain", "positive fixation", 1)], pic = "slut0.webp"),
                     ...
                     "Next" : Perk(name="欲海难填", type="level", perk_level=2, archetype="The Slut", effects=[Effect("change", "whore customer capacity", 1)], pic = "escort1_2.webp"),
                     ...
                     "Me So Horny" : Perk(name="淫娃荡妇", type="level", perk_level=3, archetype="The Slut", effects=[Effect("boost", "tiredness", -0.1)], pic = "escort2_2.webp"),

                     "Enter The Bride" : Perk(name="纯洁新娘", type="level", perk_level=0, archetype="The Bride", effects=[Effect("change", "sensitivity", 5), Effect("change", "security", 1, scope = "brothel")], pic = "bride0.webp"),
                     ...
                     "Confession" : Perk(name="同甘共苦", type="level", perk_level=1, archetype="The Bride", effects=[Effect("spillover", "xp", 0.2), Effect("spillover", "jp", 0.2)], pic = "bride1_2.webp"),
                     ...
                     "The Healer" : Perk(name="医者仁心", type="level", perk_level=2, archetype="The Bride", effects=[Effect("boost", "love gains", 0.5), Effect("change", "heal", 1, chance=0.33, scope="brothel")], pic = "bride2_2.webp"),
                     "The Virgin Whore" : Perk(name="贞洁烈女", type="level", perk_level=3, archetype="The Bride", effects=[Effect("boost", "virgin tip", 1), Effect("boost", "virgin rep", 1)], pic = "bride3.webp"),
                     }
