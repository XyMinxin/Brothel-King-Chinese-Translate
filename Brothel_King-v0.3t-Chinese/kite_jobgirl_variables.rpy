...
image anika = ProportionalScale("NPC/Jobgirl/beach/anika body.webp")
image side anika = ProportionalScale("NPC/Jobgirl/beach/anika portrait.webp", res_portrait_size, res_portrait_size)
...
image bg beach = im.Scale("backgrounds/beach.webp", config.screen_width, config.screen_height)
image beach_arrival = ProportionalScale("NPC/Jobgirl/beach/beach arrival.webp", config.screen_width, config.screen_height)
...
image beach_friend_2 = ProportionalScale("NPC/Jobgirl/beach/beach friend 2.webp", config.screen_width, config.screen_height)
image beach_friend_3 = ProportionalScale("NPC/Jobgirl/beach/beach friend 3.webp", config.screen_width, config.screen_height)
...
image beach_lay_down = ProportionalScale("NPC/Jobgirl/beach/beach lay down.webp", config.screen_width, config.screen_height)
...
image friend_stand1 = ProportionalScale("NPC/Jobgirl/beach/friend stand1.webp", config.screen_width, config.screen_height)
