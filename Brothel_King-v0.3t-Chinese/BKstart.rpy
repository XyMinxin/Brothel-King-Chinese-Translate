    ...
    # CREATE CONTRACT TEMPLATES
        ...
        contract_templates = [
                    Contract(type="cruise", district="The Docks", archetypes = ["The Player", "The Fox"],
                            ...
                            venues=["改装的帆船", "私人快艇", "豪华游艇", "小型船队", "大型游船"],
                    ...
                    Contract(type="party", district="The Cathedra", archetypes = ["The Maid", "The Slut"],
                            names=["刺激派对", "教堂之夜", "无遮大会", "彻夜不眠", "21点和21个妓女", "我的购物车呢？"],
                    ...
                    Contract(type="date", district="The Magic Gardens", archetypes = ["The Bride", "The Model"],
                            ...
                            organizers=["Calif Bretznah", "大祭司罗南", "领主纳博克", "瑞森大师", "迪库议员", "粉红男爵", "努科姆公爵", "公会会长菲利克斯"],
                    ...
                    Contract(type="meeting", district="The Warehouse", archetypes = ["The Courtesan", "The Maid"],
                            ...
                            organizers=["泽恩城邦议会", "反抗军联盟", "法罗政权政府", "方桌骑士", "鲜血群岛联盟"],
                    ...
                    Contract(type="orgy", district="The King's Hold", archetypes = ["The Slut", "The Escort"],
                            ...
                            organizers=["Mistress Smutty Kitty", "Brothel Master Quinn", "大祭司罗南", "The Arios Nun Choir", "The Gimp", "The Hooker Trade Union", "An anonymous member of the royal family", "A rich businessman", "A noble lady"],
