...
#            MC.trainers.append(NPC_sad_sill)
    ...
    python:
        ...
        district_dict = {"slum" : District("The Slums", 1, 1, 15, ((beggar, 80), (thug, 20)), pic = "districts/slums.webp", description = "贫民窟位于泽恩的外围，围绕着城墙和护城河。到处都是异乡人、难民、乞丐、瘾君子。据说盗贼公会就藏在这里，他们崇拜暗影女神莎莉娅。"),
                 ...
                 "warehouse" : District("The Warehouse", 2, 2, 40, ((thug, 10), (laborer, 20), (sailor, 20), (commoner, 30), (craftsman, 20)), ["strip club"], pic = "districts/warehouse.webp", description = "工业园区是泽恩的商业中心，工匠和临时工都来这里找活干。白天，这里的街道上车水马龙，但到了晚上就变得空空荡荡，危机四伏。"),
