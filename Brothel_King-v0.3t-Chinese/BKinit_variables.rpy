...
#### RANDOM TIPS ####
    ...
    random_tips = [
                    ...
                    "当然，执行性服务需要良好的{b}性服务{/b}技能以及{b}敏感度{/b}。{b}魅力{/b}和{b}调教{/b}技能也有帮助.",
                    "美貌和性欲对于正常的性行为很重要.",
    ...
    MC_playerclass_description = {
                                  "战士" : "你是一个战士。虽然你看起来很年轻，但你已经经历过数次生死搏斗。你的战斗能力更强，可以轻松保护青楼。",
                                  "法师" : "你是一个法师。麻瓜臣服于你的意志和魔法。你可以使用各种各样的咒语，催眠别人，洗脑别人。",
                                  "奸商" : "你是一个奸商。你从小就开始接触经商。你可以做更大的买卖，拿到更多的优惠。"
                                  }
    MC_stat_description = {
    ...
    god_description = {
                        "阿里奥斯" : "你信仰阿里奥斯，他是光明之神和天使之主。你的力量+1。",
                        "莎莉娅" : "你信仰沙利亚，她是暗影女神和暗夜的统治者。你的精神+1。",
...
#                         "heartless" : Personality(name="heartless", attributes=("very materialist", "very dom"), description="Cold, calculating, domineering and selfish. Will always try to benefit at the expense of others."),
    ...
    recent_event_templates = {  # Girl events given to the player for rewarding/punishing
                                ...
                                "MC friend" : GirlRecentEvent(type="MC friend", base_description="你和%s成为了朋友。", encourage=False, discipline=False),
                                ...
                                "MC lover" : GirlRecentEvent(type="MC friend", base_description="%s现在是你的恋人。", encourage=False, discipline=False),
...
#                            "extremely reluctant" : 100, # (obsolete)
    ...
    interact_dict = {
                    ...
                    "{size=+8}催眠暗示{/size}" : [
                                                GirlInteractionTopic("magic", "train", "服从度提高", "slave_magic", act="obedience", gold_cost=20),
                                                GirlInteractionTopic("magic", "train", "敏感度提高", "slave_magic", act="sensitivity", gold_cost=20),
                                                GirlInteractionTopic("magic", "train", "性欲提高", "slave_magic", act="libido", gold_cost=20),
                                                ],
                    "{size=+8}性爱催眠{/size}" : [
                    ...
                    "{size=+8}鼓励{/size}" : [
                                    ...
                                    GirlInteractionTopic("react", "reward", "送礼物　　", "slave_reward_gift"),
                    ...
                    "{size=+8}惩罚{/size}" : [
                                    ...
                                    GirlInteractionTopic("react", "discipline", "让她全裸", "slave_punish_naked"),
                                    GirlInteractionTopic("react", "discipline", "拳打脚踢　　　　", "slave_punish_beat"),
                    ...
                    "{size=+8}工作{/size}" : [
                                    GirlInteractionTopic("misc", None, "禁止工作期间与客人性行为　　　", "slave_forbid_cust_events", AP_cost=0, condition = "!forbid customer sex"),
