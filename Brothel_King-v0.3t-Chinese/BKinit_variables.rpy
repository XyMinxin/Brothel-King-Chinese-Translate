...
#                        "roll_critical success" : "\n{color=[c_green]}%s did everything she could to please the customers.{/color}",
                        ...
                        "DT_group" : "顾客们轮流把他们的肉棒塞到她的喉咙里，越深越爽。",
...
#汉化标签，套用了小黄文的桥段，略微修改了一下，有需要自己替换#
                        ...
                        "M sex_very bad" : "\n{color=[c_red]}%s是一场可怕的性爱，当顾客侵犯她的身体时一点也不享受。顾客觉得她很糟糕，抱怨着离开了。",
                        "M sex_bad" : "\n{color=[c_lightred]}男人将%s她尽力让顾客玩得开心，但她的假哭是相当明显的。顾客离开时松了一口气，但有些失望。",
                        "M sex_average" : "\n%s和客户打交道，尝试一些有趣的姿势。她开始享受自己，她的一些呻吟显然不是假的。",
                        "M sex_good" : "\n{color=[c_lightgreen]}%s在前戏的快速回合后，她和客户在不同的位置有狂野的性行为，直到他硬在她的身体。",
                        "M sex_very good" : "\n{color=[c_green]}%s真是太棒了，他的鸡巴就像个魅魔。她达到了性高潮，当顾客把温暖的精液注入她体内时，她大喊大叫。",
                        "M sex_perfect" : "\n{color=[c_orange]}%s不能得到足够的，大声尖叫，因为她享受被性交通过多次高潮和被覆盖在客户的粘性。",

                        "M service_very bad" : "\n{color=[c_red]}%s顾客抱怨说她不知道如何正确使用阴茎。顾客离开了，因为她甚至没能把他吃完而心烦意乱。",
                        "M service_bad" : "\n{color=[c_lightred]}%s她笨拙地试图为顾客服务，但她显然缺乏技巧。他最后手淫，而她羞愧地看着。",
                        "M service_average" : "\n%s她尽自己最大的努力为顾客服务，慢慢发展出自己的技术。在逗弄了顾客一会儿之后，她笑了，当他在她脸上卸下他的包袱时。",
                        "M service_good" : "\n{color=[c_lightgreen]}%s她用她的技巧让顾客快速而反复地射精，并用体液覆盖她的脸和乳房。",
                        "M service_very good" : "\n{color=[c_green]}%s当她开始吮吸和舔顾客的阴茎时，她已经湿了。没过多久，顾客就硬咬了她的嘴。",
                        "M service_perfect" : "\n{color=[c_orange]}%s她把自己的身体提供给顾客玩，并发出潮湿的声音，因为她熟练地吮吸他。她品尝着脸上和嘴里滚烫、粘稠的精液的感觉，乞求顾客再给她一点。",

                        "M fetish_very bad" : "\n{color=[c_red]}%s在顾客的触摸下，她又害怕又紧张。她一点也不喜欢这样，顾客完全不满意地离开了...",
                        "M fetish_bad" : "\n{color=[c_lightred]}%s当顾客对她的身体做新的、奇怪的事情时，她颤抖着。顾客一开始很感兴趣地看着她的反应，但缓慢的节奏很快就让他厌烦了。。",
                        "M fetish_average" : "\n%s她被蒙上眼睛，被绑起来，发出轻微的呻吟声。对于发生在她身上的事情，她似乎更好奇而不是害怕，顾客和她玩了一会儿很开心。。",
                        "M fetish_good" : "\n{color=[c_lightgreen]}%s当她感觉到绳子在皮肤上的咬痕时，她兴奋得发抖。顾客挑逗她的身体，直到她完全湿了，乞求被操。",
                        "M fetish_very good" : "\n{color=[c_green]}与%s她享受快乐和痛苦的混合，并顺从地乞求更多。当她被绑起来时，顾客侵犯了她，当他在她身上用力时，她达到了高潮。",
                        "M fetish_perfect" : "\n{color=[c_orange]}%s她喜欢顾客对她做的每一件事，提出新的、羞辱的方法把自己绑起来，然后受到惩罚。她尖叫着痛苦和快乐，多次cumming，因为她的各种孔被侵犯。",

                        "M bisexual_very bad" : "\n{color=[c_red]}%s不愿意互相配合。顾客很快就厌烦了，抱怨着要退款就走了。",
