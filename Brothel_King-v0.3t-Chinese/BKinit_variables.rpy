...
#### RANDOM TIPS ####
    ...
    random_tips = [
                    ...
                    "如果你想招揽更多的顾客，可以尝试广告宣发。不过宣传力度不要超出你的能力范围.",
...
init python:
    ...
    master_bedrooms = {
                        0 : Room("简陋的卧室", level=0, type="master", cost=0),
                        1 : Room("狭窄的卧室", level=1, type="master", cost=750),
                        2 : Room("宽敞的卧室", level=2, type="master", cost=2500),
                        3 : Room("豪华的卧室", level=3, type="master", cost=7500),
                        4 : Room("华美的寝宫", level=4, type="master", cost=25000),
                        5 : Room("奢华的宫殿", level=5, type="master", cost=75000),
                        }
...
#汉化标签，待润色修改#
    ...
    generic_gossip = [
                        "我不明白魔术师怎么能在光天化日之下进行实验。太阳神狂热者教会以极大的热情憎恨魔法使用者。但他们并没有采取行动关闭它们....",
...
#                        "roll_critical success" : "\n{color=[c_green]}%s did everything she could to please the customers.{/color}",
                        ...
                        "waitress_average" : "\n%s 的服务滴水不漏，她和客人们相谈甚欢. 不经意间漏出裙底和乳沟，客人们觉得她很上道。",
                        "waitress_good" : "\n{color=[c_lightgreen]}%s 在给顾客上酒的时候和他们调情，让他们觉得自己的男性魅力十足。",
                        "waitress_very good" : "\n{color=[c_green]}%s 和顾客谈笑风生，一边贴着顾客一边推销店里的酒水，对于大方的客人她用嘴把酒渡给客人喝。每个人都喜欢她。",
                        "waitress_perfect" : "\n{color=[c_orange]}%s 今天没穿内衣上班，她的胸前两颗葡萄若隐若现，她把红酒倒在胸口让客人品尝。酒水沾湿了衣服，变得透明，客人忍不住脱下裤子对着她自慰。",

                        "dancer_very bad" : "\n{color=[c_red]}%s 身体极度不协调。差点在舞台上摔一跤，顾客们嘘声连连，朝她扔烂番茄。",
                        "dancer_bad" : "\n{color=[c_lightred]}%s 的舞蹈枯燥乏味，毫无新意。客人们看得犯困，哈欠连天。",
                        "dancer_average" : "\n%s 在顾客面前搔首弄姿，让人对她浮想联翩，顾客抓了一把她的翘臀，放在鼻子面前细细品味，发誓这周不会洗手了。",
                        "dancer_good" : "\n{color=[c_lightgreen]}在 %s 起舞时全场都嗨了起来，客人把小费塞进她的胸口，沉甸甸地果实让胸口的衣服不堪重负，她不得不把双手环抱在胸前，这也让她没办法阻止客人对她伸出的魔爪。",
                        "dancer_very good" : "\n{color=[c_green]}当 %s 登台后,人们把舞台围得水泄不通。她的汗水浸透了舞女服，已经分辨不清大腿上流下的是汗液还是别的什么，客人把她团团围住，给她做了免费的面膜。",
                        "dancer_perfect" : "\n{color=[c_orange]} %s 走到客人面前,松垮的吊带自然滑落，骑在顾客身上疯狂地扭臀，两颗果实左右甩动，她的身上被客人种满了樱桃，她的衣服不知道被谁捡走了，找回来时上面沾满了精液。",

                        "masseuse_very bad" : "\n{color=[c_red]}%s 笨手笨脚地给客人按摩，力道掌握得不到位，客人吵着要退钱。",
                        "masseuse_bad" : "\n{color=[c_lightred]}%s 试着给顾客一个放松的按摩。她的技术欠缺，客人感到不满意。",
                        "masseuse_average" : "\n%s 围着浴巾给客人做按摩，一个小孩突然跑来一把扯下了她的浴巾，她只好光着身子继续给客人按摩。",
                        "masseuse_good" : "\n{color=[c_lightgreen]}%s 穿着透明的泳衣走进了房间，胸部上沾满了精油，紧贴着客人全身，双只巧手上下撸动客人的肉棒，客人射得她满手都是，为了不弄脏房间她只好把手中的精液都咽了下去。",
                        "masseuse_very good" : "\n{color=[c_green]} %s 身上只有几个创可贴覆盖着乳头和小穴，她用舌头舔去客人身上的汗水和污垢，再用湿润的小穴在客人手臂上厮磨，客人双手抓着她的大奶子，肉棒在小穴和大腿间摩擦。",
                        "masseuse_perfect" : "\n{color=[c_orange]}%s 戴着猫耳和肛塞尾巴走到人群中间，肉棒塞满了她的长发，腋窝和嘴唇。客人们反客为主，给她做了次全身按摩。事后她就像泡在精液里一样。",

                        "geisha_very bad" : "\n{color=[c_red]}%s 动作笨拙，给人感觉就像是个乡巴佬，客人把茶水直接倒在地上。",
                        "geisha_bad" : "\n{color=[c_lightred]}%s 上茶的时候努力表现得像个茶道大师;然而懂行的人眼里她错漏百出。",
                        "geisha_average" : "\n%s 和客人们玩起了真心话大冒险，不知怎么的她一直在输，身上的衣服越来越少，最后她只能用手挡住胸部和私处，最后她只能喝下客人为她加料的特殊饮品，喝完她舔了舔嘴唇。",
                        "geisha_good" : "\n{color=[c_lightgreen]}%s 的和服十分松弛，她站起身时衣服自然滑落，客人们发现她的小穴里夹着石杵，她抱头蹲下扭动腰肢，石杵也随之摆动，爱液顺着石杵流到了茶叶里面。",
                        "geisha_very good" : "\n{color=[c_green]}%s 穿了一件薄纱裙，里面什么都没穿。她吃了可以分泌乳汁的药，藕臂夹着玉乳挤出了乳汁，双腿摩擦分泌爱液，她把茶叶撒在身上让客人品尝，片刻后口水沾满全身，衣服居然被口水融化了？",
                        "geisha_perfect" : "\n{color=[c_orange]}%s 她泡在花瓣浴池里，邀请客人共浴。乳头挺立，渗出香甜的乳汁。客人脱光了走进浴池，用肉棒代替研磨杵在她的身上研磨，咬着乳头，用力嗦奶，清澈的池水变得浑浊无比。",

                        "flasher" : " 一位顾客让她露出胸部，她敞开胸口，客人在她的胸口涂满了奶油，然后大快朵颐。",
                        "temptress" : "客人今天想试试 %s ，她不好意思拒绝客人，只能服从安排。",
                        "catgirl" : "她努力吞咽，喝光了嘴里的精液，然后舔了舔舌头，最后用湿润的小穴清洁了客人的肉棒。",
                        "virgin" : " 客人对她还是个处女表示震惊，她把小穴掰开给他看后他给了许多小费。",
                        "virgin_group" : " 客人们对她还是个处女表示震惊，她把小穴掰开给他们看了他们才信。",
                        "reroll" : " 她脱光了衣服在客人面前土下座取得了原谅，勉强避免了一场灾难。",
                        "unlucky" : "",
                        "lucky" : "",
                        ...
                        "roll_critical success" : "{color=[c_green]}  %s 尽她所能来取悦客人。{/color}",
                        ...
                        "bisexual_roll_critical success" : "\n{color=[c_green]}%s 使出浑身解数来取悦顾客和搭档。{/color}",
...
#汉化标签，套用了小黄文的桥段，略微修改了一下，有需要自己替换#
                        "M anal_very bad" : "\n{color=[c_red]}%s赤身裸体的趴在他大腿上，雪白丰盈的双乳吊垂着，优美的嘴唇含住他龟头，轻轻吮吸着。可还没等到男人准备开始爽，她就被呛到，一直咳嗽，甚至吐出了今天的晚餐.....",
                        "M anal_bad" : "\n{color=[c_lightred]}插了%s片刻后她便无力了，男人只好趴在香汗淋漓的雪白背脊上，慢慢的抽插她，双手去把玩胸前的白腻乳房，玩出乳汁来，最后草草收场。",
                        "M anal_average" : "\n男人抱着%s，慢慢走进浴房，一边走一边缓慢抽插，将她衣衫半解的娇躯放在床上，让她趴着，自己双手抓住她的白屁股，掰开，欣赏她丰腴臀部里娇嫩的菊蕾，再以肉棒顶着她，驱使着她去到大床的中央。满面羞红的发出悲鸣，蹒跚的在床上爬，雪白如玉的屁股被男人的一双大手掰开，一根粗大鸡巴不断肏着她，给予她强烈的刺激。",
                        "M anal_good" : "\n{color=[c_lightgreen]}%s滚烫的脸颊埋在手臂里，被插得发出闷哼声，在男人胯下的娇躯一直在颤抖哆嗦，两瓣被双手分开的臀部绷得紧紧的，左右晃荡着。满面潮红地转头看去，眼神迷离，被男人抽插着菊蕾的身躯不断前后摇晃，让她被迫伸出手去抓住底下的毯子。男人在抽插她的菊蕾，越来越快，越来越激烈，全身上下都发烫。。",
                        "M anal_very good" : "\n{color=[c_green]}男人抱起%s的脸亲吻，胯下却不停，不断顶着，粗大肉棒抽插她的后庭菊蕾。双腿勾住男人的腰，被猛烈的抽插弄得尖叫。一对木瓜似的雪白奶子被前后撞击而晃荡个不停。",
                        "M anal_perfect" : "\n{color=[c_orange]}%s握住了他胯间的肉棒，引导着来到自己腿间，让他一插而入。湿热的白虎穴稍微一夹，两瓣肥沃阴唇夹紧他的肉茎。菊门被龟头顶开，不禁发出难捱的呻吟。男人使出浑身解数，那羞颤紧缩的菊门，才在龟头的持续顶戳研磨下，一点点的张开来。娇嫩紧窄的花芯紧紧缠住。缠绵悱恻，宛若鸳鸯交颈舞。",

                        "M sex_very bad" : "\n{color=[c_red]}%s被插了多日的阴道张开一个肉色的洞，里面的嫩肉一阵收缩，又很快闭合成为一线天。喘着气将阴茎拔出，啵的一声，肥嫩的白虎穴依依不舍的与阴茎道别。客人发现他还没射里面就有精液流出来了，顿时感觉十分恶心。",
                        "M sex_bad" : "\n{color=[c_lightred]}男人将%s压住，双手撑在她胳膊窝旁，低着头亲吻她的额头与脸颊，再亲吻她的琼鼻，眼帘，柔情蜜语的喊着她的名字，她却没有丝毫反应。",
                        "M sex_average" : "\n%s大张着双腿，闭着眼眸，娇颜潮红，一双修长雪白、汗涔涔的大腿时而绷直、时而踢动，晶莹玉润的脚趾头蜷曲着，被粗大的肉茎插得身子一直颤，两条玉腿在打摆哆嗦，被肉棒撑大并啪啪抽插不断的小穴，噗噗的冒出黏腻的蜜汁。她的白虎穴紧紧收缩，夹住肉棒，穴汁不断往外冒。但男人非但没有停下，反而摁住她的腰，继续猛烈挺动下体。",
                        "M sex_good" : "\n{color=[c_lightgreen]}潮喷的她兴奋难耐，状若疯狂的挺动腰杆，%s雪白的肉体被撞得在床上蠕动，让她不断哭泣似的呻吟，全身都是香汗。青丝在地上摇曳，双腿绷直，啊啊呻吟着，待男人最后猛地拔出肉棒，对着她潮红一片的娇躯射出浓精时，清冷绝美的她竟也闷哼一声，双手撑在地面，双脚踩着床，被肉棒撑开还未闭合的红肿白虎穴，朝着天空滋滋的喷出蜜汁，化为了一道彩虹般落下",
                        "M sex_very good" : "\n{color=[c_green]}%s被男人压着，英气的娇颜变得酡红，散发出迷人妩媚的气息，也不断回应男人的亲昵，火热的红唇亲吻他的唇瓣，双手搂着他，双脚勾住他，红唇亲吻他的脸，嬉笑着，媚笑着，仰起头被男人亲吻脖颈，被他弓着身子含住乳头时，她搂住他的脑袋，挺起胸膛让杨七吃奶，被他牙齿咬着乳头时，咯咯笑着将奶头从他嘴里拔出，将沾着口水的红肿乳尖压到他那张黝黑脸上，转而又被男人含住，吮吸，呻吟，修长的双腿缠着他的屁股。她媚意已经流淌而出，说男人不是她丈夫，别人都不信，如此缠绵缱倦的模样，哪里还在乎。",
                        "M sex_perfect" : "\n{color=[c_orange]}%s敞开宫口被男人顶入，男人搂着她亲昵抚摩许久，哄得她心花怒放，穴芯也怒放，两人情投意合，缠绵悱恻之际，她被男人亲得身子酥软，穴芯宫口软绵绵的，在男人的反复顶弄中，任由他将肉棒顶入到子宫里，宫口缠住他的肉棒，与他脸贴着脸亲昵厮磨。她张着小嘴长长呻吟，眼睛翻白，舌头吐出，一副被顶得痉挛的模样。",

                        "M service_very bad" : "\n{color=[c_red]}%s脸色羞红的用玉手推搡客人，扭着腰撑着酥软的身子躲避她的求爱，可还是被男人压在身下，继续试着顶入。过了一会男人见她十分抗拒便放弃了",
                        "M service_bad" : "\n{color=[c_lightred]}%s伸出手，拨弄着脸上男人的肉棒。男人用胯下肉棒去顶她的嘴唇，用龟头摩擦娇艳的红唇，将龟头马眼流出的透明汁液涂抹在她的唇瓣上。她闷哼一声，就是不张嘴。",
                        "M service_average" : "\n 男人的肉棒从%s的口穴内深处拔出，满是穴汁与腥臭的精液，龟头硕大上翘，刚才就是它深插进了喉咙里，把她插得全身软绵绵的，像是一个小女孩一样撒娇求肏。痉挛着泄出大股的淫水。",
                        "M service_good" : "\n{color=[c_lightgreen]}%s大大的张开嘴，让嘴唇变成能容纳肉棒的O形，可以看到她嘴里的软舌也在等待着舔舐。扭过头来，用一双玉手握住他的肉棒，眼神妩媚的看着它。被她用软舌舔舐的肉棒跳动几下，抚摩着她的脸颊，耐心的等着她为自己舔鸡巴。香舌伸出，缠绕在他龟头上，反复的勾绕旋磨。男人的脸兴奋的涨红，龟头被吸得涨麻，伸出手去抚摩她的脑袋，鼓励她继续吮吸。",
                        "M service_very good" : "\n{color=[c_green]}%s的脸颊凹陷下去，不断用力吮吸吞吐着男人龟头，发出怪异又淫蘼的波波汩汩的吮吸吞咽声，吐出肉棒，用软舌对着龟头一阵舔弄后，又去舔他的棒身，小手去弄他的睾丸，把他伺候得嘶嘶抽气。再顺势张开嘴，一口将肉棒吞下去，像是吞吃一根硕大肉肠，足足吃进去十多公分，来了一次深喉，娇艳的红唇紧贴粗大狰狞棒身，将肉棒一点点的往喉咙里吞。对着肉棒又舔又吸，吃得肉棒吧唧吧唧作响",
                        "M service_perfect" : "\n{color=[c_orange]}大量的浓精直接射入%s的喉咙，直入腹中，粘稠的精液让她脸颊酡红，许久后，男人才将肉棒拔出。两人在大床上翻滚着激烈交合。脸颊红润，丰腴的身子轻颤着，男人趴在她身上哆嗦着将精液注入她穴内，两人在床上纠缠了好一会。",

                        "M fetish_very bad" : "\n{color=[c_red]}%s被扯下了衣裳，露出雪白酥胸，男人见了大为意动，凑上前去吮吻她的乳尖。可是她却反应过激，一不小心踢了客人一脚...",
                        "M fetish_bad" : "\n{color=[c_lightred]}%s扭着头，腰肢扭了几次想躲避，都被摁住，再用力一插，细长白嫩的阳具终于尽根插入到她的菊内，龟头一点一点的探入。一直发抖。男人连连扭动，让手中的假肉棒，双管齐下，在她腿间两个蜜穴里不断进出，滋滋滋的插出水声来。",
                        "M fetish_average" : "\n 男人在%s身上耕耘着，亲吻，抚摩，抽插。她开始低声呻吟，最开始的扭腰反抗，到如今的慢慢打开双腿，迎接着男人的抽插。雪白娇嫩的乳房在胸前跳动，随着抽插的动作而活泼的蹦跶着。搂着酥软下来的身子尽情欢爱，让她被插得水流不止。",
                        "M fetish_good" : "\n{color=[c_lightgreen]}%s已经脱力，被男人面对面搂在怀里，捧着她白屁股肏，颠簸着一上一下，吞吃着阴茎，发丝不断飞舞，淫美至极。一丝不挂地被拉到阳台苟合，萧曦月趴在栏杆上，被男人肏着，内射了至少三次。",
                        "M fetish_very good" : "\n{color=[c_green]}与%s在草地上打滚交欢，两具身体缠绵在一起。也不知被内射了多少次，前面后面的肉洞被男人射了许多次，精液灌入子宫内，让她的的肚子鼓了起来，显得如此妖冶与淫蘼。男人从背后抱着她，双手搂着她腿弯，让她双腿大张，露出被白嫩阴茎插着的白虎穴，底下的嫩菊一张一合，柔软的肚子鼓起，仿佛怀胎五月。",
                        "M fetish_perfect" : "\n{color=[c_orange]}%s状若淫妇，在掺夹喘息的激烈啪啪啪声中，被粗大肉棒插得摇头晃脑，秀发乱舞，交合处，淫液不断滴落，将床单打湿。红酒在流淌，枕头被玉足踢飞。娇躯赤裸的躺上去，修长双腿大张，在一堆绒毛中被男人尽兴的抽插，雪白的身子染上酒水，却还兴奋的扭动着与他交合。两瓣肥美的臀痉挛着夹紧，男人将阴精射入她的穴内，最后又滚入了花圃中缠绵。",

                        "M bisexual_very bad" : "\n{color=[c_red]}男人用手用脸用舌头，不断玩着%s的桃臀，将肥美圆润的两瓣屁股玩得肉浪不断，舌头狂舔她的穴，刚开始她还会摇晃腰肢，用圆润的桃臀啪啪打着男人的脸，但很快就停了下来，大口喘着粗气。",
                        "M bisexual_bad" : "\n{color=[c_lightred]}浴池内有一对鸳鸯不断缠绵，%s有着令他眼馋的硕大肥臀，又白又大，与另一位姑娘玩弄时，这两瓣圆鼓鼓的臀就跟波浪一样甩动，使用双头龙时，大白臀还会夹紧那玩意，使劲的往她穴里插，叫声也十分浪荡。但她们只顾自己快活，完全忘记了客人的存在。",
                        "M bisexual_average" : "\n %s身下的女人正吃着她的奶，小嘴吮出甜腻的乳汁，一口一口的喝掉，磨镜之后，两人就如母女一样，互相搂抱着，轻抚她脸颊脑袋和后背，将嫣红涨硬的乳尖往她小嘴里凑。在两人欢好的时候，上前爱抚正在被双头龙抽插的姑娘的小脚，让她娇躯一僵，身子很快软了下去。男人猛地把脸死死的贴住她圆滚滚的大白臀，双手搂住她胯部，脸颊紧贴，伸出舌头就猛舔。",
                        "M bisexual_good" : "\n{color=[c_lightgreen]}男人伸出手去抚摸眼神迷离的%s。双手往下，抓住了她垂下的一对雪乳。在床榻上，褪掉衣裳，裸露绝美娇躯，在床上极尽香艳的接吻爱抚，她和另一位姑娘磨镜缠绵到高潮。低着头与另一位姑娘舌吻，柔软舌头闯入她小嘴里，吃她的香舌，两位绝色佳人相拥在床，乳房紧贴着律动。",
                        "M bisexual_very good" : "\n{color=[c_green]}一只手朝着%s纯白衣裳包裹的雪白乳房抓去，另一只手急不可耐的撩起另一个姑娘的裙子，对着腿间蜜穴揉搓挤按。肥嫩无毛的白虎穴分明已经湿了，两瓣肥软紧实的白嫩阴唇微微张开，吐出一缕甘甜的汁液。男人张开嘴，急躁的用舌头猛烈舔舐，舌尖钻入仙子穴内。被开发多日后曼妙多姿的娇躯被男人抱在怀中。她闭着眼眸，动情的回吻，柔软的香舌与他的大舌缠绕在一起，穴内早已湿润，蜜腔嫩肉紧紧包裹住男人的肉茎。",
                        "M bisexual_perfect" : "\n{color=[c_orange]}男人将与另一个女孩胯部连在一起，浑身赤裸、沾满欢好无数痕迹后的%s，拽到怀里。丰满娇嫩的乳房相互挤压，一边走，一边被插，男人的下体挺动着抽插。趴在她白皙丰腴的身子上不断挺动，胯部顶撞不停，隐约可见一根白玉般的假阳具连接着两人。",

                        "group_very bad" : "\n{color=[c_red]}搂着%s的肥美屁股，小手紧抓着臀肉，吃力的一下下扭着纤腰撞击她。把她插得汁水流淌，在胯下呻吟喘息，臀部肥肉被撞得好似肉浪。可是她并不会同时伺候这么多客人，这让剩下的人觉得很无趣。",
                        "group_bad" : "\n{color=[c_lightred]}男人们将来到床边的%s扑倒在床，与她缠绵亲吻，纠缠厮磨间将她身上白裙解开，对着她白嫩肥鼓的蜜穴就顶了过去。在她柔美的娇躯上肆意妄为，舔舐，抚摩，磨蹭，纤腰款款扭动，将她修长的双腿分开，贴着她的穴用力顶了顶。没过一会她就晕死过去。男人们有些扫兴。",
                        "group_average" : "\n起初还反抗，可被依依不饶的%s，被阴茎连连顶戳几次敏感花芯，且有节奏的研磨后，很快就喘得不轻，软在床上被男人们弄着，穴内不断冒出甘甜蜜汁，浑圆双乳被撞得前后颤动，顶端的乳尖早已充血变硬。客人们肏得她下不来床，身心酥软。娇艳的脸颊上泛着兴奋的红晕。",
                        "group_good" : "\n{color=[c_lightgreen]}男人们魁梧的身子紧贴着%s，扭腰挺胯，堪称疯狂的抽插着她的蝴蝶穴。她被日得发不出声，臀部悬空，汁液不断往下流，两条玉腿绷直，足尖绷紧，脑袋埋在男人的胸口，秀发胡乱飞舞着，被日到高潮后身子剧烈颤抖，可男人还是不停肏她。她记不得当晚交合了多久...",
                        "group_very good" : "\n{color=[c_green]}男人怀中抱着撒尿似的%s，她也是赤身裸体，穴内插着男人的粗大肉棒，湿淋淋的。随后弯腰后翘着臀，修长双腿站立着，雪白娇美的身子不断前后摇晃，被身后的男人顶撞不停。她还想说什么，可男人又加快肏她的动作，让她只能继续呻吟，踮起脚尖受插。",
                        "group_perfect" : "\n{color=[c_orange]}男人搂紧%s，痛吻她的双唇，颤抖而凌乱的解开她衣带，抚摩她的娇躯，将她抱起来，放到了榻上。顺从的抬起手，让人解开她洁白衣裙，牡丹肚兜下，两团丰盈的雪白乳肉若隐若现，顶端两粒樱桃已经悄然挺立。被男人肏得呻吟不止，大口喘息着承受粗大肉棒的进出，火热的缠绵享受着男女欲望。",
...
init python:
    ...
    contract_templates = [Contract(type="cruise", district="The Docks", archetypes = ["The Player", "The Fox"],
                                   names=["海上之夜", "海湾观光", "水手退休仪式", "梦幻巡游之旅"],
                                   organizers=["水手协会", "泽恩海军", "弗利布斯特社交俱乐部", "北方商盟船队"],
                                   venues=["改装过的巨型帆船", "私人破船", "豪华游艇", "小型渔船船队", "大型观光邮轮"],
                                   character=sailor,
                          ...
                          Contract(type="ceremony", district="The Cathedra", archetypes = ["The Model", "The Bride"],
                                   names=["沐浴圣光", "宗教庆典", "圣洁的仪式", "圣人集会", "祷告之后"],
                                   organizers=["太阳神的神圣教会", "圣迪尔德奥修女会", "启蒙兄弟会", "虔诚的信徒", "莎莉娅的友人", "旧神联盟", "不可提及的约格鲁的崇拜者", "太阳神教的女祭司"],
                                   venues=["大型修道院", "庄严的大教堂", "与世隔绝的寺庙", "静谧的隐居处", "忘忧寺", "辉煌的教堂", "贫困的孤儿院"],
                                   character=nun,
                          ...
                          Contract(type="festival", district="The Slums", archetypes = ["The Player", "The Fox"],
                                   ...
                                   organizers=["乡巴佬南瓜", "农民协会", "乡村俱乐部", "园艺协会", "乡绅阶级", "龌龊的嬉皮士", "牧民协会"],
                                   venues=["废品站旧址", "宽阔的露天广场", "集市广场", "城门门口", "马路边的空地"],
                          ...
                          Contract(type="date", district="The Magic Gardens", archetypes = ["The Bride", "The Model"],
                                   names=["浪漫约会", "寂寞的绅士", "领主的阁楼", "佳人有约"],
                                   organizers=["卡利夫-布雷兹纳", "大祭司罗恩", "纳布科夫领主", "瑞祥大师", "迪库伯爵", "粉红男爵", "杜克-努克姆", "公会会长菲利克斯"],
                                   character=young_maid,
                                   venues=["豪华高层公寓", "乡间别墅", "古老的宅邸", "家族府邸", "私人寺院", "有名的度假村"],
                                   MC_event_pic="NPC/encounters/thief4.webp",
                                  ),
                          Contract(type="meeting", district="The Warehouse", archetypes = ["The Courtesan", "The Maid"],
                                   names=["战略会晤", "权力的展示", "政治协商", "重要的场合", "走个过场的会议"],
                                   organizers=["泽恩议会", "反抗军联盟", "伟大的法罗一世陛下的政务部门", "圆桌骑士", "鲜血群岛"],
                                   venues=["圣战的进展", "军事合作", "放开性奴交易", "新的渔业条例", "魔法武器预算的缩减", "降低贵族的税收", "增加百姓的税收"], # Different use for venue for this particular contract
                                   character=diplomat,
                          ...
                          Contract(type="magic", district="The Magic Gardens", archetypes = ["The Escort", "The Courtesan"],
                                   names=["法师集会", "法师年会", "魔法工艺交流会", "法师协会的休闲娱乐", "魔法学校大赛", "仅限巫师"],
                                   organizers=["风佐斯大法师", "女巫联盟", "亡灵巫师俱乐部", "卡基亚的长老们", "友好的邻居-黑魔法信徒"],
                                   venues=["闹鬼的庄园", "阴森的旧宅子", "法师尖塔", "地下巢穴", "刚刚联通的恶魔维度", "尘封的书房"],
                                   character=sorceress,
