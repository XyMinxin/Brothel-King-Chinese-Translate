...
#### RANDOM TIPS ####
    ...
    random_tips = [
                    ...
                    "听人说青楼协会会给最优秀的奴隶一个神秘评级，它甚至比 'A'阶还要高级。",
...
#                        "group result bad" : "{color=[c_lightred]}%s cried and screamed as the %ss took turns violating her body.{/color} Gizel kept tauting her during the whole ordeal as she sobbed silently.",
    ...
    pop_name_dict = {
                    "M beggars" : ("无赖", "衣衫褴褛的男人", "乞丐", "流浪汉"),
                    "M thugs" : ("混混", "恶棍", "土匪", "小偷", "流氓", "窃贼"),
                    ...
                    "F beggars" : ("女无赖", "衣衫褴褛的女人", "女乞丐", "女流浪汉"),
                    "F thugs" : ("女混混", "女恶棍", "女土匪", "女飞贼", "女流氓", "老巫婆"),
                    "F laborers" : ("女劳工", "女工人", "女摊贩", "女佣", "农妇"),
                    "F sailors" : ("女海盗", "女海员", "码头女郎", "女船员", "随船护士", "女水手"),
...
init -2 python:
    ...
    contract_description = {"cruise" : ":ORG:策划了一次环绕:dis:的巡游，以犒劳大伙今年的辛勤工作。在黄昏时分从:AVEN:出发前往海湾观光，然后停泊在:LOC:附近，享受娱乐之夜。",
                            ...
                            "magic" : ":ORG:召集受邀的法师在:LOC:度过有趣的一晚。客人们将在女佣的陪伴下前往:aven:参加这次活动，共同探索:DIS:的秘密。",
                            "orgy" : ":ORG:高兴地宣布，大家将在:LOC:度过一个漫长的享受肉欲和释放本能的夜晚。大家聚集在:aven:，与同道中人和精心挑选的上等性奴一起享受禁忌的快乐。"}
