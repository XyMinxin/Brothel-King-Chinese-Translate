...
translate chinese security_8a1d79af:
    ...
    "敌人正在猛击青楼的门，看来它几乎要守住了。然而，在焦急等待了数秒之后，一声巨大的撞击声把门炸开了。"
...
translate chinese security_038b5d02:
    ...
    security_breach "剩余的[enemies]敌人会突然袭击你，他们的联合攻击会让你后退，当他们继续攻击你的女孩时，你会被践踏，当你被打倒在地时，他们会无视你。"
...
translate chinese security_db83263d:
    ...
    security "敌人的突击队员冲进门来，但你已经做好了准备。你同时给他们[damage]的伤害战斗，防止他们攻击你的女孩。"
...
translate chinese security_7bb9cd2a:
    ...
    "剩下的[enemies]敌人从你身边跑进青楼，和你的女孩们交战。"
...
translate chinese security_747c5042:
    ...
    "敌军一个接一个地倒下。你砍砍砍，砍断最后一个雇佣兵的剑手，他尖叫着跑开了。他们的将军不见了。你赢得了这场战斗。"
...
translate chinese security_a56bb971:
    ...
    "你不顾战斗，偷偷溜过他们的前线，发现了[enemy_general.fullname]，他们的将军在后面发号施令。{nw}"
...
translate chinese security_347b9da6:
    ...
    "眼袋突然打开，冒出一股浓烟。当你咳嗽着设法过去时，你看到敌人的将军不见了。"
...
translate chinese security_0f444b1c:
    ...
    "她转过身来面对你，迅速地挡开了你的进攻。她的反击是快速和致命的，你尽你最大的努力来保护自己，在她把你推回去的时候，你受到了一连串的剑击。"
...
translate chinese security_91f895fd:
    ...
    "她利用你的困惑，用她的钢爪狠狠踢你的腹股沟。你疼得缩成一团，当你抬起头想看下一拳的时候，她用拳头重重地打在你脸上。你跌倒在泥里，失去了知觉。"
...
translate chinese security_a2859643:
    ...
    "意识到你的攻击，[enemy_g]转过身来，反射性地寻找她的战斗杖，却只记得你刚刚打破了它。"
...
translate chinese security_49edadd6:
    ...
    "她在你有机会攻击之前就发现了你，在你和她之间施放了一道防火墙咒，把你从青楼和战场上切断了。你只能无助地看着对[brothel.name]的攻击继续。"
...
translate chinese security_0d9c079f:
    ...
    you "我现在要把你当作我的宠物。你在这里重建你造成的破坏是公平的。"
...
translate chinese security_17421a6e:
    ...
    you "嗯嗯……一个具有这种精神的女人将是血岛恶魔领主的完美祭品……"
...
translate chinese security_64d9bf4f:
    ...
    enemy_general.char "好吧，我向你保证。我要离开赞。"
...
translate chinese kidnap_tip_7423ebaa:
    ...
    "那个男人带你去哪里找[girl.fullname]。在{b}[loc.name]{/b}附近。"
...
translate chinese kidnap_rescue_62968ca6:
    ...
    "你到达[loc]。这就是[girl.fullname]被关押的地方。"
...
translate chinese kidnap_rescue_5c5d18ea:
    ...
    "按照告密者的指示，你开始寻找巢穴的入口，[girl.fullname]被关押的地方。"
...
translate chinese kidnap_rescue_1ce9ffeb:
    ...
    "食人魔就是无情地操[girl.fullname]，他的大鸡巴弄脏了她的内脏。"
...
translate chinese kidnap_rescue_922e8855:
    ...
    "一个叛逆的恶魔在操[girl.fullname]。在她的屁股上，喷出黏稠的怪物精液。"
...
translate chinese kidnap_rescue_807b0341:
    ...
    "一个卫兵在嘲笑[girl.fullname]，当她被一个奇怪的装置戏弄和操的时候。"
...
translate chinese kidnap_rescue_3057cbf5:
    ...
    "你破门而入，刺穿食人魔的剑，刺穿他的内脏。当他大声向后倒在尘土中死去时，他的眼睛里充满了惊讶。"
...
translate chinese kidnap_rescue_56eb5a18:
    ...
    "你砰地一声关上门，结果却弄伤了肩膀。那声音惊动了你的敌人，你可以听到[girl.fullname]低沉的尖叫声，她正在被拖走。"
