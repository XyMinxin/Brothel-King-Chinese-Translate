...
label init_items():
    python:
        ...
        all_items = [
                    ...
                    Item(name = '束发夹', target = 'girl', type = IT_Accessory, pic = 'Hairpin.webp', rank = 1, rarity = 4, price = 2500, effects = (Effect('change', 'masseuse results', 1), ), ),
                    ...
                    Item(name = 'Cimerian 废料', target = 'misc', type = IT_Misc, pic = 'Cimerian scrap.webp', sound=s_vibro, template = False, rank = 1, max_rank = 5, rarity = 1, charges = 1, price = 250, effects = (), description = "一件神秘的古代科技的垃圾。"),
                    Item(name = 'Cimerian 文物', target = 'misc', type = IT_Misc, pic = 'Cimerian artefact.webp', sound=s_vibro, template = False, rank = 1, max_rank = 5, rarity = 4, charges = 1, price = 1000, effects = (), description = "一件神秘的古代机械。也是...垃圾..."),
        ...
        extractor_items = {"extractor1" : Item(name="萃取器 Mk I", target="MC", type=IT_Story, pic="extractor1.webp", template = False, rarity = "S", price = 5000, effects=[], description = "这个奇怪的蒸汽机可以让你自动收获木材、染料或皮革。在产地部署。"),
                           "extractor2" : Item(name="萃取器 Mk II", target="MC", type=IT_Story, pic="extractor2.webp", template = False, rarity = "S", price = 25000, effects=[], description = "这个奇怪的蒸汽机可以让你自动收获大理石、丝绸或矿石。在产地部署。"),
                            }
...
#                       Item(name = "Steel Makibishi", target = 'MC', type = IT_Story, pic = 'steel makibishi.webp', template = False, rank = 3, rarity = "S", price = 1500, description = "Slows down Kunoichi movements during ninja hunt (large effect).", hidden_effect = True),
        ...
        blue_ribbon = Item(name = "Homura的缎带", target = 'MC', type = IT_Story, pic = 'blue ribbon.webp', template = False, rank = 1, rarity = "S", price = 0, pic_dir="necklace", description = "Henso女士给你的一条丝带。把它系在城市{b}广场{/b}的一个柱子上，让她知道你想见她。", hidden_effect = True)
        ...
        template_items =   [
                            ...
                            Item(name = '体操制服', target = 'girl', type = IT_Dress, pic = 'Pompom uniform.webp', template = True, rank = 1, max_rank = 6, rarity = 1, price = 400, effects = (Effect('change', 'beauty', 5), Effect('change', 'charm', 5), Effect('change', 'body', 5), Effect('change', 'refinement', -5), ), ),
...
label init_furniture():
    ...
    python:
        all_furniture = [
            ...
            Furniture('Weapon rack', type='Utilities', pic='weapon rack1.webp', rank=2, chapter=2, cost=[('dye', 2), ('leather', 4), ], duration=1, effects=[Effect("change", "defense", 1, scope="brothel")], ),
            Furniture('Weapon rack XL', type='Utilities', pic='weapon rack2.webp', rank=4, chapter=6, cost=[('wood', 6), ('marble', 10), ('ore', 12), ], duration=3, upgrade='Weapon rack', effects=[Effect("change", "defense", 2, scope="brothel")], ),
