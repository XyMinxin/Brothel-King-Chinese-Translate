...
label sill_first_time:
    ...
    show bg sill finger with fade

    play sound "moans7.wav" loop fadein 1.0
...
label sill_public:
    ...
    show bg sill bj with fade

    play sound "sucking.wav" fadein 1.0
...
label resume_intro:
    ...
    play music "wind.wav" fadein 2.0
...
#        show drogon at truecenter with dissolve
    ...
    play sound "steps.wav" fadein 0.5 fadeout 0.5
    ...
    if MC.playerclass == "Trader":
        ...
        play sound "roar.mp3" fadein 1.0 fadeout 1.0
        drogon "Rrrrh!"
...
#    play sound "steps.wav" fadein 0.5 fadeout 0.5
    ...
    play music "omerta.wav" fadein 2.0 fadeout 2.0
    ...
    gio "They say even King Pharo I is the pawn of a powerful brothel master, a fellow by the
     name of Cloud. Even I have never met him, however."
...
label resume_intro4:
    ...
    menu:
        ...
        "Stop it already!":
            ...
            play sound "moans8.wav" loop fadein 3.0
...
label day1:
    ...
    play music "snake charmer.mp3" fadein 3.0
...
label slavemarket_first_time:
    ...
    if MC.get_alignment() == "good":
        ...
        you "She is a stupid whore, but her skills are lacking. Maybe I'll use her later, as a cum
...
label main_first_time:
    ...
    $ renpy.show(room.name, at_list = [top])
    with dissolve
