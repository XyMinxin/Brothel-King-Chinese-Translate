...
label farm_meet_goldie_menu():
    ...
    menu:
        ...
        "A curse?" if menu_answers["curse"]:
            ...
            goldie "I don't know what he found in there. After an hour, he ran out, his eyes burning, raving like a mad man. His hair had turned completely white."
...
label stella_secret1():
    ...
    blood1 "I believe someone mentioned a party? ♥"
...
label farm_meet_willow():
    ...
    show sewer_monster:
        linear 0.5 xoffset -100 yoffset 75
...
#                linear 1.0 zoom 1.0
    ...
    show sewer_monster:
        linear 0.5 xalign 0.5 yalign 1.0 zoom 2.0
    ...
    show sewer_monster:
        linear 0.5 xoffset -50 yoffset 150 zoom 3.0
    ...
    show willow behind sewer_monster with dissolve:
        zoom 0.85 xalign 0.1 yalign 0.4
    ...
    stop music fadeout 3.0
    hide sewer_monster with dissolve

    you "It... It worked..."

    you "Wait... What?"

    show sewer_monster happy at truecenter with dissolve:
        xoffset -100 yoffset 75
...
label willow_recovery():
    ...
    if not NPC_willow.flags["first recovery"]:
        ...
        willow "Gee, you can't do anything for yourself in this situation... I guess I'll have to rub it for you... ♥"
        ...
        "Greet her":
            ...
            if not NPC_willow.flags["chat relative"]:
                ...
                if MC.god == "Arios":
                    ...
                    relative "Oh, I'm so glad you said that! ♥"
...
label farm_gizel_introduction():
    ...
    scene bg gizel_sex1 with dissolve
    ...
    scene bg gizel_sex2 with dissolve
    ...
    scene bg gizel_sex3 with dissolve
    ...
    scene bg gizel_sex4 with dissolve
    ...
    scene bg gizel_sex5 with doubleflash
    ...
    gizel blush "[MC.name], I have a favor to ask. ♥"
    ...
    gizel blush "Perfect. We have a deal, then, see ya! ♥"
...
label farm_first_monster():
    ...
    scene bg gizel_monster1_1 with fade
...
label farm_first_machine():
    ...
    scene bg gizel_machine1 with fade
    ...
    scene bg gizel_machine2 with dissolve
    ...
    scene bg gizel_machine3 with dissolve
    ...
    scene bg gizel_machine3 with vpunch
    ...
    scene bg gizel_machine4 with dissolve
    ...
    scene bg gizel_machine5 with doubleflash
    ...
    scene bg gizel_machine6 with flash
...
label farm_first_stallion():
    ...
    scene bg gizel_big2 with dissolve
    ...
    scene bg gizel_big3 with dissolve
    ...
    scene bg gizel_big4 with dissolve
    ...
    scene bg gizel_big5 with doubleflash
...
label satella_first_visit(): # Happens when visiting the thieves guild after the letter event is complete
    ...
    scene bg satella casting at quake
    ...
    satella "Ok then! Let's move on with the game. ♥"
...
label satella_game(game_type="the guessing game"):
    ...
    if game_type == "tag":
        ...
        satella "They don't like to get out in the light, you see... See ya! ♥"
...
label satella_thunderbolt():
    ...
    scene bg satella casting with fade
...
label satella_won():
    ...
    scene bg satella sit1 with fade
...
label satella_lost():
    ...
    scene bg satella stunned1 with fade
...
label shalia_visit(): # Happens in the morning a week after Satella's love reaches 75 (second sex). After this event, game night invitations will stop being sent
    ...
    scene bg shalia fj1 with dissolve
    ...
    scene bg shalia fj3 with flash
    ...
    scene bg shalia fj4 with doubleflash
...
label kosmo_returns2(): # Happens every 7-9 days (yes, Kosmo IS annoying)
    ...
    if girl == "kosmo_girl_magic":
            ...
            you "Yes, I'm sure you love to jerk off in front of 20 dudes..."
...
label no_money():
    ...
    if MC.loan: # Bankrupcy
        ...
        banker "The bank will seize all of your property, and throw you out. You'll get nothing. ♥"
        ...
        banker "All right, time is money, see you in [MC.loan.duration] days! Don't forget to pay me or I'll seize all your goo-oods! ♥"
    ...
    if NPC_banker.flags["first loan"]:
        ...
        if r == "back":
            ...
            if renpy.call_screen("yes_no", "你想接受终极贷款，'TJB专项'吗？你所有的钱都会被拿走，你必须在7天内赚回10万金币，否则将失去一切。"):
                ...
                banker "Either way, I'm in for a lot of fun! ♥"
                ...
                banker "I'll see you in 7 days... Don't disappoint me! ♥"
...
label tjb_special():
    ...
    if MC.gold < 100000: # Failure
        ...
        banker "Maybe you will get lucky this time? I'll be waiting... ♥"
...
label loan_repaid():
    ...
    if NPC_banker.love >= 15:
        banker "That's good, I wouldn't want to put my favorite customer in debtor prison! ♥"
...
label banker_special1():
    ...
    banker "It's strong and salty... My favorite! ♥"
...
label banker_special2():
    ...
    banker "But the night is still young... Come here! ♥"
...
label treasure_girl_sex(who, pic):
    ...
    show expression "events/" + pic at top
    with dissolve
...
label meet_gurigura():
    ...
    gurigura "Customers, customers! YAY! Welcome!!! ♥"
...
label meet_giftgirl():
    ...
    show giftgirl:
        ...
        ease 0.5 zoom 4.0 xoffset 150 yoffset 1000
        pause 0.5
