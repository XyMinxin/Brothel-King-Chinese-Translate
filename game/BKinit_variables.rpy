...
#                            "extremely reluctant" : 100, # (obsolete)
    ...
    free_interact_dict = {
                            ...
                            "GENERAL TOPICS" : [GirlInteractionTopic("chat", "chat", "闲聊", "free_chat_small_talk"),
                            ...
                            "SEXUAL TOPICS" : [
                                                ...
                                                GirlInteractionTopic("flirt", "chat about sex", "ＳＭ　　　", "free_flirt_sex_act", act="fetish", love_test=55),
                            ...
                            "OFFER" : [GirlInteractionTopic("give", "offer", "为她提供工作", "free_offer_job", love_test=90, relationship_level=5),],
...
init -4 python:
    ...
    chapter_gossip = {1 : [
                      ...
                      "c1_neutral" :[
                                    ...
                                    "莱迪队长看起来和老队长一样精明，但至少她保持低调. 激战对生意不好.",
                      ...
                      "c2_kunoichi" :[
                                    "听说过'Kunoichi'吗？一个由女忍者组成的秘密组织... 这真是太热了!",
...
#                        "roll_critical success" : "\n{color=[c_green]}%s did everything she could to please the customers.{/color}",
                        ...
                        "masseuse_very good" : "\n{color=[c_green]}当%s给顾客进行热情的全身按摩时浴巾滑落. 她用手和舌头的样子使他们兴奋起来，而他们等待着下一个轮到自己.",
