...
#### RANDOM TIPS ####
    ...
    random_tips = [
                    ...
                    "When you feel like you've seen it all, you can disable some night events in the H preferences menu.",
                    "Don't like the random name generation? You can disable it in the H preferences menu.",
                    "Not into some of the more hardcore acts? Disable them in the H preferences menu.",
                    ...
                    "Pressing the 'Esc' or 'O' key will bring out the Options menu",
    ...
    god_description = {
                        "Arios" : "You worship Arios, god of Light and lord of the Angels.",
                        "Shalia" : "You worship Shalia, goddess of Shadows and ruler of the Night.",
                        None : "You do not worship any god, and delight instead in the wonders of the natural world."
                        }

    alignment_description = {
                            "good" : "Your actions have shown you to be a good person. Love-based interactions with your girls are more successful than fear-based ones.",
                            "evil" : "You are an evil man, and revel in your own cruelty. Fear-based interactions with your girls are more successful than love-based ones.",
                            "neutral" : "You are neutral, and would rather maintain balance between your own interests and those of others. Love and fear-based interactions are equally successful."
                            }
    ...
    sorter_dict = {
                    "alpha" : ["A-z", "name", "name"],
                    "badge" : ["Bdg", "badge", "badge"],
                    "price" : ["0-9", "price", "price"],
                    "type" : ["Typ", "filter", "item type"],
                    "level" : ["Lvl", "level", "girl level"],
                    "rank" : ["Rk", "rank", "slave rank"],
                    "job" : ["Job", "job_sort_value", "girl job"],
                    "experience" : ["Tr.", "training_value", "sexual training level"],
                    }
...
init -4 python:
    ...
    farm_holding_dict = {"libido" : "Tending to minions (Lib)",
...
#                        "group result bad" : "{color=[c_lightred]}%s cried and screamed as the %ss took turns violating her body.{/color} Gizel kept tauting her during the whole ordeal as she sobbed silently.",
                        ...
                        "holding obedience" : "Gizel sent %s to clean up the farm, telling her to scrub every corner of the barn and wash the multiple stains on the floor. %s did what she was asked, rather than face the threat of Gizel's magical lash.",
                        "holding constitution" : "Gizel made %s run laps around the back on the horsetrack, giving %s vicious swats with a riding crop whenever she caught her slowing down.",
                        "holding sensitivity" : "Gizel used %s as her personal servant to pursue her perverted fantasies, forcing her to lick her body and use various toys on her hungry holes. It was tough, but %s learnt new things.",
                        "holding libido" : "Gizel asked %s to tend to the minions: feeding them, cleaning them, and helping them 'release their stress'. %s learnt a good deal about the minions' peculiar anatomy as she worked.",
    ...
    minion_adjectives = {"stallion" : ["erect", "drooling", "horny", "well-built", "snorting", "bulky", "nickering", "sleazy"],
    ...
    shopgirl_comment = {"wood" : "New shelf, perfect!", "leather" : "Great! This leather basket will fit nicely in the entrance.",
                        ...
                        "diamond" : "A girl's best friends... You've got style, handsome! And so does my new diamond-encrusted display... ♥"}
...
#    base_interaction_limits = [-50, -15, 15, 50]
    ...
    mood_description = {
                        ...
                        "change +++" : "Her mood is {b}improving fast{/b}",
                        "change ++" : "Her mood is {b}improving{/b}",
                        "change +" : "Her mood is {b}improving a little{/b}",
                        "no change" : "Her mood is {b}stable{/b}",
                        "change -" : "Her mood is {b}worsening a little{/b}",
                        "change --" : "Her mood is {b}worsening{/b}",
                        "change ---" : "Her mood is {b}worsening fast{/b}",
                        }
