...
label fight_attempt(girl, act=None, intensity=1): # Returns True or False, which is set in the '_return' variable
...
#        $ inter.init = topic.type
#        $ inter.type = topic.label # GirlInteraction variables should be renamed (to avoid confusion with the var 'type')

#        $ renpy.say("", str(inter.init) + " [inter.type]")
...
label slave_chat_init(girl, type):
...
#         $ text1 = rand_choice(("W-what... What do you want me to do?", "Please, Master, don't hurt me...", "Training? S-sure..."))

#     elif girl.love >= girl.fear + 10:

#         $ text1 = rand_choice(("Training? I hope it's gonna be fun!", "Will you train me today, Master? I'm happy!", "Anything you want, Master."))

#     else:
#         $ text1 = rand_choice(("...", "Tell me what to do.", "What should I do, Master?", "What do you want me to do?"))
...
#    scene black
    ...
    $ renpy.say("", fix_description[fix.name + " intro"] % girl.name)
...
label slave_train_obedience(girl):
    ...
    if dice(6) + MC.get_charisma() >= diff:
        ...
        $ girl.track_event("bad result", ("poor", "chores"))
...
label slave_train_constitution(girl):
    ...
    if dice(6) + MC.get_strength() >= diff:
        ...
        $ girl.track_event("bad result", ("poor", "out"))
...
label slave_advanced_training(girl, act, step):
    ...
    if fix != "no fix":
        ...
        $ text1 += fix_description[fix.name + " intro"] % girl.name
...
#            $ text1 = rand_choice(("She is especially aroused by it.", "She blushes red, and you can tell she is getting excited.", "She blushes and bites her lip.", "She looks happy and aroused."))
            $ text1 = fix_description[fix.name + " pos_reaction"]
...
#            $ text1 = rand_choice(("She looks very annoyed.", "She sighs heavily.", "She protests and tries to refuse, but you tell her she must do it."))
            $ text1 = fix_description[fix.name + " neg_reaction"]
...
label slave_do(girl, act): # Receives 'pic' from the previous label
