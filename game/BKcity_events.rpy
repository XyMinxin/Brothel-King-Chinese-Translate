...
#    stop music fadeout 2.0
    ...
    if chal == "stamina":
        ...
        if r < 0:
                ...
                play sound2 "wilhelm.wav"

                you "Ooooh... My back... <holding back tears>"

                play sound "laugh.ogg"
    ...
    if result == -1:
        ...
        play sound "orgasm.wav"

        pause 0.5

        play sound2 "orgasm2.mp3"
...
label city_slave:
    ...
    if result == 0:
        ...
        play sound2 "mmmh.wav"

        slavegirl2 "Mmmmh..."

        slavegirl1 "It's pulsating! It's so warm!"

        play sound2 "surprise.wav"
...
#    stop music fadeout 2.0
    ...
    $ gypsy = ProportionalScale("NPC/encounters/" + pics[0], 560, 600)
...
label city_rob:
    ...
    $ robber = ProportionalScale("NPC/encounters/" + pics[0], 560, 600)
...
label slave_beach_event(): # Happens in Seafront, Beach, lakefront, waterfalls during summer or spring
    ...
    menu:
        ...
        "Have sex with me": #! Add virgin check
            ...
            if girl.obedience_check(act):
                ...
                python:
                    ...
                    if act == "group":
                        act = "sex"
                        nb += 2
                        tip = girl.get_tip(act, "good", [Customer(selected_district.get_rand_pop()), Customer(selected_district.get_rand_pop())])
                        en = 10 # Energy loss is more generous for that event
                    else:
                        nb += 1
                        tip = girl.get_tip(act, "good", [Customer(selected_district.get_rand_pop())])
