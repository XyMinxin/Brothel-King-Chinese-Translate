...
#                         Achievement("Bedded: The Adventurer", "You had sex with Scarlet.", pic="portrait.webp", pic_path="NPC/Jobgirl/", target="h jobgirl"), # Event not ready yet?
                        ...
                        Achievement("A Day At The Farm", "一局游戏中，你的女孩们在农场的训练时间加起来有 %s 天。", pic="beast2.webp", pic_path="NPC/Minions/", level_nb=5, target="farm_days", requirements={1 : 10, 2 : 30, 3 : 90, 4 : 180, 5 : 365}),
                        ...
                        Achievement("Long And Hard", "一局游戏中，玩“妓院之王”的时间为 %s 游戏月。", pic="calendar.webp", pic_path="UI/", level_nb=5, target="months", requirements={1 : 1, 2 : 3, 3 : 6, 4 : 12, 5 : 24}),
                        ...
                        Achievement("爱情鸟", "有 %s 个女孩的爱情值有 %s 或更多。", level_nb=5, pic="heart.webp", pic_path="UI/", target="love", requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 25, 2 : 50, 3 : 75, 4 : 100, 5 : 125}),
                        Achievement("稻草人", "有 %s 个女孩的恐惧值有 %s 或更多。", level_nb=5, pic="skull.webp", pic_path="UI/", target="fear", requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 25, 2 : 50, 3 : 75, 4 : 100, 5 : 125}),
                        Achievement("美貌精通", "有 %s 个女孩的美貌超过 %s 。", pic="portrait.webp", pic_path="NPC/Katryn/", target="Beauty", level_nb=5, requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 50, 2 : 100, 3 : 150, 4 : 200, 5 : 250}),
                        Achievement("身材精通", "有 %s 个女孩的身材超过 %s 。", pic="portrait.webp", pic_path="NPC/Ramias/", target="Body", level_nb=5, requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 50, 2 : 100, 3 : 150, 4 : 200, 5 : 250}),
                        Achievement("魅力精通", "有 %s 个女孩的魅力超过 %s 。", pic="portrait.webp", pic_path="NPC/Gurigura/", target="Charm", level_nb=5, requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 50, 2 : 100, 3 : 150, 4 : 200, 5 : 250}),
                        Achievement("优雅精通", "有 %s 个女孩的优雅超过 %s 。", pic="portrait.webp", pic_path="NPC/Riche/", target="Refinement", level_nb=5, requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 50, 2 : 100, 3 : 150, 4 : 200, 5 : 250}),
                        Achievement("性欲精通", "有 %s 个女孩的性欲超过 %s 。", pic="portrait.webp", pic_path="NPC/Captain/", target="Libido", level_nb=5, requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 50, 2 : 100, 3 : 150, 4 : 200, 5 : 250}),
                        Achievement("服从精通", "有 %s 个女孩的服从超过 %s 。", pic="portrait.webp", pic_path="NPC/Maid/", target="Obedience", level_nb=5, requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 50, 2 : 100, 3 : 150, 4 : 200, 5 : 250}),
                        Achievement("体格精通", "有 %s 个女孩的体格超过 %s 。", pic="portrait.webp", pic_path="NPC/Jobgirl/", target="Constitution", level_nb=5, requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 50, 2 : 100, 3 : 150, 4 : 200, 5 : 250}),
                        Achievement("敏感精通", "有 %s 个女孩的敏感超过 %s 。", pic="portrait.webp", pic_path="NPC/Satella/", target="Sensitivity", level_nb=5, requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 50, 2 : 100, 3 : 150, 4 : 200, 5 : 250}),
                        Achievement("性服侍精通", "有 %s 个女孩的性服侍技能超过 %s 。", pic="portrait.webp", pic_path="NPC/Willow/", target="Service", level_nb=5, requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 50, 2 : 100, 3 : 150, 4 : 200, 5 : 250}),
                        Achievement("性交精通", "有 %s 个女孩的性交技能超过 %s 。", pic="portrait.webp", pic_path="NPC/Goldie/", target="Sex", level_nb=5, requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 50, 2 : 100, 3 : 150, 4 : 200, 5 : 250}),
                        Achievement("肛交精通", "有 %s 个女孩的肛交技能超过 %s 。", pic="portrait.webp", pic_path="NPC/Kosmo/", target="Anal", level_nb=5, requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 50, 2 : 100, 3 : 150, 4 : 200, 5 : 250}),
                        Achievement("皮绳愉虐精通", "有 %s 个女孩的皮绳愉虐技能超过 %s 。", pic="portrait.webp", pic_path="NPC/Stella/", target="Fetish", level_nb=5, requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 50, 2 : 100, 3 : 150, 4 : 200, 5 : 250}),
                        Achievement("终极精通", "有 %s 个女孩的全部技能超过 %s 。", pic="portrait.webp", pic_path="NPC/Sill/", target="ultimate", level_nb=5, requirements={1 : 1, 2 : 2, 3 : 4, 4 : 8, 5 : 16}, requirements2={1 : 50, 2 : 100, 3 : 150, 4 : 200, 5 : 250}),
                        ...
                        Achievement("Gigolo", "说服 %s 位自由女孩加入你的妓院。", pic="empty heart.webp", pic_path="UI/", target="free girl acquired", level_nb=5, requirements={1 : 1, 2 : 4, 3 : 8, 4 : 16, 5 : 32}),
                        Achievement("You Might Get Murdered", "同时拥有十个女朋友。", pic="heart.webp", pic_path="UI/", target="girlfriends", requirements={1 : 10}),
                        Achievement("We Have The Original", "在你的妓院里有 %s 位原始女孩。", pic="license2.webp", pic_path="UI/", target="originals", level_nb=5, requirements={1 : 1, 2 : 4, 3 : 8, 4 : 16, 5 : 32}),

                        Achievement("破产: 乞丐类", "让一名乞丐在妓院里花光所有的钱。", pic="beggar.webp", pic_path="UI/customers/", target="broke beggars"),
                        Achievement("破产: 暴徒类", "让一名暴徒在妓院里花光所有的钱。", pic="thug.webp", pic_path="UI/customers/", target="broke thugs"),
                        Achievement("破产: 劳工类", "让一名劳工在妓院里花光所有的钱。", pic="Laborer.webp", pic_path="UI/customers/", target="broke laborers"),
                        Achievement("破产: 水手类", "让一名水手在妓院里花光所有的钱。", pic="Sailor.webp", pic_path="UI/customers/", target="broke sailors"),
                        Achievement("破产: 平民类", "让一名平民在妓院里花光所有的钱。", pic="Commoner.webp", pic_path="UI/customers/", target="broke commoners"),
                        Achievement("破产: 工匠类", "让一名工匠在妓院里花光所有的钱。", pic="Craftsman.webp", pic_path="UI/customers/", target="broke craftsmen"),
                        Achievement("破产: 中产阶级", "让一名中产阶级在妓院里花光所有的钱。", pic="Bourgeois.webp", pic_path="UI/customers/", target="broke bourgeois"),
                        Achievement("破产: 公会阶级", "让一名公会成员在妓院里花光所有的钱。", pic="Guild Member.webp", pic_path="UI/customers/", target="broke guild members"),
                        Achievement("破产: 骑士阶级", "让一名骑士阶级在妓院里花光所有的钱。", pic="Patrician.webp", pic_path="UI/customers/", target="broke patricians"),
                        Achievement("破产: 男爵阶级", "让一名男爵阶级在妓院里花光所有的钱。", pic="aristocrat.webp", pic_path="UI/customers/", target="broke aristocrats"),
                        Achievement("破产: 伯爵阶级", "让一名伯爵阶级在妓院里花光所有的钱。", pic="Noble.webp", pic_path="UI/customers/", target="broke nobles"),
                        Achievement("破产: 国王阶级", "让一名国王阶级在妓院里花光所有的钱。", pic="Royal.webp", pic_path="UI/customers/", target="broke royals"),
                        Achievement("完美: 乞丐类", "让一名乞丐在妓院里达到最大的满足。", pic="beggar.webp", pic_path="UI/customers/", target="happy beggars"),
                        Achievement("完美: 暴徒类", "让一名暴徒在妓院里达到最大的满足。", pic="thug.webp", pic_path="UI/customers/", target="happy thugs"),
                        Achievement("完美: 劳工类", "让一名劳工在妓院里达到最大的满足。", pic="Laborer.webp", pic_path="UI/customers/", target="happy laborers"),
                        Achievement("完美: 水手类", "让一名水手在妓院里达到最大的满足。", pic="Sailor.webp", pic_path="UI/customers/", target="happy sailors"),
                        Achievement("完美: 平民类", "让一名平民在妓院里达到最大的满足。", pic="Commoner.webp", pic_path="UI/customers/", target="happy commoners"),
                        Achievement("完美: 工匠类", "让一名工匠在妓院里达到最大的满足。", pic="Craftsman.webp", pic_path="UI/customers/", target="happy craftsmen"),
                        Achievement("完美: 中产阶级", "让一名中产阶级在妓院里达到最大的满足。", pic="Bourgeois.webp", pic_path="UI/customers/", target="happy bourgeois"),
                        Achievement("完美: 公会阶级", "让一名公会成员在妓院里达到最大的满足。", pic="Guild Member.webp", pic_path="UI/customers/", target="happy guild members"),
                        Achievement("完美: 骑士阶级", "让一名骑士阶级在妓院里达到最大的满足。", pic="Patrician.webp", pic_path="UI/customers/", target="happy patricians"),
                        Achievement("完美: 男爵阶级", "让一名男爵阶级在妓院里达到最大的满足。", pic="aristocrat.webp", pic_path="UI/customers/", target="happy aristocrats"),
                        Achievement("完美: 伯爵阶级", "让一名伯爵阶级在妓院里达到最大的满足。", pic="Noble.webp", pic_path="UI/customers/", target="happy nobles"),
                        Achievement("完美: 国王阶级", "让一名国王阶级在妓院里达到最大的满足。", pic="Royal.webp", pic_path="UI/customers/", target="happy royals"),

                        Achievement("特质树: 女仆", "在一名女孩上解锁女仆特质树上的所有特质分支。", pic="The Maid portrait.jpg", pic_path="perks/", target="The Maid"),
                        Achievement("特质树: 优伶", "在一名女孩上解锁优伶特质树上的所有特质分支。", pic="The Player portrait.jpg", pic_path="perks/", target="The Player"),
                        Achievement("特质树: 模特", "在一名女孩上解锁模特特质树上的所有特质分支。", pic="The Model portrait.jpg", pic_path="perks/", target="The Model"),
                        Achievement("特质树: 花魁", "在一名女孩上解锁花魁特质树上的所有特质分支。", pic="The Courtesan portrait.jpg", pic_path="perks/", target="The Courtesan"),
                        Achievement("特质树: 伴游", "在一名女孩上解锁伴游特质树上的所有特质分支。", pic="The Escort portrait.jpg", pic_path="perks/", target="The Escort"),
                        Achievement("特质树: 狐娘", "在一名女孩上解锁狐娘特质树上的所有特质分支。", pic="The Fox portrait.jpg", pic_path="perks/", target="The Fox"),
                        Achievement("特质树: 荡妇", "在一名女孩上解锁荡妇特质树上的所有特质分支。", pic="The Slut portrait.jpg", pic_path="perks/", target="The Slut"),
                        Achievement("特质树: 新娘", "在一名女孩上解锁新娘特质树上的所有特质分支。", pic="The Bride portrait.jpg", pic_path="perks/", target="The Bride"),
