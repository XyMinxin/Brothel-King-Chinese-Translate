...
## START NERD DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_origins", ("nerd", "pervert", "loyal", "superficial"), ("It's a long and boring story. 我来自[girl.origin]。", "[girl.origin]. You really don't want to hear much more about that."), max_cap=40)
    ...
    add_dialogue("free_chat_likes", ("nerd", "class president"), ("I love learning more about [thing_cn]. Especially [best].", "I am fascinated by every kind of [thing_cn], but I find [best] especially interesting."), love=1, max_cap=40)
    add_dialogue("free_chat_dislikes", ("nerd", "class president", "repressed"), ("The more I learn about [thing_cn], the more I realise how terrible [worst] is.", "Whenever [worst] is mentioned I get annoyed. Any other [thing_cn] would be preferred."), love=2, max_cap=40)
    ...
    add_dialogue("free_joke_adult", ("nerd", "meek"), ("I'm sorry, that's making me uncomfortable. 我们能不能谈点别的？"), love=-1, max_cap=50)
    ...
    add_dialogue("free_play refuses", ("nerd", "yandere", "loyal", "class president"), ("Aaauh. *发狂* Why would you even ask me that?!"), love=-1)
    add_dialogue("free_play very reluctant", ("nerd", "loyal"), ("Huaaah. P-Please, I'm begging you, not this..."), love=1)
    add_dialogue("free_play reluctant", ("nerd"), ("*脸红* T-this is sexual harassment, you realize?"), love=2)
    ...
    add_dialogue("free_play indifferent", ("nerd"), ("I, erm... I'm not afraid to say I imagined us doing this together. *脸红*"), love=3)
    ...
    add_dialogue("free_play very interested", ("nerd", "pet", "class president", "generic"), ("*脸红* 好的。 I can feel myself getting wet already."), love=5)
    add_dialogue("free_play fascinated", ("nerd", "pet", "class president"), ("*脸红* My heart just won't stop racing. I love it."), love=5)
    ...
    add_dialogue("free_play interested after", ("nerd", "pet"), ("That was fascinating! We should try it again.", "Let's do this more often.", "You were amazing! *脸红*", "That was fantastic! *脸红*"))
    add_dialogue("free_play not interested after", ("nerd"), ("I didn't like that at all.", "*叹气* Disappointing.", "Hmm... Once again reality pales in comparison to the stories.", "I got nothing out of that."))
    ...
    add_dialogue("free_flirt_body", ("nerd", "sweet", "repressed"), ("Shut up! Who wants to hear lewd comments like that! *发狂*"), max_cap=75)
    add_dialogue("free_flirt_mind", ("nerd", "class president"), ("Th-谢谢。 I suppose I am compared to most girls.", "*咧嘴笑* You're right about that.", "*smile* Thank you!"), love=3, max_cap=75)
    ...
    add_dialogue("free_flirt_sex_experience very experienced", ("nerd"), ["She giggles and sticks her tongue out.", "g: *傻笑* I could write a book about all the things I've done. If I did, it might just become a bestseller in Zan."], multiple=True, love=3)
    ...
    add_dialogue("free_flirt_sex_experience average", ("nerd"), ["她脸红了。", "g: Well, I love to learn more about those kinds of things... And I've had a few different partners to study with over the years."], multiple=True, love=1)
    ...
    add_dialogue("free_flirt_sex_experience reply_waiting success", ("nerd"), ["g: *傻笑* That's adorable, you know that?", "g: It's like you've come straight out of a fairytale. There's nothing wrong with a prince like yourself waiting for his perfect princess."], multiple=True, love=3)
    ...
    add_dialogue("free_flirt_sex_experience reply_not_many success", ("nerd"), ["g: *傻笑* That's adorable, you know that?", "g: It's like you've come straight out of a fairytale. There's nothing wrong with a prince like yourself waiting for his perfect princess."], multiple=True, love=4)
    ...
    add_dialogue("free_flirt_sex_experience reply_been_around", ("nerd"), ("*叹气* So you're just like all the others... Disappointing..."), love=-1)
    add_dialogue("free_flirt_sex_experience reply_sex_god success", ("nerd"), ["g: *欢笑* You sound very sure of yourself. So you're an expert, huh?", "g: Maybe you could give me some lessons one day."], multiple=True, love=1)
    add_dialogue("free_flirt_sex_experience reply_sex_god failure", ("nerd"), ["g: It's easy to tell that you're mixing up fact and fiction.", "g: *叹气* All I'll say is that modesty is a virtue."], multiple=True)
    add_dialogue("free_flirt_sex_experience reply_brothel_owner", ("nerd"), ["g: *叹气* Don't remind me.", "g: Just thinking about the kinds of girls you're involved with there makes me sick. Have some standards."], multiple=True, love=-1)

    add_dialogue("free_flirt_sex_act refuses", ("nerd", "stubborn"), ("不要！ I don't think it'll be worth my time."))
    ...
    add_dialogue("free_flirt_sex_act interested", ("nerd", "pet"), ("*脸红* I don't know what it is, but just talking about it with you puts me in a good mood."), love=2)
    add_dialogue("free_flirt_sex_act a little interested", ("nerd"), ("*脸红* I do, but I won't tell you any details."), love=2)
    add_dialogue("free_flirt_sex_act very interested", ("nerd"), ("*脸红* Sure. I fantasize about doing it in public. My heart just won't stop racing, knowing I might get caught!"), love=3)
    add_dialogue("free_flirt_sex_act fascinated", ("nerd", "repressed"), ("*脸红* I-I think I'd die of embarrassment if I answered that! *whispers* {i}The answer is yes.{/i}"), love=3)
    ...
    add_dialogue("free_give_gold +", ("nerd", "meek", "cold"), ("Th-谢谢。"), love=1, max_cap=75)
    ...
    add_dialogue("free_offer_job no_lie", ("nerd", "cold", "sweet", "very idealist"), ["她用新的决心看着你。", "g: Me? A whore? Isn't there any other way...", "g: I'm glad you told me the truth about your job. It gave me time to think it over.", "g: Do you... think I could do it?"], multiple=True, love=2)
    ...
    add_dialogue("free_offer_job thinking", ("nerd"), ["g: *叹气* ...I am actually a little curious about it if I'm honest.", "g: I need some time to think about this. To consider my options.", "mc: Sure, take your time [girl.name]. See you soon."], multiple=True)
    add_dialogue("free_offer_job failure lie", ("nerd"), ["g: 不要！.. I'm not going to sign your slave contract. Don't be ridiculous.", "g: This plot twist is really bumming me out. Our story was so interesting up until this moment.", "mc: Think it over, will you?", "g: I have to go. I need some time alone... Some time away from {i}you{/i}. *发狂*"], multiple=True, love=-15)
    add_dialogue("free_offer_job failure no_lie", ("nerd"), ["g: 不要！.. I'm not going to sign your slave contract. Don't be ridiculous.", "g: This plot twist is really bumming me out. Our story was so interesting up until this moment.", "mc: Think it over, will you?", "g: I have to go. I need some time alone... Some time away from {i}you{/i}. *发狂*"], multiple=True, love=-15)

    add_dialogue("free_friend no_lie", ("nerd"), ["g: Yikes... Not exactly a dream job, is it?.", "mc: *欢笑* You would be surprised. Some would absolutely consider it a dream job.", "g: Those people are delusional. Brothels may sound fun, but you and I both know they attract the worst kinds of people.", "mc: Oh, I know how to keep them in line. That goes for my girls as well as my customers. So what is your dream job then?", "g: Hmm... Guess you've got me there. I don't really have one..."], multiple=True, love=-6)
    ...
    add_dialogue("free_friend lie", ("very introvert"), ["她冰冷地看着你。", "g: Is that so? Strange. I've never heard of you. Are you telling me the truth?", "mc: Well, uh... Oh, look at the time, haha! I really need to go."], multiple=True, love=2)
    ...
    add_dialogue("free_ask_out", ("nerd"), ["mc: [girl.name], I would love to be your prince and have you by my side.", "g: 你想让我......做你的女朋友？", "mc: Nothing would make me happier.", "g: Oh, [MC.name]! I feel as if I'm dreaming. Is this really happening? I mean... Yes! My answer is yes, of course!", "She throws herself into your arms and gives you a long, deep kiss.", "g: I have to go for now... But I'll see you around soon, handsome prince! *眨眼*"], multiple=True)

    add_dialogue("free_girlfriend intro", ("nerd"), ["g: Ah, [MC.name]! I need your help with something...", "mc: Hello, [girl.name]. How can I help?", "g: I've started writing this novel... And I'm stuck at a particular scene. I figured that if we could act it out, perhaps that will get the ideas flowing.", "mc: Why, sure... What's it about.", "g: *傻笑* Well, it's an erotic tale. There's this girl who is madly in love with a handsome prince.", "g: There's a real connection between them. They have a lot in common... Such as... Can you guess?"], multiple=True)
    add_dialogue("free_girlfriend right", ("nerd"), ["g: *眨眼* That's exactly right. Art immitates life.", "g: So at this point in the story, there is an incredible sexual tension between the girl and the prince. And the girl decides to make her move. *咧嘴笑*", "mc: Oh, I like where this is going."], multiple=True, love=5)
    add_dialogue("free_girlfriend give_up", ("nerd"), ("At least try to guess... *皱眉* I suppose you're not that interested in my story, huh?"), love=-5)
    add_dialogue("free_girlfriend wrong", ("nerd"), ["g: No! *发狂* That would make a terrible story. Who would believe that?", "mc: Oh, my bad..."], multiple=True, love=-10)
    ...
    add_dialogue("free_job_request", ("very introvert"), ["g: Hi, [MC.name].", "mc: Hi, [girl.name].", "g: Can I work for you?", "mc: Uh?", "g: I said, can I work for you? I need the money. How hard can it be, anyway?", "mc: 嗯... That's an unexpected request... Let me think about it."], multiple=True)
    ...
    add_dialogue("slave chat tastes likes", ("nerd", "class president"), ("I love learning more about [thing_cn]. Especially [best].", "I am fascinated by every kind of [thing_cn], but I find [best] especially interesting."), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("nerd", "class president", "repressed"), ("The more I learn about [thing_cn], the more I realise how terrible [worst] is.", "Whenever [worst] is mentioned I get annoyed. Any other [thing_cn] would be preferred."), unlock="LM")
    add_dialogue("slave chat origins 1", ("nerd", "pervert", "loyal", "superficial"), ("It's a long and boring story. 我来自[girl.origin]。", "[girl.origin]. You really don't want to hear much more about that."), unlock="EI")
...
## START MASOCHIST DIALOGUE 03.February.2022
    ...
    add_dialogue("free_greetings_rude", ("masochist", "helper", "rebel"), ("Hwah... *脸红* My eyes are up here, perv! I'm [girl.fullname].","I'm [girl.fullname]. Is there anything you want from me?"), love=2)
    ...
    add_dialogue("free_chat_likes", ("masochist", "meek"), ("Why would you be interested in my favorite [thing_cn]? I feel like a bug under a microscope. Uhm... [best], I guess?", "The [thing_cn] [best] is okay. Can we talk about something else instead?"), max_cap=40)
    add_dialogue("free_chat_dislikes", ("masochist", "loyal", "helper"), ("I'm one of those girls who hates the [thing_cn] [worst].", "Don't hate me for this, but I think [worst] is a terrible [thing_cn]."), love=2, max_cap=40)
    ...
    add_dialogue("free_joke_adult", ("masochist", "helper"), ("*脸红* Th-That's enough, okay?! What if someone heard you...", "*脸红* D-don't joke about something like that."), love=1, max_cap=50)
    ...
    add_dialogue("free_touch_hand", ("masochist", "meek", "repressed", "pet", "prude"), ("Just the two of us... It's so romantic!", "*脸红* This is kinda embarrassing...", "Mmm... There's something reassuring about holding hands like this."), love=2, max_cap=90)
    ...
    add_dialogue("free_touch_ass", ("masochist", "pervert", "helper"), ("Eek?! Wh-What the hell! *脸红* ...D-do that again.", "Aahh!! *脸红* Hit me harder.", "Ah! I get really excited when you're so aggressive.", "Ah! *脸红* I like it when you take control.", "Ahhn, stop, it feels way too good! *gasp*, ah! You meanie!"), love=4, max_cap=90)
    ...
    add_dialogue("free_play very reluctant", ("masochist", "creep"), ["g: Ah... S-Sorry, but this is so sudden. I don't know what to say...", "g: *脸红* I want you to {i}force{/i} me. Can you use your belt?"], multiple=True, love=1)
    add_dialogue("free_play reluctant", ("masochist", "creep"), ("*gasp* T-that?! It's not like I'm against it...but still."), love=2)
    add_dialogue("free_play a little reluctant", ("masochist", "creep"), ("*脸红* If I start screaming or crying... P-please just continue."), love=2)
    add_dialogue("free_play indifferent", ("masochist", "creep"), ("Sure... *脸红* C-can you choke me during?"), love=3)
    ...
    add_dialogue("free_flirt_sex_experience virgin", ("masochist"), ("No! I haven't been used yet. *咧嘴笑*"), love=1)
    ...
    add_dialogue("free_flirt_sex_experience reply_not_many success", ("masochist"), ("Maybe I'll show you just how depraved it can get. *眨眼*"), love=2)
    ...
    add_dialogue("free_flirt_sex_experience reply_been_around", ("masochist"), ("I'm sure you have, but here's a little secret... I'm not like the others. *眨眼*"), love=3)
    add_dialogue("free_flirt_sex_experience reply_sex_god success", ("masochist"), ["她舔了舔嘴唇。", "g: Oh, are you? Now I'm getting curious..."], multiple=True, love=4)
    ...
    add_dialogue("free_flirt_sex_act interested", ("masochist", "creep"), ("*咧嘴笑* I'm okay with it, but I would probably want to spice it up a bit... With handcuffs, for example."), love=2)
    ...
    add_dialogue("free_offer_job success", ("masochist"), ["g: I can even officially become your slave? That's a fantastic offer! I'll take it.", "g: Will you promise to punish me when I get out of line? *欢笑*"], multiple=True)
    add_dialogue("free_offer_job thinking", ("masochist"), ["g: I can even officially become your slave? That's a fantastic offer! I can't wait!", "g: Will you promise to punish me when I get out of line? *欢笑*", "g: But before we sign the paperwork, I need to take care of some things on my end... I'll make it quick! Speak to you soon."], multiple=True)
    ...
    add_dialogue("free_friend half_lie", ("masochist"), ["g: Fair enough. You and a thousand other [MC.playerclass]s in Zan. *嘲笑*", "mc: Yes, I've noticed that competition is stiff around here. So do you have a job?", "g: No, not at the moment..."], multiple=True, love=2)
    ...
    add_dialogue("free_girlfriend success", ("masochist"), ["She tears off her clothes and starts crawling around the floor on all fours.", "g: Oink oink... I'm a little piggy... I'm a piece of meat waiting to be slaughtered... Oink oink...", "mc: You applaud her as she parades around the room, naked as the day she was born.","mc: Squeal for me, piggy!", "You spank her ass and she squeals like a pig.", "After a few minutes of fun you allow her to stand up again.", "g: *脸红* Ahaha... I haven't had that much fun in a long while. You know just how to get me going, [MC.name]."], multiple=True)
    add_dialogue("free_girlfriend success naked", ("masochist"), ["She tears off her clothes and starts crawling around the floor on all fours.", "g: Oink oink... I'm a little piggy... I'm a piece of meat waiting to be slaughtered... Oink oink...", "mc: You applaud her as she parades around the room, naked as the day she was born.","mc: Squeal for me, piggy!", "You spank her ass and she squeals like a pig.", "After a few minutes of fun you allow her to stand up again.", "g: *脸红* Ahaha... I haven't had that much fun in a long while. You know just how to get me going, [MC.name].", "mc: That was an impressive performance. Have you done this before?", "g: Ehehe... Yes I have... A few times, alone in my room.", "g: I'm glad you were watching this time. That made it much more exciting. *眨眼*"], multiple=True)
    ...
    add_dialogue("accept farm", ("masochist", "pervert", "libido"), ["The farm... I heard Gizel is doing dirty, dirty things there... *脸红*", "Does that mean... Does that mean I will be locked like an animal? *脸红*", "I know I shouldn't, but... I feel excited somehow..."])
    ...
    add_dialogue("slave chat tastes likes", ("masochist", "meek"), ("Why would you be interested in my favorite [thing_cn]? I feel like a bug under a microscope. Uhm... [best], I guess?", "The [thing_cn] [best] is okay. Can we talk about something else instead?"), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("masochist", "loyal", "helper"), ("I'm one of those girls who hates the [thing_cn] [worst].", "Don't hate me for this, but I think [worst] is a terrible [thing_cn]."), unlock="LM")
...
## START MEEK DIALOGUE 03.February.2022
    ...
    add_dialogue("slave hit", ("meek", "very sub"), ["I'm sorry... *抽泣*"])
    ...
    add_dialogue("slave leave master bedroom love", ("meek", "very sub"), ["She looks disappointed.", "g: 明...明白了，主人... Have I done something wrong?"], multiple=True)
...
## START SWEET DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_likes", ("very extravert", "helper", "creep"), ("Ah, my favorite [thing_cn]? I like [best].", "A favorite [thing_cn]? It's a close call, but I would have to say [best] is the best. *smile*"), love=1, max_cap=40)
    ...
    add_dialogue("free_joke_dark", ("sweet"), ("*smile* That's a weird one!", "*傻笑* You can't just say something like that, can you?"), love=3, max_cap=50)
    ...
    add_dialogue("free_ask_out", ("sweet"), ["mc: [girl.name], I like you. Will you be my girlfriend?", "g: You really want me... to be your girlfriend?", "mc: 是的，可以吗？", "g: Oh, that makes me so happy!! Of course!", "She throws herself into your arms and gives you a long, deep kiss.", "g: I have to go for now... But let's meet again soon, sweetheart! *眨眼*"], multiple=True)
    ...
    add_dialogue("slave chat tastes likes", ("very extravert", "helper", "creep"), ("Ah, my favorite [thing_cn]? I like [best].", "A favorite [thing_cn]? It's a close call, but I would have to say [best] is the best. *smile*"), unlock="LM")
...
## START SUPERFICIAL DIALOGUE 03.February.2022
    ...
    add_dialogue("slave thanks", ("superficial", "very materialist"), ("*傻笑* I deserve it.", "I know, I'm incredible...", "I'm having {i}so{/i} much fun!", "Coming from you, that makes me so happy...", "Wow... Thank you!","Um, wow... Like... Thank you for that."))
    add_dialogue("slave effusive thanks", ("superficial", "generic"), ("Aww, you're going to make me cry... Thank you {i}SO{/i} much!", "*抽泣* Thank you!! I'm just privileged to be in a position to shine, you know?", "Oh master... It feels so good to be appreciated. Thank you {i}so{/i} much!", "Wow... Thank you!","Um, wow... Like... Thank you for that."))
...
## START HELPER DIALOGUE 03.February.2022
    ...
    add_dialogue("free_love_interest", ("helper"), ["mc: Hi, [girl.name]. Is something wrong?", "g: Uh, me? 不要！.. I was just having a chat with one of my very best friends a couple of days ago on a beautiful [season] day...", "g: She had been approached by a very agreeable young man, who brought her a lovely flower.", "g: I was very happy for her, of course...", "g: But deep down it made me wonder, could it ever happen to me? I thought probably not. I even wept a little.", "g: But then she said, maybe that man [MC.name], who you’ve been talking about so much would bring you one!", "g: And I thought, by Arios, maybe that could happen! I feel we’ve become so close and I find talking to you so easy.", "g: Not to put any pressure on you, of course!"], multiple=True)
    ...
    add_dialogue("free_ask_out", ("helper"), ["mc: [girl.name], I like you. But maybe we could be even closer... you know, take this to the next level?.", "g: 你想让我......做你的女朋友？", "mc: That's right.", "g: Why, finally you ask! Of course! I can’t wait to tell about this to all my friends!", "She throws herself into your arms and gives you a long, deep kiss.", "g: I'll do anything to stay by your side and be all yours."], multiple=True)
...
## START HOLY DIALOGUE 03.February.2022
    ...
    add_dialogue("free_flirt_spirit", ("holy"), ("谢谢。 I use my energy to spread the word of Arios.", "Do you really think so? 谢谢。 *smile*", "Arios, did you hear that? This is such a nice compliment. *smile*"), love=2, max_cap=75, sound=s_laugh)
...
## START PRUDE DIALOGUE 03.February.2022
    ...
    add_dialogue("free_play indifferent", ("prude", "very modest"), ["g: *gasp* How dare you, scoundrel!","g: *低语* Don't just blurt it out in public! Let's head to that secluded spot over there."], multiple=True, love=3)
    ...
    add_dialogue("slave hit", ("prude", "very modest"), ("啊！ That really hurt!", "*gasp* How dare you!", "Oww! There's no need for such violence!"))
    ...
    add_dialogue("slave negative fixation accept", ("prude", "very modest"), ("*gasp* That's wrong!", "Ew! That's absolutely revolting!", "*抽泣* I can't believe you're making me do this.", "Ew!! I think I'm going to be sick!"))
...
## START EASY DIALOGUE 03.February.2022
    ...
    add_dialogue("slave whining", ("generic"), ["啊...", "But...", "B-But...", "Uh? Wait...", "Ooh..."])
...
## START PET DIALOGUE 03.February.2022
    ...
    add_dialogue("free_ask_out", ("pet"), ["mc: [girl.name], you are important to me. I want you in my life.", "g: 你想让我......做你的女朋友？", "mc: That's right.", "g: I love you so much!", "She throws herself into your arms and gives you a long, deep kiss.", "g: I have to go. I need to share this great news with everyone!"], multiple=True)
...
## START CLASS PRESIDENT DIALOGUE 03.February.2022
    ...
    add_dialogue("free_flirt_mind", ("class president", "schemer"), ("*smile* I'm happy for the compliment.", "I'm not special, I think you're just a little slow. *嘲笑* But thank you nonetheless."), love=5, max_cap=75)
...
## START LOYAL DIALOGUE 03.February.2022
    ...
    add_dialogue("free_touch_ass", ("loyal", "pet"), ("You like my butt!", "Oh, that’s what you want! Does slapping my ass make you happy? *blushes*", "If you enjoy smacking me, my ass is happy do its duty... *giggles and wiggles*", "哎哟... you spanked me! Naughty... *giggles*"), love=3, max_cap=90)
    ...
    add_dialogue("slave whining", ("loyal", "very idealist", "very sub"), ("啊...", "But...", "B-But...",  "Ooh...", "Aww... please no!"))
    ...
    add_dialogue("slave lecture love", ("loyal", "very idealist"), ("Ooh, what are we going to talk about today, 主人？ *blushes*", "This may sound weird, Master [MC.name]. But I love listening to you talk about pretty much anything!", "It’s cool to have such a knowledgeable Master!", "Ooh, what naughty things do you want to lecture me about today? *giggles*"))
    ...
    add_dialogue("slave reward sex accepted", ("loyal", "very lewd", "very idealist"), ("当然了，主人。Just when I was feeling horny... *smile*", "I feel so hot! Please, take me now, Master! *grins*"), love=2, sound=s_ahaa, unlock="LM")
...
## START YANDERE DIALOGUE 03.February.2022
    ...
    add_dialogue("free_touch_kiss", ("yandere"), ("*咧嘴笑* And thus, the pact is completed.","Hey, listen... If I ever mistreat you, just know that's how I express my love sometimes.","*傻笑* It would be so funny to punch your teeth in right now. Just kidding! *kiss*", "You've lowered your guard... I could easily snap your neck right now. Don't worry, I would never do something like that. I love you. *kiss*"), love=2, max_cap=90)
    ...
    add_dialogue("free_touch_pussy", ("yandere", "creep"), ("Ah... *呻吟* If you keep going my love for you will explode into violence.", "Ah... I can't stop thinking about all the dirty things I want to force you to do...", "Ahh... This pleasure is so divine. It makes me want to hurt people.", "*呻吟* I love you so much, I think I may have to lock you up.", "*gasp* Straight to the point really was the best approach. B-Be gentle..."), love=3, max_cap=90)
...
## START STUBBORN DIALOGUE 03.February.2022
    ...
    add_dialogue("free_flirt_sex_act fascinated", ("stubborn"), ["她舔了舔嘴唇。", "g: Oh my, I love it... you’re making me feel moist between my legs right now! *blushes* I want you to deal with that. *winks*"], multiple=True, love=3)
