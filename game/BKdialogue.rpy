...
init -1 python:
    ...
    add_dialogue("free_touch_pussy", ("meek", "sweet"), "不！不要碰我那里！", love=-1, max_cap=90)
...
#     add_dialogue("free_girl get_flowers", "generic", "This is very romantic... Was there something you wanted from me?") # Had to disable this for now
    ...
    add_dialogue("refuse farm", "dom", ["农场？不！！！你不能强迫我！", "我不去农场了，这是最后的决定！不！！！", "哦，不，不是农场，你在开玩笑的吧？"])
    ...
    add_dialogue("contract failure", "festival", ["不，不，不！这不可能，这根本不可能。你被雇来做一件事，但你完全辜负了我们的期望！我不应该相信[MC.name]... *恼火*"])
    add_dialogue("contract failure special", "festival", ["不，不，不！这不行的，这根本不行的。你可能符合我们的要求，但你没有用心去做。"])
    ...
    add_dialogue("contract partial special", "date", ["有人告诉我，你的表现不尽如人意。你很幸运，你至少满足了我师父的特殊要求。"], sound=s_sigh)
    ...
    add_dialogue("contract buy offer refuse", "orgy", ["哦，不... 不！不... NO-OOOOOO！！！*喘息* *喘息*\n我来自...失望...我是一个变态的婊子..."])
    ...
    add_dialogue("task failure", "feed guests", ["在从厨房到餐桌的漫长道路上，[girl.name]挣扎着搬运巨大的托盘。在饥饿的客人和好色的醉汉的骚扰下，她最终把所有的食物洒在地上，精疲力竭。", "g: 不！！！真是一场灾难..."], multiple=True, sound=s_crash)
    ...
    add_dialogue("task failure", "fondle", ["[girl.name]被一群好色的老人围住，急于对她下毒手。她惊慌失措地躲避着他们，并从这群人中逃了出来。", "g: 不！我们付钱给你是为了什么，你这个蠢货？"], multiple=True)
    ...
    add_dialogue("task failure", "fetish", ["[girl.name]已经经历了很多，但即使是她也被这个男人的要求吓了一跳。她顺从了，但却没有从中得到任何乐趣。最后，该男子意识到他是在浪费时间，于是离开了。", "g: 不！你太差劲了！而且不是以好的方式！"], multiple=True)
    ...
    add_dialogue("MC fight intro", ("very dom"), ["g: 不！！！你不能强迫我！离我远点，你这个混蛋！", "她以惊人的力量与你争斗。"], multiple=True, sound=s_scream_loud)
    ...
    add_dialogue("slave punish scold deserved", "very materialist", ["她嘲笑着说道。", "g: Yeah, right... Whatever you say."], multiple=True, fear=-1, love=-0.5, unlock="MI")
    add_dialogue("slave punish scold deserved", "materialist", ["她看起来很恼火。", "g: Hmph..."], multiple=True, fear=-0.5, unlock="MI")
    ...
    add_dialogue("slave punish scold undeserved", "very materialist", ["她嘲笑着说道。", "g: Yeah, right... Whatever you say."], multiple=True, fear=-1, love=-0.5, unlock="MI")
    add_dialogue("slave punish scold undeserved", "materialist", ["她看起来很恼火。", "g: Hmph..."], multiple=True, fear=-0.5, unlock="MI")
...
## START BIMBO DIALOGUE 03.February.2022
    ...
    add_dialogue("slave punish scold deserved", ("very materialist"), ["她嘲笑着说道。", "g: Yeah, right... Whatever you say."], multiple=True, fear=-2, unlock="MI")
    add_dialogue("slave punish scold undeserved", ("very materialist"), ["她嘲笑着说道。", "g: Yeah, right... Whatever you say."], multiple=True, fear=-1, unlock="MI")
    add_dialogue("slave punish upkeep", ("very materialist"), ("WHAT?!? No!!!"), fear=1, unlock="MI")
...
## START REPRESSED DIALOGUE 03.February.2022
    ...
    add_dialogue("slave chat slave_life 1", ("repressed"), ["她微笑着说。", "g: I like being a slave, Master.", "g: I like it, when I don’t have decide things for myself..", "g: It helps me keep my dangerous impulses in check.", "g: I feel secure that way. Thank you, Master."], multiple=True, unlock="DS")
...
## START SCHEMER DIALOGUE 03.February.2022
    ...
    add_dialogue("slave punish scold deserved", ("schemer", "very materialist"), ["她看起来很恼火。", "g: Hmph..."], multiple=True, unlock="MI")
    add_dialogue("slave punish scold undeserved", ("schemer", "very materialist"), ["她看起来很恼火。", "g: Hmph..."], multiple=True, love=-1, unlock="MI")
...
## START LOYAL DIALOGUE 03.February.2022
    ...
    add_dialogue("slave beg give up", ("loyal", "very idealist"), ["g: 真...真的吗？", "mc: 当然了。你现在可以走了，不用担心了。", "g: T-T-Thank you, Master... I’m sure I’ll be able to get there in time, but not yet..."], multiple=True, love=2, fear=-1, sound=s_surprise)
