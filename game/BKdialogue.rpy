...
init -1 python:
    ...
    add_dialogue("free_friend no_lie", ("generic"), ["g: 是这样吗？好吧，这是个好工作，我想... ", "mc: 那你是做什么的？", "g: ..."], multiple=True)
    ...
    add_dialogue("free_friend half_lie", ("generic"), ["g: 哦，我明白了。这些天有很多冒险家在附近。", "mc: 那你是做什么的？", "g: 我？哦，咳咳..."], multiple=True)
...
## START COLD DIALOGUE 03.February.2022
    ...
    add_dialogue("free_friend half_lie", ("cold"), ["g: Ok. I don't really care, to be honest.", "mc: And 那你是做什么的？", "g: Not much, if I can help it..."], multiple=True, love=2)
    add_dialogue("free_friend lie", ("cold"), ["g: Good for you.", "mc: Yeah, thanks. 那你是做什么的？", "g: Not much, really..."], multiple=True, love=-2)
    ...
    add_dialogue("free_girlfriend intro", ("cold"), ["g: Hey [MC.name], we know each other pretty well at this point, right?", "mc: Yes, you could say so.", "g: 是吗？ Prove it to me."], multiple=True)
    ...
    add_dialogue("slave effusive thanks", ("cold", "very introvert"), ("这很好。 I guess you're all right, [MC.name]."))
    ...
    add_dialogue("slave strongly refuse", ("cold", "schemer", "creep", "yandere"), ("*叹气* Let's get this over with..."))
    ...
    add_dialogue("MC fight intro", ("cold", "very introvert"), ["g: 不要！ I don't want to play this game with you.", "She turns her back to you and attempts to leave."], multiple=True, sound=s_scream_loud)
    ...
    add_dialogue("slave naked request permanent", ("cold", "very introvert", "very materialist"), ("*叹气* I guess this is my life now..."), love=-1, fear=1, sound=s_sigh)
    ...
    add_dialogue("slave send to master bedroom love", ("cold", "very introvert", "very materialist"), ["She folds her arms and nods.", "g: 这很好。 Your bed is better than mine."], multiple=True)
    add_dialogue("slave send to master bedroom love -", ("cold", "very introvert"), ["她揉了揉眼睛。", "g: *叹气* Guess it's part of the job."], multiple=True)
    ...
    add_dialogue("slave send to master bedroom fear", ("cold", "very introvert", "very materialist"), ["She lets out a big sigh.", "g: 呃... Very 嗯..."], multiple=True)
    add_dialogue("slave send to master bedroom fear -", ("cold", "very introvert", "very materialist"), ["She lets out a big sigh.", "g: 呃... Can't you find anyone else?"], multiple=True)
    ...
    add_dialogue("slave chat slave_life 0", ("cold", "very introvert", "very materialist"), ("*叹气* Does it matter?"), unlock="DS")
    add_dialogue("slave chat slave_life 0.5", ("cold", "very introvert"), ("It's fine... Anything else?"), unlock="DS")
    add_dialogue("slave chat slave_life 1", ("cold", "very introvert"), ["她耸了耸肩。", "g: Eh... I don't mind it."], multiple=True, unlock="DS")
    ...
    add_dialogue("slave chat brothel -1", ("cold", "very introvert"), ("*叹气* It's whatever... I'm just taking it one day at a time..."), unlock="LM")
    ...
    add_dialogue("slave chat customers -2", ("cold", "very dom", "very materialist"), ["她揉了揉眼睛。", "g: 呃... Fuck 'em!"], multiple=True, unlock="MI")
    ...
    add_dialogue("slave chat well_being -3", ("cold", "very introvert"), ("*抽泣* P-please leave..."), unlock="MI")
    add_dialogue("slave chat well_being -2", ("cold", "very introvert"), ("*叹气* Leave me alone..."), unlock="MI")
    ...
    add_dialogue("slave chat tastes likes", ("cold", "very introvert", "stubborn", "princess"), ("The best [thing_cn]? It's [best]."), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("cold", "rebel", "superficial", "bimbo", "prude", "schemer", "stubborn", "repressed"), ("You know, [worst] is a terrible [thing_cn]."), unlock="LM")
    add_dialogue("slave chat tastes loves +", ("cold", "very introvert"), ("You can always wake me up for [thing_cn]."), unlock="LM")
    add_dialogue("slave chat tastes loves -", ("cold", "very introvert"), ("What's the point of [thing_cn]? I don't get it."), unlock="LM")
    add_dialogue("slave chat tastes no loves", ("cold", "very dom"), ("Keep your presents to yourself."), unlock="LM")
    add_dialogue("slave chat tastes hates", ("cold", "very dom"), ("Don't ever hand me [thing_cn]. I will destroy it."), unlock="LM")
    add_dialogue("slave chat tastes no hates", ("cold", "very introvert"), ("It's the thought that counts."), unlock="LM")
    add_dialogue("slave chat tastes positive act", ("cold", "very introvert", "very materialist"), ("呃... Can't stop thinking about [act_desc]..."), unlock="LM")
    ...
    add_dialogue("slave chat origins 1", ("cold", "nerd", "masochist", "creep", "schemer", "yandere"), ("[girl.origin].", "我是在[girl.origin]长大的。", "I'm from [girl.origin]."), unlock="EI")
    ...
    add_dialogue("slave lecture a little reluctant", ("cold", "very introvert"), ("*叹气* Is that it?"), sound=s_sigh)
    ...
    add_dialogue("slave lecture fascinated", ("cold", "very introvert"), ("I see... 谢谢你，主人。"), sound=s_aah)
    ...
    add_dialogue("slave train very interested", ("cold", "very introvert"), ("*脸红* Sure thing..."), sound=s_aah)
    ...
    add_dialogue("slave train service failure", ("cold", "very materialist"), ("*叹气* What time is it?"))
    ...
    add_dialogue("slave magic naked success", ("cold", "very materialist"), ("*欢笑* Hey there, hot stuff..."), sound=s_ahaa)
    ...
    add_dialogue("slave magic group success", ("cold", "schemer", "creep", "yandere"), ("*欢笑* More! Summon more!"), sound=s_ahaa)
    ...
    add_dialogue("slave raped", ("cold", "very introvert"), ("Nngh... *抽泣*"), sound=s_screams)
    add_dialogue("slave rape positive fixation", ("cold", "very introvert"), ("T-that wasn't too bad."), love=1, fear=-1, sound=s_aah)
    add_dialogue("slave rape negative fixation", ("cold", "very introvert"), ("*抽泣* Master! Nooo!"), love=-2, fear=3, sound=s_scream_loud)

    add_dialogue("rest", ("cold", "very introvert"), ("I'll be in my room."))
    add_dialogue("accept job", ("cold", "very introvert"), ("Be a {b}[girl.job_cn]{/b}? Sounds easy enough.","Sure, I'll be your {b}[girl.job_cn]{/b}.","OK, {b}[girl.job_cn]{/b} it is."))
    add_dialogue("work_whore", ("cold", "very introvert"), ("I can combine {b}[girl.job_cn]{/b} and whoring, no problem.","Sure thing. {b}[girl.job_cn]{/b} and whoring.","I'm a slutty {b}[girl.job_cn]{/b}. Confirmed."))
    add_dialogue("exhausted", ("cold", "very introvert"), ("Not now, Master. I'm exhausted. I'll return as a {b}[girl.job_cn]{/b} when I'm ready."))
    ...
    add_dialogue("sold love", ("cold", "very introvert"), ["*叹气* I see... So this is how it ends?", "Master... I'll miss you."], sound=s_surprise)
    ...
    add_dialogue("beach whoring accept", ("cold", "very introvert"), ("Ah, whatever... 让我们动起来吧。"))
...
## START NERD DIALOGUE 03.February.2022
    ...
    add_dialogue("free_play very interested", ("nerd", "pet", "class president", "generic"), ("*脸红* Okay. I can feel myself getting wet already."), love=5)
...
## START MEEK DIALOGUE 03.February.2022
    ...
    add_dialogue("free_offer_job no_lie", ("meek", "superficial", "very sub"), ["她开始哭了起来。", "g: It sounds scary! I don't want to... Oh, what am I going to do...", "g: Will... Will you take good care of me if I do?"], multiple=True)
    add_dialogue("free_offer_job half_lie", ("meek", "superficial", "very sub"), ["她开始哭了起来。", "g: I can't believe you... What are you saying! I am so confused...", "g: It sounds scary! I don't want to... Oh, what am I going to do..."], multiple=True)
    add_dialogue("free_offer_job lie", ("meek", "superficial", "very sub"), ["她开始哭了起来。", "g: I can't believe you... What are you saying! I am so confused...", "g: It sounds scary! I don't want to... Oh, what am I going to do...", "g: Would... Would you take good care of me if I worked for you?"], multiple=True, love=1)
...
## START SUPERFICIAL DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_origins", ("superficial", "rebel", "bimbo" ), ("I'm from [girl.origin]. It was sooo boring over there.", "我来自[girl.origin]。I decided to move to Zan as soon as I could.", "I am {i}so{/i} glad we were able to move from [girl.origin] to Zan. [girl.origin] is, like, literally a shithole."), love=2, max_cap=40)
    ...
    add_dialogue("free_friend no_lie", ("superficial", "very extravert"), ["g: Oh? I'm totally digging that. Sounds like you know how to party!", "mc: And 那你是做什么的？", "g: ...Mind if we just totally change the subject?"], multiple=True, love=6)
    add_dialogue("free_friend half_lie", ("superficial", "very extravert"), ["g: Oh, that's cool or whatever.", "mc: And 那你是做什么的？", "g: Me? Nevermind that, can we change the subject?"], multiple=True, love=-2)
    add_dialogue("free_friend lie", ("superficial", "very extravert"), ["g: Oh, that's cool or whatever.", "mc: And 那你是做什么的？", "g: Me? Never mind that, can we change the subject?"], multiple=True, love=-2)
    ...
    add_dialogue("slave negative reaction", ("superficial", "very extravert"), ("Master?! What the hell?", "呃... You're being {i}such{/i} a pain right now.", "W-what?! I can't believe this... I deserve to be treated much better than this.", "*发狂* Um, could you maybe {i}think{/i} about why I'm so mad right now?"))
    ...
    add_dialogue("slave bullied", ("superficial", "very extravert"), ("Master?! What the hell?", "呃... You're being {i}such{/i} a pain right now.", "W-what?! I can't believe this... I deserve to be treated much better than this."))
    ...
    add_dialogue("slave chat origins 1", ("superficial", "rebel", "bimbo" ), ("I'm from [girl.origin]. It was sooo boring over there.", "我来自[girl.origin]。I decided to move to Zan as soon as I could.", "I am {i}so{/i} glad we were able to move from [girl.origin] to Zan. [girl.origin] is, like, literally a shithole."), unlock="EI")
    ...
    add_dialogue("slave train resisted", ("superficial", "very extravert", "very dom"), ("Master?! What the hell?","呃... Why should I? You're being {i}such{/i} a pain right now.","*发狂* You should know that I hate that sort of thing."))
    ...
    add_dialogue("slave reward sex accepted", ("superficial", "very extravert", "very lewd"), ["She winks and puts her hands on her hips.", "g: *傻笑* You perv... You just can't get enough of me, can you?"], multiple=True, love=1, sound=s_ahaa, unlock="LM")
...
## START HELPER DIALOGUE 03.February.2022
    ...
    add_dialogue("accept farm", ("helper"), ("I see... I must have displeased you, somehow...", "Oh, the farm... If I must, Master...", "如果你这么说，主人。", "I shall go then...", "I understand, Master."))
...
## START HOLY DIALOGUE 03.February.2022
    ...
    add_dialogue("free_flirt_sex_experience reply_brothel_owner", ("holy"), ("I see... At least you are spreading some joy in the city. Though I don't know how Arios feels about this...", "Well, it is a job, and Zan needs it. At least you'll know your way around, when we get to it... *脸红*"), love=1)
    ...
    add_dialogue("free_friend no_lie", ("holy"), ["g: Is that so? Arios is not too fond of this business, but I guess you help spreading joy. In your own way...", "mc: That certainly is a way to put it. And 那你是做什么的？", "g: I am an acolyte for a branch of the Arios church. However something feels strange recently. But let's not talk about that right now..."], multiple=True, love=1)
    add_dialogue("free_friend half_lie", ("holy"), ["g: Oh, I see. Lots of adventurers around these days. May Arios' blessing be with you.", "mc: 谢谢。 And 那你是做什么的？", "g: I am an acolyte for a branch of the Arios church. However something feels strange recently. But let's not talk about that right now..."], multiple=True, love=1)
...
## START SCHEMER DIALOGUE 03.February.2022
    ...
    add_dialogue("free_play indifferent", ("schemer", "bimbo"), ("*叹气* Let's get this over with..."), love=3, sound=s_sigh)
...
## START PRUDE DIALOGUE 03.February.2022
    ...
    add_dialogue("MC take virginity", ("prude", "very modest"), ["She looks distraught.", "g: *抽泣* Oh, Arios forgive me... You've taken away my innocence!", "g: I'm feeling sick. What have I done?!"], multiple=True, love=5)
    ...
    add_dialogue("accept farm fear", ("prude", "very modest"), ["She looks distraught. 泪水在她的眼睛里涌动。", "g: T-the farm? This can't be happening...", "g: It's just a bad dream, isn't it? Just a dream.", "A wry smile creeps onto her face. She has completely broken down and is offering no resistance."], multiple=True)
...
## START LOYAL DIALOGUE 03.February.2022
    ...
    add_dialogue("slave leave master bedroom love", ("loyal", "very idealist"), ["她叹了口气。", "g: You’re sending me away, Master?", "g: I know it’s my duty to do what you say, but I wouldn’t mind sleeping by your side just one more night!"], multiple=True)
    ...
    add_dialogue("slave train accepted", ("generic", "loyal", "very idealist"), ("好的，主人。", "As you wish, Master.", "Your wish is my command, Master.", "哦，[MC.name]主人... *脸红*", "当然了，主人。", "I am happy to oblige, Master.", "Aye aye, Master [MC.name]!"))
...
## START YANDERE DIALOGUE 03.February.2022
    ...
    add_dialogue("free_flirt_sex_experience experienced", ("yandere"), ["g: Ehehe... Yes, you could say so.", "g: But I'll try to control my urges and behave, for your sake. *咧嘴笑*"], multiple=True, love=2)
...
## START STUBBORN DIALOGUE 03.February.2022
    ...
    add_dialogue("free_friend no_lie", ("stubborn"), ["g: A brothel owner? That’s pretty disgusting… I don’t like folks who work in the flesh trade. I had a good impression of you. Maybe I was wrong? ... and I am used to being right.", "mc: And 那你是做什么的？", "g: ..."], multiple=True, love=-2)
    add_dialogue("free_friend half_lie", ("stubborn"), ["g: Adventurer, that’s quite cool! I’m a pretty down-to-earth girl, but I don’t mind a bit of excitement. *眨眼*", "mc: And 那你是做什么的？", "g: Me? Oh, ahem..."], multiple=True, love=1)
    ...
    add_dialogue("slave train refused", ("stubborn", "very dom"), ("No way!!! Don’t even think about it!", "I will not do it! I won't. There’s no fucking way!", "把你的脏爪子从我身上拿开！！！", "What? No!!! For fuck’s sake!", "Fuck off!", "I PREFER NOT TO!"))
    ...
    add_dialogue("refuse sex act", ("stubborn", "very dom"), ("No way!!! Don’t even think about it!", "I will not do it! I won't. There’s no fucking way!", "把你的脏爪子从我身上拿开！！！", "What? No!!! For fuck’s sake!", "Fuck off!", "I PREFER NOT TO!"))
