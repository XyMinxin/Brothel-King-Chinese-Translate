...
init -1 python:
    ...
    add_dialogue("free_greetings_polite", ("superficial", "rebel", "sweet"), "天啊，没想到在这里遇到了一位真正的绅士! *笑*我叫[girl.fullname]。很高兴见到你。", love=2)
    ...
    add_dialogue("free_chat_likes", ("generic"), ("我最喜欢[thing]是[best]。"), love=1, max_cap=40) # Argument is 'thing', 'favourite'
    add_dialogue("free_chat_dislikes", ("generic"), ("我非常不喜欢[thing]是[worst]。恶心！", "我讨厌[thing]是[worst]。"), love=1, max_cap=40) # Argument is 'thing', 'least favourite'
    ...
    add_dialogue("free_flirt_sex_experience reply_sex_god success", ("lewd"), "嘿，注意疾病，你这只狗... *大笑*", love=2)
...
#     add_dialogue("free_girl get_flowers", "generic", "This is very romantic... Was there something you wanted from me?") # Had to disable this for now
    ...
    add_dialogue("free_job_request", "very dom", ["g: [MC.name]... 请帮帮我！*恐慌*", "mc: 请求帮助？这听起来不像你...", "g: 我...我在几个星期前把这个人冰冻起来了...他之前试图强奸我，所以我就...几天后，我将接受审判... 他们会... 他们会奴役我！", "在Zan，如果你没有钱来支付你的罪行，法官可以让你成为奴隶...", "g: 我会用最后的钱来支付保释金......他们肯定会咬定我有罪，而那个人的兄弟肯定会奴役我！他们会在我的余生中强奸和折磨我！", "g: 数以万计的金币...我没有别的办法了... 如果我能够以某种方式逃脱这场审判...", "mc: 嗯... 你知道吗，奴隶不能被审判？似乎只有自由的男人和女人可以被审判？", "g: 但我不是一个奴隶...... 你的建议是什么？"], multiple=True, fear=-5)
    ...
    add_dialogue("task description", "catwalk", "Zan的主要设计师之一将在一场时装秀中展示他的最新作品。[girl.fullname]得到一件超短裙，并被送到T台上。")
    ...
    add_dialogue("slave chat brothel 2", ("modest"), ["S他脸红了，咬着嘴唇。", "g: 我很惭愧地说，但我喜欢这里......我从未想过自己会成为这样的女孩，但是...*脸红*"], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat tastes likes", ("generic"), "我最喜欢的[thing]是[best]。我真的很喜欢它！", unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("generic"), "我真的不喜欢[thing]是[worst]。恶心！", unlock="LM")

    # For presents
    add_dialogue("slave chat tastes loves +", ("generic"), "你知道什么会让我如此高兴吗？我喜欢[thing]...我希望有一些。", unlock="LM")
    add_dialogue("slave chat tastes loves -", ("generic"), "我喜欢[thing]。这些东西很不错。", unlock="LM")
    add_dialogue("slave chat tastes no loves", ("generic"), "礼物对我没有好处。这不是我的东西。", unlock="LM")

    add_dialogue("slave chat tastes hates", ("generic"), "我真的很讨厌[thing]。请不要给我这样的东西。", unlock="LM")
    ...
    add_dialogue("origin Zan", "generic", "我对Zan的老街了如指掌......我曾经和我的[girl.story_guardian]一起走到市场，想知道那些挂着红灯笼的奇怪房子是什么... 现在我知道了... *脸红*")
...
## START PERVERT DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_life", ("pervert", "yandere", "creep"), ["g: 我所知道的是，{i}我的{/i}生命，{i}我的{/i}宇宙，{i}我的{/i}一切都可以在Zan这里找到。","mc: 哦？","g: *傻笑* 别装傻了，你肯定知道我在说什么！"], multiple=True, max_cap=25)
    add_dialogue("free_chat_love", ("pervert", "sweet", "princess", "pet"), ("当然，我在等待我的闪亮盔甲的骑士......*傻笑*"), love=2, max_cap=25)
    add_dialogue("free_chat_origins", ("pervert", "very lewd", "bimbo"), ("我在[girl.origin]的一家妓院附近长大。", "我是在[girl.origin]长大的。那里太无聊了！", "呃, [girl.origin]。在Zan要好得多！"), love=1, max_cap=40)
    add_dialogue("free_chat_hobbies", ("pervert", "rebel", "easy"), ("我{i}爱{/i}[hobby]。", "大多数爱好都超级无趣，但[hobby]还不错。", "最近，我看到一整班的性奴[hobby]在露出。这让我{i}很{/i}湿。Zan是不是很奇怪？"), max_cap=40)
    add_dialogue("free_chat_likes", ("pervert", "bimbo", "easy", "tsundere"), ("我{i}爱{/i}[best]。它是最好的。任何其他的[thing]都不行！*傻笑*", "我很确定大家都认同，最好的[thing]是[best]。"), love=2, max_cap=40)
    add_dialogue("free_chat_dislikes", ("pervert", "creep"), ("让我超级郁闷的一件事是[worst]。讨厌！", "我唯一比禁欲更讨厌的[thing]是[worst]。"), love=1, max_cap=40)
    ...
    add_dialogue("free_joke_mean", ("generic", "very extravert", "very introvert", "very idealist", "very materialist"), ("*大笑* 还有吗！还有吗？！"), love=1, max_cap=50)
    ...
    add_dialogue("free_offer_job thinking", ("pervert", "very lewd"), ["g: 我需要一点时间来考虑这个问题......", "g: Zan的性产业是如此多样，有很多选择可以考虑。"], multiple=True)
    ...
    add_dialogue("free_girl get_flowers", ("pervert"), ["g: 啊，谢谢你！你给我带来了一株植物的断裂生殖器！*大笑* 你真好。", "g: 话说，之前你提到的那个地方是怎么样的呢？"], multiple=True)
    ...
    add_dialogue("accept farm", ("pervert", "very lewd"), ["g: 呃...我必须这样做吗？在Zan我有很多动物可以训练。","她盯着你看了一小会儿，希望你能重新考虑。", "g: 好吧主人，我会去的......啊，我会想念这个地方的。在我回来前帮我暖床，可以吗？*眨眼*"], multiple=True)
    ...
    add_dialogue("slave send to master bedroom love", ("pervert", "very lewd"), ["她笑了，对你眨了眨眼。", "g: 这是我的荣幸，主人。也许你可以教我一些新的技巧......不如今晚？"], multiple=True)
    ...
    add_dialogue("slave leave master bedroom fear +", ("generic", "very introvert", "very idealist", "very materialist", "very modest", "very sub"), ["她看起来很忧虑。", "g: Y-yes Master. H-have I disappointed you?"], multiple=True)
    add_dialogue("slave leave master bedroom fear", ("pervert", "very lewd"), ["她耸耸肩。","g: Looking for some fresh meat to plow, I suppose? Fine... Just let me know when you're longing for my cunt again. *wink*"], multiple=True)
    ...
    add_dialogue("slave chat slave_life -1", ("pervert", "very extravert"), ["她看起来很恼火。","g: What am I supposed to say to that? That I love being a slave? That I'd like to do this the rest of my life?", "g: I have my own desires, obviously... I'm not a brainwashed lemming who purely lives to do your bidding."], multiple=True, unlock="DS")
    ...
    add_dialogue("slave chat customers -1", ("pervert", "rebel", "superficial", "bimbo", "tsundere", "yandere", "stubborn"), ["She crosses her arms and grunts.","g: 呃... Most of them are truly pathetic. No wonder they're paying for sex, none of them know how to properly please a woman."], multiple=True, unlock="MI")
    ...
    add_dialogue("slave chat well_being attacked", ("pervert", "rebel", "stubborn", "yandere", "creep", "stubborn"), ("呃... How do you think I feel after getting assaulted and raped [nb_times] in a month?! It's fucked up. Please do something about it, Master."))
    ...
    add_dialogue("slave chat tastes likes", ("pervert", "very extravert"), ("我{i}爱{/i}[best]。它是最好的。吮吸它，任何其他[thing]！*傻笑*", "我很确定大家都认同，最好的[thing]是[best]。"), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("pervert", "very extravert"), ("让我超级郁闷的一件事是[worst]。讨厌！", "我唯一比禁欲更讨厌的是[thing][worst]。"), unlock="LM")
    ...
    add_dialogue("slave chat tastes positive act", ("pervert", "very lewd"), ("Lately I've been really fascinated by [act_desc]. I love watching other people do that. Maybe I should try it? *咧嘴笑*"), unlock="LM")
    ...
    add_dialogue("slave chat origins 1", ("pervert", "very lewd", "bimbo"), ("我在[girl.origin]的一家妓院附近长大。", "我是在[girl.origin]长大的。那里太无聊了！", "呃, [girl.origin]。在Zan要好得多！"), unlock="EI")
    ...
    add_dialogue("slave lecture indifferent", ("pervert", "very lewd"), ("*呻吟* You are really putting me in the mood to experiment! Can we have a practical lesson next?"))
    add_dialogue("slave lecture a little interested", ("pervert", "very lewd"), ("*呻吟* This is getting me so turned on... Why talk about it when we can just give it a try?"), sound=s_surprise)
    ...
    add_dialogue("slave lecture very interested", ("pervert", "very lewd"), ["As you describe [act_desc] [girl.name] slips one of her hands between her thighs.", "她开始玩弄自己，发出了愉悦的呻吟。", "g: That sounds so amazing, [MC.name]... I can't wait to do it."], multiple=True, sound=s_mmh)
    ...
    add_dialogue("slave train very interested", ("pervert", "very lewd"), ("*呻吟* I'm about to cum already! Aah... L-Let's keep going..."), sound=s_aah)
    add_dialogue("slave train fascinated", ("pervert", "very lewd"), ("*呻吟* Ahh... I love the way you make me feel! I could cum over and over doing this. I love you so much, [MC.name]..."), sound=s_orgasm_fast)
    ...
    add_dialogue("slave train sex failure", ("pervert", "very lewd"), ("I-我很抱歉，主人... This is all new to me. I'm very nervous."))
    add_dialogue("slave train sex success", ("pervert", "very lewd"), ("*呻吟* Master's dick is so fucking amazing. I can't stop cumming!"))
    ...
    add_dialogue("slave train anal success", ("pervert", "very lewd"), ("*呻吟* That feels so fucking good..."))
    ...
    add_dialogue("slave train group success", ("pervert", "very lewd"), ("*呻吟* The efficiency of it... I could fit so many dicks into a day... It's fantastic."))
    ...
    add_dialogue("slave magic service success", ("pervert", "very lewd"), ("你是我的主人。.. I live to pleasure you..."), sound=s_mmh)
    ...
    add_dialogue("work_whore", ("pervert", "very lewd"), ("So I'm officially a {b}[girl.job_cn]{/b}, but when it gets down to it I'm a whore. *giggle* Yeah, that sounds about right. {w=1.0}{nw}"))
...
## START COLD DIALOGUE 03.February.2022
    ...
    add_dialogue("slave send to master bedroom love -", ("cold", "very introvert"), ["她揉了揉眼睛。", "g: *sigh* Guess it's part of the job."], multiple=True)
...
## START NERD DIALOGUE 03.February.2022
    ...
    add_dialogue("free_girlfriend right", ("nerd"), ["g: *wink* That's exactly right. Art immitates life.", "g: So at this point in the story, there is an incredible sexual tension between the girl and the prince. And the girl decides to make her move. *咧嘴笑*", "mc: Oh, I like where this is going."], multiple=True, love=5)
...
## START MEEK DIALOGUE 03.February.2022
    ...
    add_dialogue("free_play a little interested", ("meek", "very sub", "creep", "yandere"), ("*blush* If you want me to, I'll, 嗯... I'll do all sorts of things..."), love=4)
    ...
    add_dialogue("slave strongly refuse", ("meek", "very modest", "very sub"), ("*sob* N-no... Please have mercy, master...", "*sob* 啊！! M-master...", "*sob* N-not like this..."), sound=s_screams)
    ...
    add_dialogue("slave train beg", ("meek", "very modest", "very sub"), ("*sob* N-no, not that... Please have mercy, master...", "*sob* 啊！! M-master... Please don't...", "*sob* N-not that, please master..."))
    add_dialogue("slave discipline beg", ("meek", "very sub", "very idealist"), ["She cowers in fear, using her hands to cover her head.", "啊！! *sob* P-please have mercy, master..."], multiple=True)
    ...
    add_dialogue("slave chat well_being -2", ("meek", "very sub", "very introvert"), ["她看起来很沮丧。", "g: *sob* I'm so tired...", "g: I just want to be alone, master."], multiple=True, unlock="MI")
    ...
    add_dialogue("slave chat well_being sick", ("generic", "very modest", "very sub"), ["她看起来很悲伤。", "g: *sigh* I'm not sure how much more my body can take. This place is filthier than the slum's gutters."], multiple=True)
    ...
    add_dialogue("slave punish beat", ("meek", "very sub"), ("啊！ You're really hurting me! *sob*"), fear=1, sound=s_screams, unlock="DS")
    ...
    add_dialogue("exhausted", ("meek", "very sub", "very materialist"), ("*sigh* I'm pooped... I'll return to being a {b}[girl.job_cn]{/b} as soon as I can."))
...
## START SWEET DIALOGUE 03.February.2022
    ...
    add_dialogue("free_touch_pussy", ("sweet", "loyal", "superficial"), ("*blush* Wh-什么？！ What's this all of a sudden?", "*blush* D-Don't touch me so much, I'm getting jittery!", "*blush* Wha—?! Y-You surprised me there...", "啊！", "*blush* Eeep!"), love=2, max_cap=90)
    ...
    add_dialogue("free_ask_out", ("sweet"), ["mc: [girl.name], I like you. Will you be my girlfriend?", "g: You really want me... to be your girlfriend?", "mc: 是的，可以吗？", "g: Oh, that makes me so happy!! Of course!", "She throws herself into your arms and gives you a long, deep kiss.", "g: I have to go for now... But let's meet again soon, sweetheart! *wink*"], multiple=True)
...
## START SUPERFICIAL DIALOGUE 03.February.2022
    ...
    add_dialogue("slave send to master bedroom fear", ("superficial", "generic", "very materialist"), ["她看起来很恼火。", "g: *sigh* Yeah sure, whatever..."], multiple=True)
    ...
    add_dialogue("slave chat slave_life 0", ("superficial", "very introvert"), ["She looks frustrated.", "g: 呃... What do you expect me to say? A girl like me ought to be revered and coddled, not ordered around."], multiple=True, unlock="DS")
    ...
    add_dialogue("work_whore", ("superficial", "very extravert"), ("*giggle* I'm going to be, like, the sluttiest {b}[girl.job_cn]{/b} {i}ever{/i}. {w=1.0}{nw}"))
...
## START BIMBO DIALOGUE 03.February.2022
    ...
    add_dialogue("free_touch_breasts", ("bimbo", "pervert"), ("Ahn! It's hard to keep my voice down... That feels nice.", "*呻吟* You're getting me in the mood!", "*giggle* One sec, I'll flash you. *wink*"), love=5, max_cap=90)
    add_dialogue("free_touch_pussy", ("bimbo", "pervert", "creep"), ("Oh, you prefer naughty, dirty foreplay? I like it!", "*giggle* I'm proud of my body. What do you think of it?",  "*咧嘴笑* Want me to give you a little peek down there?"), love=3, max_cap=90)
    ...
    add_dialogue("free_play a little interested", ("bimbo", "superficial", "schemer"), ("Mmmhh... I knew you'd say that! *咧嘴笑* I'll make you my slave, body and soul."), love=4)
    ...
    add_dialogue("free_friend half_lie", ("bimbo"), ["g: 呃... Whenever I hear the word {i}[MC.playerclass]{/i} I get all sleepy.", "mc: So what about you?", "g: Haven't you guessed? I use my feminine charms to get by... *wink*"], multiple=True, love=-3)
...
## START HOLY DIALOGUE 03.February.2022
    ...
    add_dialogue("free_flirt_sex_experience virgin", ("holy"), ("嗯... in accordance to Arios' teachings, I am still... pure... I can't believe I'm telling you this! *blush*"), love=1)
...
## START CREEP DIALOGUE 03.February.2022
    ...
    add_dialogue("free_girlfriend give_up", ("creep", "yandere"), ["g: 我明白了... My image of you was slightly wrong, it seems.","g: *sigh* I'm trash. I'm worthless. Throw me away and forget about me."], multiple=True, love=-5)
    add_dialogue("free_girlfriend wrong", ("creep", "yandere"), ["g: 我明白了... My image of you was slightly wrong, it seems.","g: *sigh* I'm trash. I'm worthless. Throw me away and forget about me."], multiple=True, love=-10)
...
## START PRINCESS DIALOGUE 03.February.2022
    ...
    add_dialogue("slave chat brothel 2", ("princess","very modest"), ["S他脸红了，咬着嘴唇。", "g: 我很惭愧地说，但我喜欢这里......我从未想过自己会成为这样的女孩，但是...*脸红*"], multiple=True, unlock="LM")
...
## START CLASS PRESIDENT DIALOGUE 03.February.2022
    ...
    add_dialogue("free_flirt_sex_act fascinated", ("class president"), ["g: *呻吟* To reach climax that is an optimal choice for me...", "g: *blush* N-naturally I have considered all the tools at my disposal to figure out how I can best be pleasured."], multiple=True, love=3)
...
## START LOYAL DIALOGUE 03.February.2022
    ...
    add_dialogue("slave beg proceed", ("loyal", "very idealist", "very sub"), ("Oh, noooo!!!", "*She just stares at you in shock*", "*sob* 她开始哭了起来。"), love=-1)
    ...
    add_dialogue("slave send to master bedroom fear -", ("loyal", "very idealist", "very sub"), ["她耸耸肩。", "g: Fine, Sir. If you say so... I guess it doesn’t matter where I spend my nights."], multiple=True)
    ...
    add_dialogue("slave chat slave_life -2", ("loyal", "very idealist"), ["她的眼睛里涌出了泪水，看起来毫无希望。", "g: I... I don't know what I'm doing here...", "g: ... it just goes against everything I believe in. *sob*"], multiple=True, unlock="DS")
...
## START YANDERE DIALOGUE 03.February.2022
    ...
    add_dialogue("free_touch_kiss", ("yandere"), ("*咧嘴笑* And thus, the pact is completed.","Hey, listen... If I ever mistreat you, just know that's how I express my love sometimes.","*giggle* It would be so funny to punch your teeth in right now. Just kidding! *kiss*", "You've lowered your guard... I could easily snap your neck right now. Don't worry, I would never do something like that. I love you. *kiss*"), love=2, max_cap=90)
...
## START STUBBORN DIALOGUE 03.February.2022
    ...
    add_dialogue("free_friend half_lie", ("stubborn"), ["g: Adventurer, that’s quite cool! I’m a pretty down-to-earth girl, but I don’t mind a bit of excitement. *wink*", "mc: And 那你是做什么的？", "g: Me? Oh, ahem..."], multiple=True, love=1)
