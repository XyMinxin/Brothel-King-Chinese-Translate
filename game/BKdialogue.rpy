...
## START MEEK DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_likes", ("meek", "loyal", "helper", "masochist", "prude"), "Hmm... [best] is quite nice. It was my mother's favorite [thing_cn] as well. But I would rather discuss another subject.", max_cap=40)
    add_dialogue("free_chat_dislikes", ("meek", "very sub"), "The [thing_cn] [worst] gives me the creeps! I still can't figure out why...", love=2, max_cap=40)
    ...
    add_dialogue("free_touch_hand", ("meek", "very sub"), ("*微笑* You're a good person. I'm not afraid of you at all, even though you're a guy.", "Wah! T-this is nice..."), love=3, max_cap=90)
    add_dialogue("free_touch_kiss", ("meek", "very introvert", "cold", "nerd", "masochist", "creep", "repressed", "schemer"), ("*微笑* I like you more and more every day... Stay with me forever?", "Being with you always makes my heart pound, [MC.name]..."), love=2, max_cap=90)
    add_dialogue("free_touch_ass", ("meek", "very sub", "sweet", "easy"), ("Hehe... I'm glad to be with you. As a special present, I'll let you touch it all you want.", "*傻笑* It's the perfect size for your hands."), love=2, max_cap=90)
    ...
    add_dialogue("free_touch_pussy", ("meek", "very modest", "sweet", "class president"), ("Ah! 你在做什么？！"), love=1, max_cap=90)
    ...
    add_dialogue("free_play indifferent", ("meek", "very introvert", "very sub"), ("*脸红* D-don't give me that look... I will do it, for you..."), love=3)
    add_dialogue("free_play a little interested", ("meek", "very sub", "creep", "yandere"), ("*脸红* If you want me to, I'll, 嗯... I'll do all sorts of things..."), love=4)
    add_dialogue("free_play interested", ("meek", "very modest"), ("*喘息* Y-You're shameless... I like it!"), love=4)
    ...
    add_dialogue("free_play fascinated", ("meek", "very sub"), ("Y-yes!! 谢谢。.. Whenever I'm with you, I start getting... really in the mood..."), love=5)
    add_dialogue("MC take virginity", ("meek"), ("Ahh... I've never done that before... *脸红* I'm glad my first time was with you."), love=5)
    ...
    add_dialogue("free_flirt_beauty", ("meek", "nerd", "prude", "pet", "stubborn"), ("Thanks for the compliment. I know I look pretty plain, but I'm glad I'm your type.", "*脸红* Oh, don't look at me like that...", "*脸红* This is embarrassing..."), love=1, max_cap=75)
    ...
    add_dialogue("free_flirt_mind", ("meek", "very modest", "very idealist"), ("Wow, thank you!", "Th-Thank you for always taking time to talk to me. It cheers me up.", "谢谢。.. Whenever I'm with you, I start feeling...really happy..."), love=3, max_cap=75)
    add_dialogue("free_flirt_spirit", ("meek", "very sub"), ("Wow, thank you!", "Th-Thank you for always taking time to talk to me. It cheers me up.", "谢谢。.. Whenever I'm with you, I start feeling...really happy..."), love=2, max_cap=75)

    add_dialogue("free_flirt_sex_experience very experienced", ("meek", "very introvert"), ("I'm really good at that sort of thing. *脸红* B-but talking to guys is still kind of scary to me."), love=3)
    ...
    add_dialogue("free_flirt_sex_experience reply_sex_god success", ("meek", "very modest", "very idealist"), ("*脸红* T-that's not something to brag about!"))
    add_dialogue("free_flirt_sex_experience reply_sex_god failure", ("meek", "very modest", "very idealist"), ("*脸红* T-that's not funny!"), love=-1)
    add_dialogue("free_flirt_sex_experience reply_brothel_owner", ("meek", "very idealist"), ("*脸红* L-Let's talk about that another time!"), love=1)

    add_dialogue("free_flirt_sex_act refuses", ("meek", "very modest", "very sub"), ("Um, sorry... 我们能不能谈点别的？ You're making me uncomfortable."))
    ...
    add_dialogue("free_flirt_sex_act very interested", ("meek", "very sub", "very introvert" ), ("*脸红* Normally I don't think about it that much. But whenever I'm with you, I start getting...really in the mood...", "*脸红* Um... I don't know how I compare to other girls, but...I think I get turned on by that pretty easily?"), love=3)
    add_dialogue("free_flirt_sex_act fascinated", ("meek", "very sub", "very modest"), ("*脸红* Y-Yeah, duh! I'm sure every girl likes that...", "*脸红* Um... I don't know how I compare to other girls, but...I think I get turned on by that pretty easily?"), love=3)

    add_dialogue("free_give_gold +++", ("generic", "very introvert", "very idealist", "very modest", "very sub"), ("You are too kind! 谢谢。"), love=6, max_cap=75)
    add_dialogue("free_give_gold ++", ("meek", "very sub", "very modest"), ("T-that's so sweet of you..."), love=4, max_cap=75)
    add_dialogue("free_give_gold +", ("generic", "very introvert", "very idealist", "very modest", "very sub", "nerd"), ("Oh... 好的。"), love=2, max_cap=75)
    add_dialogue("free_give_gold -", ("meek", "very modest", "very idealist"), ("What's this for?"), max_cap=75)
    add_dialogue("free_give_gold --", ("meek", "pet", "very idealist"), ("What's the matter with you? *发狂* You don't have to pay me to hang around with me."), love=-1, max_cap=75)

    add_dialogue("free_offer_job no_lie", ("meek", "superficial", "very sub"), ["她开始哭了起来。", "g: It sounds scary! 我不想这样做。.. Oh, what am I going to do...", "g: Will... Will you take good care of me if I do?"], multiple=True)
    add_dialogue("free_offer_job half_lie", ("meek", "superficial", "very sub"), ["她开始哭了起来。", "g: I can't believe you... What are you saying! I am so confused...", "g: It sounds scary! 我不想这样做。.. Oh, what am I going to do..."], multiple=True)
    add_dialogue("free_offer_job lie", ("meek", "superficial", "very sub"), ["她开始哭了起来。", "g: I can't believe you... What are you saying! I am so confused...", "g: It sounds scary! 我不想这样做。.. Oh, what am I going to do...", "g: Would... Would you take good care of me if I worked for you?"], multiple=True, love=1)
    ...
    add_dialogue("free_friend no_lie", ("very modest", "meek", "very sub"), ["g: No!! Y-you're scaring me... Let's talk about something else.", "mc: Fine... 那你是做什么的？", "g: Uhm..."], multiple=True, love=-2)
    add_dialogue("free_friend half_lie", ("very modest", "meek", "very sub"), ["g: Wow, that sounds really nice!", "mc: It pays the bills... 那你是做什么的？", "g: Uhm..."], multiple=True, love=5)
    ...
    add_dialogue("free_love_interest", ("meek"), ["She looks flustered", "mc: Is everything all right, [girl.name]?", "g: W-嗯... Yes, but I need to talk to you. *脸红*", "mc: I'm right here, aren't I?", "g: Uh, yes... Ever since I've met you, so many things have changed.", "g: Just thinking about you makes my heart skip a beat... And I can't stop thinking about you.", "g: I've never really dated anyone before, b-but if you wouldn't mind... W-will you go out with me?", "Her face is bright red, it clearly took a lot of courage for her to say that.", "mc: That's so nice to hear from you, [girl.name]. I'm very proud of you.", "g: Wah! Y-you don't have to answer right away... Please will you think about it, for me?", "mc: I will. 谢谢。", "g: Ah! You could bring me flowers when you are ready to give your answer!"], multiple=True)
    ...
    add_dialogue("slave negative fixation accept", ("meek", "very modest", "very sub"), ["*抽泣* B-but master... Do we have to do this?","*pout* I-I don't like it, master...", "P-please be gentle, master...", "I-if I must, master..."])
    ...
    add_dialogue("slave chat tastes likes", ("meek", "loyal", "helper", "masochist", "prude"), "Hmm... [best] is quite nice. It was my mother's favorite [thing_cn] as well. But I would rather discuss another subject.", unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("meek", "very sub"), "The [thing_cn] [worst] gives me the creeps! I still can't figure out why...", unlock="LM")
