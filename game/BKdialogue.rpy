...
init -1 python:
    ...
    add_dialogue("free_joke_mean", ("very idealist"), "什么... 停止吧！*疯狂*", love=-1, max_cap=50)
    ...
    add_dialogue("free_flirt_body", ("nerd", "sweet"), "闭嘴吧！谁想听这样的淫秽评论！？*疯狂*", love=-1, max_cap=75)
    ...
    add_dialogue("free_give_gold --", "generic", "给我钱，是吗？你认为我是一个小气的妓女吗？*疯狂*", love=-1, max_cap=75)
...
#     add_dialogue("free_girl get_flowers", "generic", "This is very romantic... Was there something you wanted from me?") # Had to disable this for now
    ...
    add_dialogue("free_girlfriend wrong", "generic", ["g: 你好恶心！根本不是这样！！！你你真是个糟糕的男朋友...*疯狂*", "mc: 啊，呃，抱歉..."], multiple=True, love=-10)
