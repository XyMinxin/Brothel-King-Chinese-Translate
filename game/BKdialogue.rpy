...
#     add_dialogue("free_girl get_flowers", "generic", "This is very romantic... Was there something you wanted from me?") # Had to disable this for now
    ...
    add_dialogue("slave chat brothel 1", ("lewd"), ["她舔了舔嘴唇。", "g: There's so much happening here, I never get bored... And I can enjoy a good fucking every once in a while! *blush*"], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat brothel 1", ("modest"), ["她脸红了。", "g: I always thought brothels were the worst. But now that I work here, I guess it's actually quite all right."], multiple=True, unlock="LM")
    ...
    add_dialogue("slave chat other_girls 0", ("extravert"), ["她皱起了眉头。", "g: Some girls are nicer than others. But I know for sure some are bitching behind my back."], multiple=True, unlock="EI")
    add_dialogue("slave chat other_girls 0.5", ("extravert"), ["她思考了一会儿。", "g: I've had some time to meet the other girls and chat with them. I cannot say that I have an amazing social life, but this is a start."], multiple=True, unlock="EI")
...
## START SWEET DIALOGUE 03.February.2022
    ...
    add_dialogue("slave chat other_girls 0", ("very extravert"), ["她皱起了眉头。", "g: Some girls are nicer than others. But I know for sure some are bitching behind my back."], multiple=True, unlock="EI")
    add_dialogue("slave chat other_girls 0.5", ("very extravert"), ["她思考了一会儿。", "g: I've had some time to meet the other girls and chat with them. I cannot say that I have an amazing social life, but this is a start."], multiple=True, unlock="EI")
...
## START PRINCESS DIALOGUE 03.February.2022
    ...
    add_dialogue("slave chat brothel 1", ("princess","very modest"), ["她脸红了。", "g: I always thought brothels were the worst. But now that I work here, I guess it's actually quite all right."], multiple=True, unlock="LM")
...
## START EASY DIALOGUE 03.February.2022
    ...
    add_dialogue("slave chat brothel 1", ("very lewd"), ["她舔了舔嘴唇。", "g: There's so much happening here, I never get bored... And I can enjoy a good fucking every once in a while! *blush*"], multiple=True, unlock="LM")
