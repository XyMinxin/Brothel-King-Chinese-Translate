...
## START REBEL DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_likes", ("rebel"), ("You can't go wrong with the [thing_cn] [best].","You're putting me on the spot here... I would say [best] is a pretty dope [thing_cn]."), love=2, max_cap=40)
    add_dialogue("free_chat_dislikes", ("rebel", "pervert"), ("Ugh, why do you want to talk about this? You're bumming me out. The [thing_cn] [worst] sucks.", "Fucking [worst] is a shit [thing_cn]."), max_cap=40)
    ...
    add_dialogue("free_touch_pussy", ("rebel", "pervert"), ("Oohhhh... Bold move! *咧嘴笑*"), love=2, max_cap=90)
    ...
    add_dialogue("free_play indifferent", ("rebel"), ("*欢笑* You really like that? I don't really get it..."), love=3)
    ...
    add_dialogue("free_play fascinated", ("rebel", "masochist"), ("*呻吟* Fuck yeah, take me [MC.name]."), love=5)
    ...
    add_dialogue("free_flirt_body", ("rebel", "prude", "stubborn"), ("*欢笑* It's only natural to get this fit when you spend your days fighting with men."), love=3, max_cap=75)
    ...
    add_dialogue("free_flirt_sex_experience reply_waiting success", ("rebel"), ("*欢笑* Is that so? Mind if I test that resolve of yours?"), love=4)
    add_dialogue("free_flirt_sex_experience reply_waiting failure", ("rebel"), ("*咧嘴笑* Nice try, but I know a liar when I see one."), love=1)

    add_dialogue("free_flirt_sex_experience reply_not_many success", ("rebel"), ("That's disappointing. You ought to live a little!"))
    add_dialogue("free_flirt_sex_experience reply_not_many failure", ("rebel"), ("*咧嘴笑* I know a liar when I see one."), love=-1)
    ...
    add_dialogue("free_flirt_sex_act very interested", ("rebel"), ["她咬着嘴唇。", "g: That's so fucking hot... Keep talking, I'm digging it."], multiple=True, love=3)
    ...
    add_dialogue("free_offer_job no_lie", ("rebel", "very dom"), ["她给了你一个愤怒的眼神。", "g: Me? A whore? Are you fucking crazy!", "mc: Considering your options, do you really have a choice?", "g: What the... This is so bad. Will it get me out of trouble at least?"], multiple=True, love=2)
    ...
    add_dialogue("free_friend half_lie", ("very idealist", "rebel"), ["g: A [MC.playerclass]? Oh, this is awesome! You should teach me some tricks!", "mc: 嗯，当然...你呢，你是做什么的？", "Her mood darkens a bit.", "g: Well, just like you... I'm between jobs..."], multiple=True, love=-4)
    add_dialogue("free_friend lie", ("rebel"), ["g: Oh? You don't hear that every day. Sounds like a pretty sweet deal.", "mc: The pay is good. How about you?", "g: I'm having a hard time holding down a job. I keep getting into fights with whoever starts bossing me around. *欢笑*"], multiple=True, love=3)
    ...
    add_dialogue("slave chat slave_life 0.5", ("very dom"), ["她叹了口气。", "g: It has its ups and downs. Of course I would prefer to be free..."], multiple=True, unlock="DS")
    ...
    add_dialogue("slave chat tastes likes", ("rebel"), ("You can't go wrong with the [thing_cn] [best].","You're putting me on the spot here... I would say [best] is a pretty dope [thing_cn]."), unlock="LM")
    add_dialogue("slave chat tastes dislikes", ("rebel", "pervert"), ("Ugh, why do you want to talk about this? You're bumming me out. The [thing_cn] [worst] sucks.", "Fucking [worst] is a shit [thing_cn]."), unlock="LM")
...
## START COLD DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_origins", ("cold", "nerd", "masochist", "creep", "schemer", "yandere"), ("[girl.origin].", "我是在[girl.origin]长大的。", "I'm from [girl.origin]."), max_cap=40)
    ...
    add_dialogue("free_chat_likes", ("cold", "very introvert", "stubborn", "princess"), ("The best [thing_cn]? It's [best]."), love=1, max_cap=40)
    add_dialogue("free_chat_dislikes", ("cold", "rebel", "superficial", "bimbo", "prude", "schemer", "stubborn", "repressed"), ("You know, [worst] is a terrible [thing_cn]."), max_cap=40)

    add_dialogue("free_joke_harmless", ("cold", "very introvert", "bimbo", "repressed", "prude"), ("*傻笑* Okay, you got me with that one."), love=2, max_cap=50)
    ...
    add_dialogue("free_touch_pussy", ("cold", "nerd", "schemer", "princess", "stubborn"), ("*呻吟* Do we have to do this now?"), max_cap=90)

    add_dialogue("free_play refuses", ("cold", "stubborn", "rebel", "creep", "yandere"), ["She gives you a cold stare.", "g: No."], multiple=True, love=-1)
    add_dialogue("free_play very reluctant", ("cold", "rebel", "stubborn", "schemer", "tsundere"), ["g: 呃... Do I have to?", "g: Fine! Just this once, okay?"], multiple=True, love=1)
    ...
    add_dialogue("free_flirt_sex_act reluctant", ("cold", "stubborn", "rebel"), ["她看起来很恼火。", "g: Why are you so obsessed by this sort of stuff?"], multiple=True)
    ...
    add_dialogue("free_flirt_sex_act interested", ("cold", "rebel", "schemer"), ["她微笑着说。", "g: Oh, sure! I'm interested."], multiple=True, love=2)
    add_dialogue("free_flirt_sex_act a little interested", ("cold", "rebel", "very materialist"), ["她微笑着说。", "g: Yeah, I like it."], multiple=True, love=2)
    ...
    add_dialogue("free_flirt_sex_act fascinated", ("cold", "bimbo", "pet"), ["Her cheeks flush red.", "g: Where did you hear about that?", "g: I could tell you so many embarrassing stories about that... But I still love it. *眨眼*"], multiple=True, love=3)
...
## START NERD DIALOGUE 03.February.2022
    ...
    add_dialogue("free_flirt_mind", ("nerd", "class president"), ("Th-Thanks. I suppose I am compared to most girls.", "*咧嘴笑* You're right about that.", "*smile* Thank you!"), love=3, max_cap=75)
...
## START MEEK DIALOGUE 03.February.2022
    ...
    add_dialogue("slave chat brothel -1", ("meek", "very modest", "very idealist"), ["Tears well up in her eyes.", "g: *抽泣* Oh, this place is awful, master... I don't belong here..."], multiple=True, unlock="LM")
...
## START SUPERFICIAL DIALOGUE 03.February.2022
    ...
    add_dialogue("slave negative reaction", ("superficial", "very extravert"), ("Master?! What the hell?", "呃... You're being {i}such{/i} a pain right now.", "W-what?! I can't believe this... I deserve to be treated much better than this.", "*mad* Um, could you maybe {i}think{/i} about why I'm so mad right now?"))
    add_dialogue("slave whining", ("superficial", "very extravert"), ("呃... {i}Really?{/i}", "That's {i}such{/i} bullshit...", "呃...", "Hmpf...", "*mad* Um, could you maybe {i}think{/i} about why I'm so mad right now?"))
    ...
    add_dialogue("slave negative fixation accept", ("superficial", "very extravert"), ("呃... {i}Someone{/i} is pushing boundaries right now...", "I'm feeling {i}so{/i} awkward right now.", "*mad* 呃... Maybe you should think about how that makes me feel?!", "Um, seriously? Fine... But you have to respect my boundaries, okay?"))
    ...
    add_dialogue("slave naked request accept", ("superficial", "very extravert","very materialist"), ("*叹气* Do I have to? I guess I don't mind stealing the show, as long as those degenerates can keep their paws off me..."), love=1, sound=s_ahaa)
    ...
    add_dialogue("slave chat other_girls -2", ("superficial", "very extravert", "very dom"), ["She looks furious.", "g: 呃... Why are we even talking about {i}that{/i}? There's NO WAY I can even think about making friends right now."], multiple=True, unlock="EI")
    ...
    add_dialogue("slave train resisted", ("superficial", "very extravert", "very dom"), ("Master?! What the hell?","呃... Why should I? You're being {i}such{/i} a pain right now.","*mad* You should know that I hate that sort of thing."))
...
## START HELPER DIALOGUE 03.February.2022
    ...
    add_dialogue("free_flirt_sex_experience very experienced", ("helper"), ["She laughs.", "g: Heh! If only you knew... I {i}do{/i} have a social life and it is not just limited to having a lot of friends.", "g: I've done everything, and then some more, in the bed chamber! *眨眼*"], multiple=True, love=3)
    ...
    add_dialogue("slave thanks", ("helper"), ("Thank you.", "谢谢你，主人。", "Thank you, Master [MC.name].", "Thanks, Master.", "谢谢你，主人。I appreciate that.", "Thank you, I appreciate that."))
...
## START HOLY DIALOGUE 03.February.2022
    ...
    add_dialogue("free_flirt_mind", ("holy", "prude"), ("Oh thank you. *脸红* I wish I knew the words to brighten up your day too.", "Oh, come on... Do you really think so? Thank you... *脸红*", "Arios, did you hear that? This is the best compliment ever!"), love=3, max_cap=75, sound=s_laugh)
    ...
    add_dialogue("free_friend half_lie", ("holy"), ["g: Oh, I see. Lots of adventurers around these days. May Arios' blessing be with you.", "mc: Thank you. And 那你是做什么的？", "g: I am an acolyte for a branch of the Arios church. However something feels strange recently. But let's not talk about that right now..."], multiple=True, love=1)
...
## START CLASS PRESIDENT DIALOGUE 03.February.2022
    ...
    add_dialogue("free_play fascinated", ("class president", "nerd"), ("*呻吟* Y-Yeah. Is it strange that I get so incredibly overcome by lust just thinking about it? No... It's normal. Totally normal."), love=5)
...
## START LOYAL DIALOGUE 03.February.2022
    ...
    add_dialogue("slave thanks", ("loyal", "very sub"), ("Thank you.", "谢谢你，主人！It makes me happy that you appreciate my efforts.", "Thank you, Master [MC.name]. I am only happy to do my duty.", "Thanks, Master.", "谢谢你，主人。I appreciate that.", "Thank you, I am so happy you find my work is up to the standards of [brothel.name].", "Thank you, Sir! I really appreciate that you’ve given me this opportunity!"))
...
## START YANDERE DIALOGUE 03.February.2022
    ...
    add_dialogue("free_chat_likes", ("yandere", "schemer"), ("Listen here, [best] is a fantastic [thing_cn]. It's not up for debate.", "I hate it when someone dislikes [best] as a [thing_cn]. I mean... What? It is the best [thing_cn]! That's a fact!", "I get so angry whenever someone doesn't give the [thing_cn] [best] the respect it deserves."), love=3, max_cap=40)
    add_dialogue("free_chat_dislikes", ("yandere"), ("Uhm... The [thing_cn] [worst], I suppose? I don't really care, to be honest.","The [thing_cn] [worst] isn't all that special in my opinion. But who cares about that stuff... Can we talk about something else?"), max_cap=40)
    ...
    add_dialogue("free_friend no_lie", ("yandere"), ["g: *傻笑* So you whip girls into submission for a living? Fascinating stuff...", "mc: Yeah, sure. So how about you?", "g: Ah, I get by..."], multiple=True, love=2)
    ...
    add_dialogue("slave chat tastes dislikes", ("yandere"), ("Uhm... The [thing_cn] [worst], I suppose? I don't really care, to be honest.","The [thing_cn] [worst] isn't all that special in my opinion. But who cares about that stuff... Can we talk about something else?"), unlock="LM")
...
## START STUBBORN DIALOGUE 03.February.2022
    ...
    add_dialogue("slave thanks", ("stubborn", "very dom"), ("Thank you.", "谢谢你，主人。", "Thank you, [MC.name].", "谢谢你，主人。I appreciate that!", "Thank you, I appreciate that!"))
