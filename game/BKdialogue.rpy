...
## START PERVERT DIALOGUE 03.February.2022
    ...
    add_dialogue("slave reward sex accepted", ("pervert", "very lewd", "pet", "loyal"), ("非常感谢你，主人。骑着你的肉棒总是让我振作起来。"), love=3, sound=s_ahaa, unlock="LM")
    ...
    add_dialogue("slave reward praise", ("pervert", "very extravert"), ("*傻笑* It's my pleasure, really!"), love=1, unlock="MI")
    add_dialogue("slave reward gold", ("pervert", "superficial", "bimbo", "creep", "pet", "loyal", "yandere"), ("Aww... All I really want is a bit of your time. The two of us, alone and aroused... *傻笑*"), unlock="MI")
    add_dialogue("slave reward pet", ("pervert", "very lewd"), ["You caress your fingers through her hair and kiss her on the forehead, before slapping her ass to signal her to leave.", "g: W-what's the point of foreplay if it all ends there?", "g: Look, Master... See how wet you just made me?", "She spreads open her vagina right in front of your face. Big trails of pussy juice drip down from it.", "g: *叹气* I've got to go now... To take care of this."], multiple=True, love=-1, unlock="DS")
    add_dialogue("slave reward day off", ("pervert", "very lewd"), ("I appreciate that, Master. Sometimes you need some time off to really service {i}yourself{/i}, if you know what I mean. *眨眼*"), unlock="DS")
    add_dialogue("slave reward day off KO", ("generic", "very extravert", "very idealist", "very materialist", "very lewd", "very modest"), ("*傻笑* I already have a day off today, silly..."))
    ...
    add_dialogue("slave punish upkeep KO", ("pervert", "very extravert"), ("*傻笑* Uhm... I'm pretty sure there is nothing left to take away there."))
    add_dialogue("slave punish beat", ("pervert", "very lewd", "masochist"), ["She grins and bends over. You spank her ass until it's completely red. Drool flies out of her mouth with each hit.", "g: Ahh! Aaaha!!! Yes, master!! Please... Give it to me... 啊！", "She is clearly in great pain, judging from the way she limps off..."], multiple=True, sound=s_screams, unlock="DS")
    add_dialogue("slave punish farm", ("pervert", "very extravert"), ("*欢笑* The farm? Are you joking?"), fear=1, unlock="DS")
    add_dialogue("slave punish naked", ("pervert", "very lewd"), ["g: *傻笑* Oh noooo... That's so shameful!", "She takes off her clothes without a second thought and starts running around the brothel.", "g: Hey everyone, look at me! I'm being punished right now!"], multiple=True, fear=-1, unlock="LM")
    add_dialogue("slave punish naked KO", ("pervert", "very extravert"), ("*傻笑* And what clothes do you expect me to start taking off right now?"))
    ...
    add_dialogue("slave rape positive fixation", ("pervert", "very lewd"), ("*呻吟* I can't believe that just happened... T-that was so fucking hot..."), love=3, fear=-2, sound=s_aah)
    ...
    add_dialogue("accept job", ("pervert", "very extravert"), ("Sure, I don't mind being a {b}[girl.job_cn]{/b}. It kinda suits me, actually.{w=1.0}{nw}"))
    add_dialogue("work_whore", ("pervert", "very lewd"), ("So I'm officially a {b}[girl.job_cn]{/b}, but when it gets down to it I'm a whore. *傻笑* Yeah, that sounds about right. {w=1.0}{nw}"))
    add_dialogue("exhausted", ("pervert", "very lewd"), ("Master... My pussy is completely sore... Don't ask... I need some more time to rest, and I'll be back in business as a {b}[girl.job_cn]{/b} as soon as I recover."))
    ...
    add_dialogue("sold", ("pervert", "very lewd"), ("*叹气* I hope I will at least end up at another whorehouse... So long, master [MC.name]."))
    add_dialogue("sold love", ("pervert", "very lewd"), ("*抽泣* I'm going to miss this place. You have taught me so much... I'll always cherish you in my heart, Master [MC.name]."), sound=s_surprise)
    ...
    add_dialogue("advertise", ("pervert", "very lewd"), ["*傻笑* Hardcore midget guro! Lesbian perverted rituals! Your sexual fantasies can become reality at [brothel.name]!", "Hey there, stud... I hope I'll see you later tonight. *眨眼*", "I'm single and ready to mingle. Can I see you tonight at [brothel.name]?", "If you have a penis, come prove it to me at [brothel.name]! *傻笑*", "Drinks, entertainment, baths, dates and whores! Yes gentlemen, we truly have it all!", "If you've got a massive cock, prove it to me right now and your first drink tonight will be on me! *傻笑*"])
    ...
    add_dialogue("beach meet MC", ("pervert", "very lewd"), ["g: Ah, [MC.name]! There you are...", "She stares around at all the other beachgoers, holding up one hand to keep the sun out of her eyes.", "g: *傻笑* Everyone is practically nude. There's so much sexual energy here.", "mc: There sure is, [girl.name]... And you're partly to blame!", "g: Hehehe... Guilty as charged, master."], multiple=True)
    add_dialogue("beach oiling", ("pervert", "very lewd"), ["Mmmm... Thank you, master... *低语* {i}I could give you an erotic massage, if you'd like.{/i}"], sound=s_ahaa)
    add_dialogue("beach accept oiling", ("pervert", "very lewd"), ["*傻笑* I was hoping it would lead to this... Mmmhhh... Keep going, master..."])
    add_dialogue("beach refuse oiling", ("pervert", "very lewd"), ["Uhmm... I'll do that part myself. *眨眼*"])
    add_dialogue("beach accept public sex", ("pervert", "bimbo", "yandere", "creep"), ["g: God, yes!! I am so damn horny. Let's show everyone that our love has no limits, yeah?", "mc: Sounds good to me, let's give the people a show.", "She takes a deep breath, turns around and shouts as loud as she can.", "g: HEY EVERYONE, COME WATCH US FUCK EACH OTHER'S BRAINS OUT!!", "Sure enough, a curious crowd starts gathering around the two of you.", "g: *傻笑* {i}That{/i} got their attention. Let's have some fun..."], multiple=True)
    ...
    add_dialogue("beach whoring request", ("pervert", "very lewd"), ["Ehehe... The same thought crossed my mind. You know me too 嗯..."])
