...
label init_postings():
    python:
        ...
        quest_templates = [
                        ...
                        Quest("quest", name = '无聊的Zan', main_stat = 'Sex', second_stat = 'Anal', other_stats = ("Libido", "Constitution", "Obedience", "Sensitivity"), tags = 'sex', description = "我被困在这里，整天在当地的酒吧里喝啤酒. 我烦死了. 请给我找些'乐子'.", sound = s_mmmh),
        ...
        class_templates = [
                            ...
                            Quest("class", name = '游泳培训', main_stat = 'Constitution', second_stat = 'Libido', other_stats = ("Body", "Charm", "Refinement"), tags = 'swim', description = "阳光照在裸露的身体上... 水沿着撩人的曲线流淌... 晒黑油在闪亮的皮肤上... 当然还有游泳. 嗯.", sound = s_aaha),
