...
label init_spells():
    ...
    python:
        ...
        spellbook = {
                    "Warrior" : [
                            Spell('Heavy Lifting', 'strength.jpg', level=2, effects=[Effect("gain", "strength", 1)], description="Pumping and Pimping."),
                            ...
                            Spell('Secret technique', 'strength.jpg', level=10, effects=[Effect("gain", "strength", 1)], description="I will find you, and I will kill you. Twice."),
                            ...
                            Spell('Commanding Voice', 'charisma.jpg', level=14, effects=[Effect("gain", "charisma", 1)], description="From the battlefield to the whorehouse, you've never lost that edge."),
                            ...
                            Spell('Eye Of The Tiger', 'strength.jpg', level=18, effects=[Effect("gain", "strength", 1)], description="ADRIAAAAAN!!!"),
                            ...
                            Spell('Lightning Reflexes', 'speed.jpg', level=22, effects=[Effect("gain", "speed", 1)], description="Swift like a cobra."),
                    ...
                    "Trader" : [
                            Spell('Rogue', 'charisma.jpg', level=2, effects=[Effect("gain", "charisma", 1)], description="Every day I'm hustling."),
                            Spell('The Haggler', 'haggler.jpg', type="passive", level=3, effects=[Effect("boost", "buy", -0.02, scales_with="charisma"), Effect("boost", "sell", 0.02, scales_with="charisma")], description="'That's it. I'm walking away now...' Better prices for girls and items."),
                            ...
                            Spell('Street Fighter', 'strength.jpg', level=6, effects=[Effect("gain", "strength", 1)], description="The mean streets of Borgo have taught you all that there is to know about street fighting. Always stab from the back."),
                            ...
                            Spell('Adventurer', 'charisma.jpg', level=10, effects=[Effect("gain", "charisma", 1)], description="You don't always adventure far from your bed, but at least you look the part."),
                            ...
                            Spell('Smooth Criminal', 'charisma.jpg', level=18, effects=[Effect("gain", "charisma", 1)], description="You've been hit by, you've been struck by…"),
                            ...
                            Spell('Shadowrunner', 'speed.jpg', level=22, effects=[Effect("gain", "speed", 1)], description="You're fast. You've got the ship that made the Westmarch Run in less than twelve parsecs… Somewhere."),
                    ...
                    "Wizard" : [
                            ...
                            Spell('Wise', 'charisma.jpg', level=6, effects=[Effect("gain", "charisma", 1)], description="This is payback for all those times they called you a 'Wise guy'."),
                            ...
                            Spell('Enhanced senses', 'enhanced.webp', type="transe", level=11, cost=6, effects=[Effect("boost", "refinement gains", 0.05, scales_with="spirit", scope="brothel"), Effect("boost", "sensitivity gains", 0.05, scales_with="charisma", scope="brothel")], duration="turn", description="Now, did you know there is a 5th dimension? And a 6th, and a 7th, and a 13th?"),
                            Spell('Doll master', 'doll.webp', type="transe", level=11, cost=6, effects=[Effect("boost", "beauty gains", 0.05, scales_with="spirit", scope="brothel"), Effect("boost", "obedience gains", 0.05, scales_with="charisma", scope="brothel")], duration="turn", description="I saw people sticking a needle into a voodoo doll, but never {i}there{/i}…"),
                            ...
                            Spell('Staff master', 'strength.jpg', level=14, effects=[Effect("gain", "strength", 1)], description="If all else fails, you can still crack their skulls with it."),
                            ...
                            Spell('Swift', 'speed.jpg', level=22, effects=[Effect("gain", "speed", 1)], description="I've got magic in my pants. I mean, they make me run faster."),
                            ...
                            Spell('Mindtrick', 'mindtrick.webp', type="trick", level=24, cost=10, effects=[Effect("boost", "job customer budget", 0.25, scope="brothel"), Effect("boost", "whore customer budget", 0.25, scope="brothel")], description="Learnt that trick from an old bum called Zobiwan. He was good at escorting druids, though."),
                            ],
                    }
...
label init_moons():
    python:
        moons = {
                 ...
                 8 : Moon("harvest", effects=[Effect("boost", "farm preference increase", 1, scope="farm"), Effect("boost", "all sex acts preference increase", -0.5, scope="brothel")], description="It's time to harvest your crops, tend to your cattle, find a partner, and bang her brains out.", sound = s_moo),
