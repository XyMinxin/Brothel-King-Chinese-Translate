...
#    text str(selected_pic.has_tag("inside")) color "#000000" xalign 0.5 yalign 0.5 xsize 0.5
    ...
    frame yalign 0.93 xfill True xalign 0.45 xsize 800 background None:
        ...
        hbox:
            textbutton ">" text_size 18 action Return("cycle_next") hovered tt.Action("切换到下一张图片（快捷键：右方向键）") xalign 1.0 yalign 1.0 xsize 40 ysize 40 xfill True yfill True
            textbutton "+10" text_size 14 action Return("cycle_next_10") hovered tt.Action("向前浏览10张图片（快捷键：Shift+右方向键）") xalign 1.0 yalign 1.0 xsize 40 ysize 40 xfill True yfill True
            textbutton "+100" text_size 14 action Return("cycle_next_100") hovered tt.Action("向前浏览100张图片（快捷键：Ctrl+右方向键）") xalign 1.0 yalign 1.0 xsize 40 ysize 40 xfill True yfill True
