...
label c2_suzume_onsen(): # Happens at night when the player has an onsen and at least 3 days have passed
    ...
    # you "*pant* *pant*"
    #
    # suzume "It isn't often that I can say that I have had my fill... But you made me happy. ♥"
    #
    # you "N-No... No problem..."
    #
    ...
    if special:
        ...
        if NPC_narika.flags["hunt stage"] >=2 and NPC_mizuki.flags["hunt stage"] >=2 and NPC_haruka.flags["hunt stage"] >=2:
            if not story_flags["all ninjas met twice"]:
                ...
                $ calendar.set_alarm(calendar.time+1, StoryEvent(label = "c2_palace_visit2", type = "morning"))
                $ calendar.set_alarm(calendar.time+1, StoryEvent(label = "c2_kosmo_new_recruit", type = "night"))
