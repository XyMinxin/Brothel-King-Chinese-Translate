...
translate chinese strings:
    ...
    new "本菜单上的选项旨在提高可访问性。它们可能不适用于所有游戏，某些选项的组合可能导致游戏无法游玩。这不是游戏或引擎的问题。为了在更改字体时获得最佳效果，尽量保持文字大小与原来相同。"
    ...
    new "这个程序包含一些许可证下的自由软件，包括MIT许可证和GNU Lesser General Public许可证。一个完整的软件列表，包括完整源代码的链接，你可以在{a=https://www.renpy.org/l/license}这里{/a}找到。"
    ...
    new "启用剪贴板声音。按'shift+C'来禁用。"

    # renpy/common/00preferences.rpy:601
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "自言-自语会说 \"[renpy.display.tts.last]\"。按'alt+shift+V'来禁用。"
    ...
    new "它的图形驱动可能是过时的或操作不正确。这可能会导致缓慢或不正确的图形显示。"

    # renpy/common/00gltest.rpy:259
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "{a=edit:1:log.txt}log.txt{/a} 文件可能包含帮助您确定计算机出了什么问题的信息。"

    # renpy/common/00gltest.rpy:264
    old "More details on how to fix this can be found in the {a=[url]}documentation{/a}."
    new "有关如何修复此问题的更多详细信息，请参见 {a=[url]}documentation{/a}。"
    ...
    new "将traceback.txt文件复制到剪贴板作为论坛的BB代码，如https://lemmasoft.renai.us/."
    ...
    new "将tracback .txt文件复制到剪贴板作为Discord的Markdown。"
    ...
    new "尝试回滚到以前的时间，允许您保存或选择一个不同的选择。"
