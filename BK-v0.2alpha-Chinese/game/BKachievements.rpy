...
#                         Achievement("Bedded: The Adventurer", "You had sex with Scarlet.", pic="portrait.webp", pic_path="NPC/Jobgirl/", target="h jobgirl"), # Event not ready yet?
                        ...
                        Achievement("北斗神拳", "战士的等级达到 %s 级。", pic="warrior.webp", pic_path="UI/", level_nb=5, target="战士", requirements={1 : 5, 2 : 10, 3 : 15, 4 : 20, 5 : 25}),
                        ...
                        Achievement("金手指", "奸商的等级达到 %s 级。", pic="trader.webp", pic_path="UI/", level_nb=5, target="奸商", requirements={1 : 5, 2 : 10, 3 : 15, 4 : 20, 5 : 25}),
                        Achievement("Johny B. Good", "成为正义的光辉榜样。也是一个青楼老板。为什么不呢？", pic="al_good.webp", pic_path="UI/", target="good"),
                        Achievement("瑞士", "你不偏袒任何一方，你只是收取你的奖金。", pic="al_neutral.webp", pic_path="UI/", target="neutral"),
