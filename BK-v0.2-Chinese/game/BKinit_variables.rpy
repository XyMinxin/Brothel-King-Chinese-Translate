...
#### RESOLUTION ####
    ...
    RES_BASE_X = 1024
    RES_BASE_Y = 768
    res_xy_ratio = 1.0 # WIP - Default (1.0) is 4:3. Set this aspect ratio to 1.2 for 16:10, 1.334 for 16:9.
...
#### RANDOM TIPS ####
    ...
    MC_playerclass_description = {
                                  "战士" : "你是个战士。你可能还年轻，但你经历过的血战不止这些。你在战斗和保护青楼中更强大。",
                                  "法师" : "你是个巫师。人们臣服于你的意志和魔法。你可以使用最多的法术。",
                                  "奸商" : "你是个奸商。你从年轻时混迹江湖开始就一直在努力。你可以做更好的交易，拿到最好的价格。"
                                  }
    MC_stat_description = {
    ...
    god_description = {
                        "阿里奥斯" : "你崇拜阿里奥斯，光明之神和天使之主。",
                        "莎莉娅" : "你崇拜莎莉娅，阴影女神和夜晚的统治者。",
...
init -4 python:
    ...
    minion_description = {"stallion" : "种马是血岛的男性性奴隶，魔法洗脑加上选择性地繁殖使它们拥有异常巨大的……",
                         "beast" : "野兽是吉泽尔在农场里养的各种各样的动物。更像是动物园，真的。",
                         "monster" : "怪物是不自然的恶魔，在克塞洛斯最黑暗的洞穴里爬行。它们有很多种形式，但有触角的总是最受欢迎。",
                         "machine" : "在吉泽尔的工作室里，机器或人工制品总是拥有众多用途，但实际上它们似乎只是为一件事而设计——性。"
                         }
    ...
    farm_holding_dict = {"libido" : "照看奴仆{size=-6}(+性欲){/size}",
                            "sensitivity" : "服侍吉泽尔{size=-6}(+敏感){/size}",
    ...
    farm_description = {"stallion intro" : "%s在马厩和一匹悬挂得很好的种马过夜。",
                        "beast intro" : "%s在兽栏里和一只肮脏下流的动物一起过夜。",
                        "monster intro" : "%s和一个淫荡、恶心的家伙在怪物洞里过了一夜。",
                        "machine intro" : "%s在车间里的一台又大又怪的机器旁过夜。",
                        ...
                        "naked intro" : "吉泽尔示意%s在%s面前裸露身体。",
                        "service intro" : "吉泽尔把%s推倒在地，并示意她为%s服务。",
                        "sex intro" : "吉泽尔命令%s准备好让%s艹。",
                        "anal intro" : "吉泽尔要求%s把屁股抬高让%s走后门。",
                        "fetish intro" : "吉泽尔把墙上的链子拿给%s看， 说她会看着%s得逞的。",
                        "bisexual intro" : "吉泽尔决定加入%s和%s一起玩。",
                        "group intro" : "吉泽尔命令%s今晚将要和一群%s发生群交行为。",
...
#                        "group result bad" : "{color=[c_lightred]}%s cried and screamed as the %ss took turns violating her body.{/color} Gizel kept tauting her during the whole ordeal as she sobbed silently.",
                        ...
                        "holding obedience" : "吉泽尔派%s去打扫农场，告诉她要擦洗谷仓的每一个角落，清洗地板上的污渍。%s按照她的要求做了，而不是去面对魔法鞭笞的威胁。",
                        "holding constitution" : "吉泽尔命令%s在马道上绕着农行跑了一圈，每当她发现%s减速时，就狠狠地用鞭子抽她。",
                        "holding sensitivity" : "吉泽尔用%s作为她的私人仆人来追求她变态的幻想，强迫她舔身体，用各种各样的玩具玩弄那些饥饿的洞洞。这很困难，但%s还是学到了新东西。",
                        "holding libido" : "吉泽尔要求%s照顾奴仆: 喂养它们，清洁它们，帮助它们“释放压力”。%s在她工作的过程中，她了解到很多关于奴仆们独特的体征特点。",
                        "holding obedience good": "作为一个额外的挑战，吉泽尔让%s在她持续工作的时候穿上紧缚身体的绳子。 {color=[c_green]}粗糙的绳子以一种既不舒服又奇怪的方式摩擦着她的身体。{/color}",
                        "holding obedience bad": " {color=[c_lightred]}%s厌恶吉泽尔的奴仆留下的所有污秽和体液。{/color}",
                        "holding constitution good": " 吉泽尔认为在室外不穿衣服会让%s更加狂野，于是她让她光着身子跟动物一起跑。{color=[c_green]}在户外和动物一起裸体让她觉得自己的身心更愉悦。{/color}",
                        "holding constitution bad": " {color=[c_lightred]}当%s以创纪录的速度跑完一圈时，她轻蔑地看了吉泽尔一眼。{/color}",
                        "holding sensitivity good": " %s用熟练的舌头舔着吉泽尔勃起的阴蒂，给了她美妙的高潮。{color=[c_green]}她现在更熟悉如何取悦女人。{/color}",
                        "holding sensitivity bad": " 吉泽尔把%s弄得筋疲力尽，气喘吁吁地倒在地上。{color=[c_lightred]}她的体格受到了影响。{/color}",
    ...
    pref_response = {
                    ...
                    "modest indifferent" : "哦，又让我做%s……你真是个变态……*脸红*",
                    ...
                    "lewd interested": "嗯，%s……我已经湿透了……*潮红*",
                    "lewd very interested": "哦，%s，它让我停不下来了……我被人看的时候感觉挺舒服……啊！！！*呻吟*",
                    "lewd fascinated": "哦……我要去了！啊，%s去了！！！*喷射*",
                    }
...
#                            "extremely reluctant" : 100, # (obsolete)
    ...
    interact_dict = {
                    ...
                    "{font=[gui.yishu]}{size=18}顾客{/font}" : [
