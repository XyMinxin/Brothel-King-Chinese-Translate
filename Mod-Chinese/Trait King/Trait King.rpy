...
label traitking_early_init:
    ...
    python:
        ...
        traitking_neg_evolved = { 
                "Godless" : Trait(_("Devout"), verb = "be", eff1 = Effect("boost", "reputation gains", 0.1), base_description = __("She once was lost, but now faithfully serves her God.")),
                "Trauma" : Trait(_("Stoic"), verb="be", effects = [Effect("boost", "love", -0.2), Effect("boost", "fear", -0.4)], base_description = __("She is emotionally stable despite losing her virginity against her will.")),
                "Dull" : Trait(_("Curious"), verb = "be", eff1 = Effect("special", "effect chance", 0.1), base_description = __("She once led a sheltered life, but now invites new experiences into her life.")),
                "Mean" : Trait(_("Reserved"), verb = "be", eff1 = Effect("change", "charm", -5, scales_with = "rank"), eff2 = Effect("change", "refinement", 10), base_description = __("She has a mean streak, but tries not to speak her mind whenever it is filled with negativity.")),
                "Scars" : Trait(_("Marks"), verb = "be", eff1 = Effect("change", "body", -5, scales_with = "rank"), eff2 = Effect("change", "charm", 10), base_description = __("She carries herself with such confidence that you barely notice her nasty scars.")),
                "Plain" : Trait(_("Odd"), verb = "be", eff1 = Effect("change", "beauty", -5, scales_with = "rank"), eff2 = Effect("change", "charm", 10), base_description = __("She's looks like an ordinary girl, but makes up for it with her unique personality.")),
                "Rude" : Trait(_("Raw"), verb = "be", eff1 = Effect("change", "refinement", -5, scales_with = "rank"), base_description = __("She tries to be considerate, despite her uncultured origins.")),
                "Rough" : Trait(_("Impolite"), verb = "be", eff1 = Effect("change", "sensitivity", -5, scales_with = "rank"), opposite = "Delicate", base_description = __("She occasionally acts without considering decorum.")),
                "Weak" : Trait(_("Tender"), verb = "be", eff1 = Effect("change", "constitution", -5, scales_with = "rank"), opposite = "Resilient", base_description = __("She has trained hard to be a bit less vulnerable than she once was.")),
                "Defiant" : Trait(_("Resistant"), verb = "be", eff1 = Effect("change", "obedience", -5, scales_with = "rank"), eff2=Effect("change", "valuation", -20), opposite = "Meek", base_description = __("She likes to rebel against authority every now and then.")),
                "Gluttonous" : Trait(_("Craving"), verb = "be", eff1 = Effect("change", "constitution", -15), base_description = __("She is always hungry, but has learned not to overindulge.")),
                "Uncouth" : Trait(_("Primitive"), verb="be", eff1=Effect("change", "refinement", -20), opposite = "Groomed", base_description = __("She lacks basic manners, but has good intentions.")),
                "Deaf" : Trait(_("Inattentive"), verb = "be", eff1 = Effect("change", "obedience", -10), eff2 = Effect("change", "waitress jp gains", -0.25), base_description = __("She may not be deaf, but she is often absentminded.")),
                "Timid" : Trait(_("Bashful"), verb = "be", eff1 = Effect("boost", "charm gains", -0.25), eff2 = Effect("change", "sensitivity", 10), opposite = "charming", base_description = __("She's is endearingly shy.")),
                "Plump" : Trait(_("Full-figured"), verb = "be", eff1 = Effect("boost", "body gains", -0.25), eff2 = Effect("change", "constitution", 10), opposite = "Fit", base_description = __("She has generous natural curves.")),
                "Scruffy" : Trait(_("Authentic"), verb = "be", eff1 = Effect("boost", "beauty gains", -0.25), eff2 = Effect("change", "beauty", 10), opposite = "Beautiful", base_description = __("She prefers to be genuine and acknowledges her imperfections instead hiding them.")),
                "Vulgar" : Trait(_("Honest"), verb = "be", eff1 = Effect("boost", "refinement gains", -0.25), eff2 = Effect("change", "libido", 10), opposite = "Elegant", base_description = __("She freely speaks her mind without mincing words.")),
                "Tame" : Trait(_("Restrained"), verb = "be", eff1 = Effect("boost", "libido gains", -0.25), eff2=Effect("change", "refinement", 10), opposite = "Slutty", base_description = __("She is well-behaved.")),
                "Frail" : Trait(_("Cherished"), verb = "be", eff1 = Effect("boost", "constitution gains", -0.25), eff2=Effect("change", "sensitivity", 10), opposite = "Athletic", base_description = __("She is frail, but worth protecting.")),
                "Rebellious" : Trait(_("Liberated"), verb = "be", eff1 = Effect("boost", "obedience gains", -0.25), eff2 = Effect("change", "charm", 10), opposite = "Obedient", base_description = __("She is free to make her own choices.")),
                "Distrustful" : Trait(_("Independent"), verb = "be", eff1 = Effect("boost", "love gains", -0.25), eff2 = Effect("change", "refinement", 10), opposite = "Loyal", base_description = __("She's an independent and reliable girl.")),
                "Fearful" : Trait(_("Anxious"), verb = "be", eff1 = Effect("boost", "fear", 0.25), eff2 = Effect("change", "defense", 1), opposite = "Brave", base_description = __("She's nervous and quick to worry.")),
                "Paranoid" : Trait(_("Cautious"), verb = "be", eff1 = Effect("boost", "fear", 1.0), eff2 = Effect("change", "defense", 2), base_description = __("She's wary and takes great care to avoid danger.")),
                "Homely" : Trait(_("Comfortable"), verb = "be", eff1 = Effect("boost", "reputation gains", -0.1), eff2 = Effect("boost", "love", 0.25), opposite = "Sexy", base_description = __("She feels at ease.")),
                "Prude" : Trait(_("Behaved"), verb = "be", eff1 = Effect("boost", "service jp gains", -0.25), eff2 = Effect("boost", "sex jp gains", -0.25), eff3=Effect("change", "refinement", 10), opposite = "Naughty", base_description = __("She does not like meaningless sex and prefers to build a connection first.")),
                "Naive" : Trait(_("Green"), verb = "be",eff1 = Effect("boost", "anal jp gains", -0.25), eff2 = Effect("boost", "fetish jp gains", -0.25), eff3=Effect("change", "beauty", 10), opposite = "Kinky", base_description = __("She does not like doing the weird stuff... Yet...")),
                "Square" : Trait(_("Traditional"), verb = "be", eff1 = Effect("change", "sex act requirements", 20), eff2=Effect("change", "refinement", 10), opposite = "Pervert", base_description = __("She prefers to do things by the book.")),
                "Strong Gag Reflex" : Trait(_("Throat spasms"), verb = "have", eff1 = Effect("increase satisfaction", "service", -1), eff2=Effect("change", "libido", 10), base_description = __("She used to choke a lot more, but still vomits on a dick now and then.")),
                "All thumbs" : Trait(_("Klutzy"), verb = "be", eff1 = Effect("increase satisfaction", "waitress", -1), eff2 = Effect("change", "libido", 10), opposite=['Deft', 'Bright', 'Brisk', 'Rowdy'], base_description = __("She still struggles to make herself useful.")),
                "Awkward" : Trait(_("Embarrassed"), verb = "be", eff1 = Effect("increase satisfaction", "dancer", -1), eff2 = Effect("change", "charm", 10), opposite=['Nimble', 'Agile', 'Brisk', 'Powerful'], base_description = __("She feels uncomfortable in some situations.")),
                "Brutal" : Trait(_("Fierce"), verb = "be", eff1 = Effect("increase satisfaction", "masseuse", -1), eff2 = Effect("change", "constitution", 10), opposite=['Deft', 'Soft skin', 'Agile', 'Unhurried'], base_description = __("She likes to openly display her strength.")),
                "Dumb" : Trait(_("Dopey"), verb = "be", effects = [Effect("increase satisfaction", "geisha", -1), Effect("change", "charm", 10)], opposite=['Nimble', 'Soft skin', 'Bright', 'Modest'], base_description = __("She's stupid and funny.")),
                "Oafish" : Trait(_("Simple"), verb = "be", eff1 = Effect("boost", "dancer jp gains", -0.25), eff2 = Effect("boost", "geisha jp gains", -0.25), eff3 = Effect("change", "libido", 10), opposite=['Nimble', 'Agile', 'Brisk', 'Soft skin', 'Bright'], base_description = __("She does not like thinking about complicated things.")),
                "Clumsy" : Trait(_("Silly"), verb = "be", eff1 = Effect("boost", "waitress jp gains", -0.25), eff2 = Effect("boost", "masseuse jp gains", -0.25), eff3 = Effect("change", "sensitivity", 10), opposite=['Deft', 'Bright', 'Brisk', 'Rowdy', 'Soft skin', 'Agile'], base_description = __("People like to make fun of her mistakes.")),
                "Slow" : Trait(_("Relaxed"), verb = "be", eff1 = Effect("boost", "xp gains", -0.25), eff2 = Effect("change", "libido", 10), opposite = ["Fast learner", "Sharp", "Genius"], base_description = __("She prefers to take it easy.")),
                "Arrogant" : Trait(_("Self-assured"), verb = "be", eff1 = Effect("boost", "all jp gains", -0.25 ), eff2 = Effect("change", "body", 10), opposite = "Humble", base_description = __("She may be a bit too confident in her abilities.")),
                "Stubborn" : Trait(_("Determined"), verb = "be", eff1 = Effect("boost", "xp gains", -0.1 ), eff2 = Effect("boost", "all jp gains", -0.1 ), eff3 = Effect("change", "constitution", 10), base_description = __("She feels driven pursue her own ideas, even when they are questionable.")),
                "Lazy" : Trait(_("Peaceful"), verb = "be", eff1 = Effect("boost", "max energy", -0.1), eff2 = Effect("change", "refinement", 10), opposite = ["Energetic", "Driven"], base_description = __("She is serene and carefree.")),
                "Blind" : Trait(_("Myopic"), verb = "be", eff1 = Effect("change", "defense", -2), eff2 = Effect("change", "sensitivity", 10), base_description = __("She is short-sighted.")),
                "Vulnerable" : Trait(_("Accessible"), verb = "be", eff1 = Effect("change", "defense", -2), eff2 = Effect("change", "sensitivity", 10), opposite = ["Strong", "Warrior"], base_description = __("She sees it as her duty to comfort even the most unstable individuals.")),
                "Expensive" : Trait(_("Valuable"), verb = "be", eff1 = Effect("boost", "upkeep", 1), eff2=Effect("change", "valuation", +50), opposite = "Humble", base_description = __("She deserves to be treated like a princess.")),
                "Greedy" : Trait(_("Philanthropic"), verb = "be", eff1 = Effect("boost", "upkeep", -0.8), base_description = __("She wishes to live a frugal life and donates whatever she can to those in need.")),
                "Cold" : Trait(_("Cool"), verb = "be", eff1 = Effect("change", "refinement", -10, scales_with = "rank"), eff2 = Effect("boost", "tiredness", -0.1), base_description = __("She knows how to hold her nerve.")),
                "Jaded" :  Trait(_("Veteran"), verb = "be a", eff1 = Effect("special", "skill catch up", 1), eff2 = Effect("change", "valuation", -10, scales_with = "rank"), opposite = "Sensitive", base_description = __("She guides the others through her experience and know-how.")),
                "Sickly" : Trait(_("Empathic"), verb = "be", eff1 = Effect("boost", "hurt", +2), eff2=Effect("change", "sensitivity", 20), opposite = "Tough", base_description = __("Disease and hardship has made her become more compassionate.")),
                "Unlucky" : Trait(_("Unrelenting"), verb = "be", eff1 = Effect("special", "unlucky", 1), eff2 = Effect("reroll", "job critical failure", 1), base_description = __("She has some terrible luck, but perseveres through sheer willpower."), opposite = "Lucky"),
                "Slave Brand" : Trait(_("Trophy"), verb="be a", effects = [Effect("boost", "prestige", 1.5), Effect("change", "valuation", -100)], archetype="The Bride", base_description = __("She has a tattoo that says {i}'Property of Kosmo. If found, please return to rightful owner.'{/i}.")),

                "Lesbian" : Trait(_("Queer"), verb = "be a", eff1=Effect("increase satisfaction", "all sex acts", -1), eff2=Effect("increase satisfaction", "bisexual", 3), archetype="The Courtesan", base_description = __("She does not get aroused by men, but serves women like no other.")),
                "City girl" : Trait(_("Cosmopolitan"), verb="be a", eff1=Effect("boost", "farm preference increase", -1.0), eff2=Effect("change", "valuation", +60), eff3 = Effect("change", "refinement", 20), archetype="The Escort", base_description = __("She is a cultured soul who thrives in the city, but would despise living in the countryside.")),
                ...
                "Deceitful" : Trait(_("Sly"), verb = "be", eff1=Effect("boost", "income", -0.01), eff2=Effect("change", "valuation", +50), base_description = __("She is a manipulative girl who makes sure she gets whatever she wants.")),
                "Inbred" : Trait(_("Pureblood"), verb = "be a", eff1 = Effect("boost", "love", 0.5), eff2 = Effect("boost", "all jp gains", -0.5), eff3=Effect("change", "valuation", +400), base_description = __("Her father and mother were closely related by blood, which leads people to assume that she might come from a royal bloodline.")),
                "Depressed" : Trait(_("Cynical"), verb="be", eff1=Effect("change", "mood", -1), eff2=Effect("change", "constitution", 10), base_description = __("She has a pessimistic outlook on life and copes with this by openly showing her contempt.")),
                "Chaste" : Trait(_("Pure"), verb = "be", eff1 = Effect("increase satisfaction", "waitress", 1), eff2 = Effect("increase satisfaction", "geisha", 1), eff3=Effect("change", "valuation", +100), opposite = "Pervert", base_description = __("She disapproves of sex outside of marriage, yet she works in a brothel. Visitors consider it endearing.")),
                "Disfigured" : Trait(_("Repaired"), verb = "be", eff1 = Effect("boost", "naked bonus", -0.1), eff2 = Effect("change", "beauty", -10), eff3=Effect("change", "valuation", -25), opposite = "Nice boobs", base_description = __("She was disfigured in a nasty accident, but specialist doctors have concealed the damage as much as they could.")),
                "Drunkard" : Trait(_("Teetotaler"), verb="be a", eff1=Effect("change", "constitution", 15, scales_with = "rank"), eff2= Effect("boost", "reputation gains", -0.25), eff3=Effect("change", "valuation", +50), base_description = __("She completely abstains from intoxicating beverages.")),
                # "Kidnapped" : Trait(_("Bonded"), verb = "be", eff1=Effect("change", "obedience", 40), eff2 = Effect("boost", "love", 0.5), eff3=Effect("change", "maintenance", 1, scope="brothel"), base_description = __("She was kidnapped, but cares deeply about you due to Stockholm Syndrome.")),
                "Frigid" : Trait(_("Composed"), verb = "be", eff1 = Effect("change", "libido", -10), eff2 = Effect("increase satisfaction", "masseuse", 1), eff3=Effect("increase satisfaction", "dancer", 1), opposite = "Horny", base_description = __("She is always calm and collected, which allows the customers to wind down.")),
                "Asexual" : Trait(_("Celibate"), verb = "be", effects = [Effect("change", "libido", -50), Effect("increase satisfaction", "all sex acts", -1), Effect("increase satisfaction", "all jobs", 1)], opposite = "Pervert", base_description = __("She has little to no interest in intimacy, but understands that she must earn her keep one way or the other.")),
                ...
                "Half-elf" : Trait(_("Fey Blood"), verb = "be a", effects=[Effect("boost", "tiredness", -0.1)], base_description = __("She has elven blood running through her veins, but customers don't seem to mind.")),
                "Monsterkin" : Trait(_("Beastly"), verb = "be a", effects=[Effect("special", "immune", 1), Effect("change", "security", -1, scope = "brothel")], base_description = __("Some believe that she was birthed by a monster. But don't let that scare you, she's an admirable creature once you get to know her.")),
